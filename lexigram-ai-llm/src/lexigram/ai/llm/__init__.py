...
_LAZY_IMPORTS: dict[str, str] = {
    ...
    "OpenRouterPricingSource": "lexigram.ai.llm.pricing",
    "OutputFilter": "lexigram.ai.llm.security.core",
    "ParseError": "lexigram.ai.llm.structured.exceptions",
    "PricingConfig": "lexigram.ai.llm.config",
    "PricingCostEstimator": "lexigram.ai.llm.pricing.estimator",
    "PricingManager": "lexigram.ai.llm.pricing",
    "PricingManagerBuilder": "lexigram.ai.llm.pricing",
    "PricingSourceConfig": "lexigram.ai.llm.config",
