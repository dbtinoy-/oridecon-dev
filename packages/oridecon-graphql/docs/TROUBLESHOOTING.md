---
title: oridecon-graphql Troubleshooting
...
**Fix:** Wire `oridecon-auth` to authenticate requests before they reach the GraphQL controller. Add `@strawberry.field(permission_classes=[IsAuthenticated])` to protected fields.
