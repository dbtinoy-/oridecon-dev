---
title: oridecon-graphql How-Tos
...
```python
from oridecon.graphql.config import GraphQLConfig, PersistedQueryConfig
...
```python
from oridecon.graphql.security.permissions import AbstractPermission
import strawberry
...
```bash
uv add oridecon-graphql[subscriptions]
```
...
```python
from oridecon.graphql.config import GraphQLConfig, DepthLimitConfig
...
```python
from oridecon.graphql import GraphQLError, GraphQLErrorCode
...
```python
from oridecon.graphql import trace_resolver
