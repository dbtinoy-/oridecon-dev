...
from oridecon.graphql.subscriptions.protocol import GQLWSMessageType
from oridecon.graphql.subscriptions.transport._connection import SubscriptionConnection
from oridecon.graphql.types import SubscriptionInfo
from oridecon.logging import get_logger

if TYPE_CHECKING:
    from collections.abc import AsyncIterator, Awaitable, Callable

    from oridecon.contracts.graphql.protocols import SubscriptionAuthHandlerProtocol
    from oridecon.contracts.web import WebSocketProtocol

logger = get_logger(__name__)

from oridecon.graphql.subscriptions.transport._messaging import _WSMessagingMixin
    ...
    def __init__(
        ...
        Args:
            ...
            subscription_auth_handler: Optional per-subscription authorization
                ...
                :meth:`~oridecon.contracts.graphql.protocols.SubscriptionAuthHandlerProtocol.authorize`
    ...
    async def handle(
        ...
        Args:
            websocket: The WebSocket connection; any object satisfying
                :class:`~oridecon.contracts.http.WebSocketProtocol`
    ...
    async def _handle_subscribe(
        ...
        try:
            ...
            if self._context_factory:
                from oridecon.graphql.core.context import GraphQLRequest as GQLRequest
