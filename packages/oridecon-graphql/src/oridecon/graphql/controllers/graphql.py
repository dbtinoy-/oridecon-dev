"""GraphQL Controller for oridecon-web integration.

This module provides a Controller-based implementation for GraphQL endpoints,
following the oridecon-contracts.web.Controller pattern.
"""
...
from oridecon.contracts.web import post
from oridecon.contracts.web.controller import ControllerProtocol
from oridecon.graphql import constants as const
from oridecon.graphql.exceptions import AuthenticationError
from oridecon.logging import get_logger

if TYPE_CHECKING:
    # GraphQLExecutorProtocol imported by providers/tests; not needed here now
    from oridecon.contracts.core.di import ContainerProtocol
    from oridecon.contracts.graphql import GraphQLRequestProtocol
...
class GraphQLController(ControllerProtocol):
    ...
    Example:
        ...
        ``oridecon.web`` directly::

            from oridecon.contracts.web.protocols import HTTPApplicationProtocol
