...
from oridecon.contracts.graphql.protocols import GraphQLExecutorProtocol
...
class GraphQLModule(Module):
    ...
    def configure(
        ...
        Args:
            config: :class:`~oridecon.graphql.config.GraphQLConfig` or ``None``
            ...
            context_factory_class: Optional custom :class:`~oridecon.graphql.core.context.ContextFactory`
