"""Oridecon GraphQL Provider

Provider for GraphQL functionality in Oridecon Framework.
"""
...
from oridecon.contracts.web import WebRateLimiterProtocol
from oridecon.di.provider import Provider
from oridecon.graphql import constants as const
...
if TYPE_CHECKING:
    ...
    from oridecon.graphql.core.caching import ResponseCache
    from oridecon.graphql.core.context import ContextFactory
    from oridecon.graphql.core.execution import GraphQLExecutorProtocol
    from oridecon.graphql.monitoring.metrics import MetricsCollectorProtocol

    # Types used only for annotations inside the provider
    from oridecon.graphql.schema.builder import SchemaBuilderProtocol
    from oridecon.graphql.security.rate_limit import UnifiedRateLimiter
...
from oridecon.graphql.di._discovery import _GraphQLDiscoveryMixin
from oridecon.graphql.di._schema_diff import run_schema_diff


class GraphQLProvider(_GraphQLDiscoveryMixin, Provider):
    """Provider for GraphQL functionality.

    This provider integrates GraphQL capabilities into the Oridecon Framework,
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.graphql.controllers import GraphQLController
        from oridecon.graphql.core.caching import ResponseCache
        from oridecon.graphql.core.context import ContextFactory
        from oridecon.graphql.core.execution import GraphQLExecutorProtocol
        from oridecon.graphql.dataloader.cache import InMemoryCache
        from oridecon.graphql.monitoring.metrics import MetricsCollectorProtocol
        from oridecon.graphql.schema.builder import SchemaBuilderProtocol
        from oridecon.graphql.security.rate_limit import RateLimiter, UnifiedRateLimiter
        ...
        from oridecon.contracts.graphql.protocols import WebSocketTransportProtocol
    ...
    async def boot(self, container: BootContainerProtocol) -> None:
        ...
        from oridecon.graphql.core.caching import ResponseCache, _MemoryCacheShim
        ...
        from oridecon.graphql.subscriptions.transport import GraphQLWSTransport
        ...
        with contextlib.suppress(
            ...
            from oridecon.graphql.subscriptions.auth import SubscriptionAuth
