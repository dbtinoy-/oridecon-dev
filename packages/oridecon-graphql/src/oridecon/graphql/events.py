...
Typed :class:`~oridecon.contracts.domain.events.DomainEvent` subclasses
published to the :class:`~oridecon.contracts.events.EventBusProtocol` during
...
Example::
    ...
    from oridecon.graphql.events import AfterExecuteEvent
...
if TYPE_CHECKING:
    from oridecon.graphql.core.execution import ExecutionContextProtocol
