...
class SchemaValidator:
    ...
    delegating depth enforcement to :class:`~oridecon.graphql.security.depth.DepthLimitValidator`
    and alias enforcement to :class:`~oridecon.graphql.security.alias.AliasLimitValidator`.
    ...
    def __init__(
        ...
        """
        from oridecon.graphql.security.alias import AliasLimitValidator
        from oridecon.graphql.security.complexity import ComplexityAnalyzer
        from oridecon.graphql.security.depth import DepthLimitValidator
