...
class SchemaBuilderProtocol:
    ...
    def add_dataloader(self, name: str, factory: Any) -> SchemaBuilderProtocol:
        ...
        :class:`~oridecon.graphql.providers.GraphQLProvider` during ``boot()``,
    ...
    def build(self) -> Schema:
        ...
        from oridecon.graphql.core.introspection import IntrospectionGuardExtension
        from oridecon.graphql.security.alias import AliasLimitExtension
        from oridecon.graphql.security.complexity import ComplexityLimitExtension
        from oridecon.graphql.security.depth import DepthLimitExtension

        cfg = self._config
        env_raw: str = cfg.env or os.getenv("ORI_ENV", "development") or "development"
