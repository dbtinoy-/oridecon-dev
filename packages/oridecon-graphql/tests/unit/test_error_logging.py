...
from oridecon.graphql.core.error_logging import ErrorLogEntry, ErrorLogger, QueryLogger
...
class TestDefaultInstances:
    def test_default_error_logger(self) -> None:
        from oridecon.graphql.core.error_logging import default_error_logger

        assert isinstance(default_error_logger, ErrorLogger)

    def test_default_query_logger(self) -> None:
        from oridecon.graphql.core.error_logging import default_query_logger
