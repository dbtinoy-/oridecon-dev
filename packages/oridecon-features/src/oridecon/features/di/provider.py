...
:class:`FeatureFlagsProvider` registers a :class:`~oridecon.features.manager.FlagManager`
...
:class:`~oridecon.features.backends.local.LocalProvider` for
the simple boolean contract and a
:class:`~oridecon.features.backends.local.LocalProvider` backed by
...
class FeatureFlagsProvider(Provider):
    ...
    * ``FlagManager`` as a singleton wrapping a
      :class:`~oridecon.features.backends.local.LocalProvider` seeded from
      :attr:`~oridecon.features.config.FeatureFlagsConfig.initial_flags`.
    """
