...
from oridecon.features.constants import (
    DEFAULT_CACHE_TTL,
    DEFAULT_ENABLED,
...
from oridecon.features.types import Flag
...
class FeatureFlagsConfig(BaseConfig):
    ...
    :class:`~oridecon.feature_flags.manager.FlagManager` instance.
    """
