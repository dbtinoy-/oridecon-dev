...
from oridecon.features.decorators._utils import _is_coroutinefunction, _resolve_manager
...
def feature_flag(
    ...
    * Otherwise :class:`~oridecon.features.exceptions.FeatureFlagDisabledError`
      is raised.

    Args:
        name: Feature flag name to check.
        manager: Explicit :class:`~oridecon.features.manager.FlagManager`; resolved
