...
from oridecon.features.decorators._utils import _resolve_manager
from oridecon.features.exceptions import FeatureFlagDisabledError

if TYPE_CHECKING:
    from oridecon.features.manager.flag_manager import FlagManager
...
def feature_flag_sync(
    ...
    *,
    ...
    Evaluation uses :meth:`~oridecon.features.backends.base.AbstractFlagProvider.evaluate_sync`
...
def require_flag_sync(
    ...
    *,
    ...
    """Synchronous variant of :func:`~oridecon.features.decorators.require_flag`.

    Raises :class:`~oridecon.features.exceptions.FeatureFlagDisabledError`
