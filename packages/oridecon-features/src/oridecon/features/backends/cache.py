...
Stores flag definitions in a :class:`~oridecon.contracts.cache.protocols.CacheBackendProtocol`
...
* :meth:`CacheBackendFlagProvider.list_flags` returns an empty list because
  ...
  supports enumeration (e.g. :class:`~oridecon.features.backends.local.LocalProvider`).
"""
...
from oridecon.features.exceptions import FlagNotFoundError
from oridecon.features.types import Flag, FlagType
...
class CacheBackendFlagProvider:
    ...
    Args:
        ...
        prefix: Key prefix applied to every flag name to avoid collisions
            with other cache users.  Defaults to ``"oridecon:features:flag:"``.
    """
    ...
    def __init__(
        ...
        ttl: int = 3600,
        prefix: str = "oridecon:features:flag:",
    ) -> None:
        self._cache = cache
        self._ttl = ttl
        self._prefix = prefix
    ...
    async def list_flags(self) -> list[Flag]:
        ...
        .. note::
            ...
            :class:`~oridecon.contracts.cache.protocols.CacheBackendProtocol` protocol
            ...
            :class:`~oridecon.features.backends.local.LocalProvider`.
    ...
    async def evaluate(self, name: str, context: dict[str, Any] | None = None) -> bool:
        ...
        :class:`~oridecon.features.backends.base.AbstractFlagProvider`.
