...
in application code. It wraps any :class:`~oridecon.features.backends.base.AbstractFlagProvider`
...
from oridecon.features.types import FlagContext, FlagEvaluation
...
if TYPE_CHECKING:
    ...
    from oridecon.features.manager.types import (
...
class FlagManager:
    ...
    Wraps an :class:`~oridecon.features.backends.base.AbstractFlagProvider` and
    ...
    async def evaluate(
        ...
        Returns:
            A :class:`~oridecon.features.types.FlagEvaluation` result.
        """
    ...
    async def get_value(
        ...
        from oridecon.features.backends.base import _dict_to_context
