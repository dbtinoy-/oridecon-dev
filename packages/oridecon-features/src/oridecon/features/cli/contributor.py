...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.features.cli.generators.flag:FeatureFlagGenerator",
        "src/features",
    ),
)
...
class FeaturesCliContributor:
    """CLI contributor for the oridecon-features package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.features.cli.commands:create_features_app",
                contributor="features",
                category="features",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.features.cli.checks:check_flag_manager",
                contributor="features",
                category="features",
                timeout=5.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.features.cli.doctor:check_features_config",
                contributor="features",
                category="features",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.features.cli.shell:provide_flag_manager",
                contributor="features",
            ),
        ]
