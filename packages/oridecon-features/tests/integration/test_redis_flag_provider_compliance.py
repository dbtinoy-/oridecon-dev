...
from oridecon.testing.compliance import FlagProviderCompliance
from oridecon.testing.integration.fixtures import redis_client  # noqa: F401
...
class TestRedisFlagProviderCompliance(FlagProviderCompliance):
    ...
    async def create_provider(self) -> object:
        ...
        """
        try:
            from oridecon.features.backends.cache import (
