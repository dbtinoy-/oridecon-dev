...
Internal design of the `oridecon-workflow` package.
...
|------|-----------|---------|-------|--------|
| `AgentNode` | `AGENT` | Execute a Oridecon agent | `state[input_key]` | `state[output_key]` |
...
|----------|---------------|--------|
| `PipelineProtocol` | `Pipeline` | `oridecon.contracts.workflow` |
| `PipelineStepProtocol` | `FunctionStep`, `ConditionalStep`, `ParallelStep` | `oridecon.contracts.workflow` |
| `PipelineContextProtocol` | `PipelineContext` | `oridecon.contracts.workflow` |
| `SagaProtocol` | `AbstractSaga` | `oridecon.contracts.workflow` |
| `SagaStoreProtocol` | User-provided | `oridecon.contracts.workflow` |
| `StateMachineProtocol` | `StateMachine` | `oridecon.contracts.workflow` |
| `StatePersistenceProtocol` | `DatabaseStatePersistence` | `oridecon.contracts.workflow` |
| `WorkflowGraphProtocol` | `WorkflowBuilder` | `oridecon.contracts.workflow` |
| `WorkflowNodeProtocol` | `AbstractWorkflowNode` | `oridecon.contracts.workflow` |
| `ExecutionProtocol` | `WorkflowEngine` | `oridecon.contracts.workflow` |
| `BulkProcessorProtocol` | `BulkOperation` | `oridecon.contracts.workflow` |
| `ApprovalProtocol` | User-provided | `oridecon.contracts.workflow` |
| `CacheBackendProtocol` | User-provided (checkpoints) | `oridecon.contracts.infra.cache` |
| `CircuitBreakerProtocol` | User-provided | `oridecon.contracts.infra.resilience` |
| `DatabaseProviderProtocol` | User-provided (state) | `oridecon.contracts.data` |

Shared types (`SagaStep`, `SagaStepError`, `StateTransitionRecord`) and enums (`SagaState`) live in `oridecon.contracts.workflow`.
...
| CLI commands | Automatic via `oridecon.cli.contributors` entry point | `WorkflowCliContributor` |
