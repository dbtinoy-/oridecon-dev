...
class ApprovalChain:
    """Orchestrates a sequence of :class:`~oridecon.workflow.approval.ApprovalStep`
    objects under a configurable :class:`~oridecon.workflow.approval.ApprovalPolicy`.
    ...
    Example::
        ...
        from oridecon.workflow.approval import ApprovalChain, ApprovalStep, ApprovalPolicy
