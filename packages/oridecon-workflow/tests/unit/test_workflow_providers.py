...
from oridecon.contracts.workflow import SagaStoreProtocol, StateMachineProtocol, StatePersistenceProtocol
from oridecon.workflow.config import BulkOperationConfig, GraphConfig
...
class TestWorkflowModuleStub:
    ...
    def test_stub_exports_pipeline_protocol(self):
        from oridecon.contracts.workflow import PipelineProtocol
