"""Unit tests for oridecon.workflow.constants module."""

from __future__ import annotations

import pytest

from oridecon.workflow import constants
...
class TestGraphEngineConstants:
    ...
    def test_graph_env_prefix(self) -> None:
        ...
        assert constants.GRAPH_ENV_PREFIX == "ORI_WORKFLOW__GRAPH__"
    ...
    def test_graph_env_prefix_format(self) -> None:
        ...
        assert constants.GRAPH_ENV_PREFIX.startswith("ORI_")
