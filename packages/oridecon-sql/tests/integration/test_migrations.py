"""Tests for Oridecon DB migrations"""
...
from oridecon.sql.migrations.manager import ALEMBIC_AVAILABLE
...
class TestMigrationUtilities:
    ...
    async def test_init_migrations(self, tmp_path):
        ...
        from oridecon.sql.migrations import init_migrations
    ...
    async def test_create_migration(self, tmp_path):
        ...
        from oridecon.sql.migrations import create_migration
    ...
    async def test_migrate_up(self, tmp_path):
        ...
        from oridecon.sql.migrations import migrate_up
