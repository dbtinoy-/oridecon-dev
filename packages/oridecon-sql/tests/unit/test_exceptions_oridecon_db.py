...
class TestDatabaseExceptions:
    ...
    def test_database_error_inheritance(self):
        """Test DatabaseError inherits from OrideconError"""
        error = DatabaseError("Test error")
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_DB_001] Test error")
    ...
    def test_connection_error_inheritance(self):
        ...
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_001] Connection failed")
    ...
    def test_connection_pool_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_004] Pool exhausted")
    ...
    def test_transaction_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_013] Transaction failed")
    ...
    def test_query_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_005] Query failed")
    ...
    def test_migration_error_inheritance(self):
        ...
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_DB_002] Migration failed")
    ...
    def test_schema_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_019] Schema error")
    ...
    def test_integrity_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_008] Integrity violation")
    ...
    def test_lock_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_017] Lock error")
    ...
    def test_unit_of_work_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_024] Unit of work error")
    ...
    def test_repository_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_023] RepositoryProtocol error")
    ...
    def test_not_found_error_inheritance(self):
        ...
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_DOM_002] Entity not found")
    ...
    def test_duplicate_key_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_009] Duplicate key")
    ...
    def test_foreign_key_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_010] Foreign key violation")
    ...
    def test_check_constraint_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_012] Check constraint violation")
    ...
    def test_deadlock_error_inheritance(self):
        ...
        assert isinstance(error, DatabaseError)
        assert isinstance(error, OrideconError)
        assert str(error).startswith("[ORI_ERR_SQL_018] Deadlock detected")

    def test_all_exceptions_exported(self):
        """Test that all exception classes are properly exported"""
        import oridecon.sql.exceptions as db_exceptions
        from oridecon.sql.exceptions import __all__ as exported_exceptions
        ...
        for exception_name in exported_exceptions:
            assert hasattr(db_exceptions, exception_name), f"{exception_name} not found in oridecon.sql.exceptions"
