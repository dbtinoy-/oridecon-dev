"""Unit tests for oridecon-sql exceptions.

This module contains tests for the exception hierarchy in oridecon.sql.exceptions.
...
class TestDatabaseExceptionHierarchy:
    ...
    def test_database_error_inherits_from_oridecon_error(self) -> None:
        from oridecon.contracts.exceptions import OrideconError

        assert issubclass(DatabaseError, OrideconError)
...
class TestDataLayerExceptions:
    ...
    def test_data_error_inherits_from_oridecon_error(self) -> None:
        from oridecon.contracts.exceptions import OrideconError

        assert issubclass(DataError, OrideconError)
...
class TestExceptionAllExports:
    ...
    def test_all_contains_all_exceptions(self) -> None:
        from oridecon.sql import exceptions as exc_module
