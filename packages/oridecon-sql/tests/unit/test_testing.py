...
# Skip this module if `oridecon.testing` isn't importable in this environment.
# pytest.importorskip("oridecon.testing")
try:
    from oridecon.testing import DatabaseTestBed, DatabaseTestClient
except ImportError:
    DatabaseTestBed = None
    DatabaseTestClient = None


@pytest.mark.skipif(DatabaseTestClient is None, reason="oridecon.testing not available")
...
@pytest.mark.skipif(DatabaseTestBed is None, reason="oridecon.testing not available")
