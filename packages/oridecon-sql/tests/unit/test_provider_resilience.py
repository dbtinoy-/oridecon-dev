...
from oridecon.sql import DatabaseService, HealthStatus
from oridecon.sql.exceptions import DatabaseConnectionError
...
class _FakeRetryPipeline:
    ...
    async def execute(self, func, *args, **kwargs):
        from oridecon.sql.resilience.core import retry_call
