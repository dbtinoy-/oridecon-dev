"""Unit tests for oridecon.sql.exceptions module."""

import pytest

from oridecon.contracts.exceptions import OrideconError
from oridecon.sql import exceptions as exc


class TestExceptionHierarchy:
    """Tests for exception hierarchy."""

    def test_database_error_inherits_from_oridecon_error(self):
        assert issubclass(exc.DatabaseError, OrideconError)
...
class TestDataLayerExceptions:
    ...
    def test_data_error_inherits_from_oridecon_error(self):
        assert issubclass(exc.DataError, OrideconError)
