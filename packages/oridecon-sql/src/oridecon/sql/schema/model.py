"""Declarative schema model system for oridecon-sql.

Provides a Prisma/Django-inspired model definition system:

    from oridecon.sql.schema import Model, Field, Index, Relationship
...
from oridecon.sql.schema.descriptors import (
...
from oridecon.sql.schema.field_types import _TYPE_MAP, _get_sql_type
from oridecon.sql.schema.field_types import FieldType as FieldType
from oridecon.sql.schema.hooks import _model_hooks as _model_hooks
from oridecon.sql.schema.hooks import after_create as after_create
from oridecon.sql.schema.hooks import after_delete as after_delete
from oridecon.sql.schema.hooks import after_update as after_update
from oridecon.sql.schema.hooks import before_create as before_create
from oridecon.sql.schema.hooks import before_delete as before_delete
from oridecon.sql.schema.hooks import before_update as before_update
from oridecon.sql.schema.hooks import fire_hooks as fire_hooks
...
class Model(metaclass=ModelMeta):
    ...
    In the Oridecon architecture, a `Model` represents the data-access layer
    ...
    - **Entity (Domain Layer):** A pure Python object containing core business
      ...
      Defined in `oridecon-contracts` or the application's domain package.
