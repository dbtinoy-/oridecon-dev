...
from oridecon.contracts.exceptions.infra import NoPrimaryBackendError
from oridecon.di.provider import Provider, ProviderPriority
from oridecon.logging import get_logger
from oridecon.primitives.context import Context
from oridecon.sql.providers.database_service import (  # noqa: F401 — tests patch this name here
    DatabaseService,
)
...
from oridecon.sql.di._registration import _DatabaseRegistrationMixin
...
class DatabaseProvider(_DatabaseRegistrationMixin, Provider):
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        # Wire optional resilience pipeline factory (provided by oridecon-resilience).
    ...
    def _register_admin_widgets(
        ...
        from oridecon.sql.admin.handlers.migration_status import (
        ...
        from oridecon.sql.migrations.runner import MigrationRunnerAdapter
