...
class _DatabaseRegistrationMixin:
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.sql.config import DataConfig
        from oridecon.sql.query.compiler import PredicateCompiler
    ...
    async def _register_single_backend(
        ...
        # that want to run/rollback migrations without importing oridecon-sql internals.
        ...
        try:
            ...
            from oridecon.sql.di.provider import _warn_alembic_missing  # noqa: PLC0415

            _warn_alembic_missing()

        # Database-backed search backends have moved to oridecon-search
        # (`oridecon.search.backends.mysql` / `oridecon.search.backends.postgres`).
        ...
        # no longer imports from oridecon.sql.search to keep the package boundary clean.
    ...
    def _register_shared_stores(
        ...
        from oridecon.contracts.core.stores import LockStoreProtocol
        from oridecon.contracts.infra import StateStoreProtocol
    ...
    def _register_migration_runner(
        ...
        """
        from oridecon.contracts import MigrationManagerProtocol
        from oridecon.contracts.data.sql.migrations import MigrationRunnerProtocol
        from oridecon.sql.migrations.runner import MigrationRunnerAdapter
