...
the container without depending on oridecon-sql's internal class hierarchy.
"""

from __future__ import annotations

from oridecon.contracts.data.sql.migrations import (
...
class MigrationRunnerAdapter:
    ...
    oridecon-sql internals directly.
