...
:class:`~oridecon.contracts.domain.pagination.CursorPage` results.  Uses
:class:`~oridecon.data.query.cursor.CursorCodec` for opaque cursor encoding.
"""
...
from oridecon.contracts.domain.pagination import CursorPage
...
class CursorPaginator(Generic[T]):
    ...
    Args:
        ...
        codec: Codec used to encode/decode cursor strings.  If omitted, a
            default :class:`~oridecon.data.query.cursor.CursorCodec` is used.
    ...
    async def paginate(
        ...
        **kwargs: Any,
        ...
        Returns:
            A :class:`~oridecon.contracts.domain.pagination.CursorPage` with
