"""Protocol definitions for oridecon-sql API."""
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts import ContainerResolverProtocol, HealthCheckResult
...
class ConnectionProtocol(Protocol):
    ...
    Mirrors ``oridecon.sql.abstractions.connection.DatabaseConnection``:
