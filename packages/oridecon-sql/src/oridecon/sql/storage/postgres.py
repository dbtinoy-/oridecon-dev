"""PostgreSQL-backed key-value storage for Oridecon Framework.

This module provides :class:`PostgresStorage`, a :class:`~oridecon.contracts.StorageBackendProtocol`
...
:mod:`oridecon.sql.providers.postgres_provider`, which is a *database
...
when you need full SQL access via the Oridecon DB abstraction.
"""
...
from oridecon.contracts import StorageBackendProtocol, StorageType
