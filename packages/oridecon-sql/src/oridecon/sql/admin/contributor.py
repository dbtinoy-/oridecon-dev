"""SQL admin contributor — provides widget and health data for oridecon-sql."""
...
from oridecon.contracts import Result
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        contributor="sql",
        handler="oridecon.sql.admin.actions:run_migrations",
        icon="arrow-up-circle",
        category="operations",
    ),
)
...
class SqlAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-sql package.
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        ...
        return [
            ManagementPageDefinition(
                ...
                contributor="sql",
                route_path="/sql",
                handler="oridecon.sql.admin.pages.overview:SqlOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.sql.admin.pages.migrations:SqlMigrationsPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="arrow-up-circle",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.sql.admin.pages.queries:SqlQueriesPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="search",
