...
::
    ...
    OrideconError (from oridecon.exceptions)
    └── DatabaseError
        ...
        │   ├── TableNotFoundError
        │   ├── ColumnNotFoundError
        │   └── MigrationError (from oridecon.exceptions)
        ├── LockError
...
class DuplicateKeyError(IntegrityError):
    ...
    _code: str = "ORI_ERR_SQL_009"


class ForeignKeyError(IntegrityError):
    """Foreign key constraint violated."""

    _code: str = "ORI_ERR_SQL_010"
...
class SchemaError(DatabaseError):
    ...
    _code: str = "ORI_ERR_SQL_019"


class TableNotFoundError(SchemaError):
    """Referenced table does not exist."""

    _code: str = "ORI_ERR_SQL_020"


class ColumnNotFoundError(SchemaError):
    """Referenced column does not exist."""

    _code: str = "ORI_ERR_SQL_021"


# Note: MigrationError is imported from oridecon.exceptions and
...
class DataError(OrideconError):
    """Base exception for data access layer failures."""

    _code: str = "ORI_ERR_SQL_026"
...
class TenantScopingError(DatabaseError):
    ...
    Mirrors :class:`~oridecon.sql.row_level_security.NoSecurityPolicyError`:
