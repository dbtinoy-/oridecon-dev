"""Lazy loader implementation for oridecon-sql providers."""
...
def _lazy_import(name: str) -> Any:
    ...
    module_map = {
        "PostgresProvider": "oridecon.sql.providers.postgres_provider",
        "MySQLProvider": "oridecon.sql.providers.mysql_provider",
    }
