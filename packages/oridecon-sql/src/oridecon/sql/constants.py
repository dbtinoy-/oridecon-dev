"""Package-level constants for oridecon-sql.
...
try:
    __version__: str = importlib.metadata.version("oridecon-sql")
except ImportError:
    __version__ = "0.0.0"
...
ENV_PREFIX: str = "ORI_SQL__"
ENV_NESTED_DELIMITER: str = "__"
"""Delimiter for nested env var keys (e.g. ORI_SQL__POOL__MAX_SIZE)."""
...
# ---------------------------------------------------------------------------
# Pagination defaults (moved from oridecon.data)
# ---------------------------------------------------------------------------
