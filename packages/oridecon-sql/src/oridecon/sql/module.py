...
from oridecon.contracts.data import DatabaseProviderProtocol, UnitOfWorkProtocol
...
class DatabaseModule(Module):
    ...
    Registers :class:`~oridecon.contracts.data.DatabaseProviderProtocol` and
    :class:`~oridecon.contracts.data.UnitOfWorkProtocol` for constructor injection.
    ...
    def configure(
        ...
        Args:
            config: A :class:`~oridecon.sql.config.DatabaseConfig` instance,
    ...
    def stub(cls, config: DatabaseConfig | None = None) -> DynamicModule:
        ...
        Args:
            config: Optional :class:`~oridecon.sql.config.DatabaseConfig`
