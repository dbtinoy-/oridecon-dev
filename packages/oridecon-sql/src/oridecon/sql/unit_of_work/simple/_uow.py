...
from oridecon.sql.exceptions import DatabaseConnectionError, DatabaseError, QueryError
from oridecon.sql.unit_of_work.base import AbstractUnitOfWork
from oridecon.sql.unit_of_work.simple._operations import (  # noqa: F401
...
class SimpleUnitOfWork(AbstractUnitOfWork):
    ...
    Extends :class:`~oridecon.data.uow.base.AbstractUnitOfWork` with full DB
