"""Unit of Work implementation for the Oridecon DB package.

Extends :class:`oridecon.data.uow.base.AbstractUnitOfWork` with SQL-transaction
...
from oridecon.sql.unit_of_work.simple._operations import (
...
from oridecon.sql.unit_of_work.simple._uow import SimpleUnitOfWork, unit_of_work
