...
from oridecon.contracts.data import ConnectionPoolProtocol
...
from oridecon.sql.backends.sqlite._connection import HAS_MONITORING, SQLiteConnection
from oridecon.sql.backends.sqlite._shims import (  # noqa: F401
    HAS_MONITORING,
    HAS_SQLITE,
    DatabaseMonitor,
    aiosqlite,
...
class SQLiteConnectionPool(ConnectionPoolProtocol):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not HAS_SQLITE:
            raise ImportError(
                "aiosqlite is required for SQLite support. Install with: pip install oridecon-sql[sqlite]",
            )
