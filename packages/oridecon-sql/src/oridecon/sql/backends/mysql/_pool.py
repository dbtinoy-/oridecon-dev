...
from oridecon.contracts.infra.resilience import CircuitBreakerProtocol, RetryConfig
from oridecon.logging import get_logger
from oridecon.primitives import clock as ambient_clock
from oridecon.sql.backends.mysql._shims import (
    HAS_MYSQL,
    MySQLError,
    aiomysql,
)
...
class MySQLConnectionPool(ConnectionPoolProtocol):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not HAS_MYSQL:
            raise ImportError(
                "aiomysql is required for MySQL support. Install with: pip install oridecon-sql[mysql]",
            )
