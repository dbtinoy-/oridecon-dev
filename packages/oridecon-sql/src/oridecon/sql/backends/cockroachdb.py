...
asyncpg-based :class:`~oridecon.sql.backends.postgres.PostgresConnectionPool`
...
from oridecon.sql.backends.postgres import PostgresConnectionPool
...
class CockroachDBConnection(PostgresConnectionPool):
    ...
    Args:
        ...
        **kwargs: Additional keyword arguments forwarded to
            :class:`~oridecon.sql.backends.postgres.PostgresConnectionPool`.
    """
    ...
    async def _create_pool(self, pool_kwargs: dict[str, Any]) -> None:
        ...
        server_settings.setdefault("application_name", "oridecon-cockroachdb")
