...
Example:
    from oridecon.sql.repositories.cached import CachedRepository

    cached_repo = CachedRepository(
        inner=user_repo,
        cache=redis_backend,  # Implements oridecon.contracts.cache.protocols.CacheBackendProtocol
        ttl=300,
    )
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.security import HasherProtocol
