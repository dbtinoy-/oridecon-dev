"""SQL Repository pattern implementation for the Oridecon DB package.

Provides :class:`SQLRepository`, a concrete SQL-backed implementation of
``AbstractRepository`` from ``oridecon.data``.
"""
...
from oridecon.contracts.data.identifiers import Column, Table
from oridecon.logging import get_logger
from oridecon.primitives.data import AbstractRepository
from oridecon.sql.context.keys import TENANT_ID
from oridecon.sql.repositories._advanced_mixin import _AdvancedMixin
from oridecon.sql.repositories._filter_mixin import _FilterMixin
from oridecon.sql.repositories._read_mixin import _ReadMixin
from oridecon.sql.repositories._rls_mixin import _RLSMixin
from oridecon.sql.repositories._write_mixin import _WriteMixin

if TYPE_CHECKING:
    from oridecon.contracts import DatabaseProviderProtocol
    from oridecon.sql.context import DbContext
    from oridecon.sql.row_level_security import RowLevelSecurityPolicy
...
class SQLRepository(  # type: ignore[misc]
    ...
    and quoted at construction time using the :mod:`oridecon.sql.sql`
    ...
    async def delete(self, entity_or_id: Any) -> bool:
        ...
        """
        from oridecon.sql.exceptions import RepositoryError
