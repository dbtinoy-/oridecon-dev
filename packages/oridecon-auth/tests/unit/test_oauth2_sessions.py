...
class TestOrideconConnectSession:
    """Test OrideconConnect session adapter"""

    def setup_method(self):
        """Setup test method"""
        self.mock_http_client = AsyncMock()
        self.session = OrideconConnectSession(self.mock_http_client)
    ...
    async def test_request_get(self):
        ...
        assert isinstance(response, OrideconConnectResponse)
...
class TestOrideconConnectResponse:
    """Test OrideconConnect response adapter"""
    ...
    def setup_method(self):
        ...
        self.response = OrideconConnectResponse(self.mock_response)
