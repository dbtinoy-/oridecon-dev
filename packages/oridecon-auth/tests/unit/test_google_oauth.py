...
from oridecon.contracts.auth import VerifiedIdentityClaims
...
class TestGoogleOAuthService:
    ...
    async def test_verify_id_token_returns_verified_claims(
        ...
        mocker.patch(
            "oridecon.auth.authn.google_oauth.jwt.get_unverified_header",
        ...
        with (
            ...
            patch(
                "oridecon.auth.authn.google_oauth.jwt.algorithms.RSAAlgorithm.from_jwk",
                return_value="public-key",
            ),
            patch(
                "oridecon.auth.authn.google_oauth.jwt.decode",
                return_value={
                    "sub": "google-sub",
