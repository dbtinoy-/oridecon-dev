...
from oridecon.auth.web.guards import AuthGuard, use_guards
from oridecon.di.container import Container
from oridecon.primitives.context import Context, request_scope
...
async def test_auth_guard_accepts_request_context_identity_without_request_state_user() -> (
    ...
    request.scope = {"oridecon_resolver": SimpleNamespace(resolve=resolve)}
