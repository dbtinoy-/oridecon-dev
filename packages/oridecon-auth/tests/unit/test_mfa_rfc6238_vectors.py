...
:mod:`oridecon.auth.authn.mfa` against the official test vectors
...
from oridecon.auth.authn.mfa import _hotp, generate_totp_code
...
class TestTOTPRFC6238Vectors:
    ...
    def test_totp_default_is_6_digits(self) -> None:
        ...
        from oridecon.auth.authn.mfa import DEFAULT_TOTP_DIGITS
