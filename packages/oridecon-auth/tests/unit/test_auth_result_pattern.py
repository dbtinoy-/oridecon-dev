...
from oridecon.auth.services import AuthServiceWithResultPattern
...
class TestAuthServiceResultPattern:
    ...
    async def test_error_codes_set_correctly(self) -> None:
        ...
        assert AuthError._code == "ORI_ERR_AUTH_004"
        assert InvalidCredentialsError._code == "ORI_ERR_AUTH_007"
        assert PasswordPolicyError._code == "ORI_ERR_AUTH_024"
        assert TokenExpiredError._code == "ORI_ERR_AUTH_012"
        assert TokenBlacklistedError._code == "ORI_ERR_AUTH_013"
