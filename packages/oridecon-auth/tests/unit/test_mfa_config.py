...
from oridecon.auth.config import AuthConfig, BackupCodeConfig, MFAConfig, TOTPConfig
...
def test_mfa_config_defaults() -> None:
    ...
    assert cfg.backup.issuer == "oridecon"
...
def test_mfa_config_partial_dict() -> None:
    ...
    assert cfg.backup.issuer == "oridecon"  # default
