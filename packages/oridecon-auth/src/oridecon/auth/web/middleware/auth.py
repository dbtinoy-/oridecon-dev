...
from oridecon.auth.config import AuthMiddlewareConfig
from oridecon.logging import get_logger
from oridecon.primitives.context import USER_ID, Context

if TYPE_CHECKING:
    from collections.abc import Callable

    from oridecon.auth.authn.services import LoginAttemptTracker
    from oridecon.auth.models.user import User
    from oridecon.contracts import AuthProviderProtocol
    from oridecon.contracts.web import RequestProtocol as Request

from datetime import UTC

# Re-export guards for convenience
from oridecon.auth.authz.guards import optional_auth, require_permissions, require_roles
from oridecon.auth.web.middleware.api_key_authenticator import ApiKeyAuthenticator
from oridecon.auth.web.middleware.jwt_authenticator import JwtAuthenticator
from oridecon.auth.web.middleware.response_handler import AuthResponseHandler
from oridecon.auth.web.middleware.session_authenticator import SessionAuthenticator
from oridecon.auth.web.middleware.session_validator import SessionValidator
from oridecon.auth.web.middleware.throttle import RateLimitMiddleware
from oridecon.auth.web.middleware.token_cache import TokenCache
from oridecon.auth.web.middleware.token_extractor import TokenExtractor
...
class AuthMiddleware:
    ...
    async def __call__(
        ...
        from oridecon.di.resolution.context import get_resolver
...
# RateLimitMiddleware has been moved to oridecon.auth.web.middleware.throttle
...
async def _get_auth_provider(context: Any | None = None) -> AuthProviderProtocol:
    ...
    from oridecon.contracts.auth import AuthProviderProtocol
    from oridecon.di.resolution.context import get_resolver
