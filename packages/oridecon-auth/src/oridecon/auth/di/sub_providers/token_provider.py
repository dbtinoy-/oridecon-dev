# oridecon/auth/providers/token_provider.py
        ...
        **kwargs: Any,
        ...
        if secret_key:
            ...
            if env in _STRICT_ENVS:
                raise ConfigurationError(
                    ...
                    "Set ORI_AUTH__TOKEN__SECRET_KEY (or pass a configured AuthConfig)."
                )
        ...
        if resolved_secret is None:
            ...
            logger.warning(
                ...
                "restart; set ORI_AUTH__TOKEN__SECRET_KEY for stable dev secrets.",
            )
