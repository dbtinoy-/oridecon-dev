...
:class:`~oridecon.auth.authz.service.AuthorizationService`, which is either
injected at construction time or created as a default instance.

Example::

    from oridecon.auth.authz.guards import require_auth, require_roles
...
class AuthorizationGuard:
    ...
    async def check_authorization(self, user: User | None) -> bool:
        ...
        Returns:
            ...
            :class:`~oridecon.auth.authz.service.AuthorizationService` for
