"""Unified Authorization Service for Oridecon.
...
See Also:
    - :class:`oridecon.auth.policies.engine.PolicyEngine`: ABAC policy engine.
    - :class:`oridecon.auth.types.RoleDefinition`: Role definition model.
"""
...
from oridecon.auth.authz._check_mixin import _AuthCheckMixin
from oridecon.auth.authz._parsers import (
    ListValueParser,
    NoneValueParser,
    StringValueParser,
    ValueParser,
...
from oridecon.auth.types import RoleDefinition
from oridecon.contracts.exceptions import DependencyError, UnresolvableDependencyError
...
class AuthorizationService(_AuthCheckMixin):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            audit_logger: Optional :class:`~oridecon.contracts.audit.AuditLoggerProtocol`
    ...
    async def sync_from_db(self, container: Any) -> None:
        ...
        # GenericRepository is a concrete class from oridecon-sql.
