...
if TYPE_CHECKING:
    from oridecon.auth.authz._parsers import ValueParserRegistry
    from oridecon.auth.exceptions import AuthorizationError
...
class _AuthCheckMixin:
    ...
    async def authorize(
        ...
        :class:`~oridecon.contracts.auth.guard.AuthorizerProtocol` protocol (note:
