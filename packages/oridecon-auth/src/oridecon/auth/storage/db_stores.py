...
from oridecon.auth.storage._mongo_store import MongoDBUserStore
from oridecon.auth.storage._sql_store import SQLUserStore
...
class RedisUserStore:
    ...
    Implements :class:`~oridecon.auth.storage.token_store.CachedUserStore` —
    ...
    :class:`~oridecon.auth.storage.token_store.UserStoreProtocol` must be used as the
