...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.events.protocols import PubSubProtocol
...
class CachedUserStore:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            pubsub: Optional :class:`~oridecon.contracts.events.protocols.PubSubProtocol`
    ...
    async def subscribe_to_invalidations(self) -> None:
        ...
        :class:`~oridecon.contracts.events.protocols.PubSubProtocol` backend is
