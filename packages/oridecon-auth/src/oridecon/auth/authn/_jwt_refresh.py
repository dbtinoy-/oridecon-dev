"""Refresh-token rotation seam for :class:`~oridecon.auth.authn.jwt.JWTTokenManager`.

This module is an internal implementation detail; import
:class:`~oridecon.auth.authn.jwt.JWTTokenManager` directly.
"""
...
from oridecon.auth.authn._jwt_revocation import _JWTRevocationMixin
from oridecon.auth.models import AuthToken
from oridecon.auth.models.user import User
from oridecon.contracts.auth.exceptions import TokenError as ContractsTokenError

if TYPE_CHECKING:
    from oridecon.auth.types import TokenPair
    from oridecon.contracts.auth.token import VerifiedToken
    from oridecon.logging import LoggerProtocol as Logger
...
class _JWTRefreshMixin(_JWTRevocationMixin):
    ...
    async def refresh_token(
        ...
        ``TokenManagerProtocol`` protocol from ``oridecon.contracts.auth.token``.
        ...
        from oridecon.auth.exceptions import TokenError as AuthTokenError
