"""Token verification seam for :class:`~oridecon.auth.authn.jwt.JWTTokenManager`.
...
from oridecon.auth.authn._binding import TokenBindingConfig, verify_binding
...
class _JWTVerificationMixin:
    ...
    async def verify_token(
        ...
        *,
        ...
        """
        from oridecon.auth.exceptions import TokenAudienceError, TokenInvalidError
        ...
        try:
            ...
            if allow_missing_audience:
                ...
                if effective_audience is None:
                    ...
                    if os.getenv("ORI_ENV", "development") == "production":
                        self.logger.warning(
