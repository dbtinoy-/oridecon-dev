"""Token creation mixin for :class:`~oridecon.auth.authn.jwt.JWTTokenManager`.
...
from oridecon.auth.authn._binding import TokenBindingConfig, compute_binding_hash
...
class _JWTCreationMixin:
    ...
    def create_token(
        ...
        protocol check from ``oridecon.contracts.auth.token``.
