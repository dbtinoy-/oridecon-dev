...
from oridecon import serialization as _json
...
if TYPE_CHECKING:
    ...
    from oridecon.auth.authn.schemas import RegisterRequest
...
class LoginAttemptTracker(LoginAttemptTrackerProtocol):
    ...
    state via an injected :class:`~oridecon.contracts.cache.protocols.CacheBackendProtocol`.
    ...
    _CACHE_KEY_PREFIX = "oridecon:auth:attempts:"
...
class AuthenticationService:
    ...
    async def refresh_token(self, refresh_token: str) -> Result[AuthToken, TokenError]:
        ...
        """
        from oridecon.contracts.auth.exceptions import TokenError as _TokenError
        from oridecon.result import Err, Ok
