"""Account verification service for Oridecon Auth."""
...
from oridecon.auth.exceptions import AlreadyVerifiedError, UserNotFoundError
...
class AccountVerificationService:
    ...
    async def verify(self, token: str) -> Result[None, ContractsVerificationError]:
        ...
        """
        from oridecon.contracts.auth.exceptions import VerificationError as VErr
