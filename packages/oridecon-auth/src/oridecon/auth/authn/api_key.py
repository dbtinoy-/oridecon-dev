"""API Key AuthenticatorProtocol for Oridecon Auth.
...
from oridecon.auth.exceptions import AuthenticationError
...
class APIKeyAuthenticator:
    ...
    async def _resolve_user(self, raw_key: str) -> User | None:
        ...
        Returns:
            :class:`~oridecon.auth.models.user.User` if found, ``None``
            otherwise.
        """
        import inspect
