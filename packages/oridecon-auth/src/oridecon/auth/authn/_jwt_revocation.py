"""Revocation / blacklist seam for :class:`~oridecon.auth.authn.jwt.JWTTokenManager`.
...
from oridecon.auth.authn._jwt_verification import _JWTVerificationMixin
...
class _JWTRevocationMixin(_JWTVerificationMixin):
    ...
    async def logout(self, token: str) -> Result[None, ContractsTokenError]:
        ...
        """
        from oridecon.auth.hooks import AuthTokenRevokedHook
