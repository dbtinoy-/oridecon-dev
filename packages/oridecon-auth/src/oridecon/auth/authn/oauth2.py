...
This module provides OAuth2 authentication support for Oridecon, enabling
...
Example:
    Setting up OAuth2 authentication::
        ...
        from oridecon.auth.authn.oauth2 import OAuth2Authenticator
...
from oridecon.auth.authn.oauth2_session import (
    OrideconConnectResponse as OrideconConnectResponse,
)
from oridecon.auth.authn.oauth2_session import (
    OrideconConnectSession as OrideconConnectSession,
)
from oridecon.auth.exceptions import OAuth2Error
from oridecon.auth.types import OAuth2UserInfo
...
class OAuth2Manager:
    ...
    async def get_authorization_url(
        ...
        if self._http_client:
            session = OrideconConnectSession(self._http_client)
