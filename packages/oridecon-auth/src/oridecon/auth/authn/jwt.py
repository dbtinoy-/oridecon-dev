...
from oridecon.auth.authn._jwt_creation import _JWTCreationMixin
from oridecon.auth.authn._jwt_lifecycle import _JWTLifecycleMixin
from oridecon.auth.authn._key_utils import normalize_jwt_keys
from oridecon.auth.authn.blacklist import JWTBlacklist
from oridecon.auth.authn.key_rotation import JWTKeyStore
...
class JWTTokenManager(_JWTCreationMixin, _JWTLifecycleMixin):
    ...
    def __init__(
        ...
        *,
        ...
        env = os.getenv("ORI_ENV", "development").lower()
