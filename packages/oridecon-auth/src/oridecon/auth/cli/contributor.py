...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.auth.cli.generators.auth_guard:AuthGuardGenerator",
        "src/guards",
    ),
    (
        "auth_policy",
        "Generate an authorization policy",
        "oridecon.auth.cli.generators.auth_policy:AuthPolicyGenerator",
        "src/policies",
    ),
    (
        "guard",
        "Generate an authorization guard",
        "oridecon.auth.cli.generators.guard:AuthGuardGenerator",
        "src/guards",
    ),
)
...
class AuthCliContributor:
    """CLI contributor for the oridecon-auth package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.auth.cli.commands:create_auth_app",
                contributor="auth",
                category="security",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.auth.cli.checks:check_auth_service",
                contributor="auth",
                category="security",
                timeout=5.0,
                critical=True,
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.auth.cli.doctor:check_jwt_secret",
                contributor="auth",
                category="security",
            ),
            DoctorCheckContribution(
                ...
                check_path="oridecon.auth.cli.doctor:check_auth_config",
                contributor="auth",
                category="security",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.auth.cli.shell:provide_auth",
                contributor="auth",
            ),
        ]
    ...
    def get_hooks(self) -> list[HookContribution]:
        ...
        return [
            HookContribution(
                event="post_command",
                handler_path="oridecon.auth.cli.hooks:log_auth_command",
                contributor="auth",
                priority=90,
            ),
        ]
    ...
    def get_schema_setup(self) -> list[SchemaSetupContribution]:
        ...
        return [
            SchemaSetupContribution(
                ...
                setup_fn_path="oridecon.auth.cli.schema_setup:ensure_oauth_identities",
