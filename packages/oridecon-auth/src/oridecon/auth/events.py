...
Consumers subscribe via :class:`~oridecon.contracts.events.protocols.EventBusProtocol`.
All events inherit from :class:`~oridecon.contracts.domain.events.DomainEvent` and carry
