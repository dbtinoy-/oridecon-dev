...
:class:`~oridecon.contracts.auth.repositories.SessionRepositoryProtocol`
implementation, and then resolving the owning user via a caller-supplied
async callable.

This is intentionally separate from :class:`~oridecon.auth.authn.jwt.JWTTokenManager`
...
class SessionCookieBackend:
    ...
    :class:`~oridecon.contracts.auth.user.AuthenticatedUserProtocol` requires
    ...
    def __init__(
        ...
        from oridecon.identity.generator import Uuid4Generator
