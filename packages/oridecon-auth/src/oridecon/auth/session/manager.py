...
from oridecon.auth.models.session import UserSession
from oridecon.auth.session.fingerprint import generate_device_id
from oridecon.auth.storage.in_memory_stores import InMemorySessionStore
from oridecon.auth.storage.session_store import SessionStore
from oridecon.contracts.audit import AuditEntry, AuditLoggerProtocol
        ...
        *,
        ...
        Args:
            session_store: Optional storage backend.  Defaults to an
                :class:`~oridecon.auth.storage.in_memory_stores.InMemorySessionStore`
                when not provided.
