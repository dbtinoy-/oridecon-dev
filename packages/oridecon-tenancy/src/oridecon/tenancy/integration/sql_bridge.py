...
Uses DatabaseContextProtocol from contracts instead of direct oridecon-sql imports.
"""
...
class TenantSQLContextBridge:
    ...
    from oridecon-sql. Falls back gracefully when db context is unavailable.
    """
    ...
    def __init__(self, app: ASGIApp, ctx: Context) -> None:
        ...
        Args:
            ...
            ctx: Shared :class:`~oridecon.primitives.context.Context`.
        """
        self._app = app
        self._ctx = ctx
