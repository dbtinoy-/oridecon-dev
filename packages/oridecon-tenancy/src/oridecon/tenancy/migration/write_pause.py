...
if TYPE_CHECKING:
    from oridecon.contracts.cache.protocols import (  # type: ignore[import-untyped]
...
class WritePauseRegistry:
    ...
    Uses an optional :class:`~oridecon.contracts.cache.protocols.CacheBackendProtocol`
