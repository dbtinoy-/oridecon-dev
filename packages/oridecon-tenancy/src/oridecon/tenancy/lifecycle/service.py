...
from oridecon.contracts.tenancy.errors import TenantError, TenantSlugConflictError
...
from oridecon.contracts.tenancy.types import TenantInfo
...
class TenantLifecycleService:
    ...
    and invalidate the :class:`~oridecon.tenancy.enforcement.validator.TenantValidator`
