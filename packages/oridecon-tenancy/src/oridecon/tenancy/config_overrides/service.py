...
from oridecon.contracts.events.protocols import DomainEventPublisherProtocol
from oridecon.contracts.tenancy.events import TenantConfigChanged
from oridecon.contracts.tenancy.protocols import TenantConfigProviderProtocol
...
class TenantConfigService:
    ...
    Combines a raw :class:`~oridecon.contracts.tenancy.protocols.TenantConfigProviderProtocol`
    ...
    def __init__(
        ...
        Args:
            ...
            event_bus: Event bus for publishing
                :class:`~oridecon.contracts.tenancy.events.TenantConfigChanged`
                events.
        """
