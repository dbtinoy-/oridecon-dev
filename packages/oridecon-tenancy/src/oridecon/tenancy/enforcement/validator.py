...
class TenantValidator:
    ...
    def __init__(
        ...
        Args:
            provider: Tenant storage implementing
                :class:`~oridecon.contracts.tenancy.protocols.TenantProviderProtocol`.
            cache_ttl: Seconds to cache a validated
                :class:`~oridecon.contracts.tenancy.types.TenantInfo` record.
    ...
    async def validate(self, tenant_id: str) -> TenantInfo | None:
        ...
        Returns:
            The :class:`~oridecon.contracts.tenancy.types.TenantInfo` if the
