...
from oridecon.contracts.tenancy.protocols import TenantResolverProtocol


class ResolverRegistry:
    """Ordered registry of :class:`~oridecon.contracts.tenancy.protocols.TenantResolverProtocol` instances.
    ...
    def register(self, resolver: TenantResolverProtocol) -> None:
        ...
        Args:
            resolver: A resolver implementing
                :class:`~oridecon.contracts.tenancy.protocols.TenantResolverProtocol`.
        """
    ...
    def from_config(
        ...
        Args:
            ...
            header_name: Header name for :class:`~oridecon.tenancy.resolution.header.HeaderTenantResolver`.
            subdomain_pattern: Base domain for :class:`~oridecon.tenancy.resolution.subdomain.SubdomainTenantResolver`.
            path_pattern: Path pattern for :class:`~oridecon.tenancy.resolution.path.PathTenantResolver`.
            jwt_claim_key: Claim key for :class:`~oridecon.tenancy.resolution.jwt_claim.JWTClaimTenantResolver`.
