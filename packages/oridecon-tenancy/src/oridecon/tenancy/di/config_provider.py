...
from oridecon.tenancy.config import ConfigOverridesConfig
...
class TenantConfigProvider(Provider):
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        :class:`~oridecon.tenancy.di.lifecycle_provider.TenantLifecycleProvider`
        ...
        async def _config_service_factory(
            ...
            try:
                ...
                from oridecon.tenancy.di.lifecycle_provider import _NoOpEventBus
