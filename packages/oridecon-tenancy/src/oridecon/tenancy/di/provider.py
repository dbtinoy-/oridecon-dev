...
from oridecon.tenancy.config import TenancyConfig
from oridecon.tenancy.di.config_provider import TenantConfigProvider
from oridecon.tenancy.di.integration_provider import TenantIntegrationProvider
from oridecon.tenancy.di.lifecycle_provider import TenantLifecycleProvider
from oridecon.tenancy.di.migration_provider import TenantMigrationProvider
from oridecon.tenancy.di.resolution_provider import TenantResolutionProvider
...
class TenancyProvider(Provider):
    ...
    1. :class:`~oridecon.tenancy.di.resolution_provider.TenantResolutionProvider`
    2. :class:`~oridecon.tenancy.di.lifecycle_provider.TenantLifecycleProvider`
    3. :class:`~oridecon.tenancy.di.config_provider.TenantConfigProvider`
    4. :class:`~oridecon.tenancy.di.integration_provider.TenantIntegrationProvider`
    ...
    def __init__(self, config: TenancyConfig | None = None) -> None:
        ...
        Args:
            config: Optional :class:`~oridecon.tenancy.config.TenancyConfig`.
