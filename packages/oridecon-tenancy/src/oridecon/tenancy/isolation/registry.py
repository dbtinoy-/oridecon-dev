...
from oridecon.contracts.tenancy.protocols import TenantIsolationStrategyProtocol


class IsolationStrategyRegistry:
    """Registry of :class:`~oridecon.contracts.tenancy.protocols.TenantIsolationStrategyProtocol`
    ...
    def _default_entries(cls) -> dict[str, TenantIsolationStrategyProtocol]:
        ...
        oridecon-sql and environment-specific provisioning logic.
