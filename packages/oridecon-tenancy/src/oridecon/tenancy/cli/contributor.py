...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.tenancy.cli.generators.resolver:TenantResolverGenerator",
        "src/tenancy",
    ),
)
...
class TenancyCliContributor:
    """CLI contributor for the oridecon-tenancy package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.tenancy.cli.commands:create_tenancy_app",
                contributor="tenancy",
                category="tenancy",
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.tenancy.cli.doctor:check_tenancy_config",
                contributor="tenancy",
                category="tenancy",
            ),
            DoctorCheckContribution(
                ...
                check_path="oridecon.tenancy.cli.doctor:check_isolation_strategy",
                contributor="tenancy",
                category="tenancy",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.tenancy.cli.shell:provide_tenant_service",
                contributor="tenancy",
            ),
        ]
