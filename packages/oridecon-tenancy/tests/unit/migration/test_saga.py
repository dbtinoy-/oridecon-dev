...
from oridecon.contracts.tenancy.migration import CopyResult, MigrationContext
...
from oridecon.workflow.checkpoint.store_memory import (
...
class TestReviewImports:
    ...
    def test_migration_copy_strategy_importable_from_migration(self) -> None:
        ...
        from oridecon.contracts.tenancy.migration import MigrationCopyStrategy
