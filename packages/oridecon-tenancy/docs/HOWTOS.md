---
title: oridecon-tenancy How-Tos
...
```python
from oridecon.tenancy import TenancyConfig, ResolutionConfig
...
from oridecon.contracts.tenancy.types import TenantResolutionContext
...
```python
from oridecon.tenancy.stores.sql import SQLTenantProvider
...
```python
from oridecon.tenancy import TenancyConfig, LifecycleConfig
...
Requires `oridecon-sql` and a Postgres database.
...
```python
from oridecon.tenancy import TenantProvisioner
...
```python
from oridecon.tenancy import CachedTenantConfigProvider
