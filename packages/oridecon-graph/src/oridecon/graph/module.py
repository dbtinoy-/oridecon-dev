...
class GraphModule(Module):
    ...
    Registers :class:`~oridecon.contracts.data.graph.protocols.GraphStoreProtocol`
    and :class:`~oridecon.contracts.data.graph.protocols.GraphProtocol` for
    ...
    def configure(
        ...
        Args:
            config: :class:`~oridecon.graph.config.GraphConfig`, a plain
    ...
    def stub(cls, config: GraphConfig | None = None) -> DynamicModule:
        ...
        Args:
            config: Optional :class:`~oridecon.graph.config.GraphConfig`
