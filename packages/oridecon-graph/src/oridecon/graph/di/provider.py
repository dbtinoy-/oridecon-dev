...
from oridecon.graph.backends.registry import GraphStoreRegistry
from oridecon.graph.config import GraphConfig
from oridecon.logging.factory import get_logger
...
class GraphProvider(Provider):
    ...
    async def _maybe_wrap_with_tenancy(
        ...
        from oridecon.graph.tenancy.resolver import TemplatedTenantCollectionResolver
