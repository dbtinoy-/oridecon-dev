...
from oridecon.contracts.data.graph import GraphNode, TraversalQuery, StartSpec, TraversalStep
from oridecon.graph.backends.memory import backend, graph as mem_graph
