...
`oridecon-graph` provides a **graph-oriented** abstraction with two layers:
...
```python
from oridecon.contracts.data.graph import GraphStoreProtocol
...
```python
from oridecon.contracts.data.graph import GraphStoreProtocol, GraphProtocol
...
from oridecon.contracts.data.graph import PropertyFilter
...
```python
from oridecon.contracts.data.graph import NodeSpec
...
```python
from oridecon.contracts.data.graph import IndexSpec, ConstraintSpec
