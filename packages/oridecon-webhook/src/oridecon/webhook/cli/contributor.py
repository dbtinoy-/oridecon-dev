"""CLI contributions for oridecon-webhook."""
...
_SCHEMA_SETUP_CONTRIBUTIONS: tuple[SchemaSetupContribution, ...] = (
    SchemaSetupContribution(
        ...
        setup_fn_path="oridecon.webhook.cli.schema_setup:ensure_subscriptions",
        contributor="webhook",
    ),
    SchemaSetupContribution(
        name="webhook.delivery_attempts",
        description="Webhook delivery attempt storage",
        setup_fn_path="oridecon.webhook.cli.schema_setup:ensure_delivery_attempts",
        contributor="webhook",
    ),
)
