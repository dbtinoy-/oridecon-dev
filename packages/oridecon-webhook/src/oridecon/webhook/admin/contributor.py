...
class WebhookAdminContributor(BaseAdminContributor):
    ...
    Registers webhook management sections in the Oridecon admin panel.
    ...
    async def on_admin_boot(self, container: ContainerResolverProtocol | None) -> None:
        ...
        :class:`~oridecon.webhook.di.sub_providers.admin_provider.WebhookAdminProvider`;
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        ...
        return [
            ManagementPageDefinition(
                ...
                handler="oridecon.webhook.admin.pages.subscriptions:WebhookSubscriptionsPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.webhook.admin.pages.deliveries:WebhookDeliveriesPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="send",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.webhook.admin.pages.dead_letter:WebhookDeadLetterPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="alert-triangle",
