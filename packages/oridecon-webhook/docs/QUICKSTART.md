---
title: oridecon-webhook Quickstart
description: Install, wire, and deliver your first webhook event in 5 minutes
---

:::note[What you'll need]
- Python 3.11+
- An existing Oridecon application (see [getting-started](/getting-started/installation/))
:::
...
```bash
pip install oridecon-webhook
```

For SQL-backed persistence (optional):

```bash
pip install oridecon-webhook[sql]
```
...
from oridecon.contracts.webhook import WebhookEvent
