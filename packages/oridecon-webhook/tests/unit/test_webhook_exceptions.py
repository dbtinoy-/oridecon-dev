...
from oridecon.webhook.exceptions import (
...
class TestSubscriptionNotFoundError:
    ...
    def test_error_code(self) -> None:
        ...
        assert SubscriptionNotFoundError._code == "ORI_ERR_WEBHOOK_002"
...
class TestSubscriptionInactiveError:
    ...
    def test_error_code(self) -> None:
        ...
        assert SubscriptionInactiveError._code == "ORI_ERR_WEBHOOK_003"
...
class TestInvalidWebhookURLError:
    ...
    def test_error_code(self) -> None:
        ...
        assert InvalidWebhookURLError._code == "ORI_ERR_WEBHOOK_004"
...
class TestDeliveryAttemptNotFoundError:
    ...
    def test_error_code(self) -> None:
        ...
        assert DeliveryAttemptNotFoundError._code == "ORI_ERR_WEBHOOK_005"
...
class TestSecretRotationError:
    ...
    def test_error_code(self) -> None:
        ...
        assert SecretRotationError._code == "ORI_ERR_WEBHOOK_006"
...
class TestExceptionAllExports:
    ...
    def test_all_contains_expected_items(self) -> None:
        ...
        from oridecon.webhook import exceptions
        expected = [
            "DeliveryAttemptNotFoundError",
            "InvalidWebhookURLError",
            "SecretRotationError",
