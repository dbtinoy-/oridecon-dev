---
title: oridecon-monitor Quickstart
description: Install, wire monitoring, and collect your first metrics.
---

:::note[Maturity]
`oridecon-monitor` is **alpha (0.1.x)** and MIT-licensed. Public APIs may change before 1.0.
:::
...
# From config — reads ORI_MONITOR__* env vars
