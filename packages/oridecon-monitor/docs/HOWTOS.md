---
title: oridecon-monitor How-Tos
...
# Wrap the web ASGI app (if using oridecon-web):
...
```python
from oridecon.monitor import traced
...
```python
from oridecon.monitor import profile_async_function
