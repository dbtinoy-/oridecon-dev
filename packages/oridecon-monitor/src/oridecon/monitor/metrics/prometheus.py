"""Internal Prometheus metric registry utility for Oridecon Monitor.

.. internal::
    This module is **not** part of the public API.  It is infrastructure used
    exclusively by :class:`oridecon.monitor.backends.prometheus.PrometheusBackend`
    ...
    Use :class:`~oridecon.monitor.backends.prometheus.PrometheusBackend` (for an
    HTTP-serving backend) or
    :class:`~oridecon.monitor.backends.exporters.PrometheusMetricsExporter` (for
