...
from oridecon.monitor.di._attrs import _MonitorAttrsMixin
from oridecon.monitor.health import HealthCheckerRegistry

if TYPE_CHECKING:
    from oridecon.contracts import BootContainerProtocol
...
class _MonitorLifecycleMixin(_MonitorAttrsMixin):
    ...
    async def boot(self, container: BootContainerProtocol) -> None:
        ...
        # configured (ORI_MONITOR__ERROR_TRACKING__DSN).
        ...
        if (
            ...
            from oridecon.monitor.backends.db_exporter import DBMetricsExporter
        ...
        self.metrics_collector.create_counter(
            "oridecon_requests_total",
            "Total number of requests",
        )
        self.metrics_collector.create_gauge(
            "oridecon_active_connections",
            "Number of active connections",
        )
        self.metrics_collector.create_histogram(
            "oridecon_request_duration_seconds",
        ...
        from oridecon.monitor.alerts.channels.weekly_digest import (
        ...
        if digest_dispatcher is not None:
            from oridecon.contracts.infra.tasks import TaskManagerProtocol
            from oridecon.monitor.alerts.digest_worker import (
