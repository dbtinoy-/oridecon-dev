...
from oridecon.monitor import MetricsCollectorProtocol
from oridecon.monitor.metrics.prometheus import exporter as prometheus_exporter
from oridecon.monitor.middleware.auth import is_authorized, send_unauthorized
...
class PrometheusMiddleware:
    ...
    *path* (default ``/metrics``);
    otherwise the framework's :class:`~oridecon.monitor.metrics.collector.MetricsCollectorProtocol`
    ...
    Args:
        ...
        metrics_collector: Optional pre-configured
            :class:`~oridecon.monitor.metrics.collector.MetricsCollectorProtocol`.
    ...
    async def __call__(self, scope: dict, receive: Callable, send: Callable) -> None:
        ...
        if PROMETHEUS_AVAILABLE:
            ...
            active_gauge = self.metrics_collector.get_metric("oridecon_active_requests")
            if active_gauge:
