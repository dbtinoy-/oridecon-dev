...
Example:
    >>> from oridecon.monitor import OTelMiddleware
    >>>
...
class OTelMiddleware:
    """Middleware for OpenTelemetry tracing and metrics in Oridecon-Web.
    ...
    def __init__(self, app: ASGIApp):
        ...
        if _opentelemetry_available:
            self.tracer = trace.get_tracer("oridecon.web")
            self.meter = metrics.get_meter("oridecon.web")
