...
if TYPE_CHECKING:
    from oridecon.contracts.monitor.projection_tier import ProjectionTier
...
class TierAwareAlertDispatcher:
    ...
    Implements :class:`~oridecon.contracts.observability.metrics.AlertDispatcherProtocol`:
