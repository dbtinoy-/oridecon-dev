...
class LoggingAlertDispatcher:
    ...
    Implements :class:`~oridecon.contracts.observability.protocols.AlertDispatcherProtocol`.
    ...
    and is registered by :class:`~oridecon.monitor.di.provider.MonitorProvider`
    as the default
    :class:`~oridecon.contracts.observability.protocols.AlertDispatcherProtocol`
