"""Unit tests for Oridecon Monitor package"""

from unittest.mock import Mock

import pytest

from oridecon.logging import get_logger, Logger
from oridecon.monitor import (
...
class TestMonitorProvider:
    ...
    def test_request_recording(self):
        ...
        assert "oridecon_requests_total" in metrics
        assert "oridecon_request_duration_seconds" in metrics
