...
from oridecon.monitor.health.checker_registry import HealthCheckerRegistry, get_health_checker
...
async def test_get_health_checker_utility():
    ...
    with patch("oridecon.di.resolution.context.get_resolver", return_value=mock_resolver):
