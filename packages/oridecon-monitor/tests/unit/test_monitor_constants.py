"""Unit tests for oridecon.monitor.constants."""

from __future__ import annotations

import pytest

from oridecon.monitor import constants
...
class TestEnvironmentPrefixes:
    ...
    def test_env_prefix(self) -> None:
        assert constants.ENV_PREFIX == "ORI_MONITOR__"
...
class TestDefaultConfiguration:
    ...
    def test_default_service_name(self) -> None:
        assert constants.DEFAULT_SERVICE_NAME == "oridecon-service"
...
class TestMetricPrefixes:
    ...
    def test_metric_prefix(self) -> None:
        assert constants.METRIC_PREFIX == "oridecon_"

    def test_request_total_metric(self) -> None:
        assert constants.REQUEST_TOTAL_METRIC == "oridecon_requests_total"

    def test_active_connections_metric(self) -> None:
        assert constants.ACTIVE_CONNECTIONS_METRIC == "oridecon_active_connections"

    def test_request_duration_metric(self) -> None:
        assert constants.REQUEST_DURATION_METRIC == "oridecon_request_duration_seconds"
