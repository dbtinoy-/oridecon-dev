...
from oridecon.contracts.core.health import HealthCheckCategory, HealthCheckResult, HealthStatus
...
async def test_run_all_exception(mocker):
    ...
    from oridecon.monitor.health import checker as checker_module
