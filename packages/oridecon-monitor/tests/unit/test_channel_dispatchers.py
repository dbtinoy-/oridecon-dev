...
from oridecon.contracts.observability.metrics import AlertDispatcherProtocol
from oridecon.contracts.web.http_protocols import HTTPClientProtocol
...
class TestPagerDutyAlertDispatcher:
    ...
    async def test_sends_event_to_pagerduty(self, http_client: AsyncMock):
        from oridecon.monitor.alerts.channels.pagerduty import (
...
class TestSlackBusinessHoursDispatcher:
    ...
    async def test_respects_timezone_parameter(self, http_client: AsyncMock):
        ...
        import oridecon.monitor.alerts.channels.slack_business_hours as mod
        from oridecon.monitor.alerts.channels.slack_business_hours import (
            SlackBusinessHoursDispatcher,
        )
