...
if TYPE_CHECKING:
    ...
    from oridecon.tasks.scheduling.persistence import SchedulerStore
...
class TaskScheduler:
    ...
    def __init__(
        ...
        Args:
            ...
            store: Optional :class:`~oridecon.tasks.scheduling.persistence.SchedulerStore`
    ...
    async def restore_from_store(self) -> int:
        ...
        Raises:
            RuntimeError: If no :class:`~oridecon.tasks.scheduling.persistence.SchedulerStore`
