...
dependencies and raises :exc:`~oridecon.tasks.exceptions.TaskDependencyCycleError`
...
from oridecon.tasks.exceptions import TaskDependencyCycleError
...
class DependencyResolver:
    ...
    is found, :exc:`~oridecon.tasks.exceptions.TaskDependencyCycleError` is
    raised and the graph is **not** modified — keeping it permanently valid.

    The resolver is typically held by :class:`~oridecon.tasks.scheduling.scheduler.TaskScheduler`
