...
**optional** dependency of ``oridecon-tasks``.  Install it with::

    pip install croniter

or::

    pip install "oridecon-tasks[cron]"
...
class CronExpression:
    ...
    .. note::
        ...
        See :mod:`oridecon.tasks.scheduling.cron` for installation instructions.
