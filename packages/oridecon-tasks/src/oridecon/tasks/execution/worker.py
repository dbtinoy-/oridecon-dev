...
from oridecon.tasks.config import TaskWorkerConfig
...
from oridecon.tasks.execution._concurrency import WorkerConcurrencyMixin
from oridecon.tasks.execution._di_resolver import resolve_handler_dependencies
from oridecon.tasks.execution._failure_handling import send_to_dlq
from oridecon.tasks.execution._invoke import invoke_handler
from oridecon.tasks.execution._lifecycle import TaskWorkerServices, WorkerJobStats
from oridecon.tasks.execution._middleware_chain import (
    create_default_pipeline,
    execute_handler_through_middleware,
)
from oridecon.tasks.hooks import TaskCompletedHook, TaskFailedHook
...
from oridecon.tasks.progress.core import ProgressTracker
...
class TaskWorker(WorkerConcurrencyMixin):
    ...
    async def _send_to_dlq(self, job: JobProtocol, error_msg: str = "") -> None:
        ...
        Delegates to :func:`~oridecon.tasks.execution._failure_handling.send_to_dlq`.
    ...
    async def _resolve_dependencies(
        ...
        Delegates to :func:`~oridecon.tasks.execution._di_resolver.resolve_handler_dependencies`.
    ...
    async def _execute_with_middleware(
        ...
        Delegates to
        :func:`~oridecon.tasks.execution._middleware_chain.execute_handler_through_middleware`.
