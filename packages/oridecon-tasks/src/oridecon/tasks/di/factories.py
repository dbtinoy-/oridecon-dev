...
Import through ``oridecon.tasks.di`` — the public API is re-exported there.
"""
...
def create_memory_task_provider(
    ...
    """
    from oridecon.tasks.backends import MemoryTaskQueue
    from oridecon.tasks.di.provider import TaskProvider
...
def create_redis_task_provider(
    ...
    """
    from oridecon.tasks.backends import RedisTaskQueue
    from oridecon.tasks.di.provider import TaskProvider
...
def create_rabbitmq_task_provider(
    ...
    """
    from oridecon.tasks.backends import RabbitMQTaskQueue
    from oridecon.tasks.di.provider import TaskProvider
