"""Task provider for Oridecon Framework integration."""
...
from oridecon.tasks.di._lifecycle import (  # noqa: F401 — re-export
    _check_queue_health,
    _connect_queue,
    _TaskLifecycleMixin,
    _wire_queue_hooks,
)
from oridecon.tasks.di._operations import _TaskOperationsMixin
from oridecon.tasks.di._registration import _TaskRegistrationMixin
...
from oridecon.tasks.results.core import InMemoryResultStore, ResultStore
...
class TaskProvider(
    ...
    """Task processing provider for Oridecon Framework.
    ...
    def from_config(cls, config: TaskConfig, **context: Any) -> TaskProvider:
        ...
        provided, a :class:`~oridecon.tasks.backends.memory.MemoryTaskQueue`
        is created.
        """
