...
.. note::
    **Boundary with oridecon-workflow:**
    ...
    ``oridecon-workflow`` provides *business process* orchestration —
    multi-step pipelines, sagas, and bulk operations for in-process
    coordination. Use ``oridecon.workflow.pipeline`` when you need
...
if TYPE_CHECKING:
    ...
    from oridecon.tasks.workflows.state import WorkflowStateStore
...
from oridecon.tasks.workflows.factories import chain as chain  # noqa: E402
