...
from oridecon.tasks.workflows.core import StepResult, WorkflowResult, WorkflowStatus
...
class WorkflowStateStore(Protocol):
    ...
    async def save_state(self, workflow_id: str, result: WorkflowResult) -> None:
        ...
        Args:
            ...
            result: Current :class:`~oridecon.tasks.workflows.core.WorkflowResult`
    ...
    async def load_state(self, workflow_id: str) -> WorkflowResult | None:
        ...
        Returns:
            Saved :class:`~oridecon.tasks.workflows.core.WorkflowResult`, or
...
class DatabaseWorkflowStateStore:
    ...
    store JSON-serialized :class:`~oridecon.tasks.workflows.core.WorkflowResult`
    snapshots.  The database provider is injected by the DI container and must
    implement :class:`~oridecon.contracts.data.DatabaseProviderProtocol`.
