...
Example:
    ...
    from oridecon.tasks.results import CacheBackendResultStore
...
_KEY_PREFIX = "oridecon:task:result:"
...
class CacheBackendResultStore(ResultStore):
    ...
    Stores serialised :class:`~oridecon.tasks.models.job.JobResult` objects
