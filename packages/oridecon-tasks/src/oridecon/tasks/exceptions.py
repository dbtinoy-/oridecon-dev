"""Task-specific exception hierarchy for the oridecon-tasks package."""
...
class TaskError(TaskQueueError):
    ...
    _code: str = "ORI_ERR_TASK_003"


class TaskNotFoundError(TaskError):
    """Raised when a task cannot be found"""

    _code: str = "ORI_ERR_TASK_004"


class TaskTimeoutError(TaskError):
    """Raised when a task execution exceeds timeout"""

    _code: str = "ORI_ERR_TASK_005"


class TaskCancelledError(TaskError):
    """Raised when a task is cancelled"""

    _code: str = "ORI_ERR_TASK_006"


class TaskExecutionError(TaskError):
    """Raised when a task execution fails"""

    _code: str = "ORI_ERR_TASK_007"
...
class TaskDependencyCycleError(TaskError):
    ...
    call.  If adding the new job's :attr:`~oridecon.tasks.models.job.JobProtocol.depends_on`
...
class TaskRegistrationError(OrideconError):
    """Raised when a scheduled or handler task fails to register."""

    _code: str = "ORI_ERR_TASK_011"
