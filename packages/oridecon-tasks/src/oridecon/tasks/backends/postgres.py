...
from oridecon.contracts.data.identifiers import table as _sql_table
from oridecon.logging import get_logger
from oridecon.result import Ok, Result
from oridecon.serialization import dumps, loads
from oridecon.tasks.config import PostgresTaskConfig
from oridecon.tasks.hooks import TaskEnqueuedHook
...
if TYPE_CHECKING:
    ...
    from oridecon.tasks.exceptions import TaskError
...
class PostgresTaskQueue:
    ...
    **Construction**
    ...
    :class:`~oridecon.contracts.data.DatabaseProviderProtocol` so that the
