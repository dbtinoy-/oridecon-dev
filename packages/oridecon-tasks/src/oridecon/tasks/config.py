"""Configuration models for Oridecon Tasks.
...
Example:
    ...
    # From environment
    config = TaskConfig()  # reads ORI_TASKS__* env vars
"""
...
class TaskConfig(BaseConfig):
    """Hierarchical root configuration for Oridecon Tasks.
            ...
            if (
                ...
                issues.append(
                    ConfigIssue(
                        ...
                        severity="error",
                        suggestion=(
                            "Set ORI_TASKS__BACKEND__REDIS_URL to the production Redis URL."
                        ),
                    )
                )
            if (
                ...
                issues.append(
                    ConfigIssue(
                        ...
                        severity="error",
                        suggestion=(
                            "Set ORI_TASKS__BACKEND__AMQP_URL to the production AMQP URL."
                        ),
                    )
                )
        return issues
