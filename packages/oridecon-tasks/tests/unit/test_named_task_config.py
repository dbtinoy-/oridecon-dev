...
from oridecon.tasks.config import NamedTaskConfig, TaskBackendConfig, TaskConfig
...
class TestNamedTaskConfigExport:
    """Test that NamedTaskConfig is properly exported from oridecon.tasks."""

    def test_named_task_config_importable_from_package(self) -> None:
        """NamedTaskConfig is accessible via lazy import from oridecon.tasks."""
