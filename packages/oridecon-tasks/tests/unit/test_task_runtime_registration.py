...
from oridecon.tasks import MemoryTaskQueue, task
from oridecon.tasks.decorators import _clear_registered_tasks, unwrap_task_handler
...
def _write_task_package(tmp_path: Path, package_name: str, module_name: str) -> str:
    ...
    module_path.write_text(
        "from oridecon.tasks import scheduled, task\n\n"
