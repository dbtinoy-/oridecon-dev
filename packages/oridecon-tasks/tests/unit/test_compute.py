...
import oridecon.tasks  # noqa: F401
from oridecon.tasks.concurrency.compute import Compute
from oridecon.tasks.types import PoolStrategy
...
class TestComputePoolNoGlobalMutation:
    ...
    def test_compute_pool_does_not_mutate_global_mp_context(self) -> None:
        ...
        import oridecon.tasks.concurrency.compute as compute_module
