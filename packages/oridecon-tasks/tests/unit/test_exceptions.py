...
from oridecon.tasks.types import PoolStrategy, Priority
...
class TestTaskRegistrationError:
    ...
    def test_task_registration_error_import(self) -> None:
        ...
        from oridecon.tasks.exceptions import TaskRegistrationError

        err = TaskRegistrationError("bad task")
        assert err.message == "bad task"

    def test_task_registration_error_is_oridecon_error(self) -> None:
        """Test TaskRegistrationError is a OrideconError."""
    ...
    def test_task_registration_error_code(self) -> None:
        ...
        err = TaskRegistrationError("bad task")
        assert err.code == "ORI_ERR_TASK_011"
