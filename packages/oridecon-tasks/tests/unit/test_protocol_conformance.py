"""Protocol conformance tests for oridecon-tasks domain models.

Verifies that the concrete JobProtocol and JobTemplateProtocol dataclasses satisfy
the runtime-checkable protocols defined in oridecon-contracts.
"""

from oridecon.contracts.infra.tasks import JobProtocol as JobProtocol
from oridecon.contracts.infra.tasks import JobTemplateProtocol as JobTemplateProtocol
...
class TestJobProtocolConformance:
    ...
    def test_job_is_instance_of_job_protocol(self) -> None:
        ...
        assert isinstance(
            job,
            JobProtocol,
        ), "JobProtocol dataclass must be an instance of oridecon.contracts.tasks.JobProtocol protocol"
...
class TestJobTemplateProtocolConformance:
    ...
    def test_job_template_is_instance_of_job_template_protocol(self) -> None:
        ...
        assert isinstance(
            template,
            JobTemplateProtocol,
        ), "JobTemplateProtocol dataclass must be an instance of oridecon.contracts.tasks.JobTemplateProtocol protocol"
