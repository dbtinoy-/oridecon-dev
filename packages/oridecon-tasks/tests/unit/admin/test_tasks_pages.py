...
from oridecon.contracts.admin.widget_content import TableContent
from oridecon.tasks.admin.pages import TasksFailedPage, TasksHistoryPage
from oridecon.tasks.models import JobResult
from oridecon.tasks.results import InMemoryResultStore
