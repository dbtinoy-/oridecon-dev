"""DI provider for oridecon-queue."""
...
from oridecon.queue.drivers.registry import QueueDriverRegistry
...
class QueueProvider(Provider):
    ...
    Reads :class:`~oridecon.queue.config.QueueConfig`, creates the
