...
from oridecon.queue.hooks import MessageConsumedHook, MessagePublishedHook
...
class KafkaQueue:
    ...
    Requires: pip install oridecon-queue[kafka]
    ...
    def __init__(
        ...
        client_id: str = "oridecon",
        group_id: str = "oridecon-consumers",
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "aiokafka required: pip install oridecon-queue[kafka]"
            ) from exc
    ...
    async def subscribe(self, topic: str, handler: Any) -> None:
        ...
        async def _handle_record(data: dict[str, Any]) -> None:
            from oridecon.contracts.queue.types import BusMessage as BusMsg
