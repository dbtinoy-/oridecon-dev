...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.queue.cli.generators.message_consumer:MessageConsumerGenerator",
        "src/consumers",
    ),
)
...
class QueueCliContributor:
    """CLI contributor for the oridecon-queue package."""
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.queue.cli.checks:check_broker_connection",
                contributor="queue",
                category="messaging",
                timeout=10.0,
                critical=True,
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.queue.cli.doctor:check_broker_configured",
                contributor="queue",
                category="messaging",
            ),
        ]
