"""Admin contributor for oridecon-queue — surfaces queue depth, consumer lag,
and failed-message widgets into the Oridecon admin dashboard.
"""
...
from oridecon.queue.admin.handlers.failed_messages import FailedMessagesWidgetHandler
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        contributor="queue",
        handler="oridecon.queue.admin.actions:retry_failed",
        icon="refresh-cw",
        category="operations",
    ),
)
...
class QueueAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-queue package.
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        return [
            ManagementPageDefinition(
                ...
                contributor="queue",
                route_path="/queue",
                handler="oridecon.queue.admin.pages.overview:QueueOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.queue.admin.pages.jobs:QueueJobsPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="briefcase",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.queue.admin.pages.consumers:QueueConsumersPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="cpu",
