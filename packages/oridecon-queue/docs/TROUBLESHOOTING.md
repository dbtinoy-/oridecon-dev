---
title: oridecon-queue Troubleshooting
...
**Error:**
```
oridecon.queue.exceptions.RedisQueueError: Connection refused
```
...
**Error:**
```
oridecon.queue.exceptions.KafkaQueueError: LeaderNotAvailable
```
...
**Error:**
```
oridecon.queue.exceptions.SQSQueueError: AccessDenied
```
...
**Error:**
```
oridecon.queue.exceptions.AzureServiceBusQueueError: Authentication failed
```
...
**Error:**
```
oridecon.queue.exceptions.GCPPubSubQueueError: Topic not found
```
