...
class TestRedisQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        err = RedisQueueError()
        assert err.backend == "redis"
        assert err._code == "ORI_ERR_QUEUE_002"
...
class TestRabbitMQQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        assert err._code == "ORI_ERR_QUEUE_003"
...
class TestKafkaQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        assert err._code == "ORI_ERR_QUEUE_004"
...
class TestSQSQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        assert err._code == "ORI_ERR_QUEUE_005"
...
class TestAzureServiceBusQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        assert err._code == "ORI_ERR_QUEUE_006"
...
class TestGCPPubSubQueueError:
    ...
    def test_defaults(self) -> None:
        ...
        assert err._code == "ORI_ERR_QUEUE_007"
