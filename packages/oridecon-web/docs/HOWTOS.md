...
```python
from oridecon.web.config import CORSConfig
...
```python
from oridecon.web import throttle, get
...
Requires the `websocket` extra: `uv add "oridecon-web[websocket]"`
