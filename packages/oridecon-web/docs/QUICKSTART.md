---
title: oridecon-web Quickstart
description: Install, configure, and run a Oridecon web API in under 5 minutes.
---
...
- [Your First App](../../docs/oridecon-docs/getting-started/first-app.md) — the full walkthrough with DI, controllers, and `Result` types
