---
title: oridecon-web Troubleshooting
...
For GraphQL, add `oridecon-graphql` to your project and register `GraphQLProvider`:

```python
from oridecon.graphql import GraphQLProvider
...
- Enable query logging for integrations: `export ORI_LOGGING__LEVEL=DEBUG`.
