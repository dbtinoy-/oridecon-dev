...
```python
from oridecon.web.middleware.rate_limit import RateLimiter
...
oridecon-web never leaks internal tracebacks in production. The `DefaultExceptionFilter` returns sanitized error bodies:
