...
class TestTraceparentUtils:
    def test_extract_valid_traceparent(self) -> None:
        from oridecon.web.middleware.tracing import extract_traceparent
    ...
    def test_inject_traceparent_returns_none_when_no_context(self) -> None:
        from oridecon.web.middleware.tracing import inject_traceparent
        from oridecon.contracts.core.trace_context import trace_id_var, span_id_var
    ...
    def test_load_trace_to_context_no_header(self) -> None:
        from oridecon.web.middleware.tracing import load_trace_to_context
