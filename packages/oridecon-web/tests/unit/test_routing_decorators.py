...
class TestRouteDecorator:
    ...
    def test_route_sets_route_config(self):
        from oridecon.web.routing.decorators import route
...
class TestHttpMethodDecorators:
    ...
    def test_put_decorator(self):
        from oridecon.web.routing.decorators import put
    ...
    def test_delete_decorator(self):
        from oridecon.web.routing.decorators import delete
    ...
    def test_patch_decorator(self):
        from oridecon.web.routing.decorators import patch
    ...
    def test_head_decorator(self):
        from oridecon.web.routing.decorators import head
    ...
    def test_options_decorator(self):
        from oridecon.web.routing.decorators import options
    ...
    def test_trace_decorator(self):
        from oridecon.web.routing.decorators import trace
    ...
    def test_decorator_preserves_function_metadata(self):
        from oridecon.web.routing import get
    ...
    def test_decorator_with_path_parameters(self):
        from oridecon.web.routing import get, post
    ...
    def test_multiple_decorators_on_same_function(self):
        ...
        from oridecon.web.routing.decorators import get, route
        ...
        from oridecon.web.routing import put
