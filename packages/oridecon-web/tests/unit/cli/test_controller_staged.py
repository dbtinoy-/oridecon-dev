...
from oridecon.contracts.cli.generators import CollisionPolicy, GenerationOptions
from oridecon.testing.generators import assert_generated_tree
from oridecon.web.cli.generators import ControllerGenerator
...
def test_fail_policy_at_staging_level(tmp_path: Path) -> None:
    from oridecon.contracts.exceptions.infra import CollidingFileError
