"""HTTP security component tests for oridecon-web.

Covers: SecurityConfig, SecurityHeadersConfig, CORSMiddlewareFactory.
Adapted from oridecon-security unit tests; imports updated to
oridecon.web.security.* after HTTP middleware absorption in Task 3.
"""
...
class TestSecurityPackageExports:
    ...
    def test_http_security_surface_is_reexported(self) -> None:
        ...
        from oridecon.web.security.csp.builder import CSPPolicy as CanonicalCSPPolicy
        from oridecon.web.security.csrf.middleware import (
