...
from oridecon.web.routing.parameters import query, path, body
from oridecon.web.pipes.builtin.parse import ParseIntPipe
from oridecon.web.pipes.decorators import use_pipes
from oridecon.web.protocols import PipeProtocol, ParamMetadata
...
class TestPipeIntegration:
    ...
    async def test_validation_pipe_pydantic_error(self):
        # ValidationPipe should raise oridecon.contracts.exceptions.domain.ValidationError
