...
from oridecon.web.routing.controller_registry import ControllerRegistry
from oridecon.web.routing.manager import WebRouterManager
from oridecon.web.routing.registry import RouteRegistry

routes_registry_mod = sys.modules["oridecon.web.routing.registry"]
controller_registry_mod = sys.modules["oridecon.web.routing.controller_registry"]
