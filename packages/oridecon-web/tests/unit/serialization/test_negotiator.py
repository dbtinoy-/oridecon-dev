...
from oridecon.web.serialization.negotiator import ContentNegotiator, get_negotiator
...
class TestGetNegotiator:
    def test_returns_content_negotiator_instance(self) -> None:
        ...
        with patch("oridecon.di.resolution.context.get_resolver", return_value=None):
            from oridecon.web.serialization import negotiator as neg_module
            # Reset the global
    ...
    def test_uses_resolver_when_available(self) -> None:
        ...
        with patch(
            "oridecon.di.resolution.context.get_resolver",
