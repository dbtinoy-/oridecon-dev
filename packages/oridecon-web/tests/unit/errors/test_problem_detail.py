...
class TestProblemDetailFactories:
    ...
    def test_validation_error(self) -> None:
        ...
        assert pd.status == 400
        assert pd.type == "urn:oridecon:validation-error"
    ...
    def test_not_found(self) -> None:
        ...
        assert pd.type == "urn:oridecon:not-found"
    ...
    def test_bad_request(self) -> None:
        ...
        assert pd.type == "urn:oridecon:bad-request"
    ...
    def test_internal_error(self) -> None:
        ...
        assert pd.type == "urn:oridecon:internal-error"
