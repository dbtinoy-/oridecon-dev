...
class TestSecurityConfigCollapseDecisions:
    ...
    def test_hsts_config_is_from_web_security_package(self) -> None:
        """HSTSConfig is the canonical class from oridecon.web.security."""
        from oridecon.web.security.config import HSTSConfig as WebSecurityHSTSConfig
    ...
    def test_csp_config_is_from_web_security_package(self) -> None:
        """CSPConfig is the canonical class from oridecon.web.security."""
        from oridecon.web.security.config import CSPConfig as WebSecurityCSPConfig
    ...
    def test_cross_origin_config_is_from_web_security_package(self) -> None:
        """CrossOriginConfig is canonical from oridecon.web.security."""
        from oridecon.web.security.config import (
    ...
    def test_csrf_config_is_from_web_security_package(self) -> None:
        """CSRFConfig is the canonical class from oridecon.web.security."""
        from oridecon.web.security.config import CSRFConfig as WebSecurityCSRFConfig
    ...
    def test_cors_config_is_from_web_security_package(self) -> None:
        """CORSConfig is the canonical class from oridecon.web.security."""
        from oridecon.web.security.config import CORSConfig as WebSecurityCORSConfig
    ...
    def test_security_config_is_from_web_security_package(self) -> None:
        """SecurityConfig is canonical from oridecon.web.security."""
        from oridecon.web.security.config import SecurityConfig as WebSecurityConfig
    ...
    def test_no_local_class_definitions_for_collapsed_classes(self) -> None:
        ...
        from oridecon.web import config as web_config_module
        ...
        for cls_name in ["HSTSConfig", "CSPConfig", "CrossOriginConfig"]:
            ...
            assert inspect.getmodule(cls) is not web_config_module, (
                f"{cls_name} should be defined in oridecon.web.security.config, not oridecon-web/config.py"
            )
    ...
    def test_no_circular_imports(self) -> None:
        ...
        from oridecon.web.config import SecurityConfig as WebSecurityConfig
        from oridecon.web.security.config import SecurityConfig as DirectSecurityConfig
