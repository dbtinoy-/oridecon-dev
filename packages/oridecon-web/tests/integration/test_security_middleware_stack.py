...
Adapted from oridecon-security integration tests; imports updated to
oridecon.web.security.* after HTTP middleware absorption in Task 3.

GuardChain stays in oridecon.security (core); HTTP middleware classes
move to oridecon.web.security.*.
"""
...
from oridecon.security.guards.chain import GuardChainImpl as GuardChain
