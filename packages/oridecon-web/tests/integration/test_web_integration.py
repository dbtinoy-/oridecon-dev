"""Integration tests for oridecon-web"""
...
from oridecon.web import JSONResponse, get
from oridecon.web.middleware.cors import CORSMiddleware
...
from oridecon.web.security.guards import AuthGuard
...
class TestWebIntegration:
    ...
    async def test_error_handling(self, test_bed):
        ...
        from oridecon.web.exceptions import NotFoundError
    ...
    async def test_response_types_integration(self, test_bed):
        ...
        from oridecon.web import HTMLResponse, RedirectResponse
