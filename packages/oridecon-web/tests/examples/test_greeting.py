...
from oridecon.web.quickstart import _reset_quickstart_registry
import sys
...
def test_greeting_gear_1():
    ...
    os.chdir(os.path.join(original_cwd, "oridecon-web/examples/greeting"))
    ...
    try:
        ...
        with TestClient(app) as client:
            ...
            assert response.json()["message"] == "Welcome to Oridecon Gear 1"
