...
from oridecon.web.routing.types import RoutableProtocol
...
def _create_param_decorator(
    ...
    def decorator(
        ...
        param_decorator._oridecon_param_info = metadata  # type: ignore[attr-defined]
        return param_decorator

    # Attach metadata to the decorator function itself
    decorator._oridecon_param_info = metadata  # type: ignore[attr-defined]
    return decorator
