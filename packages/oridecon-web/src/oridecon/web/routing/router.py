...
See Also:
    - :class:`oridecon.web.Controller`: Base controller class.
    - :mod:`oridecon.web.routing.decorators`: HTTP method decorators.
    - :class:`oridecon.web.middleware.Middleware`: Middleware base class.
"""
