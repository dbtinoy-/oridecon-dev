...
from oridecon.contracts.web.protocols import CRUDServiceProtocol
...
from oridecon.web.transport.responses import json_response
...
class GenericController(Controller, Generic[T]):
    ...
    HTTP status code they map to::
        ...
        from oridecon.web import error_status
