"""Health check route registration for oridecon-web."""
...
from oridecon.web.routing.health_checks import WebHealthChecker
...
async def _resolve_application(request: Request) -> Application:
    """Resolve the oridecon Application from the Starlette request."""
    from oridecon.app.base import Application as OrideconApplication
    ...
    return cast(
        "OrideconApplication",
        await container.resolve(OrideconApplication, bypass_visibility=True),
    )
