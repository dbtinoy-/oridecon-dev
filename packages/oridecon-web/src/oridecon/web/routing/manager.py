"""Router manager for oridecon-web."""
...
from oridecon.web.protocols import WebProviderProtocol
...
class WebRouterManager:
    ...
    def __init__(self, provider: WebProviderProtocol):
        ...
        from oridecon.web.routing.route_handlers import (
    ...
    async def add_route(
        ...
        # Store Oridecon Route metadata if supported
    ...
    async def register_controller_routes(
        ...
        from oridecon.web.routing import register_controller
