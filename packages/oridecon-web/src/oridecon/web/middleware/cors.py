"""CORS middleware wrapper for oridecon-web security primitives."""
...
from oridecon.web.security.cors.middleware import CORSMiddleware as WebCORSMiddleware
...
class CORSMiddleware(WebCORSMiddleware):
    ...
    Wraps :class:`oridecon.web.security.cors.middleware.CORSMiddleware`
