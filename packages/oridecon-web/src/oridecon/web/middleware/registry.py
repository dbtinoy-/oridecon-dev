"""Middleware registry for oridecon-web.

Enables extensible adaptation of various middleware types (Starlette,
DIScope, Oridecon-native) into the final Starlette middleware stack.
"""
...
class MiddlewareAdapterRegistry:
    ...
    def adapt(self, middleware: Any) -> StarletteMiddleware:
        ...
        # Final fallback: Oridecon Middleware Adapter
        from oridecon.web.middleware.adapter import _OrideconMiddlewareAdapter

        return StarletteMiddleware(_OrideconMiddlewareAdapter, oridecon_mw=middleware)
