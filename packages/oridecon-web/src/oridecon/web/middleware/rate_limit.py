...
:mod:`oridecon.web.middleware.rate_limit_strategies` (sliding window,
...
from oridecon.web.middleware.rate_limit_strategies import (
...
def _rate_limit_429_response(exc: Exception) -> JSONResponse:
    ...
    Args:
        exc: The :class:`~oridecon.contracts.exceptions.RateLimitError`.
