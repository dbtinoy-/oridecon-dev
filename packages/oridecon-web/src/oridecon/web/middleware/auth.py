...
Authentication logic (JWT, OAuth2, etc.) is implemented in oridecon-auth package.

Architecture:
- oridecon-web: HTTP transport (middleware, headers, cookies)
- oridecon-auth: Security logic (JWT decoding, password hashing, OAuth flows)
"""
...
from oridecon.contracts.auth.guard import (
...
class AuthenticationMiddleware:
    ...
    Example:
        from oridecon.web.middleware.auth import AuthenticationMiddleware
...
AuthenticationError = OrideconAuthenticationError
AuthorizationError = OrideconAuthorizationError
