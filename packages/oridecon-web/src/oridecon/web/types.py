...
the Oridecon Web framework. These provide type safety and consistent interfaces.
"""
...
from oridecon.web.config import ServerConfig, WebProviderConfig

# Re-export key types from submodules
from oridecon.web.protocols import ParamMetadata
from oridecon.web.routing.versioning import VersioningConfig, VersioningStrategy
