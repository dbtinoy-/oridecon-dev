...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.events import CommandBusProtocol, QueryBusProtocol
...
class JSONSerializer(AbstractMediaSerializer):
    ...
    async def serialize(
        ...
        # oridecon.web.transport.responses.JSONResponse handles high-performance
        # serialization (orjson/Pydantic) via core oridecon.serialization.
...
class HTMLSerializer(AbstractMediaSerializer):
    ...
    async def serialize(
        ...
        from oridecon.web.transport.responses import HTMLResponse
...
class ResponseSerializer:
    ...
    async def serialize(
        ...
        from oridecon.web.transport.responses import HTMLContent, JSONResponse
        ...
        if isinstance(result, Result):
            if result.is_ok():
                ...
                from oridecon.web.exceptions import HTTPError
        ...
        from oridecon.contracts.events.messages import Command, Query
        ...
        if isinstance(result, (Command, Query)):
            try:
                ...
                from oridecon.web.exceptions import InternalServerError
        ...
        try:
            from oridecon.contracts.domain.base import (  # type: ignore[attr-defined]
                DomainModel,
            )
