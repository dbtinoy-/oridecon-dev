...
from oridecon.web.config import ServerConfig, WebConfig  # ServerConfig used in stub()
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments forwarded to
                :class:`~oridecon.web.di.provider.WebProvider`.
        """
        ...
        from oridecon.web.admin.handlers.request_rate import RequestRateWidgetHandler
        from oridecon.web.admin.handlers.server_status import ServerStatusWidgetHandler
