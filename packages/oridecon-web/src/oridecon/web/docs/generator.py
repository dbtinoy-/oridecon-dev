"""OpenAPI specification generator for oridecon-web
...
class OpenAPIGenerator:
    ...
    Register through the :class:`~oridecon.web.di.provider.WebProvider` so
        ...
        for meta in metadata:
            ...
            if p_type in ("query", "header", "cookie", "form"):
                ...
                if annotation and annotation is not inspect.Parameter.empty:
                    from oridecon.web.docs.type_registry import (
