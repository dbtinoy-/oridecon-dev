...
are owned and processed by the current Oridecon application:
...
A gateway (reverse-proxy pattern) is appropriate when the Oridecon application
...
or the messaging layer (:mod:`oridecon.messaging`) with a pub/sub backend.
