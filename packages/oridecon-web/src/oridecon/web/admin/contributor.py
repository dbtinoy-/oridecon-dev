"""Admin contributor for oridecon-web — surfaces web server widgets, navigation,
health checks, and actions into the Oridecon admin dashboard.
"""
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        title="Reload Routes",
        contributor="web",
        handler="oridecon.web.admin.actions:reload_routes",
        icon="refresh-cw",
        category="operations",
    ),
)
...
class WebAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-web package.
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        return [
            ManagementPageDefinition(
                ...
                contributor="web",
                route_path="/web",
                handler="oridecon.web.admin.pages.overview:WebOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.web.admin.pages.routes:WebRoutesPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="map",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.web.admin.pages.middleware:WebMiddlewarePage",
                category=PageCategory.INFRASTRUCTURE,
                icon="layers",
