...
from oridecon.contracts.cli.contributions import DoctorCheckContribution
...
_OPTIONS: dict[str, tuple[GeneratorOption, ...]] = {
    ...
    "error": (
        ...
        GeneratorOption(
            name="error_code",
            type_hint="str",
            description="Registry error code (ORI_ERR_WEB_...)",
        ),
    ),
}
...
class WebCliContributor:
    """CLI contributor for the oridecon-web package."""
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.web.cli.checks:check_routes_valid",
                contributor="web",
                category="web",
            ),
        ]
