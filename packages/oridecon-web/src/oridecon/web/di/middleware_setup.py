"""Middleware registration helper for the Oridecon web layer."""
...
class MiddlewareSetup:
    """Encapsulates Starlette middleware registration for the Oridecon web layer.
    ...
    def _add_host_validation(self, app: Starlette) -> None:
        ...
        from oridecon.web.middleware.host import HostValidationMiddleware
    ...
    def _add_cors(self, app: Starlette) -> None:
        ...
        from oridecon.web.security.cors.middleware import (
    ...
    def _add_request_context(
        ...
        from oridecon.web.middleware.request_context import RequestContextMiddleware
    ...
    def _add_hooks(self, app: Starlette) -> None:
        ...
        from oridecon.web.middleware.hooks import WebHooksMiddleware
