"""Registration-group sections for :class:`~oridecon.web.di.provider.WebProvider`.
...
def register_transport_services(
    ...
    from oridecon.primitives.context import Context, create_default_context
...
def register_security_services(
    ...
    from oridecon.web.security.cors.middleware import CORSMiddlewareFactory
...
def register_routing_services(
    ...
    from oridecon.web.routing.registry import RouteRegistry, route_registry
    ...
    from oridecon.web.filters.pipeline import FilterPipeline, filter_pipeline
    ...
    from oridecon.contracts.web import ResponseFactoryProtocol
    from oridecon.web.responses import StarletteResponseAdapter
    ...
    from oridecon.web.serialization.serializers import ResponseSerializer
    ...
    # oridecon-tasks job APIs, not this web background-runner interface.
    from oridecon.contracts.web.protocols import BackgroundTaskRunnerProtocol
    from oridecon.web.background.tasks import StarletteBackgroundTaskRunner
...
def register_admin_services(
    ...
    from oridecon.web.admin.contributor import WebAdminContributor
    from oridecon.web.admin.handlers.active_connections import (
        ActiveConnectionsWidgetHandler,
    )
    from oridecon.web.admin.handlers.request_rate import (
        RequestRateWidgetHandler,
    )
    from oridecon.web.admin.handlers.server_status import (
...
def merge_contributed_extensions(
    ...
    from oridecon.web.contributors import discovery as contributor_discovery
...
def register_middleware_registries(
    ...
    from oridecon.web.middleware.base import MiddlewareRegistry
    from oridecon.web.middleware.di_scope import DIScopeMiddleware
    from oridecon.web.middleware.registry import (
