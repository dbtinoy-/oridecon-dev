"""Route registration helper for the Oridecon web layer."""
...
class RouteSetup:
    """Encapsulates route and mount registration for the Oridecon web layer.
    ...
    async def configure(
        ...
        6. Main controller discovery via :class:`~oridecon.web.routing.manager.WebRouterManager`.
