...
from oridecon.web.config import WebConfig, WebProviderConfig
from oridecon.web.di import provider_sections
from oridecon.web.di.middleware_setup import MiddlewareSetup
from oridecon.web.di.route_setup import RouteSetup
...
from oridecon.web.routing.manager import WebRouterManager
...
class WebProvider(Provider):
    ...
    **Config-first factory** — construct from an explicit ``WebConfig``::
        ...
        from oridecon.web import WebProvider, WebConfig
    ...
    **Advanced** — pass individual components explicitly (e.g. for tests)::
    ...
    def auto_discover(
        ...
        **kwargs: Any,
        ...
        :class:`~oridecon.web.routing.controllers.Controller` subclasses and
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        :mod:`oridecon.web.di.provider_sections`, invoked at the same ordered
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        Phase 1 — OpenAPI generator
            Instantiates :class:`~oridecon.web.routing.OpenAPIGenerator` with
        ...
        Phase 3 — Middleware pipeline
            Iterates registered :class:`~oridecon.web.middleware.AbstractMiddleware`
        ...
        from oridecon.logging.debug import is_debug_mode
        from oridecon.web.filters.pipeline import FilterPipeline
        ...
        self.openapi_generator = OpenAPIGenerator(
            title=str(getattr(self.web_config, "openapi_title", "Oridecon API")),
    ...
    def _init_starlette(self, container: ContainerResolverProtocol) -> Starlette:
        ...
        from oridecon.web.integrations.starlette import build_starlette_app
    ...
    async def _setup_integrations(
        ...
        from oridecon.logging.debug import is_debug_mode
        from oridecon.web.filters import DefaultExceptionFilter
        ...
        from oridecon.web.exceptions import DependencyResolutionError
    ...
    def run_server(
        ...
        **kwargs: Any,
        ...
        Delegates to :func:`oridecon.web.server.runner.run_server`, which
        is sync-only; call :func:`oridecon.web.server.runner.run_server_async`
        from async code instead.
        """
        from oridecon.web.server.runner import run_server as _run_server
