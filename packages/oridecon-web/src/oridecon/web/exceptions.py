...
Aligned with oridecon-contracts exception hierarchy.
"""
...
class HTTPError(OrideconError):
    """Base HTTP error, compatible with OrideconError."""

    _code: str = "ORI_ERR_WEB_014"
