...
of the lower-level :func:`~oridecon.web.middleware.rate_limit.rate_limit`
decorator, plus a ``RateLimitModule`` for module-level configuration.

Usage::

    from oridecon.web import throttle, RateLimitModule
...
def throttle(
    ...
    *,
    ...
    :func:`~oridecon.web.middleware.rate_limit.rate_limit` decorator.
    ...
    from oridecon.web.middleware.rate_limit import rate_limit as _rate_limit
...
class RateLimitModule:
    ...
    Registers a :class:`~oridecon.web.di.rate_limit.RateLimitProvider` in
    ...
    def configure(
        ...
        *,
        ...
        """Create a :class:`~oridecon.di.module.DynamicModule` that wires up
        rate limiting.
