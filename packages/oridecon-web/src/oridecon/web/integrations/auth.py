...
class AuthIntegration:
    ...
    async def configure(app: Starlette, container: Container, web_config: Any) -> None:
        ...
        from oridecon.contracts.auth.guard import AuthenticatorProtocol
        from oridecon.contracts.exceptions import ContainerError
    ...
    async def _add_role_guard(
        ...
        :class:`~oridecon.web.middleware.role_guard.RoleResolverProtocol`,
