...
if TYPE_CHECKING:
    ...
    from oridecon.web.transport.responses import (  # type: ignore[attr-defined]
        FastJSONResponse,
        FileResponse,
        HTMLResponse,
        HTMXResponse,
    ...
    from oridecon.web.transport.sse import (
        EventSourceResponse,
        ServerSentEvent,
        sse_response,
    )
...
_LAZY_IMPORTS = {
    ...
    # SSE
    "EventSourceResponse": ("oridecon.web.transport.sse", "EventSourceResponse"),
    "ServerSentEvent": ("oridecon.web.transport.sse", "ServerSentEvent"),
    "sse_response": ("oridecon.web.transport.sse", "sse_response"),
    # WebSocket
    "WebSocket": ("oridecon.web.transport.websockets", "WebSocket"),
    "GuardedWebSocket": ("oridecon.web.transport.websocket_guards", "GuardedWebSocket"),
    "execute_websocket_guards": (
        "oridecon.web.transport.websocket_guards",
        "execute_websocket_guards",
    ),
    # Reactive
    "sse_from_stream": ("oridecon.web.transport.reactive", "sse_from_stream"),
}
