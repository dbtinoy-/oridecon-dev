...
from oridecon.serialization import dumps, dumps_str

# Use oridecon common JSON utilities for consistent serialization across packages
...
class FastJSONResponse(Response):
    """JSON response using oridecon common JSON utilities.
    ...
    def render(self, content: Any) -> bytes:
        ...
        # Use oridecon common JSON utilities for everything else
...
class JSONResponse(FastJSONResponse):
    ...
    Uses oridecon common JSON utilities for consistent serialization
    across all Oridecon packages. Automatically uses Pydantic's Rust serializer
