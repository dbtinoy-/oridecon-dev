...
Provides concise aliases over :func:`~oridecon.web.security.guards.use_guards`
for the most frequent use cases.

Example::

    from oridecon.web import guard, roles
...
from oridecon.web.security.guards import RoleGuard, use_guards
