...
from oridecon.security.constants import ENV_NESTED_DELIMITER, ENV_PREFIX
from oridecon.validation import ConfigDict, Field, model_validator
from oridecon.web.security.config.cors import CORSConfig
from oridecon.web.security.config.csp import CSPConfig
from oridecon.web.security.config.csrf import CSRFConfig
...
class SecurityConfig(BaseConfig):
    """Root HTTP security configuration for oridecon-web.
