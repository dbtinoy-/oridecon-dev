"""Tests for the oridecon-search admin contributor skeleton."""

from __future__ import annotations

from oridecon.search.admin import SearchAdminContributor
...
class TestSearchAdminContributor:
    ...
    def test_all_exports(self) -> None:
        ...
        from oridecon.search.admin import __all__
