...
from oridecon.search import constants as search_const
...
class TestGetBackend:
    ...
    @patch("oridecon.search.backends.factory._sqlite_available", True)
    @patch("oridecon.search.backends.factory.SQLiteSearchBackend")
    ...
    @patch("oridecon.search.backends.factory._mongodb_available", True)
    @patch("oridecon.search.backends.factory.MongoSearchBackend")
    ...
    @patch("oridecon.search.backends.factory._elasticsearch_available", True)
    @patch("oridecon.search.backends.factory.ElasticsearchBackend")
    ...
    @patch("oridecon.search.backends.factory._typesense_available", True)
    @patch("oridecon.search.backends.factory.TypesenseBackend")
