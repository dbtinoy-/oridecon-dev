...
from oridecon.search.exceptions import SchedulerError
from oridecon.search.indexing.batch import BatchStats
from oridecon.search.indexing.scheduler import (
    IndexingJob,
    IndexingScheduler,
    ScheduleConfig,
    SchedulerStats,
...
class TestIndexingScheduler:
    ...
    async def test_execute_job_with_data(self, scheduler: IndexingScheduler, mock_engine: MagicMock) -> None:
        ...
        with patch('oridecon.search.indexing.scheduler.BatchIndexer') as mock_batch:
