...
import pytest
import oridecon.testing.clients.search.client as search_client_module

from oridecon.search import SearchResult
search_client_module.SearchResult = SearchResult

from oridecon.testing.clients.search import (
    MockSearchBackend,
    SearchTestBed,
    SearchTestClient,
    SearchTestData,
