...
Converts an admin-facing :class:`~oridecon.search.filterset.types.FilterSet`
into a :class:`~oridecon.search.engine.SearchQuery` ready for execution
by any registered search backend.

The translation is performed by mapping each
:class:`~oridecon.search.filterset.types.FilterCondition` to its corresponding
:class:`~oridecon.search.query.types.QueryOperator` and delegating to the
:class:`~oridecon.search.query.builder.SearchQueryBuilder` for consistent
filter compilation.
"""

from __future__ import annotations

from oridecon.search.engine import SearchQuery
...
from oridecon.search.query.types import QueryOperator, SortDirection
...
class FilterSetTranslator:
    ...
    Example::
        ...
        from oridecon.search.filterset import FilterCondition, FilterOperator, FilterSet
        from oridecon.search.filterset import FilterSetTranslator
