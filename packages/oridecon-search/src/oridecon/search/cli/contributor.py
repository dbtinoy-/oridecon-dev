...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.search.cli.generators.search_index:SearchIndexGenerator",
        "src/search",
    ),
)
...
class SearchCliContributor:
    """CLI contributor for the oridecon-search package."""
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.search.cli.checks:check_search_backend",
                contributor="search",
                category="search",
                timeout=10.0,
            ),
