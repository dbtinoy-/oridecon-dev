...
from oridecon.primitives.data import ReadOnlyMapper
from oridecon.search.exceptions import TransformationError
...
class DocumentTransformer(ReadOnlyMapper[dict[str, Any], dict[str, Any]]):
    ...
    Extends ``ReadOnlyMapper[dict, dict]`` from ``oridecon.data.mapper`` so
