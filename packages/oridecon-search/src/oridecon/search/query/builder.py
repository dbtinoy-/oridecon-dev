...
from oridecon.contracts.data import FilterExpression
from oridecon.logging import get_logger
from oridecon.search.config import QueryConfig
...
class SearchQueryBuilder:
    ...
    def filter_expr(self, expr: FilterExpression) -> SearchQueryBuilder:
        ...
        Accepts the ``FilterExpression`` type from ``oridecon.contracts.data``
    ...
    def build(self) -> SearchQuery:
        ...
        from oridecon.search.query.operator_registry import get_query_operator_registry
