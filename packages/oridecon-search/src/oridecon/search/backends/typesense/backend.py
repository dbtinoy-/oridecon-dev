...
from oridecon.search.backends.filters import render_typesense
from oridecon.search.config import TypesenseConfig
...
class TypesenseBackend(SearchBackendBase):
    ...
    async def bulk_operation(
        ...
        **kwargs: Any,
        ...
        """
        from oridecon.search.engine import BulkOperationResult, BulkResult
