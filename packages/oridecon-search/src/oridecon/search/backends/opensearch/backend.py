...
from oridecon.search.config import ElasticsearchConfig, OpenSearchConfig
...
class OpenSearchBackend(ElasticsearchBackend):
    ...
    Args:
        config: OpenSearch connection configuration.  Accepts an
            :class:`~oridecon.search.config.OpenSearchConfig` instance, a plain
    ...
    Example:
        ::
            ...
            from oridecon.search.config import OpenSearchConfig
