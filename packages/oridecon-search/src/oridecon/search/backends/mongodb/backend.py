...
Migrated to use ``DocumentStoreProtocol`` from ``oridecon-nosql``
...
from oridecon.search.backends.filters import render_mongodb
from oridecon.search.config import MongoSearchConfig
