...
* Subclass :class:`~oridecon.search.backends.base.SearchBackendBase`.
...
from oridecon.search.backends.base import SearchBackendBase
from oridecon.search.backends.factory import get_backend
from oridecon.search.backends.meilisearch import MeiliSearchBackend
from oridecon.search.backends.mysql import MySQLDatabaseSearchBackend
from oridecon.search.backends.null import NullBackend
from oridecon.search.backends.postgres import PostgresDatabaseSearchBackend

try:
    from oridecon.search.backends.sqlite import SQLiteSearchBackend
except ImportError:
    SQLiteSearchBackend = None  # type: ignore[misc,assignment]

try:
    from oridecon.search.backends.mongodb import MongoSearchBackend
except ImportError:
    MongoSearchBackend = None  # type: ignore[misc,assignment]

try:
    from oridecon.search.backends.elasticsearch import ElasticsearchBackend
except ImportError:
    ElasticsearchBackend = None  # type: ignore[misc,assignment]

try:
    from oridecon.search.backends.opensearch import OpenSearchBackend
except ImportError:
    OpenSearchBackend = None  # type: ignore[misc,assignment]

try:
    from oridecon.search.backends.typesense import TypesenseBackend
except ImportError:
