"""Base class for all Oridecon search backends.
...
from oridecon.primitives.data import AbstractReadOnlyRepository
from oridecon.result import Result
from oridecon.search.engine import validate_search_query
