...
from oridecon.contracts import ContainerRegistrarProtocol, ContainerResolverProtocol
from oridecon.contracts.core import HealthCheckResult, HealthStatus, ProviderPriority
from oridecon.di.provider import Provider
from oridecon.logging import get_logger
from oridecon.search.backends.db_registry import DbSearchBackendRegistry
from oridecon.search.config import BackendType, SearchConfig
    ...
    **Multi-backend** (Named DI):
        ...
        if self.backend is None:
            ...
            if self._config is None:
                raise RuntimeError(
                    ...
                    "or a OrideconConfig with a 'search' section."
                )
    ...
    def configure(cls, config: SearchConfig) -> SearchProvider:
        ...
        if config.backend_type in (BackendType.POSTGRES, BackendType.MYSQL):
            # Database-backed search backends live in oridecon-sql, not here.
