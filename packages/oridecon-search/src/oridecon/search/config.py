"""Configuration models for Oridecon Search.
...
Example:
    ...
    # From environment
    config = SearchConfig()  # reads ORI_SEARCH__* env vars
"""
...
class ElasticsearchConfig(BaseConfig):
    ...
    index_prefix: str = Field(default="oridecon_search_")
...
class SearchConfig(BaseConfig):
    """Root configuration for Oridecon Search."""
