...
class StorageModule(Module):
    ...
    Registers :class:`~oridecon.contracts.BlobStoreProtocol` for constructor
    injection.
    ...
    def configure(
        ...
        Args:
            config: :class:`~oridecon.storage.config.StorageConfig` or ``None``
            ...
            enable_encryption: Enable server-side encryption for all stored
                ...
                :class:`~oridecon.storage.config.EncryptionConfig`.
    ...
    def stub(cls, config: StorageConfig | None = None) -> DynamicModule:
        ...
        Args:
            config: Optional :class:`~oridecon.storage.config.StorageConfig`
