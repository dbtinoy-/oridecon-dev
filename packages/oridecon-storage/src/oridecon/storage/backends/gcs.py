...
class GCSDriver(AbstractDriver):
    ...
    Install the optional dependency with::
        ...
        pip install oridecon-storage[gcs]
    ...
    async def upload(
        ...
        **options: Any,
        ...
        Returns:
            :class:`~oridecon.contracts.infra.storage.FileInfo` for the stored object.
    ...
    async def list(self, prefix: str = "") -> AsyncGenerator[FileInfo, None]:
        """Yield :class:`~oridecon.contracts.infra.storage.FileInfo` for objects matching *prefix*.
