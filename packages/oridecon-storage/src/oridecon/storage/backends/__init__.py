...
from oridecon.storage.backends.unavailable import _make_unavailable_class

try:
    from oridecon.storage.backends.s3 import S3Driver as S3Driver
...
try:
    from oridecon.storage.backends.gcs import GCSDriver as GCSDriver
...
try:
    from oridecon.storage.backends.azure import AzureDriver as AzureDriver
