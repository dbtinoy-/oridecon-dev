"""Local file storage implementation for Oridecon."""
...
if TYPE_CHECKING:
    from oridecon.contracts import HealthCheckResult
...
class LocalStorage(StorageBackendProtocol):
    ...
    async def health_check(self, timeout: float = 5.0) -> HealthCheckResult:
        ...
        Returns:
            :class:`~oridecon.contracts.HealthCheckResult` reflecting whether
