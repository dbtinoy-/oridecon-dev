"""Configuration models for Oridecon Storage.
...
Example:
    ...
    # From environment
    config = StorageConfig()  # reads ORI_STORAGE__* env vars
"""
...
class StorageConfig(BaseConfig):
    """Hierarchical root configuration for Oridecon Storage.
    ...
    Example::
        ...
        # From environment variables (``ORI_STORAGE__*``)
                ...
                if isinstance(driver, StorageS3Config):
                    if (
                        ...
                        raise ValueError(
                            ...
                            " ORI_STORAGE__DRIVERS__<name>__SECRET_KEY.",
                        )
                    ...
                    raise ValueError(
                        ...
                        " ORI_STORAGE__DRIVERS__<name>__ACCOUNT_KEY.",
                    )
