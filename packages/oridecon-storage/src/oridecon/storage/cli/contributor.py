...
class StorageCliContributor:
    """CLI contributor for the oridecon-storage package."""
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.storage.cli.checks:check_storage_backend",
                contributor="storage",
                category="storage",
                timeout=10.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.storage.cli.doctor:check_storage_configured",
                contributor="storage",
                category="storage",
            ),
        ]
