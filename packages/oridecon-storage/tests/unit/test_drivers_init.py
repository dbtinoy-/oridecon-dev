...
class TestDriversInit:
    ...
    def test_s3_driver_in_all_if_available(self):
        ...
        from oridecon.storage.backends import S3Driver, __all__
    ...
    def test_gcs_driver_in_all_if_available(self):
        ...
        from oridecon.storage.backends import GCSDriver, __all__
    ...
    def test_azure_driver_in_all_if_available(self):
        ...
        from oridecon.storage.backends import AzureDriver, __all__
...
class TestUnavailableDrivers:
    ...
    def test_driver_class_names(self):
        ...
        from oridecon.storage.backends import (
            AbstractDriver,
            LocalDriver,
            MemoryDriver,
            S3Driver,
...
class TestMakeUnavailableClass:
    ...
    def test_make_unavailable_class_creates_stub(self):
        ...
        from oridecon.storage.backends import _make_unavailable_class
