...
from oridecon.storage import exceptions as storage_exc


class TestStorageError:
    def test_inheritance(self) -> None:
        assert issubclass(storage_exc.StorageError, OrideconError)
        assert hasattr(storage_exc.StorageError, "_code")

    def test_code(self) -> None:
        exc = storage_exc.StorageError("test message")
        assert exc._code == "ORI_ERR_STORE_001"
...
class TestStorageFileNotFoundError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_002"
...
class TestStorageUnsupportedOperationError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_003"
...
class TestTransactionError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_004"
...
class TestQuotaExceededError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_005"
...
class TestInvalidPathError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_006"
...
class TestStorageUnavailableError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_007"
...
class TestChecksumMismatchError:
    ...
    def test_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_STORE_008"
