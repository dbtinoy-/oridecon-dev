...
from oridecon.storage.config import (
    EncryptionConfig,
    NamedStorageConfig,
    StorageAzureConfig,
    StorageConfig,
...
class TestStorageConfig:
    ...
    def test_validate_production_security_rejects_insecure_s3(self, insecure_value: str) -> None:
        ...
        original_env = os.environ.get("ORI_ENV")
        try:
            os.environ["ORI_ENV"] = "production"
            ...
            if original_env is not None:
                os.environ["ORI_ENV"] = original_env
            else:
                os.environ.pop("ORI_ENV", None)
    ...
    def test_validate_production_security_passes_in_dev(self) -> None:
        ...
        original_env = os.environ.get("ORI_ENV")
        try:
            os.environ["ORI_ENV"] = "development"
            config = StorageConfig(
                drivers={
                    "s3": StorageS3Config(
                        bucket="test-bucket",
