"""Integration tests for oridecon-storage package lifecycle."""
...
class TestStorageProtocolsIntegration:
    ...
    def test_storage_driver_protocol_import(self):
        ...
        from oridecon.contracts.infra.storage import StorageDriverProtocol
...
class TestStorageExceptionsIntegration:
    ...
    def test_storage_error_import(self):
        ...
        from oridecon.storage.exceptions import StorageError
    ...
    def test_storage_file_not_found_error_import(self):
        ...
        from oridecon.storage.exceptions import StorageFileNotFoundError
