...
from oridecon.testing.compliance import BlobStoreCompliance
from oridecon.testing.integration.fixtures import (
...
class TestMinioBlobStoreCompliance(BlobStoreCompliance):
    ...
    ``oridecon.testing.integration.fixtures``.  The test class is auto-skipped
    ...
    async def create_store(self) -> object:
        ...
        """
        try:
            from oridecon.storage.backends.s3 import S3Driver  # noqa: F401
        except ImportError:
