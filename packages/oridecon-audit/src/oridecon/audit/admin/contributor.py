...
if TYPE_CHECKING:
    from oridecon.contracts.audit import AuditEntry, AuditVerifierProtocol
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        ...
        return [
            ManagementPageDefinition(
                ...
                contributor="audit",
                route_path="/audit",
                handler="oridecon.audit.admin.pages.audit_log:AuditLogPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.audit.admin.pages.verification:AuditVerificationPage",
                category=PageCategory.SECURITY,
                icon="shield-check",
