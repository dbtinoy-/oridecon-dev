...
class AuditBundleProvider(Provider):
    ...
    # present (see oridecon/di/orchestrator/lifecycle.py::_inject_provider_config).
    ...
    def _compose_sub_providers(self) -> None:
        ...
        """
        from oridecon.audit.di.sub_providers.admin_provider import AuditAdminProvider
        from oridecon.audit.di.sub_providers.core_provider import AuditCoreProvider
        from oridecon.audit.di.sub_providers.retention_provider import (
            AuditRetentionProvider,
        )
        from oridecon.audit.di.sub_providers.scheduling_provider import (
            AuditSchedulingProvider,
        )
        from oridecon.audit.di.sub_providers.verifier_provider import (
