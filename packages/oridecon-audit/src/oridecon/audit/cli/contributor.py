...
_GENERATOR_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.audit.cli.generators.audited:AuditedHandlerGenerator",
        "src/audit",
    ),
)
...
class AuditCliContributor:
    """CLI contributor for the oridecon-audit package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.audit.cli.commands:create_audit_app",
                contributor="audit",
                category="security",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.audit.cli.checks:check_audit_store",
                contributor="audit",
                category="security",
                timeout=10.0,
                critical=True,
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.audit.cli.doctor:check_hmac_key",
                contributor="audit",
                category="security",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.audit.cli.shell:provide_audit_logger",
                contributor="audit",
            ),
        ]
    ...
    def get_hooks(self) -> list[HookContribution]:
        ...
        return [
            HookContribution(
                event="post_command",
                handler_path="oridecon.audit.cli.hooks:log_cli_command",
                contributor="audit",
                priority=80,
            ),
        ]
