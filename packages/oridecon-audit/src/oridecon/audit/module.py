"""AuditModule — IoC module for the Oridecon audit subsystem."""

from __future__ import annotations

from typing import TYPE_CHECKING, Any

from oridecon.contracts.audit import AuditLoggerProtocol, AuditStoreProtocol
...
class AuditModule:
    ...
    Or with an explicit :class:`~oridecon.audit.config.AuditConfig` section::
    ...
    def configure(
        ...
        **overrides: Any,
        ...
        Args:
            config: Explicit :class:`~oridecon.audit.config.AuditConfig`
