...
from oridecon.audit.cli.contributor import AuditCliContributor
from oridecon.audit.cli.generators.audited import AuditedHandlerGenerator
...
def test_audited_importable_from_package_root() -> None:
    module = importlib.import_module("oridecon.audit")
