...
class TestVersion:
    ...
    def test_version_is_string(self) -> None:
        from oridecon.audit.constants import __version__
...
class TestEnvironmentConstants:
    ...
    def test_env_prefix(self) -> None:
        from oridecon.audit.constants import ENV_PREFIX
        assert ENV_PREFIX == "ORI_AUDIT__"

    def test_env_nested_delimiter(self) -> None:
        from oridecon.audit.constants import ENV_NESTED_DELIMITER
...
class TestDefaultConfigValues:
    ...
    def test_default_store_backend(self) -> None:
        from oridecon.audit.constants import DEFAULT_STORE_BACKEND
        assert DEFAULT_STORE_BACKEND == "sql"

    def test_default_table_name(self) -> None:
        from oridecon.audit.constants import DEFAULT_TABLE_NAME
        assert DEFAULT_TABLE_NAME == "audit_log"

    def test_default_verification_schedule(self) -> None:
        from oridecon.audit.constants import DEFAULT_VERIFICATION_SCHEDULE
        assert DEFAULT_VERIFICATION_SCHEDULE == "0 * * * *"

    def test_default_verification_batch_size(self) -> None:
        from oridecon.audit.constants import DEFAULT_VERIFICATION_BATCH_SIZE
...
class TestStoreBackendEnum:
    ...
    def test_sql_value(self) -> None:
        from oridecon.audit.constants import StoreBackend
...
class TestAuditSeverityEnum:
    ...
    def test_low_value(self) -> None:
        from oridecon.audit.constants import AuditSeverity
...
class TestAuditOutcomeEnum:
    ...
    def test_success_value(self) -> None:
        from oridecon.audit.constants import AuditOutcome
