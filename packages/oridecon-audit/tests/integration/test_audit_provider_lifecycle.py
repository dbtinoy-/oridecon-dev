...
from oridecon.testing.integration.fixtures import postgres_pool  # noqa: F401
...
class TestAuditProviderLifecycle:
    ...
    async def test_in_memory_store_appends_and_queries(self) -> None:
        ...
        from oridecon.contracts.audit import AuditEntry, AuditEventSeverity, AuditQuery
