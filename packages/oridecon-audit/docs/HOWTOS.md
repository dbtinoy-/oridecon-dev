---
title: oridecon-audit How-Tos
description: Common recipes for oridecon-audit
sidebar:
  order: 5
---
...
```python
from oridecon.contracts.audit import AuditEntry, AuditEventSeverity, AuditLoggerProtocol
...
```python
from oridecon.audit import AuditBundleProvider, AuditConfig
...
# Register the handler with a task provider (e.g. from oridecon-tasks)
...
```python
from oridecon.audit.events import (
