...
from oridecon.secrets.backends.aws import AWSSecretsManagerStore
from oridecon.secrets.backends.azure import AzureKeyVaultStore
from oridecon.secrets.backends.gcp import GCPSecretManagerStore
from oridecon.secrets.backends.vault import HashicorpVaultStore
...
def test_exception_hierarchy() -> None:
    assert SecretAccessError().code == "ORI_ERR_SECRET_003"
    assert SecretBackendError().code == "ORI_ERR_SECRET_005"
    assert SecretNotFoundError("x").code == "ORI_ERR_SECRET_002"