---
title: oridecon-testing Quickstart
description: Install oridecon-testing and write your first test with fakes and test environments
---
...
```bash
uv add --dev "oridecon-testing[web,db]"
```
