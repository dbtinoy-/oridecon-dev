---
title: oridecon-testing Compliance
...
Import from `oridecon.testing.compliance`:
...
- `oridecon.testing.compliance` — full module listing
- `oridecon.contracts.cache.CacheBackendProtocol` — protocol definition
