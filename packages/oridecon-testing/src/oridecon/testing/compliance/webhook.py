...
Covers :class:`~oridecon.contracts.webhook.protocols.WebhookSubscriptionStoreProtocol`
and :class:`~oridecon.contracts.webhook.protocols.WebhookDeliveryStoreProtocol`.
...
def _make_attempt(**kwargs: Any) -> Any:
    ...
    """
    from oridecon.contracts.webhook.types import DeliveryAttempt, DeliveryStatus
...
class WebhookDeliveryStoreCompliance(abc.ABC):
    ...
    async def test_count_recent_failures_counts_failed_attempts(self) -> None:
        ...
        from oridecon.contracts.webhook.types import DeliveryStatus
