"""
Testing infrastructure for oridecon-events.

This module provides comprehensive testing utilities for the Oridecon events framework,
...
Example:
    >>> import pytest
    >>> from oridecon.testing.clients.events import EventTestBed, EventTestClient
    >>>
    >>> @pytest.mark.asyncio
...
from oridecon.testing.clients.events.fixtures import (
    command_bus,
    command_client,
    command_handlers,
    command_test_bed,
