...
from oridecon.testing.clients.events.fixtures._async import (
...
def event_handlers() -> Any:
    ...
    from oridecon.events import (  # - local import for test fixture classes
...
def query_handlers() -> Any:
    ...
    from oridecon.events import QueryHandlerProtocol
