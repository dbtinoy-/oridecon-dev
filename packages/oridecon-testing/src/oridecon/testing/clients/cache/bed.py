...
from oridecon.cache import CacheProvider, CacheService, MemoryCacheBackend
from oridecon.cache.config import default_cache_config
...
class CacheTestBed(TestEnvironment):
    """Test bed for oridecon-cache testing.
