"""UI testing helpers for oridecon-ui components.
...
Usage::
    ...
    from oridecon.testing.ui import render_component, assert_html_contains
...
def render_component(component_class: type, *args: Any, **kwargs: Any) -> str:
    ...
    Args:
        component_class: A :class:`~oridecon.ui.base.Component` subclass.
    ...
    """
    from oridecon.ui.core.base import NoContext, render_to_string
