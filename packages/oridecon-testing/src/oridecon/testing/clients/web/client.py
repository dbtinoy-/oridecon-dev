...
class WebTestClient:
    ...
    for Oridecon web applications. It automatically extracts the underlying
    ASGI application from a Oridecon Application instance and provides
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            app: A Oridecon Application, WebProvider, or raw ASGI application.
    ...
    def _extract_asgi_app(self, app: Any) -> Any:
        ...
        # If it's a Oridecon Application
    ...
    def _prepare_kwargs(self, kwargs: dict[str, Any]) -> dict[str, Any]:
        ...
        if self._user is not None:
            ...
            if headers is None:
                headers = {}
            # Standard Oridecon test header for user simulation
