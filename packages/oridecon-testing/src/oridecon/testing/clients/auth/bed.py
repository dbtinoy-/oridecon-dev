"""Test bed for oridecon-auth testing."""
...
from oridecon.testing.clients.auth.types import AuthTestUser
...
class AuthTestBed(TestEnvironment):
    ...
    def create_test_token(self, user: AuthTestUser, **kwargs: Any) -> Any:
        ...
        from oridecon.testing.clients.auth.types import AuthTestToken as _AuthTestToken
