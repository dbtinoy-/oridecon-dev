"""TestContainer implementation for Oridecon testing."""
...
class OrideconContainerHarness(Container):
    ...
    Usage::
        ...
        container = OrideconContainerHarness()
    ...
    def override(self, interface: type[T], implementation: Any) -> Any:
        ...
        Example:
            with container.override(UserService, MockUserService()):
                ...
        """
        from oridecon.testing.harness.overrides import override as _override
...
__all__ = ["OrideconContainerHarness"]
