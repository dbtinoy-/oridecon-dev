...
class ContainerTestFixture:
    ...
    Wraps :class:`~oridecon.testing.harness.container.OrideconContainerHarness` with automatic
    ...
    def __init__(self, *, register_mocks: bool = False) -> None:
        ...
        self._container: OrideconContainerHarness = OrideconContainerHarness(
    ...
    @property
    def container(self) -> OrideconContainerHarness:
        """Return the underlying :class:`OrideconContainerHarness`.
