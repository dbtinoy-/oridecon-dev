...
Provides composable, minimal fixtures based on :mod:`oridecon.testing.fakes`
and :class:`~oridecon.testing.fixtures.bed.TestEnvironment`.
"""
...
from oridecon.testing.lib import (
    test_assertions,
    test_data_factory,
)
...
async def test_container() -> AsyncGenerator[ContainerTestFixture, None]:
    ...
    for all common Oridecon protocols.  The container is disposed automatically
