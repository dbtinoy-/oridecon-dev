...
require a specific service to be running.  When the Oridecon pytest
...
Usage::
    ...
    from oridecon.testing import requires_redis, requires_postgres
...
# Named marks — the Oridecon pytest plugin (plugin.py) handles
