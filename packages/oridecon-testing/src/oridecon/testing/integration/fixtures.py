...
Usage in conftest.py::
    ...
    pytest_plugins = ["oridecon.testing.integration.fixtures"]
...
def elasticsearch_index() -> str:
    ...
    """
    return f"oridecon_test_{uuid.uuid4().hex[:12]}"
...
def mongodb_database(mongodb_client: object) -> object:
    ...
    """
    db_name = f"oridecon_test_{uuid.uuid4().hex[:12]}"
...
def minio_bucket() -> str:
    ...
    """
    return f"oridecon-test-{uuid.uuid4().hex[:12]}"
