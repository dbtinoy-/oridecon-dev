...
use the ``oridecon-events`` extension.

Example::

    from oridecon.testing import InMemoryCommandBus, InMemoryQueryBus
...
from oridecon.contracts.events import CommandBusProtocol as CommandBusProtocol
from oridecon.contracts.events import QueryBusProtocol as QueryBusProtocol
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.events import CommandHandlerProtocol, QueryHandlerProtocol
...
class InMemoryCommandBus(CommandBusProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        from oridecon.app.pipeline import (
