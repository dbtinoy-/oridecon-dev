...
from oridecon.contracts.exceptions.events import EventError, HandlerNotFoundError


class MemoryBackendError(OrideconError):
    """Base exception for all memory backend errors."""

    _code: str = "ORI_ERR_TEST_003"


class CommandBusError(EventError):
    """Raised when a command bus operation fails."""

    _code: str = "ORI_ERR_TEST_004"
