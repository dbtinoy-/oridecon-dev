...
Provides a :class:`~oridecon.contracts.audit.AuditLoggerProtocol`-compatible
...
from oridecon.contracts.audit import AuditEntry, AuditLoggerProtocol, AuditQuery
