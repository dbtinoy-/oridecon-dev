...
from oridecon.contracts.core.lock import DistributedLockProtocol, LockInfo
from oridecon.contracts.exceptions.components import LockAcquisitionError
...
class InMemoryAsyncLock:
    ...
    :class:`oridecon.contracts.lock.AsyncLockProtocol` for tasks that need a
