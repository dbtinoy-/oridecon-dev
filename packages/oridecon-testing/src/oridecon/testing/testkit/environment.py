...
from oridecon.testing.memory.lock import InMemoryDistributedLock
...
class TestEnvironment:
    ...
    def make_repository(self) -> InMemoryRepository:
        """Create a fresh :class:`~oridecon.memory.repository.InMemoryRepository`."""
        return InMemoryRepository()

    def make_uow(self) -> InMemoryUnitOfWork:
        """Create a fresh :class:`~oridecon.memory.uow.InMemoryUnitOfWork`."""
