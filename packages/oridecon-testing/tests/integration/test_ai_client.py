...
# Mock the modules
# sys.modules["oridecon.testing.bed"] = type("MockModule", (), {"TestEnvironment": MockTestEnvironment})
# sys.modules["oridecon.ai.llm.types"] = type("MockModule", (), {
#     "ChatMessage": MockChatMessage,
#     "Completion": MockCompletion,
# })
# sys.modules["oridecon.ai.ml.types"] = type("MockModule", (), {
#     "Features": MockFeatures,
#     "Prediction": MockPrediction,
# })
# sys.modules["oridecon.ai.vector.types"] = type("MockModule", (), {"SearchResult": Mock RAGSearchResult})
# sys.modules["oridecon.contracts"] = type("MockModule", (), {
#     "LLMClientProtocol": MockLLMClient,
#     "VectorStoreProtocol": MockVectorStore,
# })

# Import ai_client normally
from oridecon.testing.clients.ai import AITestData, AITestClient, AITestBed
