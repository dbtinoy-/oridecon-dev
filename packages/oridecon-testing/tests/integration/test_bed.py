...
# Mock the modules
# sys.modules["oridecon.testing.mocks"] = type("MockModule", (), {
#     "MockProvider": MockProvider,
#     "MockWebProvider": MockWebProvider,
#     "MockDatabaseProvider": MockDatabaseProvider,
# })
# sys.modules["oridecon.app.base"] = type("MockModule", (), {"Application": MockApplication})
# sys.modules["oridecon.di.providers"] = type("MockModule", (), {"Provider": MockProvider})

# Mock the entire oridecon framework comprehensively to avoid import issues
def create_mock_module(name, **attrs):
    """Create a mock module with given attributes."""
    return type(name, (), attrs)

# Mock all oridecon modules that might be imported
# sys.modules["oridecon"] = create_mock_module("oridecon")
# sys.modules["oridecon.ai"] = create_mock_module("oridecon.ai")
# sys.modules["oridecon.ai.llm"] = create_mock_module("oridecon.ai.llm")
# sys.modules["oridecon.ai.llm.providers"] = create_mock_module("oridecon.ai.llm.providers")
# sys.modules["oridecon.ai.llm.providers.mock"] = create_mock_module("oridecon.ai.llm.providers.mock")
# sys.modules["oridecon.decorators"] = create_mock_module("oridecon.decorators")
# sys.modules["oridecon.decorators.di"] = create_mock_module("oridecon.decorators.di", inject=lambda: None)
# sys.modules["oridecon.di"] = create_mock_module("oridecon.di")
# sys.modules["oridecon.di.scopes"] = create_mock_module("oridecon.di.scopes", ServiceScope=object)
# sys.modules["oridecon.di.providers"] = create_mock_module("oridecon.di.providers", Provider=MockProvider)
# sys.modules["oridecon.di.providers.presets"] = create_mock_module("oridecon.di.providers.presets", BACKGROUND_WORKER_PRESET=object)
# sys.modules["oridecon.di.builder"] = create_mock_module("oridecon.di.builder", ContainerBuilder=object, ScopeType=object)
# sys.modules["oridecon.di.container"] = create_mock_module("oridecon.di.container", ScopedContainer=object)
# sys.modules["oridecon.exceptions"] = create_mock_module("oridecon.exceptions")

# Mock oridecon.testing modules
# sys.modules["oridecon.testing"] = create_mock_module("oridecon.testing")
# sys.modules["oridecon.testing.fixtures.containers"] = create_mock_module("oridecon.testing.fixtures.containers", apply_overrides=lambda *args: None)

# Mock oridecon submodules
common_mock = create_mock_module("oridecon")
json_serialization_mock = create_mock_module("oridecon.serialization", dumps=lambda x: "mock", loads=lambda x: {})
logging_mock = create_mock_module("oridecon.logging", getLogger=lambda x: create_mock_module("MockLogger", exception=lambda *args: None, debug=lambda *args: None, info=lambda *args: None, warning=lambda *args: None, error=lambda *args: None)())
validation_mock = create_mock_module("oridecon.validation")
validation_protocols_mock = create_mock_module("oridecon.validation.protocols", validate_protocol=lambda *args: None)
exceptions_mock = create_mock_module("oridecon.exceptions", OrideconError=Exception)
...
# sys.modules["oridecon"] = common_mock
# sys.modules["oridecon.serialization"] = json_serialization_mock
# sys.modules["oridecon.logging"] = logging_mock
# sys.modules["oridecon.validation"] = validation_mock
# sys.modules["oridecon.validation.protocols"] = validation_protocols_mock
# sys.modules["oridecon.exceptions"] = exceptions_mock

# Import bed directly by loading the module
bed_spec = importlib.util.spec_from_file_location(
    "bed",
    os.path.join(os.path.dirname(__file__), "..", "..", "src", "oridecon", "testing", "fixtures", "bed.py"),
)
