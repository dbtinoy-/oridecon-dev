...
# sys.modules["oridecon.app"] = create_mock_module("oridecon.app")
# sys.modules["oridecon.app.base"] = create_mock_module("oridecon.app.base", Application=MockApplication)
...
exceptions_mock = create_mock_module("oridecon.exceptions", OrideconError=Exception, ConfigurationError=Exception)
...
# sys.modules["oridecon.testing.mocks"] = create_mock_module("oridecon.testing.mocks", MockProvider=type("MockProvider", (), {}), MockWebProvider=MockWebProvider)
...
# Mock oridecon.web
# sys.modules["oridecon.web"] = create_mock_module("oridecon.web")
# sys.modules["oridecon.web.transport"] = create_mock_module("oridecon.web.transport")
# sys.modules["oridecon.web.transport.responses"] = create_mock_module("oridecon.web.transport.responses", JSONResponse=lambda data: MockResponse(json_data=data))
...
# sys.modules["oridecon.testing.bed"] = bed_module
...
web_client_spec = importlib.util.spec_from_file_location(
    "web_client",
    os.path.join(os.path.dirname(__file__), "..", "..", "src", "oridecon", "testing", "clients", "web", "__init__.py"),
)
