...
from oridecon.testing.exceptions import TestingError, TokenBudgetExceededError


class TestTestingError:
    """Tests for TestingError."""

    def test_testing_error_is_oridecon_error(self) -> None:
        """Test TestingError inherits from OrideconError."""
