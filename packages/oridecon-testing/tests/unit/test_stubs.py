"""Tests for assert_stub_modules() helper in oridecon.testing.stubs.
...
from oridecon.di.module.decorator import module
from oridecon.di.module.dynamic import DynamicModule
from oridecon.testing.lib.stubs import ConfigurationError, assert_stub_modules
