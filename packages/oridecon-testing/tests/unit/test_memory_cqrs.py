...
from oridecon.testing.memory.constants import (
...
class TestMemoryTypes:
    ...
    def test_outbox_status_import(self) -> None:
        ...
        from oridecon.testing.memory.types import OutboxStatus

        assert OutboxStatus is not None

    def test_outbox_entry_import(self) -> None:
        """Test OutboxEntry can be imported."""
        from oridecon.testing.memory.types import OutboxEntry
