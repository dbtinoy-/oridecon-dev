...
class TestComplianceSuitesAvailability:
    ...
    def test_compliance_suites_exported_from_testing(self) -> None:
        """Verify at least some compliance suites are exported from oridecon.testing."""
        from oridecon import testing
    ...
    def test_repository_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import RepositoryCompliance
    ...
    def test_event_bus_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import EventBusCompliance
    ...
    def test_database_provider_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import DatabaseProviderCompliance
    ...
    def test_task_queue_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import TaskQueueCompliance
    ...
    def test_blob_store_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import BlobStoreCompliance
    ...
    def test_search_engine_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import SearchEngineCompliance
    ...
    def test_flag_provider_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import FlagProviderCompliance
    ...
    def test_middleware_compliance_available(self) -> None:
        ...
        try:
            from oridecon.testing import MiddlewareCompliance
