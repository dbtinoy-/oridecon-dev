"""Tests for Result assertion helpers in oridecon.testing.lib.assertions.
...
class TestTopLevelImport:
    """Verify assert_ok / assert_err are importable from oridecon.testing."""

    def test_assert_ok_importable(self) -> None:
        from oridecon.testing import assert_ok as top_assert_ok  # noqa: PLC0415

        assert callable(top_assert_ok)

    def test_assert_err_importable(self) -> None:
        from oridecon.testing import assert_err as top_assert_err  # noqa: PLC0415
