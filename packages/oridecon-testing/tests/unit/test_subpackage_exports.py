"""Test that all public APIs are exported via __all__ in oridecon-testing subpackages.

This test suite validates API surface completeness for:
- oridecon.testing.compliance (protocol compliance test suites)
- oridecon.testing.memory (in-memory implementations)
- oridecon.testing.fixtures (pytest fixtures)
...
class TestComplianceSubpackageExports:
    ...
    def test_compliance_has_all_attribute(self) -> None:
        ...
        from oridecon.testing import compliance
    ...
    def test_compliance_all_contains_base_suites(self) -> None:
        ...
        from oridecon.testing.compliance import __all__
...
class TestMemorySubpackageExports:
    ...
    def test_memory_has_all_attribute(self) -> None:
        ...
        from oridecon.testing import memory
    ...
    def test_memory_all_contains_core_classes(self) -> None:
        ...
        from oridecon.testing.memory import __all__
...
class TestFixturesSubpackageExports:
    ...
    def test_fixtures_has_all_attribute(self) -> None:
        ...
        from oridecon.testing import fixtures
    ...
    def test_fixtures_all_contains_core_fixtures(self) -> None:
        ...
        from oridecon.testing.fixtures import __all__
...
class TestAllSubpackagesConsistency:
    ...
    def test_all_subpackages_have_all_attribute(self) -> None:
        ...
        from oridecon.testing import compliance, fixtures, memory
...
class TestIntegrationImportsViaAll:
    ...
    def test_import_compliance_exports(self) -> None:
        ...
        from oridecon.testing.compliance import CacheBackendCompliance
    ...
    def test_import_memory_exports(self) -> None:
        ...
        # Import a known export
        from oridecon.testing.memory import InMemoryRepository
    ...
    def test_import_fixtures_exports(self) -> None:
        ...
        # Import a known export
        from oridecon.testing.fixtures import fake_event_bus
    ...
    def test_star_import_compliance(self) -> None:
        ...
        import oridecon.testing.compliance as compliance_module
    ...
    def test_star_import_memory(self) -> None:
        ...
        import oridecon.testing.memory as memory_module
    ...
    def test_star_import_fixtures(self) -> None:
        ...
        import oridecon.testing.fixtures as fixtures_module
