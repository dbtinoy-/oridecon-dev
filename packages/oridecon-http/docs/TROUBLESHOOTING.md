---
title: oridecon-http Troubleshooting
...
**Fix:** Wait for the circuit breaker to half-open, or check the health of the downstream service. Requires `oridecon-resilience` to be registered.
