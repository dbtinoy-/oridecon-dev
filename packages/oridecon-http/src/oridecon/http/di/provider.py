"""DI provider for the oridecon.http module.

Registers :class:`~oridecon.http.HTTPClient` as a container-managed singleton
...
class HTTPProvider(Provider):
    ...
    Registers :class:`~oridecon.http.HTTPClient` (and its
    :class:`~oridecon.contracts.web.HTTPClientProtocol` binding) as a
