"""Numeric and primitive input validation utilities for oridecon.http.

Validates ports, timeouts, and positive integers. Raises
:class:`~oridecon.http.exceptions.HTTPError` on invalid input so callers get a
well-typed infrastructure error.
"""

from __future__ import annotations

from oridecon.http.exceptions import HTTPClientError
