"""Async HTTP client for oridecon core.
...
from oridecon.contracts.security import is_safe_url_for_request
from oridecon.contracts.web import HttpResponse, InterceptorProtocol
...
from oridecon.http.types import RequestContext
from oridecon.logging import get_logger

logger = get_logger(__name__)

_CIRCUIT_OPEN_CODE = "ORI_ERR_RES_009"
_RETRY_EXHAUSTED_CODE = "ORI_ERR_RES_008"
...
from oridecon.http.client._streaming import _HTTPStreamingMixin
from oridecon.http.client._verbs import _HTTPVerbsMixin
...
class HTTPClient(
    ...
    When used through :class:`~oridecon.http.HTTPProvider`, ``retry_policy``
    ...
    Args:
        config: Pool and client configuration.  Defaults to
            :class:`~oridecon.http.HTTPClientConfig` with framework defaults.
        ...
        retry_policy: Retry policy for transient failures.  Defaults to a
            :class:`~oridecon.resilience.RetryPolicy` with framework defaults.
        ...
        metrics: Optional :class:`~oridecon.contracts.observability.protocols.MetricsRecorderProtocol`
    ...
    def __init__(
        ...
        if retry_policy is None:
            ...
            from oridecon.http.retry import RetryPolicy
