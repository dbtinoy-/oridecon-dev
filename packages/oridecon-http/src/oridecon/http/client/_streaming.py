...
if TYPE_CHECKING:
    ...
    from oridecon.http.client.http_client import HTTPClient  # noqa: F401
...
from oridecon.contracts.web.sse import ServerSentEvent
...
class _HTTPStreamingMixin:
    ...
    async def sse(
        ...
        **kwargs: Any,
        ...
        response into :class:`~oridecon.contracts.web.sse.ServerSentEvent` objects.
        ...
        Yields:
            ...
            :class:`~oridecon.contracts.web.sse.ServerSentEvent` objects.
