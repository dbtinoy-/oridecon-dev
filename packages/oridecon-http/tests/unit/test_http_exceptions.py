"""Unit tests for oridecon-http exceptions.

These tests verify the exception hierarchy in oridecon.http.exceptions.
"""
...
class TestHTTPUnsafeURLError:
    ...
    def test_http_unsafe_url_error_code(self) -> None:
        ...
        assert error._code == "ORI_ERR_HTTP_008"
...
class TestExceptionAllExports:
    ...
    def test_all_contains_all_exceptions(self) -> None:
        from oridecon.http import exceptions as exc_module
