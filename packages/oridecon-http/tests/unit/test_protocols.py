"""Tests for oridecon.http.protocols."""
...
class TestHTTPClientProtocol:
    ...
    def test_is_importable(self) -> None:
        """HTTPClientProtocol is importable via oridecon.http.protocols."""
...
class TestInterceptorChainProtocol:
    ...
    def test_is_importable(self) -> None:
        """InterceptorChainProtocol is importable via oridecon.http.protocols."""
...
class TestInterceptorProtocol:
    ...
    def test_is_importable(self) -> None:
        """InterceptorProtocol is importable via oridecon.http.protocols."""
...
class TestModuleAll:
    ...
    def test_all_contains_all_protocols(self) -> None:
        ...
        from oridecon.http import protocols
