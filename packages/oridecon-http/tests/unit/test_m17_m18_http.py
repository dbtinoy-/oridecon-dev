...
from oridecon.http.config import ConnectionPoolConfig
from oridecon.http.constants import DEFAULT_MAX_CONNECTIONS_PER_HOST
...
class TestM18ResiliencePipelineHook:
    ...
    async def test_request_routed_through_resilience_pipeline(self) -> None:
        ...
        with patch(
            "oridecon.http.client.http_client._to_http_response",
