...
Uses :class:`~oridecon.contracts.infra.protocols.StateStoreProtocol` so that the
...
Example::
    ...
    from oridecon.resilience.rate_limiter import DistributedRateLimiter
...
_KEY_PREFIX = "oridecon:resilience:ratelimit"
...
class DistributedRateLimiter:
    ...
    Args:
        ...
        store: A :class:`~oridecon.contracts.infra.protocols.StateStoreProtocol`
