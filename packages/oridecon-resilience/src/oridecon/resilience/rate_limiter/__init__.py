...
Oridecon's rate-control API is layered:
...
Example — using a shared RateLimiter::
    ...
    from oridecon.resilience.rate_limiter import RateLimiter
...
from oridecon.resilience.rate_limiter.distributed import DistributedRateLimiter
from oridecon.resilience.rate_limiter.models import RateLimiterStats
from oridecon.resilience.rate_limiter.sliding_window import SlidingWindowLimiter
from oridecon.resilience.rate_limiter.token_bucket import RateLimiter, TokenBucket
