...
from oridecon.contracts.domain.idempotency import IdempotencyRecord, IdempotencyStatus
...
class InMemoryIdempotencyStore:
    ...
    async def get_record(self, key: str) -> IdempotencyRecord | None:
        ...
        Returns an :class:`~oridecon.contracts.domain.idempotency.IdempotencyRecord`
