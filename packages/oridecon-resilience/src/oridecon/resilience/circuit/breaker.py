...
from oridecon.resilience.circuit._metrics import (
    BucketedSlidingWindowCounter,
    CircuitBreakerMetrics,
)
from oridecon.resilience.circuit._presets import sensitive_config, tolerant_config

# CircuitBreakerRegistry is defined below (depends on CircuitBreaker, defined above)
from oridecon.resilience.exceptions import CircuitOpenError
    ...
    **Using the config object** (recommended for production)::
    ...
    Example:
        Using as a decorator::
            ...
            from oridecon.resilience import circuit_breaker
...
from oridecon.resilience.circuit._decorators import (  # noqa: E402
    circuit_breaker,
    circuit_breaker_sync,
)
from oridecon.resilience.circuit._registry import CircuitBreakerRegistry
