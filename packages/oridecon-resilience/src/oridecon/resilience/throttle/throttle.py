...
from oridecon.resilience.rate_limiter import RateLimiter, SlidingWindowLimiter
from oridecon.resilience.rate_limiter.models import RateLimiterStats
...
class Throttler:
    ...
    async def acquire(self) -> None:
        ...
        Emits ``throttle.allowed`` via the :class:`~oridecon.contracts.observability.protocols.MetricsRecorderProtocol`
    ...
    async def try_acquire(self) -> bool:
        ...
        :class:`~oridecon.contracts.observability.protocols.MetricsRecorderProtocol` when one
