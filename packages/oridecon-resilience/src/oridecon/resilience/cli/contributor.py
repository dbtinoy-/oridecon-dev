...
class ResilienceCliContributor:
    """CLI contributor for the oridecon-resilience package."""
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.resilience.cli.checks:check_circuit_breakers",
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.resilience.cli.doctor:check_resilience_config",
                contributor="resilience",
                category="resilience",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.resilience.cli.shell:provide_resilience_pipeline",
                contributor="resilience",
            ),
        ]
    ...
    def get_schema_setup(self) -> list[SchemaSetupContribution]:
        ...
        return [
            SchemaSetupContribution(
                ...
                setup_fn_path="oridecon.resilience.cli.schema_setup:ensure_idempotency_keys",
