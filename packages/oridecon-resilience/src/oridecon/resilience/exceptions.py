...
class IdempotencyBackendError(IdempotencyError):
    ...
    Attributes:
        _code: Machine-readable error code ``ORI_ERR_IDEM_005``.
    """

    _code = "ORI_ERR_IDEM_005"
...
class IdempotencyConfigurationError(IdempotencyError):
    ...
    Attributes:
        _code: Machine-readable error code ``ORI_ERR_IDEM_006``.
    """

    _code = "ORI_ERR_IDEM_006"
