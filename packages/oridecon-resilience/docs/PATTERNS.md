---
title: oridecon-resilience Patterns
...
```python
from oridecon.contracts.infra.resilience.models import CircuitBreakerConfig
...
```python
from oridecon.resilience import CircuitBreaker
...
```python
from oridecon.resilience import retry
...
```python
from oridecon.resilience.config import BulkheadConfig
...
```python
from oridecon.resilience import RateLimiter
...
```python
from oridecon.contracts.infra.resilience.models import TimeoutConfig
...
```python
from oridecon.resilience import with_timeout
from oridecon.resilience.exceptions import ResilienceTimeoutError
...
```python
from oridecon.resilience import Throttler, throttle
...
from oridecon.contracts.infra.resilience.models import RetryConfig, CircuitBreakerConfig, TimeoutConfig
...
Env var override: `ORI_RESILIENCE__RETRY__MAX_ATTEMPTS=5`

## Testing resilience patterns

```python
from oridecon.resilience import CircuitBreaker
from oridecon.resilience.circuit import CircuitState
