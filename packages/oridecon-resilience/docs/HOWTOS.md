---
title: oridecon-resilience How-Tos
description: Common recipes for oridecon-resilience
sidebar:
  order: 5
---
...
```python
from oridecon.resilience import CircuitBreakerRegistry, RetryConfig
from oridecon.resilience.decorators import circuit_breaker, retry
