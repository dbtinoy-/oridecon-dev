---
title: oridecon-resilience Guide
description: Concepts, mental model, and common usage patterns for oridecon-resilience
sidebar:
  order: 2
---
...
**oridecon-resilience** provides proven fault-tolerance patterns to make your application resilient to failure.
...
```python
from oridecon.resilience import CircuitBreaker, CircuitBreakerConfig
...
```python
from oridecon.resilience import with_timeout, TimeoutConfig
...
```python
from oridecon.resilience import Throttler
...
```python
from oridecon.resilience import idempotent, InMemoryIdempotencyStore
