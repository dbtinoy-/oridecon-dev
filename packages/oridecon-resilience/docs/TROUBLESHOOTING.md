---
title: oridecon-resilience Troubleshooting
description: Common errors, causes, and fixes for oridecon-resilience
sidebar:
  order: 6
---
...
**Exception:** `CircuitOpenError` (from `oridecon.resilience.exceptions`)
...
**Exception:** `RetryExhaustedError` (from `oridecon.resilience.exceptions`)
...
**Exception:** `BulkheadRejectedError` (from `oridecon.resilience.exceptions`)
...
**Exception:** `ResilienceTimeoutError` (from `oridecon.resilience.exceptions`)
...
**Exception:** `DuplicateRequestError` (from `oridecon.resilience.exceptions`)
