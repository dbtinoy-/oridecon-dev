...
from oridecon.resilience.rate_limiter import SlidingWindowLimiter
from oridecon.resilience.throttle import Throttler
from oridecon.resilience.throttle.throttle import ThrottleConfig
...
class TestDeadApiRemoved:
    ...
    def test_throttle_module_exports_only_throttler(self) -> None:
        import oridecon.resilience.throttle as throttle_pkg
    ...
    def test_resilience_package_no_longer_exports_dead_api(self) -> None:
        from oridecon import resilience
