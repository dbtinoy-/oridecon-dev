"""Tests for the oridecon-notification admin contributor."""
...
from oridecon.notification.admin import (
    InboxHandlers,
...
class TestNotificationAdminContributor:
    ...
    def test_management_pages(self, contributor: NotificationAdminContributor) -> None:
        ...
        assert any(
            page.handler
            == "oridecon.notification.admin.pages.inbox:NotificationsInboxPage"
            for page in pages
        )
