...
from oridecon.notification.admin import NotificationAdminContributor  # noqa: E402
from oridecon.notification.inbox.service import InboxService  # noqa: E402
...
def _build_app(
    ...
    try:
        ...
        raise pytest.skip.Exception("oridecon.admin not installed")
...
class TestInboxAdminPageContainerIntegration:
    ...
    async def test_page_resolved_from_container_and_wrapped_in_shell(
        ...
        page instead).
        """
        pytest.importorskip("oridecon.admin")
        from oridecon.admin.dashboard.route_integrator import AdminPageHandler
