...
from oridecon.notification.constants import (
    APNS_BASE_URL,
    APNS_SANDBOX_URL,
    DEFAULT_APNS_TIMEOUT,
)
from oridecon.notification.exceptions import APNsNotificationError
...
class APNsPush:
    ...
    Implements :class:`~oridecon.contracts.notification.protocols.PushChannelProtocol`.
    ...
    async def send_batch(
        ...
        Each :class:`~oridecon.contracts.notification.types.PushMessage` in
