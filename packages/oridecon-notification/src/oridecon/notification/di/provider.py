"""DI provider for oridecon-notification."""
...
from oridecon.notification.backends.push.registry import PushBackendRegistry
...
try:
    from oridecon.notification.backends.sms.twilio import TwilioSMS
except ImportError:
...
class NotificationProvider(Provider):
    ...
    Reads :class:`~oridecon.notification.config.NotificationConfig`, creates
