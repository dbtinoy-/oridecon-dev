...
from oridecon.notification.config.push import NamedPushConfig
from oridecon.notification.config.sms import NamedSMSConfig
...
class NotificationConfig(BaseConfig):
    ...
    variable overrides via ``ORI_NOTIFICATION__*`` prefix.
    """
