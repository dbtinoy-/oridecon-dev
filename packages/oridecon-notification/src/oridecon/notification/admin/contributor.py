"""Admin contributor for oridecon-notification — surfaces the persisted
user inbox (InboxService) into the Oridecon admin: bell JSON endpoints,
...
class NotificationAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-notification package.
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        ...
        return [
            ManagementPageDefinition(
                ...
                handler="oridecon.notification.admin.pages.inbox:NotificationsInboxPage",
