...
from oridecon.contracts.mailer import (
    EmailMessage,
    MessageDeliveryReceipt,
)
from oridecon.logging import get_logger
from oridecon.notification.constants import DEFAULT_FROM_EMAIL, SENDGRID_API_URL
from oridecon.notification.exceptions import SendGridMailerError
...
class SendGridMailer:
    ...
    Implements :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`.
