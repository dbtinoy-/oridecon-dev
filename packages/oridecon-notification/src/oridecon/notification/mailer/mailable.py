...
from oridecon.contracts.mailer import EmailMessage
...
class Mailable(abc.ABC):
    ...
    :class:`~oridecon.contracts.mailer.types.EmailMessage` that is
    passed to :meth:`~oridecon.contracts.mailer.protocols.MailerProtocol.send`.
    ...
    def to_message(self) -> EmailMessage:
        ...
        Returns:
            A fully populated :class:`~oridecon.contracts.mailer.types.EmailMessage`.
        """
