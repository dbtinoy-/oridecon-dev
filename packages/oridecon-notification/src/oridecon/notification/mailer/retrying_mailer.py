...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.notification.delivery import DeliveryStoreProtocol

logger = get_logger(__name__)


class RetryingMailer:
    """A decorator that wraps any :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`
    ...
    recorded via :class:`~oridecon.contracts.notification.delivery.DeliveryStoreProtocol`
    ...
    Args:
        inner: The underlying :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`
    ...
    async def send(
        ...
        Conforms to :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`.
