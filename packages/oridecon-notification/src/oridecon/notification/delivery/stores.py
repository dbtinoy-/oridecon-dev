"""Delivery-state stores for :class:`~oridecon.notification.delivery.retry.RetryingMailer`.

Two implementations of
:class:`~oridecon.contracts.notification.delivery.DeliveryStoreProtocol`:
