...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.notification.cli.generators.template:NotificationTemplateGenerator",
        "src/notifications",
    ),
)
...
class NotificationCliContributor:
    """CLI contributor for the oridecon-notification package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.notification.cli.commands:create_notify_app",
                contributor="notification",
                category="notification",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.notification.cli.checks:check_notification_channels",
                contributor="notification",
                category="notification",
                timeout=15.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.notification.cli.doctor:check_smtp_config",
                contributor="notification",
                category="notification",
            ),
            DoctorCheckContribution(
                ...
                check_path="oridecon.notification.cli.doctor:check_push_credentials",
                contributor="notification",
                category="notification",
            ),
        ]
    ...
    def get_schema_setup(self) -> list[SchemaSetupContribution]:
        ...
        return [
            SchemaSetupContribution(
                ...
                setup_fn_path="oridecon.notification.cli.schema_setup:ensure_inbox_messages",
