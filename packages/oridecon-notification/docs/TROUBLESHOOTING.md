---
title: oridecon-notification Troubleshooting
...
## `ImportError: APNsPush unavailable — install oridecon-notification[apns]`
...
## `ImportError: WebPushChannel unavailable — install oridecon-notification[web-push]`
...
**Fix:**
```bash
uv add oridecon-notification[web-push]
```
...
- Check `ORI_LOGGING__LEVEL=debug` to see backend registration messages
