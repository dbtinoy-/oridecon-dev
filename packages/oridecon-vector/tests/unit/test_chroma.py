...
from oridecon.vector.backends.chroma import ChromaCollection, ChromaStore  # noqa: E402
from oridecon.vector.config import ChromaConfig  # noqa: E402
...
class TestExports:
    def test_chroma_store_importable_from_backends(self) -> None:
        from oridecon.vector.backends import ChromaStore as CS
        assert CS is ChromaStore

    def test_chroma_config_importable_from_vector(self) -> None:
        from oridecon.vector.config import ChromaConfig as CC
