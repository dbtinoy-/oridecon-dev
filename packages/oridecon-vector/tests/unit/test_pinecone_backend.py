...
from oridecon.vector.backends.pinecone import (  # noqa: E402
    PineconeCollection,
    PineconeStore,
)
from oridecon.vector.config import PineconeConfig  # noqa: E402
...
class TestPineconeCollectionSearch:
    ...
    async def test_search_with_filter(self, col: PineconeCollection) -> None:
        ...
        with patch(
            "oridecon.vector.backends.pinecone.filters.PineconeFilterCompiler"
        ) as mock_cls:
