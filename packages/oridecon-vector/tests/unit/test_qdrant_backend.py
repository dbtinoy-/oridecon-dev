...
from oridecon.contracts.core.health import HealthStatus  # noqa: E402
from oridecon.contracts.data.vector import (  # noqa: E402
    CollectionConfig,
    DistanceMetric,
    SearchQuery,
    VectorRecord,
)
from oridecon.vector.backends.qdrant import QdrantCollection, QdrantStore  # noqa: E402
from oridecon.vector.config import QdrantConfig  # noqa: E402
...
class TestQdrantCollectionSearch:
    ...
    async def test_search_with_filter(self, col: QdrantCollection) -> None:
        from oridecon.contracts.data.vector.filters import Filter
        ...
        with patch(
            "oridecon.vector.backends.qdrant.filters.QdrantFilterCompiler"
