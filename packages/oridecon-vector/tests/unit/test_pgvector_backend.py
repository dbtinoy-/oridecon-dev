...
from oridecon.vector.backends.pgvector import PgVectorCollection, PgVectorStore
from oridecon.vector.config import PgVectorConfig
...
class TestPgVectorCollectionSearch:
    ...
    async def test_search_with_filter(self, col: PgVectorCollection) -> None:
        ...
        with patch(
            "oridecon.vector.backends.pgvector.filters.PgVectorFilterCompiler"
        ) as mock_cls:
