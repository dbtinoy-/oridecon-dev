...
from oridecon.vector.backends.weaviate import (  # noqa: E402
    WeaviateCollection,
    WeaviateStore,
)
from oridecon.vector.config import WeaviateConfig  # noqa: E402
...
class TestWeaviateCollectionSearch:
    ...
    async def test_search_with_filter(self, col: WeaviateCollection) -> None:
        ...
        with patch(
            "oridecon.vector.backends.weaviate.filters.WeaviateFilterCompiler"
        ) as mock_cls:
