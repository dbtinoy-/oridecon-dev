---
title: oridecon-vector Troubleshooting
...
**Exception:** `oridecon.vector.exceptions.VectorConnectionError`
...
**Exception:** `oridecon.vector.exceptions.CollectionNotFoundError`
...
**Exception:** `oridecon.vector.exceptions.DimensionMismatchError`
