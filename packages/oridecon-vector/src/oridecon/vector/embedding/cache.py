...
This module provides caching for expensive embedding operations using oridecon-cache.
"""
...
class EmbeddingCache:
    ...
    Integrates with oridecon-cache for distributed caching support.
...
class InMemoryEmbeddingCache:
    ...
    This is a lightweight alternative when oridecon-cache is not available.
