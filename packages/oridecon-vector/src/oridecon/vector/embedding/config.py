...
ENV_PREFIX: str = "ORI_VECTOR__EMBEDDING__"
...
class EmbeddingClientConfig(BaseConfig):
    ...
    Reads from ``ORI_VECTOR__EMBEDDING__*`` environment variables.
    ...
    Example::
        ...
        ORI_VECTOR__EMBEDDING__API_BASE=http://fastembed:8000
        ORI_VECTOR__EMBEDDING__MODEL=BAAI/bge-small-en-v1.5
        ORI_VECTOR__EMBEDDING__DIMENSION=384
        ORI_VECTOR__EMBEDDING__FORMAT=fastembed

        # Local (docker-compose, infinity embedding server):
        ORI_VECTOR__EMBEDDING__API_BASE=http://fastembed
        ORI_VECTOR__EMBEDDING__MODEL=nomic-ai/nomic-embed-text-v1.5
        ORI_VECTOR__EMBEDDING__DIMENSION=768

        # Production (OpenAI — uses /v1/embeddings):
        ORI_VECTOR__EMBEDDING__API_BASE=https://api.openai.com/v1
        ORI_VECTOR__EMBEDDING__MODEL=text-embedding-3-small
        ORI_VECTOR__EMBEDDING__DIMENSION=1536
        ORI_VECTOR__EMBEDDING__API_KEY=sk-...
        ORI_VECTOR__EMBEDDING__FORMAT=openai
    """
