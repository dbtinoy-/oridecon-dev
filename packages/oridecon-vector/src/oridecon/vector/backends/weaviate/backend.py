...
from oridecon.vector.backends.base import BaseVectorStore
from oridecon.vector.backends.weaviate.collection import WeaviateCollection

if TYPE_CHECKING:
    from oridecon.vector.config import WeaviateConfig
...
class WeaviateStore(BaseVectorStore):
    ...
    ``oridecon-vector[weaviate]`` optional extra.

    Args:
        config: :class:`~oridecon.vector.config.WeaviateConfig` instance.
    """
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install oridecon-vector[weaviate]"
            ) from exc
    ...
    async def list_collections(self) -> list[CollectionInfo]:
        ...
        Returns:
            List of :class:`~oridecon.contracts.data.vector.CollectionInfo`.
