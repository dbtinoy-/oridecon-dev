"""ChromaDB vector store backend for oridecon-vector.
...
from oridecon.vector.backends.chroma_filters import ChromaFilterCompiler
from oridecon.vector.exceptions import VectorConnectionError

if TYPE_CHECKING:
    import chromadb

    from oridecon.vector.config import ChromaConfig
