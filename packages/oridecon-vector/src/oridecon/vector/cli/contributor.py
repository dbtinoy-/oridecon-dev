...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.vector.cli.generators.collection:VectorCollectionGenerator",
...
class VectorCliContributor:
    """CLI contributor for the oridecon-vector package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.vector.cli.commands:create_vector_app",
                contributor="vector",
                category="data",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.vector.cli.checks:check_vector_store",
                contributor="vector",
                category="data",
                timeout=10.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.vector.cli.doctor:check_vector_configured",
                contributor="vector",
                category="data",
            ),
        ]
