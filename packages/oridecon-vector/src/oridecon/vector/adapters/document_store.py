...
from oridecon.vector.exceptions import VectorError, VectorSearchError, VectorUpsertError

if TYPE_CHECKING:
    from oridecon.contracts.ai.vector import DocumentProtocol, SearchResultProtocol
    from oridecon.contracts.data.vector.filters import MetadataFilter
