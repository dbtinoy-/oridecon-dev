...
Wraps a ``VectorCollectionProtocol`` (provided by oridecon-vector) with AI-layer
...
from oridecon.vector.exceptions import VectorError as VectorStoreError
from oridecon.vector.filters.validation import validate_metadata_field
...
class VectorStoreAdapter:
    ...
    Receives a ``VectorStoreProtocol`` from oridecon-vector via constructor injection.
    ...
    def __init__(
        ...
        Args:
            infra_store: Infra-level vector store (from oridecon-vector's provider).
