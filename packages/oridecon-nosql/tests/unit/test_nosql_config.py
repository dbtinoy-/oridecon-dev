...
from oridecon.contracts.core.config import ConfigIssue, Environment as Env
from oridecon.nosql.config import (
    DynamoDBConfig,
    FirestoreConfig,
    MongoDBConfig,
    NamedNoSQLConfig,
...
class TestFirestoreConfig:
    def test_requires_project_id(self) -> None:
        ...
        from oridecon.contracts.exceptions import ValidationError
...
class TestDynamoDBConfig:
    def test_defaults(self) -> None:
        ...
        cfg = DynamoDBConfig()
        assert cfg.table_name == "oridecon"
