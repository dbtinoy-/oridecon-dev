...
class TestNoSQLError:
    def test_inherits_from_oridecon_error(self) -> None:
        """NoSQLError inherits from OrideconError."""
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_001"
...
class TestNoSQLConnectionError:
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_002"
...
class TestDocumentNotFoundError:
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_003"
...
class TestDuplicateKeyError:
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_004"
...
class TestDocumentValidationError:
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_005"
...
class TestTransactionError:
    ...
    def test_has_error_code(self) -> None:
        ...
        assert err._code == "ORI_ERR_NOSQL_006"
