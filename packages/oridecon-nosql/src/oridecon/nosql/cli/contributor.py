...
from oridecon.contracts.cli.contributions import HealthCheckContribution
...
_SPECS: tuple[tuple[str, str, str, str], ...] = (
    (
        ...
        "oridecon.nosql.cli.generators.document_repository:DocumentRepositoryGenerator",
        "src/repositories",
    ),
)
...
class NoSqlCliContributor:
    """CLI contributor for the oridecon-nosql package."""
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.nosql.cli.checks:check_nosql_connection",
                contributor="nosql",
                category="database",
                timeout=10.0,
            ),
