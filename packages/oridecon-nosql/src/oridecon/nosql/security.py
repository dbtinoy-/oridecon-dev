...
(``oridecon-graph``'s ``_SAFE_CYPHER_RE``/``_validate_ident`` and
``oridecon-search``'s ``_validate_field_name``) into a shared validator
...
from oridecon.nosql.exceptions import NoSQLFilterError
