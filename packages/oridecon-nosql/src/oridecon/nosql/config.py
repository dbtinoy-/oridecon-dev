...
from oridecon.nosql.constants import ENV_NESTED_DELIMITER, ENV_PREFIX
...
class MongoDBConfig(DomainModel):
    ...
    database: str = Field(default="oridecon", description="Database name")
...
class NoSQLConfig(BaseConfig):
    ...
    variable overrides via ``ORI_NOSQL__*`` prefix.
    """
