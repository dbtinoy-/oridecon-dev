...
class DynamoDBBackend(AbstractDocumentStore):
    ...
    Args:
        config: :class:`~oridecon.nosql.config.DynamoDBConfig` instance.
    """
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise NoSQLConnectionError(
                ...
                "Install with: pip install oridecon-nosql[dynamodb]"
            ) from exc
    ...
    async def _probe_connectivity(self) -> None:
        ...
        Raises:
            :class:`~oridecon.nosql.exceptions.NoSQLConnectionError`: If
