...
class FirestoreRepository:
    ...
    async def insert(self, document: dict[str, Any]) -> DocumentResult:
        ...
        Raises:
            :class:`~oridecon.nosql.exceptions.NoSQLError`: On Firestore failure.
        """
        try:
    ...
    async def update(self, doc_id: str, data: dict[str, Any]) -> DocumentResult:
        ...
        Raises:
            :class:`~oridecon.nosql.exceptions.DocumentNotFoundError`: If
    ...
    async def insert_many(self, documents: list[dict[str, Any]]) -> BulkWriteResult:
        ...
        Raises:
            :class:`~oridecon.nosql.exceptions.DuplicateKeyError`: If a
