...
from oridecon.nosql.backends.base import AbstractDocumentStore
from oridecon.nosql.backends.firestore.repository import FirestoreRepository
from oridecon.nosql.exceptions import NoSQLConnectionError
...
class FirestoreBackend(AbstractDocumentStore):
    ...
    Requires the ``oridecon-nosql[firestore]`` optional extra.
    ...
    Args:
        config: :class:`~oridecon.nosql.config.FirestoreConfig` instance.
    """
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise NoSQLConnectionError(
                ...
                "Install with: pip install oridecon-nosql[firestore]"
            ) from exc
    ...
    def session(self) -> AbstractAsyncContextManager[Any]:
        ...
        Note:
            ...
            :class:`~oridecon.nosql.backends.base.AbstractDocumentStore`.
        """
