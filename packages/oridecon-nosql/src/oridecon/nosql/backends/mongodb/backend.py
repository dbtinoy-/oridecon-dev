...
from oridecon.nosql.backends.mongodb.codecs import configure_codecs
from oridecon.nosql.backends.mongodb.collection import MongoDBCollection
from oridecon.nosql.backends.mongodb.session import mongodb_session
from oridecon.nosql.exceptions import NoSQLConnectionError

if TYPE_CHECKING:
    from contextlib import AbstractAsyncContextManager

    from oridecon.nosql.config import MongoDBConfig
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise NoSQLConnectionError(
                ...
                "Install with: pip install oridecon-nosql[mongodb]"
            ) from exc
