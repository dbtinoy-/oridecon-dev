...
All exceptions inherit from CacheError which extends OrideconError,
...
from oridecon.cache import constants as const
from oridecon.contracts.exceptions import OrideconError, SerializationError


class CacheError(OrideconError):
    """Base exception for cache errors."""

    _code: str = "ORI_ERR_CACHE_004"


class CacheBackendError(CacheError):
    """Raised when the cache backend (Redis/Memcached) fails."""

    _code: str = "ORI_ERR_CACHE_005"


class CacheConnectionError(CacheBackendError):
    """Raised when the cache connection fails."""

    _code: str = "ORI_ERR_CACHE_006"


class CacheTimeoutError(CacheError):
    """Raised when a cache operation times out."""

    _code: str = "ORI_ERR_CACHE_007"
