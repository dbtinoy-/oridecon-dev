...
and backend-ping widgets into the Oridecon admin dashboard.
"""
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        title="Flush Cache",
        contributor="cache",
        handler="oridecon.cache.admin.actions:flush_cache",
        icon="trash-2",
    ...
    AdminActionDefinition(
        ...
        title="Warm Cache",
        contributor="cache",
        handler="oridecon.cache.admin.actions:warm_cache",
        icon="flame",
        category="operations",
    ),
)
...
class CacheAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-cache package.
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        return [
            ManagementPageDefinition(
                ...
                contributor="cache",
                route_path="/cache",
                handler="oridecon.cache.admin.pages.overview:CacheOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.cache.admin.pages.keys:CacheKeysPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="key",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.cache.admin.pages.stats:CacheStatsPage",
                category=PageCategory.INFRASTRUCTURE,
                icon="bar-chart",
