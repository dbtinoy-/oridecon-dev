...
that composes any :class:`~oridecon.cache.backends.redis.backend.RedisCacheBackend`
with a :class:`~oridecon.contracts.infra.resilience.CircuitBreakerProtocol` injected
...
Usage::
    ...
    from oridecon.cache.backends.redis.resilient import ResilientRedisCacheBackend
...
class ResilientRedisCacheBackend:
    ...
    Implements :class:`~oridecon.contracts.cache.protocols.CacheBackendProtocol`
    ...
    async def get(self, key: str) -> Any:
        ...
        from oridecon.contracts.infra.cache.exceptions import CacheError
