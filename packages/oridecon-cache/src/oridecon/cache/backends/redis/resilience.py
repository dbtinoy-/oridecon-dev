...
Usage::
    ...
    from oridecon.resilience.circuit import CircuitBreakerRegistry
...
from oridecon.cache.backends.redis.circuit import (
...
class RedisCircuitBreakerBackend:
    ...
    :class:`~oridecon.resilience.circuit.backend.CircuitBreakerBackend`.
