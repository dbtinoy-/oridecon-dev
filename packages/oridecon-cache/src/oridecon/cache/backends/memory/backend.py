...
from oridecon-components, ensuring DRY compliance and consistency.
"""
...
from oridecon.cache.hooks import CacheEntryEvictedHook, CacheHitHook, CacheMissHook
from oridecon.cache.types import CacheMetrics
...
class MemoryCacheBackend(CacheBackendProtocol):
    """
    Memory cache backend using oridecon-components MemoryStateStore.

    This backend provides in-memory caching with TTL support by wrapping
    the standardized MemoryStateStore from oridecon-components.
    """
