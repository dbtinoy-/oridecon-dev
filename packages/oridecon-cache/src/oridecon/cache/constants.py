"""Cache constants for oridecon-cache.
...
try:
    __version__ = importlib.metadata.version("oridecon-cache")
...
ENV_VAR_ORI_ENV: str = "ORI_ENV"
"""Environment variable name for Oridecon environment detection."""
...
ERROR_MSG_REDIS_INSTALL: str = (
    ...
    "Install with: pip install oridecon-cache[redis]"
)
ERROR_MSG_MEMCACHED_INSTALL: str = (
    "Memcached backend requires pylibmc or python-memcached. "
    "Install with: pip install oridecon-cache[memcached]"
)
