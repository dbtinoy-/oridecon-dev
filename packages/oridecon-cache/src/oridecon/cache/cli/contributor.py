...
class CacheCliContributor:
    """CLI contributor for the oridecon-cache package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.cache.cli.commands:create_cache_app",
                contributor="cache",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.cache.cli.checks:check_cache_connection",
                contributor="cache",
                category="infrastructure",
                timeout=5.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.cache.cli.doctor:check_cache_configured",
                contributor="cache",
                category="infrastructure",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.cache.cli.shell:provide_cache",
                contributor="cache",
            ),
        ]
