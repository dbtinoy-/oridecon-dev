...
from oridecon.cache.config.backends import CacheBackendConfig, resolve_backend_type
from oridecon.cache.config.service import CacheServiceConfig
...
class CacheConfig(BaseConfig):
    """Top-level configuration for Oridecon Cache.
    ...
    def get_provider_class(cls) -> type:
        ...
        Returns:
            The :class:`~oridecon.cache.CacheProvider` class.
        """
