...
Protocols:
    CacheBackendProtocol: Re-export of CacheBackendProtocol from oridecon-contracts.
...
from oridecon.contracts.infra.cache import CacheBackendProtocol as CacheBackendProtocol
...
class CacheSerializerProtocol(Protocol):
    ...
    Note:
        ...
        canonical AsyncStringSerializerProtocol protocol, use oridecon.contracts.cache.AsyncStringSerializerProtocol.
