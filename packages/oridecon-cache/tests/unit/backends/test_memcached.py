...
from oridecon.cache.config import CacheOperationConfig
...
class TestMemcachedCacheBackend:
    ...
    async def test_lazy_client_initialization(self):
        ...
        with patch(
            "oridecon.cache.backends.memcached.backend.AsyncMemcachedClient",
    ...
    def test_import_error_handling(self):
        ...
        with patch(
            "oridecon.cache.backends.memcached.backend.AsyncMemcachedClient", None,
        ):
            try:
                backend = MemcachedCacheBackend(servers=self.servers)
            except ImportError:
