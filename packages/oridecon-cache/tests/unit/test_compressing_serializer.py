...
from oridecon.cache.exceptions import CacheSerializationError as SerializationError
...
class TestCompressingSerializer:
    ...
    async def test_compression_ratio_logging(self):
        ...
        with patch("oridecon.cache.serialization.compression.logger") as mock_logger:
            large_value = "x" * 1000
