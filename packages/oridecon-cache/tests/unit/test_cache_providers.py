...
class TestCacheProvider:
    ...
    async def test_register_binds_backend_registry(self) -> None:
        ...
        with patch("oridecon.cache.backends.registry.BackendRegistry"):
    ...
    async def test_boot_initializes_backends(self, clock) -> None:
        ...
        with patch("oridecon.cache.backends.factory.create_backend", new_callable=AsyncMock) as mock_create:
