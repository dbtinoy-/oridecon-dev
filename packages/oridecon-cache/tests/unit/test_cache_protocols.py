"""Unit tests for oridecon-cache protocols.

These tests verify the protocols defined in oridecon.cache.protocols.
"""

from typing import Any

from oridecon.cache.protocols import (
...
class TestProtocolAllExports:
    ...
    def test_all_contains_expected_protocols(self) -> None:
        from oridecon.cache import protocols as proto_module
