# packages/oridecon-cache/tests/unit/test_lock_renewal.py
...
from oridecon.cache.exceptions import LockAcquisitionError
from oridecon.cache.locks import DistributedLockProtocol, LockManager
