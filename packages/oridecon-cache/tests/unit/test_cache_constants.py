"""Unit tests for oridecon.cache.constants module."""

from __future__ import annotations

import pytest

from oridecon.cache import constants
...
class TestEnvPrefixes:
    def test_env_prefix(self) -> None:
        assert constants.ENV_PREFIX == "ORI_CACHE__"

    def test_nested_delimiter(self) -> None:
        assert constants.ENV_NESTED_DELIMITER == "__"

    def test_var_oridecon_env(self) -> None:
        assert constants.ENV_VAR_ORI_ENV == "ORI_ENV"
