"""Unit tests for oridecon-cache exceptions.

These tests verify the exception hierarchy and behavior in oridecon.cache.exceptions.
"""
...
class TestCacheExceptionHierarchy:
    ...
    def test_cache_error_inherits_from_oridecon_error(self) -> None:
        assert issubclass(CacheError, OrideconError)
...
class TestExceptionAllExports:
    ...
    def test_all_contains_all_exceptions(self) -> None:
        ...
        from oridecon.cache import exceptions as exc_module
