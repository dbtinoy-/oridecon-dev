...
**Exception:** `CacheTimeoutError` (from `oridecon.cache.exceptions`)
...
**Exception:** `CacheBackendError` (from `oridecon.cache.exceptions`)
...
**Exception:** `CacheKeyError` (from `oridecon.cache.exceptions`)
...
**Exception:** `CacheSerializationError` (from `oridecon.cache.exceptions`)
