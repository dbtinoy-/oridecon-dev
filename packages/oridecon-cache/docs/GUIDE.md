---
title: oridecon-cache Guide
description: Multi-backend caching for the Oridecon Framework — Redis, Memcached, in-memory, with stampede protection and tag-based invalidation
---
...
| `RedisCacheBackend` | `oridecon-cache[redis]` | Redis server |
| `MemcachedCacheBackend` | `oridecon-cache[memcached]` | Memcached server |
