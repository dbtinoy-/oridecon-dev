...
Example:
    ```python
    from oridecon.events.decorators import command_handler, query_handler, event_handler
...
from oridecon.events.handlers.registry import clear_handler_registry
