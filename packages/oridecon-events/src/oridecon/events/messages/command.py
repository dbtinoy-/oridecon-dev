...
from oridecon.contracts.events.messages import Command as _Command
from oridecon.contracts.events.messages import IdempotentCommand as _IdempotentCommand
