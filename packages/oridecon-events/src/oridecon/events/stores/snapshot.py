...
from oridecon.events.types import Snapshot, SnapshotStrategy

if TYPE_CHECKING:
    from collections.abc import Callable

    from oridecon.contracts.events import EventStoreProtocol, SnapshotStoreProtocol
    from oridecon.events.config import SnapshotConfig
...
class SnapshotManager(Generic[TState]):
    ...
    def __init__(
        ...
        if config is None:
            from oridecon.events.config import SnapshotConfig as _SnapshotConfig
