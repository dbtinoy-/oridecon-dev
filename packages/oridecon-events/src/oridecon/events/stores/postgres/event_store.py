...
from oridecon.events.stores.postgres.queries import PostgresQueries
...
class PostgresEventStore(AbstractEventStore):
    ...
    def _deserialize_event(self, row: Any) -> Event:
        ...
        if self.event_serializer:
            from oridecon.events.messages.event import Event as _EventType
