...
This config is used by :class:`~oridecon.events.stores.mongodb.MongoDBSnapshotStore`
for direct motor connection management.

For the top-level user-facing event store config (used with :class:`~oridecon.events.config.EventsConfig`),
see :class:`oridecon.events.config.MongoDBEventStoreConfig`.
"""
...
class MongoDBConfig(BaseConfig):
    ...
    Used directly by :class:`~oridecon.events.stores.mongodb.MongoDBSnapshotStore`
