...
Stream cursor/iterator methods live in :mod:`oridecon.events.stores._stream`
(:class:`EventStreamMixin`).  Snapshot storage lives in
:mod:`oridecon.events.stores._snapshots` (:class:`AbstractSnapshotStore`).
"""
...
from oridecon.events.stores._snapshots import (
    AbstractSnapshotStore as AbstractSnapshotStore,
)
from oridecon.events.stores._stream import EventStreamMixin as EventStreamMixin
...
if TYPE_CHECKING:
    ...
    from oridecon.events.schema.evolution import SchemaEvolution
    from oridecon.events.types import StreamInfo
...
from oridecon.contracts import EventStoreProtocol as EventStoreProtocol
