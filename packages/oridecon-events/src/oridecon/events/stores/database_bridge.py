"""Database bridge event store that uses oridecon-sql's DatabaseProvider."""

from __future__ import annotations

from typing import TYPE_CHECKING, Any

from oridecon.events.stores.base import AbstractEventStore, StoredEvent
...
class DatabaseBridgeEventStore(AbstractEventStore):
    """Event store that uses oridecon-sql's DatabaseProvider for connections.
    ...
    - Supports all backends that oridecon-sql supports
    """
    ...
    async def read(
        ...
        from oridecon import serialization as json
        from oridecon.events.messages.event import Event as EventCls
