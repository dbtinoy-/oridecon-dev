...
Example::
    ...
    from oridecon.events.migration import migrate_store, MigrationResult
    from oridecon.events.stores.memory import InMemoryEventStore
    from oridecon.events.stores.postgres import PostgresEventStore
...
if TYPE_CHECKING:
    from oridecon.events.stores.base import EventStoreProtocol
