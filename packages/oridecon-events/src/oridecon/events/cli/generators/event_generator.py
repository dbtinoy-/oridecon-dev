...
from oridecon.codegen import GenerationResult, GeneratorBase, parse_fields
...
class EventGenerator(GeneratorBase):
    ...
    ``examples/event-driven-orders``: a frozen dataclass extending
    :class:`~oridecon.contracts.domain.DomainEvent` plus a ``build_*``
