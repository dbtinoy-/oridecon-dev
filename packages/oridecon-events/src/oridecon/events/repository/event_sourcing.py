...
from oridecon.events.repository.base import AbstractRepository
from oridecon.events.stores.snapshot import SnapshotManager, SnapshotPolicy
...
if TYPE_CHECKING:
    ...
    from oridecon.events.stores.base import AbstractEventStore, AbstractSnapshotStore
...
class EventSourcingRepository(AbstractRepository[TAggregate], Generic[TAggregate]):
    ...
    def __init__(
        ...
        if snapshot_store:
            from oridecon.events.stores.snapshot import EventCountPolicy
