...
if TYPE_CHECKING:
    ...
    from oridecon.events.stores.registry import EventStoreRegistry
...
class StoreSubProvider:
    ...
    def __init__(
        ...
        from oridecon.events.stores.registry import EventStoreRegistry as _Registry
    ...
    async def setup(self, container: ContainerRegistrarProtocol | None = None) -> None:
        ...
        """
        from oridecon.events.constants import StoreType
        from oridecon.events.stores import InMemorySnapshotStore, SnapshotManager
    ...
    def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.contracts.events import EventStoreProtocol
