...
Example:
    ```python
    from oridecon.events.adapters import RabbitMQAdapter, KafkaAdapter
...
from oridecon.events.adapters.azure_servicebus import (
    AzureServiceBusAdapter,
    AzureServiceBusAdapterConfig,
)
from oridecon.events.adapters.base import (
    AdapterConfig,
    DefaultMessageSerializer,
    MessageAdapter,
    MessageSerializer,
)
from oridecon.events.adapters.kafka import (
    KafkaAdapter,
    KafkaAdapterConfig,
)
from oridecon.events.adapters.rabbitmq import (
    RabbitMQAdapter,
