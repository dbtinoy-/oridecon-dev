...
Extracted from ``oridecon.events.buses.event`` to keep ``EventBusImpl``
...
from oridecon.concurrency import BoundedChannel
...
if TYPE_CHECKING:
    from oridecon.contracts.core import ChannelProtocol
