"""Oridecon CQRS Schema Management.
...
Example:
    ```python
    from oridecon.events.schema import (
        SchemaRegistry,
        EventSchema,
        Upcaster,
        SchemaEvolution
...
from oridecon.events.schema.evolution import (
    Downcaster,
    EventMigrator,
    SchemaEvolution,
    Upcaster,
)
from oridecon.events.schema.migration import (
    MigrationConfig,
    MigrationProgress,
    MigrationResult,
    MigrationScheduler,
...
from oridecon.events.schema.registry import (
    EventSchema,
    InMemorySchemaStore,
    SchemaRegistry,
    SchemaStore,
