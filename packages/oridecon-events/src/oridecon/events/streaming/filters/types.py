...
if TYPE_CHECKING:
    ...
    from oridecon.events.streaming.filters.composite import (
        CompositeFilter,
        NegatedFilter,
    )
...
class EventFilter:
    ...
    def __and__(self, other: EventFilter) -> CompositeFilter:
        ...
        from oridecon.events.streaming.filters.composite import CompositeFilter
    ...
    def __invert__(self) -> NegatedFilter:
        """Negate this filter."""
        from oridecon.events.streaming.filters.composite import NegatedFilter
