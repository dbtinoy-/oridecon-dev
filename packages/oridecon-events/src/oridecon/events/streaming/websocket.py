...
dispatched through a :class:`~oridecon.events.streaming.dispatcher.StreamDispatcher`.
...
class EventWebSocketEndpoint:
    ...
    Subscribes to a :class:`~oridecon.events.streaming.dispatcher.StreamDispatcher`
