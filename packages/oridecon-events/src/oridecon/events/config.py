...
from oridecon.events import constants as const
from oridecon.events.stores.postgres.config import PostgresEventStoreConfig
from oridecon.events.types import EventStoreBackend, SnapshotStrategy
...
class MongoDBEventStoreConfig(BaseConfig):
    ...
    Used by :attr:`EventsConfig.mongodb <oridecon.events.config.EventsConfig.mongodb>`.
    For the store-level connection config used by :class:`~oridecon.events.stores.MongoDBSnapshotStore`,
    see :class:`oridecon.events.stores.mongodb.MongoDBConfig`.
    """
...
class RabbitMQConfig(BaseAdapterConfig):
    ...
    For low-level adapter config, see :class:`oridecon.events.adapters.RabbitMQAdapterConfig`.
    """
...
class KafkaConfig(BaseAdapterConfig):
    ...
    For low-level adapter config, see :class:`oridecon.events.adapters.KafkaAdapterConfig`.
    """
