"""Bridges from the event subsystem into oridecon.reactive streams.
...
``oridecon.reactive`` are the core layer — this module is the allowed
...
from oridecon.reactive import EventStream, Op, Stream
from oridecon.reactive.retry import RetryOptions, retry
...
def from_bus(
    ...
    """
    from oridecon.reactive.subjects import Subject
