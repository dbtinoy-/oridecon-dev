...
from oridecon.contracts.exceptions.resilience import RetryError
from oridecon.contracts.infra.resilience.models import RetryConfig
from oridecon.events.adapters.retry import retry as _retry_call
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.web.protocols import (  # type: ignore[attr-defined]
        HTTPClientProtocol,
    )
