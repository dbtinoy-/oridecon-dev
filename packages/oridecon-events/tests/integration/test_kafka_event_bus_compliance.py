...
from oridecon.testing.compliance import EventBusCompliance
from oridecon.testing.integration.fixtures import kafka_producer  # noqa: F401
...
class TestKafkaEventBusCompliance(EventBusCompliance):
    ...
    ``oridecon.testing.integration.fixtures``.  The suite is auto-skipped when
    ...
    async def create_bus(self) -> object:
        ...
        """
        try:
            from oridecon.events.adapters.kafka import (  # noqa: F401
                KafkaAdapter,
                KafkaAdapterConfig,
            )
            from oridecon.events.buses.event import EventBusImpl  # noqa: F401
        except ImportError:
    ...
    def create_event(self) -> object:
        ...
        """
        try:
            from oridecon.events.messages.event import Event  # noqa: F401
        except ImportError:
            pytest.skip("oridecon.events.messages.event not available")
