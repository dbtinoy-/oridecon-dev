"""Unit tests for oridecon-events stores - additional store tests."""

import pytest
from unittest.mock import MagicMock, AsyncMock

from oridecon.events.stores.base import AbstractEventStore, AbstractIdempotencyStore, AbstractSnapshotStore, AbstractCheckpointStore, StoredEvent
...
class TestInMemoryCheckpointStore:
    ...
    def test_in_memory_checkpoint_store_creation(self):
        ...
        from oridecon.events.stores.checkpoints import InMemoryCheckpointStore
...
class TestInMemoryIdempotencyStore:
    ...
    def test_in_memory_idempotency_store_creation(self):
        ...
        from oridecon.events.stores.idempotency import InMemoryIdempotencyStore
...
class TestInMemorySnapshotStore:
    ...
    def test_in_memory_snapshot_store_creation(self):
        ...
        from oridecon.events.stores.memory import InMemorySnapshotStore
...
class TestOutboxEventStore:
    ...
    def test_outbox_event_store_creation(self):
        ...
        from oridecon.events.stores.outbox import OutboxEventStore
...
class TestOutboxEntry:
    ...
    def test_outbox_entry_creation(self):
        ...
        from oridecon.events.stores.outbox import OutboxEntry, OutboxEntryStatus
...
class TestOutboxEntryStatus:
    ...
    def test_outbox_entry_status_values(self):
        ...
        from oridecon.events.stores.outbox import OutboxEntryStatus
...
class TestSqlCheckpointStore:
    ...
    def test_sql_checkpoint_store_creation(self):
        ...
        from oridecon.events.stores.checkpoints import SqlCheckpointStore
...
class TestSqlIdempotencyStore:
    ...
    def test_sql_idempotency_store_can_be_imported(self):
        ...
        from oridecon.events.stores.idempotency import SqlIdempotencyStore
...
class TestDatabaseBridgeEventStore:
    ...
    def test_database_bridge_event_store_can_be_imported(self):
        ...
        from oridecon.events.stores.database_bridge import DatabaseBridgeEventStore
