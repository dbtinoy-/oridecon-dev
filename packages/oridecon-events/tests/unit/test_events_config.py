...
class TestEventsConfig:
    ...
    def test_events_config_with_postgres_backend(self) -> None:
        ...
        from oridecon.events.config import EventsConfig, PostgresEventStoreConfig
        from oridecon.events.types import EventStoreBackend
    ...
    def test_events_config_with_mongodb_backend(self) -> None:
        ...
        from oridecon.events.config import EventsConfig, MongoDBEventStoreConfig
        from oridecon.events.types import EventStoreBackend
    ...
    def test_events_config_with_adapters(self) -> None:
        ...
        from oridecon.events.config import EventsConfig, KafkaConfig, RabbitMQConfig
...
class TestKafkaConfigEdgeCases:
    ...
    def test_kafka_config_all_required_fields(self) -> None:
        ...
        from oridecon.events.config import KafkaConfig
...
class TestInMemoryEventStoreConfigEdgeCases:
    ...
    def test_in_memory_config_max_events_boundary(self) -> None:
        ...
        from oridecon.events.config import InMemoryEventStoreConfig
