...
from oridecon.contracts.events.version_skew import EventTypeVersion
from oridecon.events.version_skew import KnownEventSetRegistry
...
class TestVersionAwareSubscription:
    ...
    async def test_unknown_version_upcasts_to_latest_known_version(
        ...
        from oridecon.events.schema.evolution import SchemaEvolution, Upcaster
