...
from oridecon.contracts.events import CommandBusProtocol, EventBusProtocol, QueryBusProtocol
from oridecon.di.module import DynamicModule
from oridecon.events import EventsModule
...
class TestEventsModule:
    ...
    def test_module_decorator_exists(self) -> None:
        ...
        assert hasattr(EventsModule, '__oridecon_module__')
