"""Unit tests for oridecon-events message types."""
...
from oridecon.events.messages import Command, Event, IdempotentCommand, IntegrationEvent, PaginatedQuery, PagedResult, Query
