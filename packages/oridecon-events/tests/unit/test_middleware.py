"""Unit tests for oridecon-events middleware system."""
...
from oridecon.events.middleware.base import AbstractMiddleware, MiddlewareChain
...
from oridecon.events.middleware.metrics import MetricsMiddleware
from oridecon.events.messages.base import Message
...
class TestLoggingMiddleware:
    ...
    def test_logging_middleware_default_params(self):
        ...
        from oridecon.logging import INFO, ERROR
        middleware = LoggingMiddleware()
...
class TestTransactionMiddleware:
    ...
    def test_transaction_middleware_creation(self):
        ...
        from oridecon.events.middleware.transaction import TransactionMiddleware
