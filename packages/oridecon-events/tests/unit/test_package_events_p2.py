"""P2 guardrail: oridecon-events must expose a canonical root events module."""

from __future__ import annotations


def test_events_events_root_module_exists() -> None:
    from oridecon.events.events import EventPublishedEvent, ProjectionUpdatedEvent
...
def test_events_events_re_exported_from_package_root() -> None:
    import oridecon.events as events_pkg
