...
from oridecon.events.handlers.discovery import (
...
from oridecon.events.messages import Command, Query
...
class TestHandlerDiscovery:
    ...
    def test_discover_event_types_with_events(self):
        ...
        result = discover_event_types("oridecon.events.messages")
        assert isinstance(result, dict)

    def test_discover_event_types_non_recursive(self):
        """Test discover_event_types with recursive=False."""
        result = discover_event_types("oridecon.events.messages", recursive=False)
        assert isinstance(result, dict)

    @patch("oridecon.events.handlers.discovery.importlib.import_module")
    ...
    @patch("oridecon.events.handlers.discovery.importlib.import_module")
    @patch("oridecon.events.handlers.discovery.inspect.getmembers")
...
class TestHandlerRegistry:
    ...
    def test_discover_empty_module(self):
        ...
        registry = HandlerRegistry()
        count = registry.discover("oridecon.events.messages")
        assert count == 0
    ...
    def test_discover_same_module_twice(self):
        ...
        count1 = registry.discover("oridecon.events.messages")
        count2 = registry.discover("oridecon.events.messages")

        assert count2 == 0

    @patch("oridecon.events.handlers.registry.importlib.import_module")
    ...
    @patch("oridecon.events.handlers.registry.importlib.import_module")
    @patch("oridecon.events.handlers.registry.inspect.getmembers")
    @patch("oridecon.events.handlers.registry.pkgutil.iter_modules")
