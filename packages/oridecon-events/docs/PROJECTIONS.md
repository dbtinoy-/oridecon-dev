---
title: oridecon-events Projections
...
```python
from oridecon.events.projections.base import InlineProjection
...
```python
from oridecon.events.projections.base import ProjectionProtocol, event_handler
...
```python
from oridecon.events.config import ProjectionConfig
