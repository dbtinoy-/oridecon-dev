---
title: oridecon-events Troubleshooting
...
**Error:**
```
oridecon.events.exceptions.ConcurrencyError: Expected version 5 but got 4
```
...
**Error:**
```
oridecon.events.exceptions.HandlerNotFoundError: No handler registered for CreateOrder
```
...
**Error:**
```
oridecon.events.exceptions.EventStoreConnectionError: Cannot connect to PostgreSQL
```
...
**Error:**
```
oridecon.events.exceptions.ProjectionBuildError: Projection rebuild failed
```
...
**Error:**
```
oridecon.events.exceptions.SchemaError: Event type OrderCreated version 2 not found
```
...
**Error:**
```
oridecon.events.exceptions.StreamingError: WebSocket connection failed
```
