...
> Module name: `prompt_lab` — run with `PYTHONPATH=examples/prompt-lab/src uv run python -m prompt_lab`
...
```bash
uv run pytest examples/prompt-lab/tests -q
```
