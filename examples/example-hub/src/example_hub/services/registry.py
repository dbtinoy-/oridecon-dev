...
class DemoService:
    ...
    Attributes:
        slug: URL-safe identifier; the demo is mounted at ``/examples/<slug>/``.
        name: Display name.
        ...
        demo_dir: Directory under ``examples/`` containing this demo.
    ...
    def __init__(self) -> None:
        self.services: list[DemoService] = [
            ...
            DemoService(
                ...
                "web",
                "standard",
                "Oridecon Monitor health, metrics, and tracing console",
                "monitor-stack",
                "monitorstack.app",
            ...
            DemoService(
                ...
                "web",
                "standard",
                "Oridecon MessageConsumer for one tasks topic",
                "queue-worker",
                "queueworker.app",
            ...
            DemoService(
                ...
                "web",
                "standard",
                "Oridecon vector collection, chunking, and retrieval",
                "rag-pipeline",
                "ragdocs.app",
            ...
            DemoService(
                ...
                "web",
                "standard",
                "Oridecon DatabaseModule with SQLite task repository",
                "sql-repository",
                "taskapp.app",
            ...
            DemoService(
                ...
                "web",
                "standard",
                "Oridecon subscription creation and HMAC verification",
                "webhook-relay",
                "webhookrelay.app",
