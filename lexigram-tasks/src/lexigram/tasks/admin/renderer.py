"""Shared Jinja2 renderer for lexigram-tasks admin widgets."""
...
class PackageWidgetRenderer:
    """Renders admin widget templates for lexigram-tasks. Singleton."""
    ...
    def render(self, template_name: str, context: dict[str, Any]) -> str:
        ...
        Args:
            template_name: Template filename (e.g. "tasks_summary.html").
