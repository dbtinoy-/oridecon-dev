...
DEMO_TEST_DIRS := demos/event-driven-orders/tests demos/realtime-monitor/tests demos/llm-experiment/tests demos/resilient-rates/tests demos/rag-docs/tests demos/auth-web/tests demos/auth-rbac/tests demos/support-agent/tests demos/memory-chat/tests
DEMO_COMPILE_DIRS := demos/llm-experiment demos/event-driven-orders demos/realtime-monitor demos/resilient-rates demos/rag-docs demos/auth-web demos/auth-rbac demos/support-agent demos/memory-chat
