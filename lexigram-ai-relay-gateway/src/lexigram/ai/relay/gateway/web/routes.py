...
RELAY_ROUTE_PATHS: tuple[str, ...] = tuple(path for path, _ in _ROUTE_TABLE)
...
def build_routes(resolve_gateway: ResolveGateway) -> list[Route]:
    """Build the relay POST routes bound to a gateway resolver.
