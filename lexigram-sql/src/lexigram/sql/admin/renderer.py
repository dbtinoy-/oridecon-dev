"""Shared Jinja2 renderer for lexigram-sql admin widgets."""
...
class PackageWidgetRenderer:
    """Renders admin widget templates for lexigram-sql.
    ...
    def render(self, template_name: str, context: dict[str, Any]) -> str:
        ...
        Args:
            template_name: Name of the template file (e.g., "pool_utilization.html").
