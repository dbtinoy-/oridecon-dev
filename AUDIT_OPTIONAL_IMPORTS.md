...
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/controllers/auth.py:11 |
...
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/controllers/search.py:11 |
| `starlette` | declared | type-only | lexigram-admin/src/lexigram/admin/controllers/search.py:14 |
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/controllers/settings.py:5 |
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/controllers/settings.py:6 |
...
| `pydantic` | declared | type-only | lexigram-admin/src/lexigram/admin/forms/components.py:19 |
...
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/middleware/csrf.py:5 |
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/middleware/csrf.py:6 |
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/middleware/error.py:8 |
...
| `starlette` | declared | type-only | lexigram-admin/src/lexigram/admin/relations/belongs_to_many.py:13 |
| `starlette` | declared | type-only | lexigram-admin/src/lexigram/admin/relations/belongs_to_many.py:14 |
...
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/settings/panel/controller.py:9 |
| `starlette` | declared | module | lexigram-admin/src/lexigram/admin/settings/panel/controller.py:10 |
| `htpy` | declared | module | lexigram-admin/src/lexigram/admin/settings/panel/ui.py:7 |
...
| `htpy` | declared | module | lexigram-admin/src/lexigram/admin/ui/state.py:7 |
...
| `starlette` | declared | module | lexigram-ai-relay-gateway/src/lexigram/ai/relay/gateway/web/routes.py:26 |
...
| `jinja2` | declared | module | lexigram-auth/src/lexigram/auth/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-cache/src/lexigram/cache/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-events/src/lexigram/events/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-queue/src/lexigram/queue/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-sql/src/lexigram/sql/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-tasks/src/lexigram/tasks/admin/renderer.py:8 |
...
| `jinja2` | declared | module | lexigram-web/src/lexigram/web/admin/renderer.py:12 |
...
| `starlette` | declared | module | lexigram-web/src/lexigram/web/integrations/auth.py:7 |
...
| `starlette` | declared | module | lexigram-web/src/lexigram/web/transport/requests.py:7 |
...
Optional extras not imported by package sources: `granian`, `httpx2`, `hypercorn`, `itsdangerous`, `pyyaml`, `types-aiofiles`, `uvicorn`, `websockets`
