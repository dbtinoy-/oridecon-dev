# AUDIT_SECURITY.md — Oridecon Framework Security Audit
...
Name            Skip Reason
--------------- ---------------------------------------------------------------------------------
oridecon-ai-mcp Dependency not found on PyPI and could not be audited: oridecon-ai-mcp (0.1.3008)
...
- **S603** (subprocess, 10 sites): nine operator CLI tooling sites annotated (argv lists, no shell); one genuine fix — `oridecon-cli` MCP self-invocation switched from `sys.argv[0]` to `sys.executable -m oridecon.cli.runtime.main` (argv[0] independence).
