...
oridecon v0.1.5007 (*)
oridecon-admin v0.1.5004 (*)
oridecon-ai v0.1.5003
├── oridecon v0.1.5007 (*)
├── oridecon-ai-feedback v0.1.5003 (*)
├── oridecon-ai-llm v0.1.5003 (*)
├── oridecon-ai-observability v0.1.5003 (*)
├── oridecon-ai-rag v0.1.5003 (*)
├── oridecon-contracts v0.1.5007 (*)
├── numpy v2.5.2
├── starlette v1.6.0 (*)
├── typer v0.27.1 (*)
...
├── oridecon-ai-feedback v0.1.5003 (extra: all) (*)
├── oridecon-ai-llm v0.1.5003 (extra: all) (*)
├── oridecon-ai-observability v0.1.5003 (extra: all) (*)
├── oridecon-ai-rag v0.1.5003 (extra: all) (*)
├── oridecon-testing v0.1.5005 (extra: all) (*)
├── oridecon-vector v0.1.5007 (extra: all) (*)
...
├── oridecon-ai-feedback v0.1.5003 (extra: feedback) (*)
├── anthropic v0.125.0 (extra: llm) (*)
├── oridecon-ai-llm v0.1.5003 (extra: llm) (*)
...
├── oridecon-ai-observability v0.1.5003 (extra: observability) (*)
├── beautifulsoup4 v4.15.0 (extra: rag) (*)
├── oridecon-ai-rag v0.1.5003 (extra: rag) (*)
...
├── oridecon-testing v0.1.5005 (extra: test) (*)
...
├── oridecon-vector v0.1.5007 (extra: vector) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-ai-evaluation v0.1.5003
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-ai-governance v0.1.5003
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── starlette v1.6.0 (*)
├── typing-extensions v4.16.0
...
├── starlette v1.6.0 (*)
├── typing-extensions v4.16.0
├── oridecon-admin v0.1.5004 (extra: admin)
│   ├── aiofiles v25.1.0
...
│   ├── starlette v1.6.0 (*)
│   ├── typer v0.27.1 (*)
│   ├── oridecon-auth v0.1.5007 (extra: auth) (*)
│   ├── pysaml2 v7.5.4 (extra: auth) (*)
│   ├── xmlsec v1.3.17 (extra: auth) (*)
│   ├── oridecon-cache v0.1.5006 (extra: cache) (*)
│   ├── black v26.5.1 (extra: dev) (*)
│   ├── mypy v2.3.1 (extra: dev) (*)
│   ├── ruff v0.16.3 (extra: dev)
│   ├── oridecon-events v0.1.5007 (extra: events) (*)
...
│   ├── oridecon-auth v0.1.5007 (extra: full) (*)
│   ├── oridecon-cache v0.1.5006 (extra: full) (*)
│   ├── oridecon-events v0.1.5007 (extra: full) (*)
│   ├── oridecon-tasks v0.1.5006 (extra: full) (*)
│   ├── oridecon-web v0.1.5007 (extra: full) (*)
...
│   ├── oridecon-monitor v0.1.5007 (extra: monitor) (*)
│   ├── authlib v1.7.2 (extra: oauth2) (*)
│   ├── pysaml2 v7.5.4 (extra: saml) (*)
│   ├── xmlsec v1.3.17 (extra: saml) (*)
│   ├── oridecon-search v0.1.5005 (extra: search) (*)
│   ├── oridecon-tasks v0.1.5006 (extra: tasks) (*)
│   ├── oridecon-tenancy v0.1.5007 (extra: tenancy) (*)
│   ├── pytest v9.1.1 (extra: test) (*)
│   ├── pytest-asyncio v1.4.0 (extra: test) (*)
│   ├── pytest-cov v7.1.0 (extra: test) (*)
│   ├── pytest-mock v3.15.1 (extra: test) (*)
│   ├── oridecon-web v0.1.5007 (extra: web) (*)
│   ├── black v26.5.1 (group: dev) (*)
│   ├── mypy v2.3.1 (group: dev) (*)
│   └── ruff v0.16.3 (group: dev)
├── anthropic v0.125.0 (extra: all)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-ai-relay-gateway v0.1.5003
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── orjson v3.12.0
├── starlette v1.6.0 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-audit v0.1.5004 (*)
oridecon-auth v0.1.5007 (*)
oridecon-cache v0.1.5006 (*)
oridecon-cli v0.1.5004
├── aiofiles v25.1.0
├── httpx v0.28.1 (*)
├── jinja2 v3.1.6 (*)
├── oridecon v0.1.5007 (*)
...
oridecon-contracts v0.1.5007 (*)
oridecon-events v0.1.5007 (*)
oridecon-features v0.1.5007
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── typer v0.27.1 (*)
├── mypy v2.3.1 (extra: dev) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-graphql v0.1.5006 (*)
oridecon-http v0.1.5006
├── aiohttp v3.14.3 (*)
├── jinja2 v3.1.6 (*)
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-monitor v0.1.5007 (*)
oridecon-multimedia v0.1.5004
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── oridecon-multimedia-beat v0.1.5004 (*)
├── oridecon-multimedia-image v0.1.5004 (*)
├── oridecon-multimedia-interpolate v0.1.5004 (*)
├── oridecon-multimedia-music v0.1.5004 (*)
├── oridecon-multimedia-tts v0.1.5004 (*)
├── oridecon-multimedia-upscale v0.1.5004 (*)
├── oridecon-multimedia-video v0.1.5004 (*)
├── oridecon-storage v0.1.5004 (*)
├── oridecon-tasks v0.1.5006 (*)
├── mypy v2.3.1 (extra: dev) (*)
├── ruff v0.16.3 (extra: dev)
├── oridecon-testing v0.1.5005 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-nosql v0.1.5006 (group: tooling)
├── jinja2 v3.1.6
│   └── markupsafe v3.0.3
├── oridecon v0.1.5007
│   ├── oridecon-contracts v0.1.5007
...
│   ├── pydantic v2.13.4 (*)
│   ├── structlog v26.1.0
│   ├── oridecon-audit v0.1.5004 (extra: auth)
│   │   ├── oridecon v0.1.5007 (*)
│   │   ├── oridecon-contracts v0.1.5007 (*)
│   │   ├── starlette v1.6.0
│   │   │   └── anyio v4.14.2 (*)
...
│   │   ├── mypy v2.3.1 (extra: dev) (*)
│   │   ├── ruff v0.16.3 (extra: dev)
│   │   ├── oridecon-sql v0.1.5007 (extra: sql)
│   │   │   ├── aiosqlite v0.22.1
│   │   │   ├── alembic v1.19.1
│   │   │   │   ├── mako v1.4.1
│   │   │   │   │   └── markupsafe v3.0.3
...
│   │   │   │   │   ├── idna v3.19
│   │   │   │   │   └── truststore v0.10.4
│   │   │   │   ├── oridecon-auth v0.1.5007 (extra: all)
│   │   │   │   │   ├── argon2-cffi v25.1.0
...
│   │   │   │   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   │   │   │   └── ruff v0.16.3 (group: dev)
│   │   │   │   ├── oridecon-cache v0.1.5006 (extra: all)
│   │   │   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   │   │   ├── oridecon v0.1.5007 (*)
│   │   │   │   │   ├── oridecon-contracts v0.1.5007 (*)
│   │   │   │   │   ├── orjson v3.12.0
...
│   │   │   │   ├── oridecon-storage v0.1.5004 (extra: all)
│   │   │   │   │   ├── aiofiles v25.1.0
│   │   │   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   │   │   ├── oridecon v0.1.5007 (*)
│   │   │   │   │   ├── oridecon-contracts v0.1.5007 (*)
...
│   │   │   │   ├── oridecon-storage v0.1.5004 (extra: storage) (*)
...
│   │   │   ├── pytest-mock v3.15.1 (extra: test) (*)
│   │   │   ├── black v26.5.1 (group: dev) (*)
│   │   │   ├── oridecon-testing v0.1.5005 (group: dev) (*)
│   │   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   │   └── ruff v0.16.3 (group: dev)
│   │   ├── oridecon-testing v0.1.5005 (extra: test) (*)
│   │   ├── pytest v9.1.1 (extra: test) (*)
...
│   ├── oridecon-nosql v0.1.5006 (extra: db) (*)
│   ├── oridecon-search v0.1.5005 (extra: db)
│   │   ├── jinja2 v3.1.6 (*)
│   │   ├── oridecon v0.1.5007 (*)
│   │   ├── oridecon-contracts v0.1.5007 (*)
│   │   ├── typing-extensions v4.16.0
...
│   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   └── ruff v0.16.3 (group: dev)
│   ├── oridecon-storage v0.1.5004 (extra: db) (*)
│   ├── mypy v2.3.1 (extra: dev) (*)
│   ├── pre-commit v4.6.2 (extra: dev)
│   │   ├── cfgv v3.5.0
│   │   ├── identify v2.6.19
...
│   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   └── ruff v0.16.3 (group: dev)
│   ├── oridecon-graphql v0.1.5006 (extra: graphql)
...
│   │   ├── oridecon-tasks v0.1.5006 (extra: test)
│   │   │   ├── croniter v6.2.4
│   │   │   │   └── python-dateutil v2.9.0.post0 (*)
│   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   ├── oridecon v0.1.5007 (*)
...
│   ├── oridecon-tasks v0.1.5006 (extra: tasks) (*)
│   ├── oridecon-monitor v0.1.5007 (extra: test) (*)
│   ├── pytest v9.1.1 (extra: test) (*)
│   ├── pytest-asyncio v1.4.0 (extra: test) (*)
│   ├── pytest-cov v7.1.0 (extra: test) (*)
│   ├── pytest-mock v3.15.1 (extra: test) (*)
│   └── oridecon-web[uvicorn] v0.1.5007 (extra: web)
│       ├── aiofiles v25.1.0
│       ├── jinja2 v3.1.6 (*)
│       ├── oridecon v0.1.5007 (*)
│       ├── oridecon-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-nosql v0.1.5006 (*)
oridecon-notification v0.1.5007
├── aiofiles v25.1.0
├── aiohttp v3.14.3 (*)
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-resilience v0.1.5004
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── mypy v2.3.1 (extra: dev) (*)
├── ruff v0.16.3 (extra: dev)
├── oridecon-sql v0.1.5007 (extra: idempotency-database) (*)
├── oridecon-cache v0.1.5006 (extra: idempotency-redis) (*)
├── oridecon-testing v0.1.5005 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
├── pytest-asyncio v1.4.0 (extra: test) (*)
├── pytest-cov v7.1.0 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-search v0.1.5005 (*)
oridecon-secrets v0.1.5004
├── botocore v1.40.61 (*)
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── typing-extensions v4.16.0
...
oridecon-storage v0.1.5004 (*)
oridecon-tasks v0.1.5006 (*)
oridecon-tenancy v0.1.5007
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── typer v0.27.1 (*)
├── typing-extensions v4.16.0
├── oridecon-sql v0.1.5007 (extra: all) (*)
├── oridecon-testing v0.1.5005 (extra: all) (*)
├── oridecon-workflow v0.1.5007 (extra: all) (*)
├── mypy v2.3.1 (extra: all) (*)
├── pytest v9.1.1 (extra: all) (*)
├── pytest-asyncio v1.4.0 (extra: all) (*)
├── pytest-cov v7.1.0 (extra: all) (*)
...
├── oridecon-sql v0.1.5007 (extra: sql) (*)
├── oridecon-testing v0.1.5005 (extra: test) (*)
├── oridecon-workflow v0.1.5007 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
├── pytest-asyncio v1.4.0 (extra: test) (*)
├── pytest-cov v7.1.0 (extra: test) (*)
├── pytest-mock v3.15.1 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
oridecon-web v0.1.5007 (*)
oridecon-webhook v0.1.5004
├── httpx v0.28.1 (*)
├── oridecon v0.1.5007 (*)
├── oridecon-contracts v0.1.5007 (*)
├── starlette v1.6.0 (*)
