...
lexigram v0.1.5007 (*)
lexigram-admin v0.1.5004 (*)
lexigram-ai v0.1.5003
├── lexigram v0.1.5007 (*)
├── lexigram-ai-feedback v0.1.5003 (*)
├── lexigram-ai-llm v0.1.5003 (*)
├── lexigram-ai-observability v0.1.5003 (*)
├── lexigram-ai-rag v0.1.5003 (*)
├── lexigram-contracts v0.1.5007 (*)
├── numpy v2.5.2
├── starlette v1.6.0 (*)
├── typer v0.27.1 (*)
...
├── lexigram-ai-feedback v0.1.5003 (extra: all) (*)
├── lexigram-ai-llm v0.1.5003 (extra: all) (*)
├── lexigram-ai-observability v0.1.5003 (extra: all) (*)
├── lexigram-ai-rag v0.1.5003 (extra: all) (*)
├── lexigram-testing v0.1.5005 (extra: all) (*)
├── lexigram-vector v0.1.5007 (extra: all) (*)
...
├── lexigram-ai-feedback v0.1.5003 (extra: feedback) (*)
├── anthropic v0.125.0 (extra: llm) (*)
├── lexigram-ai-llm v0.1.5003 (extra: llm) (*)
...
├── lexigram-ai-observability v0.1.5003 (extra: observability) (*)
├── beautifulsoup4 v4.15.0 (extra: rag) (*)
├── lexigram-ai-rag v0.1.5003 (extra: rag) (*)
...
├── lexigram-testing v0.1.5005 (extra: test) (*)
...
├── lexigram-vector v0.1.5007 (extra: vector) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-ai-evaluation v0.1.5003
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-ai-governance v0.1.5003
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── starlette v1.6.0 (*)
├── typing-extensions v4.16.0
...
├── starlette v1.6.0 (*)
├── typing-extensions v4.16.0
├── lexigram-admin v0.1.5004 (extra: admin)
│   ├── aiofiles v25.1.0
...
│   ├── starlette v1.6.0 (*)
│   ├── typer v0.27.1 (*)
│   ├── lexigram-auth v0.1.5007 (extra: auth) (*)
│   ├── pysaml2 v7.5.4 (extra: auth) (*)
│   ├── xmlsec v1.3.17 (extra: auth) (*)
│   ├── lexigram-cache v0.1.5006 (extra: cache) (*)
│   ├── black v26.5.1 (extra: dev) (*)
│   ├── mypy v2.3.1 (extra: dev) (*)
│   ├── ruff v0.16.3 (extra: dev)
│   ├── lexigram-events v0.1.5007 (extra: events) (*)
...
│   ├── lexigram-auth v0.1.5007 (extra: full) (*)
│   ├── lexigram-cache v0.1.5006 (extra: full) (*)
│   ├── lexigram-events v0.1.5007 (extra: full) (*)
│   ├── lexigram-tasks v0.1.5006 (extra: full) (*)
│   ├── lexigram-web v0.1.5007 (extra: full) (*)
...
│   ├── lexigram-monitor v0.1.5007 (extra: monitor) (*)
│   ├── authlib v1.7.2 (extra: oauth2) (*)
│   ├── pysaml2 v7.5.4 (extra: saml) (*)
│   ├── xmlsec v1.3.17 (extra: saml) (*)
│   ├── lexigram-search v0.1.5005 (extra: search) (*)
│   ├── lexigram-tasks v0.1.5006 (extra: tasks) (*)
│   ├── lexigram-tenancy v0.1.5007 (extra: tenancy) (*)
│   ├── pytest v9.1.1 (extra: test) (*)
│   ├── pytest-asyncio v1.4.0 (extra: test) (*)
│   ├── pytest-cov v7.1.0 (extra: test) (*)
│   ├── pytest-mock v3.15.1 (extra: test) (*)
│   ├── lexigram-web v0.1.5007 (extra: web) (*)
│   ├── black v26.5.1 (group: dev) (*)
│   ├── mypy v2.3.1 (group: dev) (*)
│   └── ruff v0.16.3 (group: dev)
├── anthropic v0.125.0 (extra: all)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-ai-relay-gateway v0.1.5003
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── orjson v3.12.0
├── starlette v1.6.0 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-audit v0.1.5004 (*)
lexigram-auth v0.1.5007 (*)
lexigram-cache v0.1.5006 (*)
lexigram-cli v0.1.5004
├── aiofiles v25.1.0
├── httpx v0.28.1 (*)
├── jinja2 v3.1.6 (*)
├── lexigram v0.1.5007 (*)
...
lexigram-contracts v0.1.5007 (*)
lexigram-events v0.1.5007 (*)
lexigram-features v0.1.5007
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── typer v0.27.1 (*)
├── mypy v2.3.1 (extra: dev) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-graphql v0.1.5006 (*)
lexigram-http v0.1.5006
├── aiohttp v3.14.3 (*)
├── jinja2 v3.1.6 (*)
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-monitor v0.1.5007 (*)
lexigram-multimedia v0.1.5004
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── lexigram-multimedia-beat v0.1.5004 (*)
├── lexigram-multimedia-image v0.1.5004 (*)
├── lexigram-multimedia-interpolate v0.1.5004 (*)
├── lexigram-multimedia-music v0.1.5004 (*)
├── lexigram-multimedia-tts v0.1.5004 (*)
├── lexigram-multimedia-upscale v0.1.5004 (*)
├── lexigram-multimedia-video v0.1.5004 (*)
├── lexigram-storage v0.1.5004 (*)
├── lexigram-tasks v0.1.5006 (*)
├── mypy v2.3.1 (extra: dev) (*)
├── ruff v0.16.3 (extra: dev)
├── lexigram-testing v0.1.5005 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-nosql v0.1.5006 (group: tooling)
├── jinja2 v3.1.6
│   └── markupsafe v3.0.3
├── lexigram v0.1.5007
│   ├── lexigram-contracts v0.1.5007
...
│   ├── pydantic v2.13.4 (*)
│   ├── structlog v26.1.0
│   ├── lexigram-audit v0.1.5004 (extra: auth)
│   │   ├── lexigram v0.1.5007 (*)
│   │   ├── lexigram-contracts v0.1.5007 (*)
│   │   ├── starlette v1.6.0
│   │   │   └── anyio v4.14.2 (*)
...
│   │   ├── mypy v2.3.1 (extra: dev) (*)
│   │   ├── ruff v0.16.3 (extra: dev)
│   │   ├── lexigram-sql v0.1.5007 (extra: sql)
│   │   │   ├── aiosqlite v0.22.1
│   │   │   ├── alembic v1.19.1
│   │   │   │   ├── mako v1.4.1
│   │   │   │   │   └── markupsafe v3.0.3
...
│   │   │   │   │   ├── idna v3.19
│   │   │   │   │   └── truststore v0.10.4
│   │   │   │   ├── lexigram-auth v0.1.5007 (extra: all)
│   │   │   │   │   ├── argon2-cffi v25.1.0
...
│   │   │   │   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   │   │   │   └── ruff v0.16.3 (group: dev)
│   │   │   │   ├── lexigram-cache v0.1.5006 (extra: all)
│   │   │   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   │   │   ├── lexigram v0.1.5007 (*)
│   │   │   │   │   ├── lexigram-contracts v0.1.5007 (*)
│   │   │   │   │   ├── orjson v3.12.0
...
│   │   │   │   ├── lexigram-storage v0.1.5004 (extra: all)
│   │   │   │   │   ├── aiofiles v25.1.0
│   │   │   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   │   │   ├── lexigram v0.1.5007 (*)
│   │   │   │   │   ├── lexigram-contracts v0.1.5007 (*)
...
│   │   │   │   ├── lexigram-storage v0.1.5004 (extra: storage) (*)
...
│   │   │   ├── pytest-mock v3.15.1 (extra: test) (*)
│   │   │   ├── black v26.5.1 (group: dev) (*)
│   │   │   ├── lexigram-testing v0.1.5005 (group: dev) (*)
│   │   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   │   └── ruff v0.16.3 (group: dev)
│   │   ├── lexigram-testing v0.1.5005 (extra: test) (*)
│   │   ├── pytest v9.1.1 (extra: test) (*)
...
│   ├── lexigram-nosql v0.1.5006 (extra: db) (*)
│   ├── lexigram-search v0.1.5005 (extra: db)
│   │   ├── jinja2 v3.1.6 (*)
│   │   ├── lexigram v0.1.5007 (*)
│   │   ├── lexigram-contracts v0.1.5007 (*)
│   │   ├── typing-extensions v4.16.0
...
│   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   └── ruff v0.16.3 (group: dev)
│   ├── lexigram-storage v0.1.5004 (extra: db) (*)
│   ├── mypy v2.3.1 (extra: dev) (*)
│   ├── pre-commit v4.6.2 (extra: dev)
│   │   ├── cfgv v3.5.0
│   │   ├── identify v2.6.19
...
│   │   ├── mypy v2.3.1 (group: dev) (*)
│   │   └── ruff v0.16.3 (group: dev)
│   ├── lexigram-graphql v0.1.5006 (extra: graphql)
...
│   │   ├── lexigram-tasks v0.1.5006 (extra: test)
│   │   │   ├── croniter v6.2.4
│   │   │   │   └── python-dateutil v2.9.0.post0 (*)
│   │   │   ├── jinja2 v3.1.6 (*)
│   │   │   ├── lexigram v0.1.5007 (*)
...
│   ├── lexigram-tasks v0.1.5006 (extra: tasks) (*)
│   ├── lexigram-monitor v0.1.5007 (extra: test) (*)
│   ├── pytest v9.1.1 (extra: test) (*)
│   ├── pytest-asyncio v1.4.0 (extra: test) (*)
│   ├── pytest-cov v7.1.0 (extra: test) (*)
│   ├── pytest-mock v3.15.1 (extra: test) (*)
│   └── lexigram-web[uvicorn] v0.1.5007 (extra: web)
│       ├── aiofiles v25.1.0
│       ├── jinja2 v3.1.6 (*)
│       ├── lexigram v0.1.5007 (*)
│       ├── lexigram-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-nosql v0.1.5006 (*)
lexigram-notification v0.1.5007
├── aiofiles v25.1.0
├── aiohttp v3.14.3 (*)
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-resilience v0.1.5004
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── mypy v2.3.1 (extra: dev) (*)
├── ruff v0.16.3 (extra: dev)
├── lexigram-sql v0.1.5007 (extra: idempotency-database) (*)
├── lexigram-cache v0.1.5006 (extra: idempotency-redis) (*)
├── lexigram-testing v0.1.5005 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
├── pytest-asyncio v1.4.0 (extra: test) (*)
├── pytest-cov v7.1.0 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-search v0.1.5005 (*)
lexigram-secrets v0.1.5004
├── botocore v1.40.61 (*)
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── typing-extensions v4.16.0
...
lexigram-storage v0.1.5004 (*)
lexigram-tasks v0.1.5006 (*)
lexigram-tenancy v0.1.5007
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── typer v0.27.1 (*)
├── typing-extensions v4.16.0
├── lexigram-sql v0.1.5007 (extra: all) (*)
├── lexigram-testing v0.1.5005 (extra: all) (*)
├── lexigram-workflow v0.1.5007 (extra: all) (*)
├── mypy v2.3.1 (extra: all) (*)
├── pytest v9.1.1 (extra: all) (*)
├── pytest-asyncio v1.4.0 (extra: all) (*)
├── pytest-cov v7.1.0 (extra: all) (*)
...
├── lexigram-sql v0.1.5007 (extra: sql) (*)
├── lexigram-testing v0.1.5005 (extra: test) (*)
├── lexigram-workflow v0.1.5007 (extra: test) (*)
├── pytest v9.1.1 (extra: test) (*)
├── pytest-asyncio v1.4.0 (extra: test) (*)
├── pytest-cov v7.1.0 (extra: test) (*)
├── pytest-mock v3.15.1 (extra: test) (*)
...
├── mypy v2.3.1 (group: dev) (*)
└── ruff v0.16.3 (group: dev)
lexigram-web v0.1.5007 (*)
lexigram-webhook v0.1.5004
├── httpx v0.28.1 (*)
├── lexigram v0.1.5007 (*)
├── lexigram-contracts v0.1.5007 (*)
├── starlette v1.6.0 (*)
