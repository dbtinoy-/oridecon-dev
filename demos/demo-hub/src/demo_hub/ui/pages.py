"""Hub console page — static serving only (logic lives in the API controller)."""
...
class HubPageController(Controller):
    """Serve the demo hub console; every handler reads from ui/."""
