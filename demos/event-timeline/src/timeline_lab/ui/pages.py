"""Static browser console for the Events Timeline Lab."""
...
class TimelinePageController(Controller):
    """Serve the no-build event timeline console."""

    @get("/")
    async def console(self, request: Request) -> FileResponse:
        return FileResponse(ROOT / "views/timeline.html", media_type="text/html")
...
__all__ = ["TimelinePageController"]
