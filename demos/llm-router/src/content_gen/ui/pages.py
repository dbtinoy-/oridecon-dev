"""Content generator page controller — static serving only.
...
- ``GET /``            — the content console (``content.html``)
...
class ContentPageController(Controller):
    """Serve the content console; every handler reads from ui/."""
