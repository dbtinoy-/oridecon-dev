"""Queue worker page controller — static serving only.
...
- ``GET /``            — the queue console (``queue.html``)
...
class QueuePageController(Controller):
    """Serve the queue console; every handler reads from ui/."""
