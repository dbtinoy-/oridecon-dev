"""Composition root for the queue-worker demo — start reading here.
...
Run with::
    ...
    PYTHONPATH=src uv run python -m queueworker
"""
...
def create_app(config: LexigramConfig | None = None) -> Application:
    ...
    """
    app = Application(name="queue-worker", config=config)
