"""Static page controller for Approval Flow."""
...
class ApprovalFlowPageController(Controller):
    @get("/")
    async def console(self, request: Request) -> FileResponse:
        return FileResponse(ROOT / "views/approval.html", media_type="text/html")
...
__all__ = ["ApprovalFlowPageController"]
