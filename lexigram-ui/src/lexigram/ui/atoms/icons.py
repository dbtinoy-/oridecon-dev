...
ICONS = {
    ...
    # Panel icons requested by UX: panel-left (sidebar) and panel-top (stack)
    ...
    "user-minus": '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="23" x2="17" y1="11" y2="11"/>',
    "user-plus": '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="14"/><line x1="22" x2="16" y1="11" y2="11"/>',
    "cog": '<path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1-1-1.72v-.51a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>',
    ...
    "menu-alt-2": '<line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/>',
    "chevron-double-left": '<path d="m11 17-5-5 5-5"/><path d="m18 17-5-5 5-5"/>',
    ...
    # Entities
    "paw-print": '<circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 0C6.5 15.5 8 12 8 12s.5-2.5 1-2"/>',
    ...
    "package": '<path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22v-10"/>',
    "plugins": '<path d="m12 22-5-6"/><path d="M6.76 11.06a3 3 0 0 1 4.24 0l1.38 1.38a3 3 0 0 1 0 4.24l-4.24 4.24a3 3 0 0 1-4.24 0L3.72 20.5a3 3 0 0 1 0-4.24Z"/><path d="M12 2h6v6"/><path d="m16.24 8.76 3.88-3.88"/><path d="M17 14h2a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2"/><path d="M4.5 2.5l2 2"/><path d="M9.5 7.5v3"/>',
    # Actions
    ...
    "sort-desc": '<path d="m3 16 4 4 4-4"/><path d="M7 20V4"/><path d="M11 12h4"/><path d="M11 8h7"/><path d="M11 4h10"/>',
    ...
    # Simplified Hospital for Lucide (rect + cross)
    "hospital": '<path d="M12 6v4"/><path d="M14 14h-4"/><path d="M14 18h-4"/><path d="M14 8h-4"/><rect width="20" height="20" x="2" y="2" rx="2"/><path d="M10 12h4"/><path d="M12 10v4"/>',  # Tweaked
    "first-aid": '<path d="M12 13v8"/><path d="M4 13v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-6"/><path d="M12 8v3"/><path d="M12 3v3"/><path d="M8 8v6"/><path d="M16 8v6"/><rect width="20" height="5" x="2" y="3" rx="1"/>',  # Kit/Briefcase style
    ...
    "cube": '<path d="m21 16-6.003 4.429L9 16l-6.003 4.429L3 5.429 8 9l7-3.571L21 9l-6.003-4.571L21 5.429V16Z"/>',  # Using generic shape or Lucide box? Lucide box is simpler. Let's use Box.
    # Actually Lucide "box": <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" x2="12" y1="22.08" y2="12"/>
    ...
    # Piccolina resource icons
    "user-circle": '<path d="M18 20a6 6 0 0 0-12 0"/><circle cx="12" cy="10" r="4"/><circle cx="12" cy="12" r="10"/>',
    "eye-off": '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" x2="23" y1="1" y2="23"/>',
    "dog": '<path d="M10 5.172C10 3.782 8.423 2.679 6.5 3c-2.823.47-4.113 6.006-4 7 .08.703 1 1 1 1"/><path d="M14 5.172C14 3.782 15.577 2.679 17.5 3c2.823.47 4.113 6.006 4 7-.08.703-1 1-1 1"/><path d="M12 21v-2"/><path d="M8 18h8a4 4 0 0 0 4-4v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2a4 4 0 0 0 4 4Z"/><circle cx="9" cy="12" r="1"/><circle cx="15" cy="12" r="1"/>',
    "activity": '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>',
    "book-open": '<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6c-1.5 0-3 .5-4 2-1-.5-2.5-2-4-2Z"/>',
    ...
    "list-order": '<line x1="10" x2="21" y1="6" y2="6"/><line x1="10" x2="21" y1="12" y2="12"/><line x1="10" x2="21" y1="18" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"/>',
    "play": '<polygon points="6 3 20 12 6 21 6 3"/>',
    "rotate-ccw": '<path d="M3 2v6h6"/><path d="M3 8a9 9 0 1 0 2-5.12"/>',
    ...
    # Text / Alignment
    "align-left": '<rect width="6" height="16" x="4" y="6" rx="2"/><rect width="6" height="9" x="14" y="6" rx="2"/><path d="M22 2H2"/>',
...
def get_icon(
    ...
    **attrs,
    ...
    if content:
        ...
        if not content.strip().startswith("<") and "M" in content:
            return el(
                "svg",
                el(
                    "path",
    ...
    # Fallback: render raw emoji/Unicode in a span, otherwise empty
    if any(ord(c) > 127 for c in name):
        return el("span", name, class_=class_name)
    return el("span", "", class_=class_name)
