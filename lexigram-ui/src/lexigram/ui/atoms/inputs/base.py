...
class AbstractInput(ABC, Component):
    ...
    BASE_CLASSES = (
        "block w-full rounded-lg border py-1.5 px-3 h-8 shadow-sm "
        "border-input bg-card text-foreground "
        "placeholder:text-muted-foreground "
        "focus:border-ring focus:ring-2 focus:ring-ring "
        "focus:ring-offset-1 focus:ring-offset-[var(--card)] "
        "sm:text-sm leading-5 transition-all duration-200 "
