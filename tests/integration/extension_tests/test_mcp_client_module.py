...
- Integration: module accessible via oridecon.ai.mcp namespace
"""
...
class TestMCPConnectionStdio:
    def test_stdio_creates_connection(self) -> None:
        from oridecon.ai.mcp.client import MCPConnection
...
class TestMCPConnectionBuildTransport:
    def test_builds_stdio_transport(self) -> None:
        from oridecon.ai.mcp.client import MCPConnection
        from oridecon.ai.mcp.client.core import StdioClientTransport
    ...
    def test_builds_sse_transport(self) -> None:
        from oridecon.ai.mcp.client import MCPConnection
        from oridecon.ai.mcp.client.core import SSEClientTransport
    ...
    def test_builds_mcp_client(self) -> None:
        from oridecon.ai.mcp.client import MCPConnection
        from oridecon.ai.mcp.client.core import MCPClient
...
class TestMCPClientRegistry:
    def _make_client(self) -> Any:
        from oridecon.ai.mcp.client.core import MCPClient, StdioClientTransport

        transport = StdioClientTransport(["echo"])
        return MCPClient(transport)

    def test_get_returns_registered_client(self) -> None:
        from oridecon.ai.mcp.client import MCPClientRegistry
...
class TestMCPClientModule:
    ...
    def test_configure_returns_module(self) -> None:
        from oridecon.ai.mcp.client import MCPClientModule
    ...
    def test_providers_returns_mcp_client_provider(self) -> None:
        from oridecon.ai.mcp.client import MCPClientModule, MCPClientProvider
...
class TestMCPClientProvider:
    ...
    async def test_registers_registry(self) -> None:
        from oridecon.ai.mcp.client import (
            MCPClientProvider,
            MCPClientRegistry,
            MCPConnection,
        )
    ...
    async def test_registers_primary_client(self) -> None:
        from oridecon.ai.mcp.client import MCPClientProvider, MCPConnection
        from oridecon.ai.mcp.client.core import MCPClient
...
class TestMCPClientModuleNamespace:
    ...
    def test_connection_in_all(self) -> None:
        from oridecon.ai.mcp import __all__
