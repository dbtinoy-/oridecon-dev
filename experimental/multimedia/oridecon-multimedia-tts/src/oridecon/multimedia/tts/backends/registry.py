    ...
    def with_defaults(cls) -> TTSBackendRegistry:
        ...
        async def _local_http(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.tts.providers.local_http import (
        ...
        async def _elevenlabs(
            ...
            **_kwargs: Any,
            ...
            try:
                from oridecon.multimedia.tts.providers.elevenlabs import (
                    ElevenLabsTTSProvider,
                )
            except ImportError as exc:
                raise ProviderNotInstalledError(
                    "ElevenLabs backend selected but its extra is not installed. "
                    "Install: pip install oridecon-multimedia-tts[elevenlabs]"
                ) from exc
        ...
        async def _chatterbox(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.tts.providers.chatterbox import (
