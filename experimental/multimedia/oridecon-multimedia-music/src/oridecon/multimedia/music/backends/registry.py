    ...
    def with_defaults(cls) -> MusicBackendRegistry:
        ...
        async def _local_http(
            ...
            **_kw: Any,
            ...
            from oridecon.multimedia.music.providers.local_http import (
        ...
        async def _stability_audio(
            ...
            **_kw: Any,
            ...
            from oridecon.di.provider_utils import resolve_credential
            from oridecon.multimedia.music.providers.stability_audio import (
        ...
        async def _ace_step(
            ...
            **_kw: Any,
            ...
            from oridecon.multimedia.music.providers.ace_step import (
        ...
        async def _stable_audio_open(
            ...
            **_kw: Any,
            ...
            from oridecon.multimedia.music.providers.stable_audio_open import (
