...
async def test_upscale_accessor_generate_delegates_to_backend_upscale() -> None:
    ...
    from oridecon.contracts.core.result import Ok
    from oridecon.contracts.multimedia.types import MediaAsset, UpscaleRequest
...
async def test_register_tolerates_metadata_import_failure() -> None:
    ...
    with patch(
        "oridecon.multimedia.di.provider.importlib.metadata.entry_points",
...
async def test_all_subsystem_accessors_are_exposed_with_task_names() -> None:
    ...
    from oridecon.multimedia.accessors import VideoAccessor
