...
from oridecon.multimedia.timeline import Timeline
...
async def test_submit_render_normalizes_and_submits() -> None:
    ...
    from oridecon.contracts.infra.storage.models import FileInfo
...
async def test_submit_render_preserves_clip_transitions() -> None:
    ...
    from oridecon.contracts.infra.storage.models import FileInfo
    from oridecon.contracts.multimedia.types import TransitionSpec
