...
class JobHandle:
    """Thin wrapper around oridecon-tasks' IdempotencyResult.

    Exists so multimedia callers don't need to import oridecon-tasks types
    ...
    def from_idempotency_result(
        ...
        # oridecon-tasks' IdempotencyResult.status is only ever "submitted"
