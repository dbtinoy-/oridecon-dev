...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.infra.storage.protocols import BlobStoreProtocol
    from oridecon.multimedia.accessors import (
        BeatAccessor,
        ComposeAccessor,
        VideoAccessor,
    )
    from oridecon.multimedia.timeline import TimelineRenderTask
...
class MultimediaProvider(Provider):
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        # "oridecon.ai.subsystems" loop, including skipping the core names.
        # ------------------------------------------------------------------
        try:
            for _ep in importlib.metadata.entry_points(
                group="oridecon.multimedia.subsystems"
            ):
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        # during register(), oridecon-storage's provider may not have bound
        # BlobStoreProtocol yet, regardless of app.use() call order. See
        # oridecon/src/oridecon/app/base.py's two-phase startup lifecycle.
        from oridecon.contracts.infra.cache.protocols import CacheBackendProtocol
        from oridecon.contracts.infra.storage.protocols import BlobStoreProtocol
        ...
        try:
            ...
            logger.warning(
                ...
                "any provider that returns raw bytes until oridecon-storage is configured",
            )
    ...
    async def _wire_task_manager(self, container: ContainerResolverProtocol) -> None:
        ...
        from oridecon.multimedia.stores import (
        ...
        try:
            ...
            logger.warning(
                ...
                reason="oridecon-tasks not configured — submit() will be unavailable, "
        ...
        from oridecon.multimedia.storage import normalize_asset_dict
    ...
    @property
    def tts(self) -> Any:
        from oridecon.multimedia.accessors import SubsystemAccessor
    ...
    def video(self) -> VideoAccessor:
        from oridecon.multimedia.accessors import SubsystemAccessor, VideoAccessor
    ...
    def compose(self) -> ComposeAccessor:
        from oridecon.multimedia.accessors import ComposeAccessor
    ...
    def beat(self) -> BeatAccessor:
        from oridecon.multimedia.accessors import BeatAccessor
