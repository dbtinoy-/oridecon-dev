...
class InterpolationTask:
    """Callable task handler — wraps an InterpolationProvider backend for oridecon-tasks.
    ...
    oridecon-storage BEFORE this dict is constructed.
    """
    ...
    async def run(self, params: dict[str, Any]) -> dict[str, Any]:
        from oridecon.contracts.multimedia.types import InterpolationRequest
