...
uv add "oridecon-multimedia-beat[madmom-server]"  # madmom reference server (DL-based)
```

The base dependency set (`aiohttp`, `oridecon`, `oridecon-contracts`) is enough to boot
