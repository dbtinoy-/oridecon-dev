...
Common issues with `oridecon-multimedia-beat` and how to fix them.
...
**Cause 1:** The `oridecon-beat-madmom-serve` process is not running, or it is bound to a
...
oridecon-beat-madmom-serve   # listens on :5600 by default
