...
from oridecon.contracts.multimedia.security import DEFAULT_MAX_MEDIA_BYTES
...
def test_madmom_server_caps_body_size() -> None:
    from oridecon.multimedia.beat.servers.madmom_server import MAX_BODY_BYTES
...
async def test_madmom_rejects_oversized_decoded_audio(
    ...
    from oridecon.multimedia.beat.servers import madmom_server
