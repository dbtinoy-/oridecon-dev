...
Depends on both dependencies purely through oridecon-contracts protocols
and constructor injection — never a direct import of
oridecon-multimedia-video (design spec §4.3).
"""
...
if TYPE_CHECKING:
    from oridecon.contracts.multimedia.protocols import UpscaleProvider, VideoProcessor
