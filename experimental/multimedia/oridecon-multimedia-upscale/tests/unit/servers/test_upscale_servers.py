...
def test_hat_server_app_sets_client_max_size() -> None:
    from oridecon.multimedia.upscale.servers.hat_server import MAX_BODY_BYTES
...
def test_real_esrgan_server_app_sets_client_max_size() -> None:
    from oridecon.multimedia.upscale.servers.real_esrgan_server import MAX_BODY_BYTES
...
async def test_hat_server_rejects_scale_factor_outside_2_4(
    ...
    from oridecon.multimedia.upscale.servers import hat_server
...
async def test_real_esrgan_server_rejects_scale_factor_outside_2_4(
    ...
    from oridecon.multimedia.upscale.servers import real_esrgan_server
