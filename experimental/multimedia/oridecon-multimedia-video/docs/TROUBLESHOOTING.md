...
Common issues with `oridecon-multimedia-video` and how to fix them.
...
- Open an issue at [oridecon](https://github.com/dbtinoy-/oridecon/issues) with the backend, the exact error text (stderr included), and your `VideoConfig`.