...
Task-oriented recipes for `oridecon-multimedia-video`.
...
```python
from oridecon.contracts.multimedia import MediaAsset, Trim
...
```python
from oridecon.contracts.multimedia import Concat, MediaAsset, TransitionSpec
...
```python
from oridecon.contracts.multimedia import OverlayText
...
```python
from oridecon.contracts.multimedia import OverlayImage
...
```python
from oridecon.contracts.multimedia import (
    ComposeAudioLayer,
    ComposeLayer,
    ComposeVideo,
    EncodeSpec,
...
```python
from oridecon.contracts.multimedia import BurnSubtitles, SubtitleCue
...
```python
from oridecon.contracts.multimedia import MediaAsset, MuxAudio
...
```python
from oridecon.contracts.multimedia import ExtractThumbnail
...
```python
from oridecon.contracts.multimedia import ToGif
...
```python
from oridecon.contracts.multimedia import Transcode
...
```python
from oridecon.contracts.multimedia import ChangeSpeed
...
```python
from oridecon.contracts.multimedia import Crop
...
```python
from oridecon.contracts.multimedia import ColorFilter
...
```python
from oridecon.contracts.multimedia import MediaAsset, RawFilter
...
This is exactly the pipeline `VideoUpscaleService` (from `oridecon-multimedia-upscale`) uses to enlarge a whole video frame-by-frame.
...
## Process by Async-Job Params (oridecon-tasks)
...
```python
from oridecon.multimedia.video.config import VideoProcessingConfig, VideoConfig
