    ...
    def with_defaults(cls) -> VideoBackendRegistry:
        ...
        async def _local_http(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.video.providers.local_http import (
        ...
        async def _runway(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.video.providers.runway import (
                RunwayVideoProvider,
            )
        ...
        async def _cogvideox(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.video.providers.cogvideox import (
        ...
        async def _comfyui(
            ...
            **_kwargs: Any,
            ...
            from oridecon.multimedia.video.providers.comfyui import (
