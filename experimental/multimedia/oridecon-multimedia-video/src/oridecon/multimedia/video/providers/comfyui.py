...
from oridecon.contracts.multimedia.types import MediaAsset, VideoRequest
from oridecon.multimedia.video.exceptions import VideoGenerationError, VideoTimeoutError
from oridecon.serialization import dumps_str, loads
...
def _load_default_workflow() -> dict[str, Any]:
    template_path = importlib.resources.files(
        "oridecon.multimedia.video.workflows"
