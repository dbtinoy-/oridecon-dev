...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.multimedia.types import VideoOperation


class VideoGenerationTask:
    """Callable task handler — wraps a VideoProvider backend for oridecon-tasks.
    ...
    async def run(self, params: dict[str, Any]) -> dict[str, Any]:
        from oridecon.contracts.multimedia.types import VideoRequest
