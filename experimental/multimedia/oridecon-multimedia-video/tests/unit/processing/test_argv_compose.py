...
from oridecon.multimedia.video.processing.argv import build_compose_argv
...
def test_allowlisted_codecs_accepted(codec: str) -> None:
    from oridecon.contracts.multimedia.types import Transcode

    from oridecon.multimedia.video.processing.argv import build_argv
