...
(``oridecon.sql.cli.generators.entity_model:EntityModelGenerator``) renders
...
from oridecon.builder.graph.models import EntityConfig, FieldConfig
...
_FIELD_ANNOTATIONS: dict[str, str] = {
    ...
    # repository (ORI_ERR_SQL_005); float is the portable numeric type and
