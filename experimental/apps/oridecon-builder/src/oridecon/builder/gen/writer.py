...
from oridecon.builder.gen.cli_bridge import load_generator
from oridecon.builder.gen.edge_resolution import (
    resolve_cqrs,
    resolve_handlers,
    resolve_projections,
)
from oridecon.builder.gen.emitted import AttributionLedger, EmittedFile
...
from oridecon.builder.gen.emitters.audit_postprocess import ControllerAuditHooks
from oridecon.builder.gen.emitters.context import pascal_entity, table_name
...
from oridecon.builder.gen.emitters.entity_emitter import (
    crud_test_filename,
    emit_crud_test,
)
...
from oridecon.builder.gen.emitters.flag_postprocess import ControllerFlagGates
...
from oridecon.builder.gen.formatting import format_project
from oridecon.builder.gen.layout import DEFAULT_LAYOUT, WriterLayout
from oridecon.builder.gen.modular import (
    Placement,
    commit_staged,
    emit_modular_project,
    sole,
)
from oridecon.builder.gen.node_generators import (
    ENTITY_ATTACHED,
...
from oridecon.builder.gen.packaging import FRAMEWORK_REPO_REL, extra_dependencies
from oridecon.builder.gen.pruning import prune_stale_generated
from oridecon.builder.gen.staging import StagingArea
...
from oridecon.codegen import GenerationResult, GeneratorBase
        ...
        *,
        ...
        for _slug, group in place.group(list(upload_entities.values())):
            files[place.pkg("uploads", "__init__.py", config=sole(group))] = (
                "# Generated by oridecon-builder. Do not edit; regenerate instead.\n"
            )
        ...
        # docs/ORIDECON_FRAMEWORK_BUGS.md — standalone handlers are not
        ...
        for idx, entity in enumerate(sorted(entities, key=lambda e: e.name), start=1):
            ...
            # bug; see docs/ORIDECON_FRAMEWORK_BUGS.md).
        ...
        # Event handlers (framework oridecon-events `event_handler` generator).
        ...
        # Domain events (framework oridecon-events `event` generator). Each
        ...
        # CQRS commands and queries (framework oridecon-events `command` /
        ...
        # Read-model projections (framework oridecon-events `projection`
