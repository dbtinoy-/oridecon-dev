...
from oridecon.builder.gen.modular.composition import (
    asgi_target,
    emit_app,
    feature_set,
)
from oridecon.builder.gen.modular.orchestration import (
    commit_staged,
    emit_modular_project,
)
from oridecon.builder.gen.modular.placement import Placement, sole
