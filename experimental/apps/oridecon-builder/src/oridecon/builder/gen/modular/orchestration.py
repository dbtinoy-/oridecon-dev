...
from oridecon.builder.gen.emitted import AttributionLedger
from oridecon.builder.gen.emitters.entity_emitter import GENERATED_HEADER
from oridecon.builder.gen.emitters.module_emitter import (
    emit_module_package,
    emit_modules_registry,
    provider_class_name,
)
from oridecon.builder.gen.formatting import autofix_text
from oridecon.builder.gen.layout import WriterLayout
from oridecon.builder.gen.modular.composition import emit_app
from oridecon.builder.gen.modular.providers import (
    _framework_imports,
    emit_infrastructure,
...
from oridecon.builder.gen.staging import StagedFile
from oridecon.builder.graph.models import (
    ModuleConfig,
    ValidatedGraph,
)
from oridecon.builder.graph.modules import module_import_graph
