...
from oridecon.builder.graph.models import GraphDocument, GraphNode, ModuleConfig
...
def derive_modules(doc: GraphDocument) -> list[ModuleCard]:
    ...
    def card(
        ...
        return ModuleCard(id_, oridecon, on, count, kinds, reserved)
    ...
    return [
        ...
        card("webhook", "oridecon-webhook", n("webhook") > 0, n("webhook"), ("webhook",)),
        ...
        card("queue", "oridecon-queue", False, 0, (), "not emitting"),
        card("resilience", "oridecon-resilience", False, 0, (), "not emitting"),
        card("secrets", "oridecon-secrets", False, 0, (), "not emitting"),
        card("tenancy", "tenant_resolver", False, 0, (), "not emitting"),
        card("workflow", "oridecon-workflow", False, 0, (), "not emitting"),
