...
from oridecon.cli.layout import COMPONENTS
...
# emits real oridecon-auth plumbing (nodes plan N4.2); email_template became
...
PALETTE_CATEGORIES: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "nodes": [
            ...
            {"kind": KIND_DATALOADER, "label": "DataLoader", "description": "GraphQL DataLoaderProtocol batch/cache loader (oridecon-graphql)", "icon": "layers", "color": NODE_COLORS[KIND_DATALOADER], "maxCount": None, "required": False},
        ],
    },
    {
        ...
        "nodes": [
            ...
            {"kind": KIND_INTERCEPTOR, "label": "Interceptor", "description": "WebInterceptorBase around handlers (oridecon-web)", "icon": "waypoints", "color": NODE_COLORS[KIND_INTERCEPTOR], "maxCount": None, "required": False},
            ...
            {"kind": KIND_API_CLIENT, "label": "API Client", "description": "Outbound HTTP client wrapping oridecon-http BaseURLHTTPClient", "icon": "cloud", "color": NODE_COLORS[KIND_API_CLIENT], "maxCount": None, "required": False},
        ],
    },
    {
    ...
    },
    {
        ...
        "nodes": [
            ...
            {"kind": KIND_STORAGE_DRIVER, "label": "Storage Driver", "description": "Blob storage backend implementing oridecon-storage AbstractDriver", "icon": "hard-drive", "color": NODE_COLORS[KIND_STORAGE_DRIVER], "maxCount": None, "required": False},
        ],
    },
    {
        ...
        "nodes": [
            ...
            {"kind": KIND_AUTH_POLICY, "label": "Auth Policy", "description": "Authorization policy scaffold (oridecon-auth auth_policy)", "icon": "shield", "color": NODE_COLORS[KIND_AUTH_POLICY], "maxCount": None, "required": False},
...
# upstream by ``oridecon.cli.layout.COMPONENTS[].shared``, the same table the
...
#: ``oridecon.builder.gen.layout.BUILDER_COMPONENTS`` — duplicated because
...
def _component_is_shared(component: str) -> bool:
    ...
    raise KeyError(
        ...
        f"oridecon.cli.layout.COMPONENTS nor a builder-owned package."
    )
