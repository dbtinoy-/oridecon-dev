...
from oridecon.cli.registry.backend_base import (
...
class DatabaseConnection:
    ...
    async def connect(self) -> Any:
        ...
        try:
            ...
            db_providers = importlib.import_module("oridecon.sql.providers")
            ...
            raise RuntimeError(f"oridecon-sql not installed: {e}") from e
