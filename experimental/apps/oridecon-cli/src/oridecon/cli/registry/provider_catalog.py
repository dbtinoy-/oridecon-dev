...
describe each installable Oridecon package and its default config.
"""
...
@dataclass
class ProviderInfo:
    """Information about a Oridecon provider."""
...
class ResilienceProvider(Provider):
    ...
    Resilience is now part of the core *oridecon* package; the provider
    exists primarily for configuration metadata rather than pulling in an
    external distribution.
    """

    name = "resilience"
    package = "oridecon"  # core oridecon package contains resilience
...
class ConnectProvider(Provider):
    ...
    name = "http"
    package = "oridecon"
    description = "HTTP client (built into oridecon core)"
    config = {
        "connect": {
