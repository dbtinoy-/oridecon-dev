...
class WebAPIPreset(PresetDefinition):
    ...
    packages = ["oridecon", "oridecon-web", "oridecon-sql"]
    config = {
...
class GraphQLPreset(PresetDefinition):
    ...
    packages = ["oridecon", "oridecon-web", "oridecon-sql", "oridecon-graphql"]
    config = {
        "web": {"host": "0.0.0.0", "port": 8000},  # noqa: S104 — preset template default
        "database": {"url": "sqlite:///./dev.db"},
...
class WorkerPreset(PresetDefinition):
    ...
    packages = ["oridecon", "oridecon-sql", "oridecon-tasks", "oridecon-queue"]
    config = {
...
class MinimalPreset(PresetDefinition):
    ...
    name = "minimal"
    description = "Bare minimum Oridecon application"
    packages = ["oridecon"]
    config = {}
...
class MicroservicePreset(PresetDefinition):
    ...
    packages = ["oridecon", "oridecon-sql", "oridecon-events", "oridecon-monitoring"]
    config = {
