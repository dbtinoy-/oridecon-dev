...
class CliError(OrideconError):
    """Base exception for oridecon-cli operations."""

    _code: str = "ORI_ERR_CLI_001"
...
class ProviderNotInstalledError(CliError):
    ...
    def __init__(self, provider: str) -> None:
        ...
        super().__init__(
            ...
            suggestions=[f"Install with: pip install oridecon-{provider}"],
        )
