"""Test generator for the Oridecon CLI."""
...
from oridecon.cli.generators.base import GenerationResult, GeneratorBase
from oridecon.cli.generators.field_parser import parse_fields
