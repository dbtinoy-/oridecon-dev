...
This module provides commands for inspecting the runtime state of a Oridecon application.
"""
...
def inspect_config() -> None:
    ...
    from oridecon.cli.commands.config import show as config_show
...
def _print_needs_context(out: OutputManager, command: str, detail: str) -> None:
    ...
    """
    out.print(f"[bold]oridecon {command}[/bold]")
    out.print()
...
def inspect_modules() -> None:
    """List all registered Oridecon modules in the application."""
    out = OutputManager()
