"""oridecon init — initialize Oridecon in an existing project."""
...
_MINIMAL_CONFIG = """\
# Oridecon configuration (validated by OrideconConfig).
...
# `oridecon.config` entry-point models).
app_name: {project_name}
debug: false
env: development
...
def init(
    ...
    """Initialize Oridecon in the current directory."""
    out = OutputManager()
