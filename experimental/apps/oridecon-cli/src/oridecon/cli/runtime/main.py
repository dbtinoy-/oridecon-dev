...
from oridecon.cli.commands import (
    add,
    config,
    contrib,
    db,
...
app = typer.Typer(
    name="oridecon",
    help="Oridecon Framework CLI — build, run, and manage Oridecon applications.",
    add_completion=True,
...
app.add_typer(init.app, name="init", help="Initialize Oridecon in existing project")
app.add_typer(new.app, name="new", help="Create a new Oridecon project")
