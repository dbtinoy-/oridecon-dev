"""Tests for oridecon dev command."""

from unittest.mock import MagicMock, patch

from typer.testing import CliRunner

from oridecon.cli.commands.dev import app
...
class TestDevCommand:
    ...
    @patch("oridecon.cli.commands.dev.ServerManager")
    def test_dev_no_entry_point_no_config(
        ...
        # (src/oridecon/cli/runtime/main.py) or any other entry point; the
