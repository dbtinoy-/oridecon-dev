...
Verifies that `oridecon add <provider>` (ProviderInstaller.add_provider_config)
...
from oridecon.cli.registry.provider import ProviderInstaller, ProviderRegistry
