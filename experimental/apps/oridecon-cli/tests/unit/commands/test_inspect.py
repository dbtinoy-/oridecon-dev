...
from oridecon.cli.commands.inspect import _print_needs_context
...
class TestInspectCommand:
    ...
    def test_providers(self) -> None:
        from oridecon.cli.commands.inspect import app as inspect_app
    ...
    def test_config_alias(self) -> None:
        from oridecon.cli.commands.inspect import app as inspect_app
        with patch("oridecon.cli.commands.config.show") as mock_show:
