...
from oridecon.cli.commands.contrib import _names_preview
...
class TestContribCommand:
    ...
    @patch("oridecon.cli.commands.contrib.ContributorRuntime.from_entry_points")
    def test_list_no_contributors(self, mock_runtime: MagicMock) -> None:
        ...
        from oridecon.cli.commands.contrib import app as contrib_app
