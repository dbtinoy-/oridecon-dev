...
from oridecon.cli.commands.shell import _banner
...
class TestShellBanner:
    def test_banner_returns_string(self) -> None:
        ...
        assert "Oridecon Interactive Shell" in banner


class TestShellCommand:
    runner = CliRunner()

    @patch("oridecon.cli.commands.shell._run_plain_repl")
    def test_shell_no_app(self, mock_repl: MagicMock) -> None:
        from oridecon.cli.commands.shell import app
    ...
    @patch("oridecon.cli.commands.shell._run_repl_with_app")
...
class TestRunPlainRepl:
    ...
    def test_plain_repl_uses_code(self, mock_interact: MagicMock) -> None:
        from oridecon.cli.commands.shell import _run_plain_repl
...
class TestRunReplWithApp:
    ...
    def test_repl_with_app_uses_code(self, mock_interact: MagicMock) -> None:
        from oridecon.cli.commands.shell import _run_repl_with_app
