...
from oridecon.cli.commands.add import app
...
class TestAddCommand:
    ...
    def test_add_database_provider(self, runner: CliRunner, temp_project: Path):
        ...
        assert "oridecon-sql" in result.output
        ...
        oridecon_yaml = temp_project / "application.yaml"
        content = oridecon_yaml.read_text()
    ...
    def test_add_auth_provider(self, runner: CliRunner, temp_project: Path):
        ...
        assert "oridecon-auth" in result.output
    ...
    def test_add_ai_provider(self, runner: CliRunner, temp_project: Path):
        ...
        assert "oridecon-ai" in result.output
    ...
    def test_add_cache_provider(self, runner: CliRunner, temp_project: Path):
        ...
        assert "oridecon-cache" in result.output
    ...
    def test_add_queue_provider(self, runner: CliRunner, temp_project: Path):
        ...
        assert "oridecon-queue" in result.output
    ...
    def test_add_provider_no_oridecon_yaml(self, runner: CliRunner, temp_dir: Path):
