...
from oridecon.cli.commands.new import app as new_app
from oridecon.cli.scaffold import render_project
...
class TestScaffoldedTree:
    ...
    def test_a_fresh_project_declares_only_its_package(
        ...
        """``[tool.oridecon]`` names the ASGI target and nothing else.
...
class TestNewModuleCommand:
    """oridecon new module creates and registers a bounded context."""
    ...
    def test_registry_imports_and_boots_modules_package(
        ...
        """The module registry imports cleanly against real oridecon APIs."""
...
class TestGenModuleOption:
    """``oridecon gen --module`` decides where a component lands."""
