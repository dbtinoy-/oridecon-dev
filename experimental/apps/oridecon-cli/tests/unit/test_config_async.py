...
from oridecon.cli.commands import config as config_command
from oridecon.cli.lib.config_loader import ConfigLoader, load_config_yaml_async
...
class TestConfigLoaderAsync:
    ...
    def test_config_init_avoids_sync_open(
        ...
        """`oridecon config init` should not rely on blocking open()."""
        runner = CliRunner()
        output_file = tmp_path / "oridecon.generated.yaml"
