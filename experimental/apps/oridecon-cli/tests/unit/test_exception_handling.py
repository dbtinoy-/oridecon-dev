...
def test_cli_error_is_oridecon_error() -> None:
    """CLI errors must extend OrideconError."""
...
def test_no_bare_except_exception_in_runtime() -> None:
    ...
    # Run: ruff check --select=BLE001 oridecon-cli/src/
    pass
