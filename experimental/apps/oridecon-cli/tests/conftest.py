"""Test configuration for oridecon-cli."""
...
def _reload_cli_modules_with_contributors(
    ...
    from oridecon.cli.runtime import main as main_module
...
def temp_project(temp_dir: Path) -> Generator[Path, None, None]:
    ...
    only way a project declares it -- through ``[tool.oridecon] module``.
    """
...
"""
    ...
    oridecon_content = """
# Oridecon configuration
"""
    (project_dir / "application.yaml").write_text(oridecon_content.strip())
