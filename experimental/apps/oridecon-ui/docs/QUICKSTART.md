...
from oridecon.ui.molecules import Card
    ...
    def render(self):
        return el(
            ...
            Card(
                ...
                children=[
                    el("p", "oridecon-ui is ready. Start building.", class_="text-muted-foreground mb-4"),
...
oridecon-ui add form -o my_components/ui
```
