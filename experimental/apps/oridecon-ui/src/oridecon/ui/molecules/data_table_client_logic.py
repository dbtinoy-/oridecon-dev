...
class DataTableScriptRenderer:
    ...
    def render(all_ids: list[str]) -> Any:
        ...
        (function() {{
            ...
            window.OrideconDownloadBulk = window.OrideconDownloadBulk || function(button) {{
            ...
            window.OrideconImportUpload = window.OrideconImportUpload || function(button) {{
            ...
            if (window.OrideconTableInitialized) return;
            window.OrideconTableInitialized = true;

            window.OrideconTableLogic = {{
            ...
            const registerResizable = () => {{
                if (window.Alpine && !window.OrideconResizableRegistered) {{
                    ...
                    window.OrideconResizableRegistered = true;
                }}
            }};
            ...
            document.addEventListener('htmx:afterSwap', (e) => {{
                try {{
                    ...
                    if (window.OrideconTableLogic && typeof window.OrideconTableLogic.updateActiveFiltersState === 'function') {{
                        window.OrideconTableLogic.updateActiveFiltersState();
                    }}
