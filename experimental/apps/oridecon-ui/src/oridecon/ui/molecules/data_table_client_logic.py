        ...
        (function() {{
            ...
            if (!window.LexigramBulkProgressInitialized) {{
                ...
                const buildBulkProgressRegion = (taskId, total) => {{
                    const domId = 'oridecon-bulk-progress-' +
                    ...
                    if (!root) {{
                        ...
                        root._orideconProgress = {{ progress: progress, fill: fill, count: count, message: message }};
                        document.body.appendChild(root);
                    }}
                    const nodes = root._orideconProgress;
                ...
                const setBulkProgress = (state, snapshot) => {{
                    ...
                    state.total = total;
                    const nodes = state.region && state.region._orideconProgress;
                    if (nodes) {{
