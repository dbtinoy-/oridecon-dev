...
class UIProvider(Provider):
    """Registers the oridecon-ui component system.

    Bind into your application bootstrap::

        from oridecon.ui.di import UIProvider
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.ui.performance.observability import MetricsCollector
        from oridecon.ui.performance.performance import RenderCache, ResponseOptimizer
