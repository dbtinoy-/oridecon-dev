...
from oridecon.ui.config import DebounceConfig, UIConfig
...
from oridecon.ui.hooks import UIComponentRenderedHook, UITemplateRenderedHook
...
class TestDecoratorsExports:
    def test_component_in_all(self) -> None:
        from oridecon.ui.decorators import __all__
