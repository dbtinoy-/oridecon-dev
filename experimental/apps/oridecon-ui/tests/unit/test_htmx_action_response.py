...
def test_toast_type_is_str_enum() -> None:
    ...
    from oridecon.ui.htmx.action_response import ToastType
...
def test_to_response_returns_html_response() -> None:
    ...
    from oridecon.ui.htmx.action_response import HtmxActionResponse, ToastData, ToastType
...
def test_no_toast_trigger_only() -> None:
    from oridecon.ui.htmx.action_response import HtmxActionResponse
...
def test_importable_from_htmx_subpackage() -> None:
    from oridecon.ui.htmx import HtmxActionResponse, ToastData, ToastType

    assert HtmxActionResponse is not None


def test_importable_from_public_api() -> None:
    from oridecon.ui import HtmxActionResponse
