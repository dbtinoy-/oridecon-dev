...
from oridecon.ui import UIModule
...
class TestUIComponent:
    ...
    def test_component_base_import(self):
        ...
        from oridecon.ui.core.base import Component
...
class TestUIContext:
    ...
    def test_context_creation(self):
        ...
        from oridecon.ui.core.context import UIContext
        ctx = UIContext()
...
class TestUIAtoms:
    ...
    def test_input_import(self):
        ...
        from oridecon.ui.atoms.inputs.text import Input
...
class TestUIOrganisms:
    ...
    def test_chart_import(self):
        ...
        from oridecon.ui.charts import BarChart, ChartConfig, ChartDataPoint, ChartType, LineChart, PieChart
