...
from oridecon.admin.realtime import AdminEvent, SubjectAdminEventHub
from oridecon.admin.resources.urls import DEFAULT_ADMIN_PREFIX, admin_url
...
def _framework_version() -> str:
    """Return the installed oridecon core package version, or 'unknown'."""
    try:
        return version("oridecon")
...
class CoreAdminContributor(BaseAdminContributor):
    ...
    def set_resource_inventory(self, inventory: Any) -> None:
        ...
        :class:`~oridecon.admin.dashboard.resource_inventory.ResourceInventory`
