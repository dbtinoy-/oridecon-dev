...
from oridecon.admin.auth.user import AdminUserRecord

if TYPE_CHECKING:
    from oridecon.admin.mapping.mapper import AdminObjectMapper
...
def register_admin_mappings(mapper: AdminObjectMapper) -> None:
    ...
    Args:
        mapper: The :class:`~oridecon.admin.mapping.mapper.AdminObjectMapper`
