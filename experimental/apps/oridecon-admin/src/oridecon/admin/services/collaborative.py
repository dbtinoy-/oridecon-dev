"""Collaborative editing support for oridecon-admin.
...
:mod:`oridecon.admin.services.realtime` WebSocket layer to push live updates
to connected users.

The edit lock store is provided via constructor injection as a
:class:`~oridecon.contracts.core.stores.LockStoreProtocol`.  In production
...
Usage::
    ...
    from oridecon.admin.services.collaborative import CollaborativeEditingService
...
if TYPE_CHECKING:
    from oridecon.admin.services.realtime import RealtimeService
...
class CollaborativeEditingService:
    ...
    :class:`~oridecon.contracts.core.stores.LockStoreProtocol`, allowing
    ...
    Args:
        ...
        realtime_service: Optional
            :class:`~oridecon.admin.services.realtime.RealtimeDataService`
