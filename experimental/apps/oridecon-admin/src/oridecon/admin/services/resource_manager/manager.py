...
:mod:`oridecon.admin.services.resource_manager.adapter`), input validation,
...
from oridecon.admin.services.resource_manager.adapter import (
    find_many_safe,
    find_one_safe,
)
from oridecon.admin.services.resource_manager.audit import record_audit
from oridecon.admin.services.resource_manager.protocols import (
    DefaultAuthorizer,
    DefaultValidator,
    ResourceDataSourceProtocol,
    Validator,
)
from oridecon.contracts.audit import AuditEventSeverity, AuditLoggerProtocol
from oridecon.contracts.auth import AuthorizerProtocol
from oridecon.contracts.exceptions import PermissionDeniedError as PermissionDenied
