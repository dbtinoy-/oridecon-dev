...
A minimal :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`
...
``oridecon-notification``; this class is a self-contained implementation
...
from oridecon.contracts.mailer import EmailMessage, MessageDeliveryReceipt
