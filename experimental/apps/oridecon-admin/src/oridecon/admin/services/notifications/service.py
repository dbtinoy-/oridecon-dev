...
from oridecon.admin.config import AdminNotificationConfig
from oridecon.admin.exceptions import NotificationError
...
from oridecon.admin.services.notifications.templates import TemplateRenderer
...
class AdminNotificationService:
    ...
    Integrates with oridecon.messaging for email delivery
