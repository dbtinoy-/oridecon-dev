...
Wraps :class:`~oridecon.admin.services.dashboard.DashboardBuilder` with
...
class WidgetPlacement:
    ...
    Attributes:
        widget_id: References a :class:`~oridecon.admin.services.dashboard.WidgetConfig` id.
...
class UserDashboardService:
    ...
    Args:
        builder: The shared :class:`~oridecon.admin.services.dashboard.DashboardBuilder`
