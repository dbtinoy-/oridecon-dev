"""File Upload Service - Refactored to use oridecon-storage.

This service replaces the custom LocalStorageBackend with oridecon-storage
for S3/Azure/GCS
...
class FileUploadService:
    """DI-injectable file upload service using oridecon-storage.
    ...
    async def upload(
        ...
        """
        Upload file using oridecon-storage.
