...
from oridecon.admin.auth.models import GUEST_USER
...
if TYPE_CHECKING:
    from oridecon.admin.auth.protocols import AdminSessionServiceProtocol
...
class AdminAuthMiddleware:
    ...
    def __init__(
        ...
        Args:
            ...
            super_admin_role: Configured super-admin role name
                ...
                oridecon-auth bypass) recognizes them consistently.
    ...
    def _mark_super_admin(self, user: AuthenticatedUserProtocol | None) -> None:
        ...
        middleware, sidebar filtering, and oridecon-auth checks consistent.
