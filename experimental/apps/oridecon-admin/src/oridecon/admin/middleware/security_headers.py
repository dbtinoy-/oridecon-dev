"""Security headers middleware for oridecon-admin.

Applies OWASP-recommended HTTP security headers to every response.
Implements SecurityHeadersProtocol from oridecon-contracts.
"""
...
from oridecon.contracts.security import SecurityHeadersProtocol
...
class AdminSecurityHeaders:
    """Concrete implementation of SecurityHeadersProtocol for oridecon-admin.
