...
if TYPE_CHECKING:
    ...
    from oridecon.admin.config import TenancyConfig
...
class AdminTenantMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        from oridecon.admin.multitenancy.context import (
        ...
        # Resolve tenant ID (delegates to oridecon-tenancy when available)
