"""Input sanitizer middleware for oridecon-admin.

Implements InputSanitizerProtocol from oridecon-contracts, providing
...
from oridecon.contracts.security import InputSanitizerProtocol
...
class AdminInputSanitizer:
    """Concrete implementation of InputSanitizerProtocol for oridecon-admin.
    ...
    def is_safe_url_for_request(self, url: str) -> bool:
        ...
        Delegates to the single shared primitive in ``oridecon.contracts``.
