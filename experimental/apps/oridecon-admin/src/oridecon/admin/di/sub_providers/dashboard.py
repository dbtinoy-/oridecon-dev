...
from oridecon.admin.dashboard.page_assembler import PageAssembler
from oridecon.admin.dashboard.permission_filter import PermissionFilter
from oridecon.admin.dashboard.settings_assembler import SettingsPanelAssembler
from oridecon.admin.dashboard.widgets import WidgetRegistry
from oridecon.contracts.admin.protocols import AdminDashboardProtocol
...
class AdminDashboardSubProvider:
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.admin.services.charts import ChartFactory
        from oridecon.admin.services.user_dashboard import UserDashboardService
