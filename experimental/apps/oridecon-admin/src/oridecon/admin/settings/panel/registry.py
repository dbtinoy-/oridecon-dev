...
if TYPE_CHECKING:
    from oridecon.admin.settings.panel.nodes import AbstractConfigNode, ConfigSpec
...
class ConfigRegistry:
    ...
    def _default_entries(cls) -> dict[str, type[ConfigSpec]]:
        ...
        from oridecon.admin.settings.panel.notifications_spec import (
            NotificationsSpec,
        )
    ...
    async def get_value_metadata(
        ...
        from oridecon.admin.settings.panel.nodes import SecretNode
