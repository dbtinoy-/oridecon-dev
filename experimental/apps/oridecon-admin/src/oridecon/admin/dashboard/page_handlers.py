...
from oridecon.admin.dashboard.page_fallbacks import (
    _placeholder_page,
    _resolve_primary_color,
)
from oridecon.admin.navigation.clusters import (
    CLUSTER_LABEL,
    CLUSTER_URL,
    cluster_items,
    is_cluster_path,
...
from oridecon.contracts.admin.page_content import PageContent
    ...
    async def __call__(self, scope: Any, receive: Any, send: Any) -> None:
        ...
        try:
            ...
            if not isinstance(response, HTMLResponse):
                from oridecon.admin.dashboard.page_renderer import (
                    render_page_content,
                )
                from oridecon.contracts.admin.page_content import PageContent
...
class StructuredPageHandler:
    ...
    async def __call__(self, scope: Any, receive: Any, send: Any) -> None:
        from oridecon.admin.dashboard.page_renderer import render_page_content
