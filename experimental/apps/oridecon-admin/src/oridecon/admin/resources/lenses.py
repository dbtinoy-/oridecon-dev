...
Example::
    ...
    from oridecon.admin.resources.lenses import ResourceLens
    from oridecon.ui.columns import TextColumn, DateColumn, BadgeColumn
...
class ResourceLens:
    ...
    Subclass to create a lens.  Attach to a :class:`~oridecon.admin.resources.base.Resource`
