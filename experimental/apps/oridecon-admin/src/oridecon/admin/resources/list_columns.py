...
from oridecon.ui import Column as OrgColumn
from oridecon.ui import TextColumn
...
def get_row_actions(table_config: Any, resource: Any, resource_prefix: str) -> Any:
    ...
    from oridecon.ui.actions.standard import DeleteAction, EditAction, ViewAction
...
def get_bulk_actions(table_config: Any, resource: Any) -> Any:
    ...
    # Keep both the legacy oridecon-ui action API and the canonical admin
    ...
    from oridecon.admin.actions.base import BulkAction as AdminBulkAction
    from oridecon.ui.actions.standard import BulkAction as OrgBulkAction
