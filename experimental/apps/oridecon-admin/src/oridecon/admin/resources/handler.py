...
from oridecon.admin.exceptions import PermissionDeniedError
...
from oridecon.admin.resources.action_handlers import (
    CloneActionHandler,
    CreateActionHandler,
    DeleteActionHandler,
    DetailActionHandler,
...
from oridecon.admin.resources.bulk_outcome import BulkOutcome
from oridecon.admin.resources.data_access import get_resource_data_source
from oridecon.admin.resources.urls import (
...
class UserPermissionsActionHandler:
    ...
    async def handle(
        ...
        Only :class:`~oridecon.admin.resources.users.UserResource`
    ...
    async def _handle_form(
        ...
        from oridecon.admin.resources.permissions_renderer import (
...
class BulkActionHandler:
    ...
    def _progress_components(
        ...
        if not callable(getattr(access, "register", None)) or not callable(
            ...
            return None
        from oridecon.admin.controllers.progress import progress_principal_key
    ...
    async def _execute_declared_action(
        ...
        if callable(executor):
            ...
            from oridecon.admin.actions.types import ActionContext
    ...
    async def _fetch_filtered_export_records(
        ...
        from oridecon.admin.resources.list_query import ListDataFetcher
    ...
    async def handle(
        ...
        from oridecon.admin.resources.base import Resource as AdminResource
        ...
        if execution_action == "delete":
            ...
            if execution_action == "export_xlsx":
                ...
                from oridecon.admin.services.export.xlsx import (
                    XLSX_CONTENT_TYPE,
                    encode_rows_as_xlsx,
                )
                ...
                # export service.
                from oridecon.admin.services.export.sanitize import (
                    sanitize_cell_value,
                )
...
class ActionHandlerRegistry:
    ...
    def _initialize_handlers(self) -> None:
        from oridecon.admin.engine.renderer import AdminRenderer as EngineAdminRenderer
        from oridecon.admin.resources.detail_renderer import DetailRenderer
        from oridecon.admin.resources.form_renderer import FormRenderer
        from oridecon.admin.resources.list_renderer import ListRenderer
