...
:class:`~oridecon.admin.layout.layout_manager.LayoutManager`. One configurator
per :class:`~oridecon.admin.layout.LayoutType`; the registry selects by
...
class GridLayoutConfigurator:
    def can_configure(self, layout_type: Any) -> bool:
        from oridecon.admin.layout import LayoutType
