...
- :class:`~oridecon.admin.resources.specs.IntegrationSpecsMixin` —
  ``cache_spec`` / ``search_spec`` / ``resilient_spec`` builders
- :class:`~oridecon.admin.resources.hooks.ResourceHooksMixin` — record
  lifecycle hooks and action-hook attachment
- :class:`~oridecon.admin.resources.table_config.TableConfigMixin` —
  table/form-display/layout configuration resolvers
- :class:`~oridecon.admin.resources.archive_ops.ArchiveOperationsMixin` —
...
from oridecon.admin.data.data_source import IDataSource
from oridecon.admin.resources.archive_ops import ArchiveOperationsMixin
from oridecon.admin.resources.data_access import get_resource_data_source
from oridecon.admin.resources.form_guard import PROTECTED_FORM_FIELDS
from oridecon.admin.resources.hooks import ResourceHooksMixin
from oridecon.admin.resources.specs import IntegrationSpecsMixin
from oridecon.admin.resources.table_config import TableConfigMixin

if TYPE_CHECKING:
    from oridecon.admin.actions.base import HeaderAction
    from oridecon.admin.forms.components import FormBase
    ...
    from oridecon.admin.ui.filters.base import Filter
    from oridecon.domain import DomainModel
    from oridecon.ui.actions import Action, BulkAction
    from oridecon.ui.columns import Column
...
class Resource(
    ...
    # Form security — see oridecon.admin.resources.form_guard
    ...
    async def search(self, query: str, *, limit: int = 5) -> list[dict[str, Any]]:
        ...
        from oridecon.admin.data.query import QuerySpec
