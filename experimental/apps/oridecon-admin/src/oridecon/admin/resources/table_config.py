...
:class:`~oridecon.admin.resources.base.Resource` via inheritance so
...
if TYPE_CHECKING:
    ...
    from oridecon.admin.layout.layout_manager import LayoutManager
...
class TableConfigMixin:
    ...
    :class:`~oridecon.admin.resources.base.Resource`).
    """
    ...
    def get_layout_manager(cls) -> LayoutManager:
        ...
        from oridecon.admin.layout import LayoutManager
        from oridecon.admin.resources.layouts import apply_layout_config
