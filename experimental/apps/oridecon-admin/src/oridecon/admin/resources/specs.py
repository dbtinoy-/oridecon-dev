...
class IntegrationSpecsMixin:
    ...
    attributes (defined by :class:`~oridecon.admin.resources.base.Resource`).
    """
    ...
    def cache_spec(self) -> Any:
        ...
        if self.cacheable is True:
            from oridecon.admin.integrations.cache import CacheableSpec
    ...
    def search_spec(self) -> Any:
        ...
        if self.searchable is True:
            from oridecon.contracts.search import SearchableSpec
    ...
    def resilient_spec(self) -> Any:
        ...
        if self.resilient is True:
            from oridecon.admin.integrations.resilience import ResilientSpec
