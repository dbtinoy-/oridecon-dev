"""Global search controller for oridecon-admin.
...
from oridecon.ui import Element, el, render_to_string

if TYPE_CHECKING:
    from starlette.requests import Request

    from oridecon.admin.services.search_service import SearchResults, SearchService
...
class SearchController:
    ...
    def _render_results(
        ...
        """
        from oridecon.admin.resources.urls import mount_admin_url
