...
async def render_config_popup(
    ...
    *,
    ...
    from oridecon.admin.controllers.widget_handler_support import ensure_edit_allowed
    from oridecon.admin.dashboard.widgets import render_widget_config_popup
