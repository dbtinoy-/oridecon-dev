...
from oridecon.admin.auth.models import AdminUser
from oridecon.admin.controllers.route_collection import collect_instance_routes
from oridecon.admin.engine.renderer import AdminRenderer
from oridecon.admin.middleware.auth import current_user
from oridecon.admin.resources.urls import admin_prefix_from_request, mount_admin_url
from oridecon.concurrency import Parallel
...
class AdminController(ControllerProtocol):
    ...
    def build_specification(self, request: Request, allowed_fields: list[str]) -> Any:
        ...
        """
        from oridecon.admin.lib.specifications import (
            AndSpecification,
            FieldSpecification,
        )
