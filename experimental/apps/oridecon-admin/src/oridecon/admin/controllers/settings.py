...
from oridecon.admin.auth.types import AdminSecurityEventType
from oridecon.admin.config import AdminRbacConfig
from oridecon.admin.controllers.base import AdminController
from oridecon.admin.controllers.settings_history import SettingsHistoryMixin
from oridecon.admin.multitenancy.adapter import resolve_tenant_id
from oridecon.admin.rbac.super_admin import is_super_admin
from oridecon.admin.resources.urls import (
    admin_prefix_from_request,
    admin_url,
    mount_admin_url,
)
from oridecon.admin.settings.conflict import SettingsConflictError
from oridecon.admin.settings.panel import BooleanNode, SecretNode
...
from oridecon.admin.settings.panel.types import ConfigCategory, PanelLink
from oridecon.admin.settings.panel.ui import ConfigDashboardUI
from oridecon.admin.settings.revision import (
    extract_submitted_revision,
    revision_matches,
    settings_revision,
)
from oridecon.admin.settings.snapshots import SettingsSnapshotService
from oridecon.contracts.web import get, post
from oridecon.logging import get_logger
from oridecon.ui import ServerToastChannel, ToastData, el, render_to_string
...
class SettingsController(SettingsHistoryMixin, AdminController):
    ...
    def _safe_audit_value(value: Any, *, key: str | None = None) -> Any:
        ...
        from oridecon.admin.settings.application import redact_config_value
