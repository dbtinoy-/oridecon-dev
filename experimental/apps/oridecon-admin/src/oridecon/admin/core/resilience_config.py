...
``oridecon.contracts.infra.resilience.models`` — import them from there.
"""
...
if TYPE_CHECKING:
    from oridecon.contracts.data import UnitOfWorkProtocol
...
async def transaction(
    ...
    Args:
        uow: A :class:`~oridecon.contracts.data.UnitOfWorkProtocol` instance.
