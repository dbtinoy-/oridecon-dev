"""Error handling and middleware integration for oridecon-admin.

This module provides error handling integration with oridecon.exceptions,
...
from oridecon.admin.exceptions import AdminError as CoreAdminError
