...
from oridecon.admin.models.provider_models import Command
...
class AdminRegistry:
    ...
    def _assign_resource_to_group(
        ...
        if group_key not in nav_groups:
            ...
            from oridecon.admin.config import AdminNavigationGroup
    ...
    def discover_controllers(
        ...
        from oridecon.admin.controllers import AdminController
