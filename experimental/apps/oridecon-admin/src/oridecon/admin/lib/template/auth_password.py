"""Password reset request/confirm page sections for oridecon-admin auth templates."""

from __future__ import annotations

from oridecon.admin.lib.template.layout import (
    _auth_footer,
    _auth_form,
    _flash_messages,
    _standalone_card,
)
from oridecon.ui import EmailInput, Link, PasswordInput
