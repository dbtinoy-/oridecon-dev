"""Request context for oridecon-admin.

Provides a context manager for request-scoped state that integrates
with oridecon-cache RequestContext for caching and with HTMX patterns.
"""
...
class AdminContext:
    ...
    Attributes:
        ...
        cache_context: oridecon-cache request context
    ...
    def add_flash(
        ...
        *,
        ...
        with full fidelity (see :func:`oridecon.ui.flash_to_toast`).
        """
...
class AdminContextManager:
    ...
    async def __aenter__(self) -> AdminContext:
        ...
        cache_ctx = None
        try:
            from oridecon.primitives.context import RequestContext
