...
from oridecon.admin.config.auth import AdminAuthConfig
from oridecon.admin.config.defaults import (
...
from oridecon.admin.config.features import (
    AdminFeaturesConfig,
    ContributorConfig,
    FrameworkPagesConfig,
)
from oridecon.admin.config.integrations import AdminIntegrationsConfig
from oridecon.admin.config.observability import AdminObservabilityConfig
from oridecon.admin.config.security import (
    AdminAuditConfig,
    AdminRateLimitConfig,
    AdminRbacConfig,
)
from oridecon.admin.config.tenancy import TenancyConfig
from oridecon.admin.config.ui import (
    AdminClustersConfig,
    AdminDataConfig,
    AdminUIConfig,
    DashboardLayoutConfig,
)
from oridecon.admin.constants import ENV_NESTED_DELIMITER, ENV_PREFIX
...
class AdminConfig(BaseConfig):
    ...
    This model represents the full configuration hierarchy for oridecon-admin.
