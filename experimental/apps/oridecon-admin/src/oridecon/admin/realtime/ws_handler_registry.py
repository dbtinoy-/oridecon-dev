...
class PingHandler:
    ...
    async def handle(
        ...
        from oridecon.admin.realtime.websocket import WSMessage, WSMessageType
...
class ActionHandler:
    ...
    async def handle(
        ...
        from oridecon.admin.realtime.websocket import WebSocketHandler
...
class WSMessageTypeRegistry(Registry[Any, WSMessageHandler]):
    ...
    def _default_entries(cls) -> dict[Any, WSMessageHandler]:
        ...
        from oridecon.admin.realtime.websocket import WSMessageType
