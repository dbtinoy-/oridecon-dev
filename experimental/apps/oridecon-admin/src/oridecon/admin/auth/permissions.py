"""Permission definitions and checks for oridecon-admin.

Integrates with oridecon-auth authorization_service for RBAC.
...
from oridecon.contracts.auth.guard import AuthorizerProtocol as AuthorizationService
