...
class AdminEmailVerificationStoreProtocol(Protocol):
    ...
    Implementations:
        - :class:`~oridecon.admin.auth.store.email_verification_sql.AdminEmailVerificationSqlStore`
    """
...
class AdminEmailVerificationServiceProtocol(Protocol):
    ...
    Implementations:
        - :class:`~oridecon.admin.auth.services.email_verification_service.AdminEmailVerificationService`
    """
