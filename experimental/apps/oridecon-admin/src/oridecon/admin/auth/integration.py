"""Auth integration for oridecon-admin.
...
CROSS-EXT-02: Uses protocols from oridecon-contracts for dependency injection,
eliminating direct cross-extension imports from oridecon-auth.
"""
...
from oridecon.contracts import AuthenticatedUserProtocol as AuthenticatedUserProtocol
