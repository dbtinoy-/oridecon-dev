...
from oridecon.admin.sql_dialect import now_expr
...
SCHEMA_SOURCE_MODULES: tuple[str, ...] = (
    "oridecon.admin.auth.store.login_attempt_sql",
    "oridecon.admin.auth.store.lockout_sql",
    "oridecon.admin.auth.store.audit_log_sql",
    "oridecon.admin.auth.store.password_reset_token_sql",
    "oridecon.admin.auth.store.mfa_sql",
    "oridecon.admin.auth.store.email_verification_sql",
    "oridecon.admin.auth.store.email_otp_sql",
    "oridecon.admin.rbac.roles_sql",
)
