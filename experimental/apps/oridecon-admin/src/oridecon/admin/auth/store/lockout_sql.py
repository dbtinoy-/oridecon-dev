...
``oridecon.admin.auth.protocols`` — never on this class directly.
"""
...
if TYPE_CHECKING:
    from oridecon.admin.auth.types import AdminLockoutInfo

from oridecon.admin.auth.types import AdminLockoutStatus
