...
from oridecon.admin.config import AdminEmailVerificationConfig
        ...
        if self._notification_service is None:
            ...
            return Err(
                AdminAuthError(
                    ...
                    "mailer backend (oridecon-notification MailerModule with "
        ...
        if result.is_err():
            ...
            return Err(
                AdminAuthError(
                    ...
                    "(oridecon-notification MailerModule with driver "
