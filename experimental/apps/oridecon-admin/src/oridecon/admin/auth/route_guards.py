"""Route-level auth guards and decorators for oridecon-admin.
...
from oridecon.admin.auth.permissions import PermissionSet, get_user_permissions
from oridecon.admin.exceptions import ErrorCode, PermissionDeniedError
from oridecon.contracts import AuthorizerProtocol
from oridecon.contracts.web import RequestProtocol
