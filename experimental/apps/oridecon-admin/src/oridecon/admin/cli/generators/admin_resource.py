"""Admin Resource generator for oridecon-admin module."""
...
from oridecon.codegen import FieldSpec, parse_fields
from oridecon.codegen.base import GenerationResult, GeneratorBase
from oridecon.contracts.cli.generators import resolve_options


class AdminResourceGenerator(GeneratorBase):
    """Generates an admin resource for the oridecon-admin module."""
