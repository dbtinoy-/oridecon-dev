...
class AdminCliContributor:
    """CLI contributor for the oridecon-admin package."""
    ...
    def get_generators(self) -> list[GeneratorDefinition]:
        ...
        return [
            GeneratorDefinition(
                ...
                contributor="admin",
                generator_path="oridecon.admin.cli.generators.admin_action:AdminActionGenerator",
            ...
            GeneratorDefinition(
                ...
                contributor="admin",
                generator_path="oridecon.admin.cli.generators.admin_resource:AdminResourceGenerator",
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.admin.cli.commands.search:create_app",
                contributor="admin",
                category="admin",
            ),
        ]
    ...
    def get_schema_setup(self) -> list[SchemaSetupContribution]:
        ...
        return [
            SchemaSetupContribution(
                ...
                setup_fn_path="oridecon.admin.cli.schema_setup:ensure_tenant_configs",
