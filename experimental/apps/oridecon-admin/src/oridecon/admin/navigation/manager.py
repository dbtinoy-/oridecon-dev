...
from oridecon.admin.clusters import ClusterRegistry
from oridecon.admin.navigation.types import MenuItem
...
class NavigationManager:
    ...
    def clusters(self) -> list[Any]:
        ...
        Returns:
            List of :class:`~oridecon.admin.clusters.Cluster` instances.
        """
