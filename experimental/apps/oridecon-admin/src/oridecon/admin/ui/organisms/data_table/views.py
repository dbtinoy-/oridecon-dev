...
class ViewStrategyRegistry(StrategyRegistry):
    ...
    def default_strategies(cls) -> dict[str, type]:
        ...
        from oridecon.admin.ui.organisms.table.views.calendar import CalendarView
        from oridecon.admin.ui.organisms.table.views.grid import GridView
        from oridecon.admin.ui.organisms.table.views.stacked import StackedView
        from oridecon.admin.ui.organisms.table.views.tabular import TabularView
