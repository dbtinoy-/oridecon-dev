...
from oridecon.admin.ui.organisms.data_table.view_controls import (
    DATA_VIEW_OPTIONS,
    controls_for,
)
...
class TableToolbar(Component):
    ...
    def render_header(self, bulk_actions: list[Any] | None = None) -> Any:
        ...
        for action in self.config.header_actions:
            ...
            # Old-style (oridecon.ui) header action: inject default create URL
            # and render via the shared old/new action bridge.
            from oridecon.ui import Action as OldActionBase
            ...
            from oridecon.admin.actions.types import ActionContext as _ActionContext
