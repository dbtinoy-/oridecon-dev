    ...
    def render(self) -> Any:
        ...
        if isinstance(self.filters, list):
            ...
            for f in self.filters:
                ...
                # Schema fields (from oridecon.admin.schema) use render_filter.
        ...
        from oridecon.admin.ui.filters.types import SelectFilter, ToggleFilter
        from oridecon.ui import TextInput
