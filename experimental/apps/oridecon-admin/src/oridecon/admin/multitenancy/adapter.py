"""Adapters that delegate admin multitenancy to oridecon-tenancy.

When ``oridecon-tenancy`` is installed, ``TenantProviderRegistry`` wraps a
...
async def resolve_tenant_id(
    ...
    *,
    ...
    """Resolve tenant ID from a request, delegating to ``oridecon-tenancy``
