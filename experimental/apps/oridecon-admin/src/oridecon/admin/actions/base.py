"""Action base classes for oridecon-admin.
...
from oridecon.admin.actions.exceptions import ActionError, PermissionDenied
...
class BulkAction(Action[list[Any], Any]):
    ...
    """Name of the task runner to use when dispatching via oridecon-tasks."""
