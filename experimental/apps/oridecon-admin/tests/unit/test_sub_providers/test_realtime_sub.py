...
class TestAdminRealtimeSubProvider:
    ...
    async def test_boot_wires_inbox_hook_to_hub(self, sub_provider):
        ...
        from oridecon.contracts.notification.inbox import INBOX_SENT_HOOK, InboxMessage
        from oridecon.hooks.ambient import fire
        from oridecon.hooks.ambient import use as use_hooks
