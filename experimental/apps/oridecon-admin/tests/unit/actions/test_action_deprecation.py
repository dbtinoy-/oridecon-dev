...
def test_old_action_can_be_instantiated() -> None:
    ...
    from oridecon.ui.actions.base import Action
...
def test_old_bulk_action_can_be_instantiated() -> None:
    ...
    from oridecon.ui.actions.base import BulkAction
...
def test_old_edit_action_can_be_instantiated() -> None:
    ...
    from oridecon.ui.actions.standard import EditAction
...
def test_old_delete_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import DeleteAction
...
def test_old_create_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import CreateAction
...
def test_old_view_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import ViewAction
...
def test_old_export_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import ExportAction
...
def test_old_delete_bulk_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import DeleteBulkAction
...
def test_old_export_bulk_action_defaults() -> None:
    ...
    from oridecon.ui.actions.standard import ExportBulkAction
