...
from oridecon.admin.auth.guards import AuthGuardMiddleware
...
class TestPermissionGuard:
    ...
    async def test_unauthenticated_returns_err(self):
        from oridecon.admin.auth.guards import PermissionGuard
    ...
    async def test_user_with_permission_returns_ok(self):
        from oridecon.admin.auth.guards import PermissionGuard
        from oridecon.admin.auth.permissions import PermissionSet
...
class TestRoleGuard:
    @pytest.mark.asyncio
    async def test_unauthenticated_returns_err(self):
        from oridecon.admin.auth.guards import RoleGuard
        from oridecon.admin.exceptions import PermissionDeniedError
...
class TestCompositeGuard:
    ...
    async def test_and_logic_all_pass_returns_ok(self):
        from oridecon.admin.auth.guards import (
            CompositeGuard,
            PermissionGuard,
            RoleGuard,
        )
