...
from oridecon.contracts.admin.widget_content import MessageContent
...
class TestWidgetControllerTenantScoping:
    ...
    async def test_widget_config_popup_uses_resolved_tenant(self) -> None:
        ...
        import oridecon.admin.controllers.widgets as widgets_module
        from oridecon.admin.multitenancy.adapter import resolve_tenant_id as original
