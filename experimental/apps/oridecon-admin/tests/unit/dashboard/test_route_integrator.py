...
from oridecon.admin.dashboard.page_handlers import _resolve_primary_color
from oridecon.admin.dashboard.route_integrator import (
    RouteIntegrator,
)
from oridecon.contracts.admin import AdminRouteSpec, BaseAdminContributor
...
class TestRouteIntegrator:
    ...
    def test_collision_error_raises(self) -> None:
        ...
        from oridecon.admin.dashboard.naming_policy import NameCollisionError
...
class TestClusterAliases:
    ...
    def test_real_page_route_is_aliased_under_cluster_namespace(self) -> None:
        ...
        from oridecon.admin.navigation.clusters import CLUSTER_GROUP
        ...
        from oridecon.admin.dashboard.page_handlers import StructuredPageHandler
    ...
    def test_placeholder_route_is_aliased_under_cluster_namespace(self) -> None:
        from oridecon.admin.core.routing import AdminRouter
        from oridecon.admin.navigation.clusters import CLUSTER_GROUP
        from oridecon.contracts.admin import NavigationContribution
...
class TestRegisterSettingsContext:
    def test_settings_panel_wrapper_receives_mount_aware_settings_url(self) -> None:
        from oridecon.admin.dashboard.page_handlers import StructuredPageHandler
        from oridecon.admin.dashboard.route_integrator import _register_settings
        from oridecon.contracts.admin import SettingsPanelDefinition
