...
from oridecon.admin.auth.adapter import AdminAuthAdapter
from oridecon.auth.authn.security import PasswordHasher
from oridecon.auth.di import AuthenticationProvider
from oridecon.contracts.auth import AuthProviderProtocol, PasswordHasherProtocol
...
async def test_delete_user_via_adapter_deletes_user():
    ...
    hashed_pw = await __import__("oridecon.auth.authn.security", fromlist=["PasswordHasher"]).PasswordHasher().hash("Secure2#")
