...
class TestQuoteIdentifier:
    ...
    def test_valid_identifier(self) -> None:
        from oridecon.admin.data.data_source import _quote_identifier
...
class TestCompatibilityImports:
    ...
    def test_interfaces_init_exports(self) -> None:
        from oridecon.admin.data.data_source import DataSourceBase, SqlDataSource
        assert DataSourceBase is not None
        assert SqlDataSource is not None

    def test_relations_init_exports(self) -> None:
        from oridecon.admin.relations import AbstractRelationManager
