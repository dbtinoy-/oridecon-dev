...
from oridecon.admin.auth.services.delegating_auth_adapter import (
...
class TestAuthenticateAdmin:
    ...
    async def test_invalid_credentials_returns_err(self) -> None:
        from oridecon.contracts.exceptions.domain import AuthenticationError
    ...
    async def test_lockout_rejects(self) -> None:
        from oridecon.admin.auth.errors import AccountLockedError
