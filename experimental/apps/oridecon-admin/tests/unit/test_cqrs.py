...
from oridecon.admin.cqrs.queries import (
    AdminQuery,
    GetAdminUser,
    GetAuditLog,
    GetDashboardStats,
...
class TestCommandDataclasses:
    ...
    def test_cqrs_init_re_exports_admin_command(self) -> None:
        ...
        from oridecon.admin.cqrs import AdminCommand as CqrsCommand
...
class TestQueryDataclasses:
    ...
    def test_admin_query_re_exported_via_cqrs(self) -> None:
        ...
        from oridecon.admin.cqrs import AdminQuery as CqrsQuery
