...
from oridecon.admin.actions.base import BulkAction
from oridecon.admin.actions.standard import DeleteAction, DeleteBulkAction, EditAction
from oridecon.admin.actions.types import ActionContext
from oridecon.admin.resources.config import TableConfiguration
from oridecon.admin.resources.list_columns import get_bulk_actions
...
from oridecon.admin.ui.organisms.data_table.actions import (
    normalize_action,
...
def test_bulk_csv_action_uses_native_download_submission():
    from oridecon.admin.actions.standard import ExportBulkAction
    ...
    assert "OrideconDownloadBulk" in rendered
