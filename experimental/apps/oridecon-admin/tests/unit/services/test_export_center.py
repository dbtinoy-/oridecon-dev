...
from oridecon.admin.services.export.pages import (
    EXPORT_PAGE_FORMATS,
    ExportCenter,
    _human_size,
...
class TestFormatAvailability:
    ...
    def test_flags_read_at_call_time(self, monkeypatch):
        from oridecon.admin.services.export import xlsx as xlsx_mod
        from oridecon.admin.services.export.adapters import pdf as pdf_mod
