...
from oridecon.admin.services.filter_manager import FilterManager


@pytest.fixture
def filter_definitions():
    """Create sample filter definitions."""
    from oridecon.admin.ui.filters.types import RangeFilter, SelectFilter, ToggleFilter

    from oridecon.admin.services.filter_manager import FilterDefinition
