...
from oridecon.admin.auth.types import AdminAuthResult
...
def _make_auth_service(
    *, verify_gate: bool = False, mfa_gate: bool = False, complete_ok: bool = True
    ...
    if complete_ok:
        ...
        from oridecon.admin.auth.errors import MfaVerificationFailedError
...
def _make_verification_service(
    *,
    ...
    if verify_ok:
        ...
        from oridecon.admin.auth.errors import EmailVerificationTokenInvalidError
...
def _make_otp_service(*, send_err: bool = False, verify_ok: bool = True) -> MagicMock:
    svc = MagicMock()
    if send_err:
        from oridecon.admin.auth.errors import EmailOtpCooldownError
