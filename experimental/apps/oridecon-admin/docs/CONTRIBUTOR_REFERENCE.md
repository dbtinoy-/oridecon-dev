...
def get_dashboard_widgets(self):
    from oridecon.contracts.admin.types import DashboardWidgetDefinition, WidgetKind
    return [
...
def get_health_definitions(self):
    from oridecon.contracts.admin.types import AdminHealthDefinition
    return [
...
Frozen value type (`oridecon.contracts.admin.health_payload`) returned by
`render_health_check`.
