---
title: oridecon-ai-memory Troubleshooting
...
```python
from oridecon.contracts.ai.memory import MemoryStoreProtocol

assert isinstance(backend, MemoryStoreProtocol)
```

**Exception:** `oridecon.ai.memory.exceptions.MemoryStoreError`
...
```python
from oridecon.ai.memory.exceptions import MemoryCapacityError
...
**Exception:** `oridecon.ai.memory.exceptions.MemoryCapacityError`
...
**Exception:** `oridecon.ai.memory.exceptions.EmbeddingError`
...
**Exception:** `oridecon.ai.memory.exceptions.FactExtractionError`
