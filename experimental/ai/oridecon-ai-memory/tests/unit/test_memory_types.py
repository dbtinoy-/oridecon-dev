...
class TestMemoryTypesImports:
    ...
    def test_imports_memory_entry(self) -> None:
        from oridecon.ai.memory.types import MemoryEntry
        from oridecon.contracts.ai.memory import MemoryEntry as ContractEntry
        assert MemoryEntry is ContractEntry

    def test_imports_memory_query(self) -> None:
        from oridecon.ai.memory.types import MemoryQuery
        from oridecon.contracts.ai.memory import MemoryQuery as ContractQuery
        assert MemoryQuery is ContractQuery

    def test_imports_memory_search_result(self) -> None:
        from oridecon.ai.memory.types import MemorySearchResult
        from oridecon.contracts.ai.memory import MemorySearchResult as ContractResult
        assert MemorySearchResult is ContractResult

    def test_imports_consolidation_result(self) -> None:
        from oridecon.ai.memory.types import ConsolidationResult
        from oridecon.contracts.ai.memory import ConsolidationResult as ContractResult
