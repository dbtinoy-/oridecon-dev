"""Exceptions for oridecon-ai-memory."""

from __future__ import annotations

from oridecon.contracts.ai.exceptions import AIMemoryError as _ContractsAIMemoryError
from oridecon.contracts.ai.memory import ConsolidationError


class MemorySystemError(_ContractsAIMemoryError):
    """Base exception for memory operations."""

    _code: str = "ORI_ERR_MEM_005"


class MemoryStoreError(MemorySystemError):
    """Raised when a backend store operation fails."""

    _code: str = "ORI_ERR_MEM_006"
