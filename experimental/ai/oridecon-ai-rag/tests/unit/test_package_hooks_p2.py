"""P2 hook surface import verification for oridecon-ai-rag."""
...
def test_rag_hooks_root_module_exists() -> None:
    ...
    assert oridecon.ai.rag.RAGPipelineStartedHook is RAGPipelineStartedHook
    assert oridecon.ai.rag.RAGDocumentsRetrievedHook is RAGDocumentsRetrievedHook
    assert oridecon.ai.rag.RAGAnswerSynthesizedHook is RAGAnswerSynthesizedHook
