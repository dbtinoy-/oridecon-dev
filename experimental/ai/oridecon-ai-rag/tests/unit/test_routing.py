"""Unit tests for oridecon-ai-rag routing."""
...
from oridecon.ai.rag.routing.types import DataSource, DataSourceType, QueryIntent
...
class TestQueryAnalyzer:
    ...
    async def test_detect_entities(self) -> None:
        ...
        analyzer = QueryAnalyzer()
        features = await analyzer.analyze("What is Oridecon?")
...
class TestRoutingStatistics:
    ...
    def test_statistics_update(self) -> None:
        ...
        from oridecon.ai.rag.routing.types import RoutingDecision
