...
class TestImageLoader:
    ...
    @patch("oridecon.ai.rag.multimodal.loaders.image.Image")
    @pytest.mark.asyncio
    ...
    @patch("oridecon.ai.rag.multimodal.loaders.image.PIL_AVAILABLE", False)
    ...
    def test_extract_text_with_mocked_pytesseract(self):
        ...
        from oridecon.ai.rag.multimodal.loaders import image as image_mod
