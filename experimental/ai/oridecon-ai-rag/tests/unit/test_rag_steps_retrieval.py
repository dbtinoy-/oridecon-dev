"""Retrieval/generation tests for oridecon.ai.rag.steps."""

from unittest.mock import AsyncMock, MagicMock

import pytest

from oridecon.ai.llm.types import Completion, Role
from oridecon.ai.rag.steps.core import (
    GenerateAnswerStep,
    RetrieveContextStep,
    TranslationStep,
)
from oridecon.ai.rag.types import Chunk
from oridecon.contracts.ai.vector import Document
from oridecon.contracts.ai.vector import RAGSearchResult as SearchResult
from oridecon.primitives.pipeline import PipelineContext
