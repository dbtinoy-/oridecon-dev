...
from oridecon.ai.rag.multimodal import (
    AudioLoader,
    CLIPEmbedding,
    CrossModalRetriever,
    ImageDocument,
...
class TestAudioLoader:
    ...
    @patch("oridecon.ai.rag.multimodal.loaders.audio.LIBROSA_AVAILABLE", False)
    ...
    @patch("oridecon.ai.rag.multimodal.loaders.audio.LIBROSA_AVAILABLE", True)
    @pytest.mark.asyncio
...
class TestVideoLoader:
    ...
    @patch("oridecon.ai.rag.multimodal.loaders.video.CV2_AVAILABLE", False)
    def test_requires_opencv(self):
        """Test that OpenCV is required."""
        with pytest.raises(ImportError, match="opencv-python is required"):
            VideoLoader()

    @patch("oridecon.ai.rag.multimodal.loaders.video.CV2_AVAILABLE", True)
    @patch("oridecon.ai.rag.multimodal.loaders.image.PIL_AVAILABLE", True)
    @patch("oridecon.ai.rag.multimodal.loaders.video.cv2")
    @pytest.mark.asyncio
...
class TestCLIPEmbedding:
    ...
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.CLIP_AVAILABLE", False)
    ...
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.CLIP_AVAILABLE", True)
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.CLIPModel")
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.CLIPProcessor")
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.torch")
    @pytest.mark.asyncio
    ...
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.CLIPProcessor")
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.torch")
    @patch("oridecon.ai.rag.multimodal.embeddings.clip.Image")
    @pytest.mark.asyncio
...
class TestMultiModalEmbedder:
    ...
    @patch("oridecon.ai.rag.multimodal.embeddings.multimodal.CLIPEmbedding")
    @pytest.mark.asyncio
