...
from oridecon.ai.rag.evaluation.types import MetricType, RAGEvaluationReport
from oridecon.contracts.ai.rag import RAGContext, RAGPipelineProtocol
...
class RAGBenchmark:
    ...
    async def _evaluate_one(
        ...
        if eval_report.get_metric(MetricType.LATENCY) is None:
            from oridecon.ai.rag.evaluation.types import EvaluationResult
