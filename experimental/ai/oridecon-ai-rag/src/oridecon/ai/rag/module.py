...
class RAGModule(Module):
    ...
    Exports:
        :class:`~oridecon.contracts.ai.rag.RAGPipelineProtocol`,
        :class:`~oridecon.contracts.ai.rag.RetrievalStrategyProtocol`,
        :class:`~oridecon.ai.rag.exceptions.RAGError`,
        :class:`~oridecon.ai.rag.exceptions.PreprocessingError`,
        :class:`~oridecon.ai.rag.exceptions.RetrievalError`,
        :class:`~oridecon.ai.rag.exceptions.SynthesisError`,
        :class:`~oridecon.ai.rag.exceptions.ChunkingError`
    """
    ...
    def configure(cls, config: RAGConfig | None = None) -> DynamicModule:
        ...
        Args:
            config: :class:`~oridecon.ai.rag.config.RAGConfig` or ``None``
