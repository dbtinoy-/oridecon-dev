...
from oridecon.contracts import ChatMessage

if TYPE_CHECKING:
    from oridecon.contracts import LLMClientProtocol
...
"""
    ...
    def _parse_reasoning_response(self, response: Any, hop: int) -> dict:
        ...
        from oridecon.ai.rag.reasoning.parsers import parse_reasoning_response_text
