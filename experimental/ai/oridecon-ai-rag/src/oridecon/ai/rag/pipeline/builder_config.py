"""Fluent configuration wiring for :class:`~oridecon.ai.rag.pipeline.builder.PipelineBuilder`.
...
from oridecon.contracts.ai.rag import RAGEvaluatorProtocol
...
class PipelineConfigWiring:
    ...
    (:class:`~oridecon.ai.rag.config.PipelineConfig`), ``self._custom_stages``
