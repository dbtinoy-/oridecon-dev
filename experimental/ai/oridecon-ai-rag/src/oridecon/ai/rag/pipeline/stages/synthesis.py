...
from oridecon.ai.rag.synthesis.synthesizers.base import ResponseSynthesizerProtocol

if TYPE_CHECKING:
    from oridecon.contracts.ai import LLMClientProtocol

from oridecon.ai.rag.config import SynthesisConfig
from oridecon.ai.rag.pipeline.types import PipelineContext
from oridecon.ai.rag.synthesis import (
