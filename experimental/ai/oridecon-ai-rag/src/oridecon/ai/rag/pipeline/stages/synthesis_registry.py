...
if TYPE_CHECKING:
    from oridecon.ai.rag.synthesis.types import SynthesisStrategy
...
class DirectSynthesisStrategyHandler:
    ...
    def can_handle(self, strategy: SynthesisStrategy) -> bool:
        from oridecon.ai.rag.pipeline.stages.synthesis import SynthesisStrategy
    ...
    def create_synthesizer(
        ...
        from oridecon.ai.rag.pipeline.stages.synthesis import DirectSynthesizer
...
class ExtractiveSynthesisStrategyHandler:
    ...
    def create_synthesizer(
        ...
        from oridecon.ai.rag.pipeline.stages.synthesis import ExtractiveSynthesizer
...
class AbstractiveSynthesisStrategyHandler:
    ...
    def create_synthesizer(
        ...
        from oridecon.ai.rag.pipeline.stages.synthesis import (
