...
imported from `oridecon.ai.rag.knowledge_graph`.
"""
...
class KnowledgeGraphBuilder:
    ...
    async def build_from_text(self, text: str) -> KnowledgeGraph:
        try:
            ...
            public_kg = getattr(
                importlib.import_module("oridecon.ai.rag.knowledge_graph"),
                "KnowledgeGraph",
                None,
            )
    ...
    async def build_from_documents(
        ...
        if merge:
            ...
            try:
                ...
                _pkg_mod = importlib.import_module("oridecon.ai.rag.knowledge_graph")
