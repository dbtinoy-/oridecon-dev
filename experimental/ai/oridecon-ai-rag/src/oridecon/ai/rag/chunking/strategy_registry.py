...
Maps :class:`~oridecon.ai.rag.chunking.types.ChunkingStrategy` enum values
...
from oridecon.ai.rag.chunking.types import ChunkingConfig, ChunkingStrategy
...
class ChunkingStrategyRegistry(StrategyRegistry):
    ...
    def default_strategies(cls) -> dict[str, type]:
        ...
        from oridecon.ai.rag.chunking.strategies.sliding_window import (
