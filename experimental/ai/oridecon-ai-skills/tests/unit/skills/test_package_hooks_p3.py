"""P3 hook surface import verification for oridecon-ai-skills."""
...
def test_skills_hooks_root_module_exists() -> None:
    ...
    assert oridecon.ai.skills.SkillRegisteredHook is SkillRegisteredHook
    assert oridecon.ai.skills.SkillExecutedHook is SkillExecutedHook
    assert (
        oridecon.ai.skills.SkillExecutionFailedHook is SkillExecutionFailedHook
    )
