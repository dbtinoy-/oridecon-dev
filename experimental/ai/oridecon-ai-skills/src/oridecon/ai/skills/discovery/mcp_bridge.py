"""MCPSkillBridge — bidirectional bridge between MCP tools and Oridecon skills."""
...
class MCPSkillBridge:
    """Import MCP tools as Oridecon skills and export skills as MCP tools.
    ...
    Note:
        The MCP integration uses :mod:`oridecon.ai.mcp` when available.
