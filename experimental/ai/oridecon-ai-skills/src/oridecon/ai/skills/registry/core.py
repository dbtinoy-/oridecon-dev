...
from oridecon.ai.skills.exceptions import SkillAlreadyRegisteredError
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.ai.skills import SkillDefinition, SkillProtocol
...
class SkillRegistry:
    ...
    def register_tool(self, tool: ToolProtocol) -> None:
        """Wrap *tool* as a :class:`~oridecon.ai.skills.base.ToolSkillAdapter` and register it.

        Args:
            tool: Any object satisfying ToolProtocol.
        """
        from oridecon.ai.skills.base import ToolSkillAdapter
