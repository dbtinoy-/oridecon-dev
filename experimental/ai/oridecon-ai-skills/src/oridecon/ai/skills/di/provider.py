...
_BUILTIN_MAP: dict[str, str] = {
    "current_datetime": "oridecon.ai.skills.builtin.datetime_skill.DateTimeSkill",
    "math_calculate": "oridecon.ai.skills.builtin.math_skill.MathSkill",
    "text_summarize": "oridecon.ai.skills.builtin.text_processing.TextSummarizeSkill",
    "text_translate": "oridecon.ai.skills.builtin.text_processing.TextTranslateSkill",
    "web_search": "oridecon.ai.skills.builtin.web_search.WebSearchSkill",
    "http_request": "oridecon.ai.skills.builtin.http_request.HTTPRequestSkill",
    "file_read": "oridecon.ai.skills.builtin.file_operations.FileReadSkill",
    "file_write": "oridecon.ai.skills.builtin.file_operations.FileWriteSkill",
    "code_execute": "oridecon.ai.skills.builtin.code_execution.CodeExecutionSkill",
}
...
class SkillsProvider(Provider):
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.ai.skills.caching.skill_cache import SkillResultCache
        from oridecon.ai.skills.executor import SkillExecutor
        from oridecon.ai.skills.permissions.permission_checker import PermissionChecker
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        if self._config.enable_skill_sources:
            ...
            from oridecon.ai.skills.discovery.skill_source_scanner import (
                SkillSourceScanner,
            )
