...
from oridecon.ai.skills.base import BaseSkill
from oridecon.ai.skills.exceptions import SkillExecutionError
from oridecon.contracts.ai.skills import SkillDefinition, SkillError, SkillResult
...
class HTTPRequestSkill(BaseSkill):
    ...
    integrate with the ``oridecon-http`` ``HTTPClientProtocol``.
