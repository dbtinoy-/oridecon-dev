...
from oridecon.ai.skills.exceptions import SkillRoutingError
...
if TYPE_CHECKING:
    from oridecon.contracts.ai.skills import SkillError, SkillResult
...
class ConditionalSkill:
    ...
    Unlike :class:`~oridecon.ai.skills.composition.router.SkillRouter`, which
    ...
    :class:`~oridecon.ai.skills.exceptions.SkillRoutingError` is returned
    wrapped in ``Err``.
    """
