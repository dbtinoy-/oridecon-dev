...
Internal design of the `oridecon-ai-skills` package.

---

## Role in the System

oridecon-ai-skills provides the skill framework for AI capabilities. It defines how skills are declared, registered, discovered, and executed within the Oridecon AI subsystem.
...
Frozen dataclass in `oridecon.contracts.ai.skills` that captures a skill's contract:
...
From `oridecon.contracts.ai.skills`:
