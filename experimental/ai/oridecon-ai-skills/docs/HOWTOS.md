---
title: oridecon-ai-skills How-tos
...
```python
from oridecon.ai.skills import SkillRegistry, SkillExecutor
...
```python
from oridecon.ai.skills import SkillChain, SkillRegistry, SkillExecutor
...
```python
from oridecon.ai.skills import validate_params
...
```python
from oridecon.ai.skills import ParallelSkills, SkillRegistry, SkillExecutor
...
result = await pipeline.execute(executor, {"raw_text": "Hello from Oridecon!"})
...
```python
from oridecon.ai.skills import SkillRegistry, ModuleScanner
