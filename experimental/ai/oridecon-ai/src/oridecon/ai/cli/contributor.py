...
class AICliContributor:
    """CLI contributor for the oridecon-ai package."""
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.ai.cli.commands:create_ai_app",
                contributor="ai",
                category="ai",
    ...
    def get_health_checks(self) -> list[HealthCheckContribution]:
        ...
        return [
            HealthCheckContribution(
                ...
                check_path="oridecon.ai.cli.checks:check_llm_provider",
                contributor="ai",
                category="ai",
                timeout=15.0,
            ),
            HealthCheckContribution(
                ...
                check_path="oridecon.ai.cli.checks:check_subsystem_discovery",
                contributor="ai",
                category="ai",
                timeout=5.0,
            ),
    ...
    def get_doctor_checks(self) -> list[DoctorCheckContribution]:
        ...
        return [
            DoctorCheckContribution(
                ...
                check_path="oridecon.ai.cli.doctor:check_ai_api_keys",
                contributor="ai",
                category="ai",
            ),
        ]
    ...
    def get_shell_context(self) -> list[ShellContextContribution]:
        ...
        return [
            ShellContextContribution(
                ...
                factory_path="oridecon.ai.cli.shell:provide_ai_client",
                contributor="ai",
            ),
        ]
