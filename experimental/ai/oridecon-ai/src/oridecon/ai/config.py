"""Configuration schemas for Oridecon Intelligence.
...
Example:
    ...
    # From environment
    config = AIConfig()  # reads ORI_AI__* env vars
"""
...
from oridecon.ai import constants as const
...
class AIConfig(BaseConfig):
    """Complete configuration for Oridecon Intelligence.
    ...
    def get_provider_class(cls) -> type[ProviderProtocol]:
        ...
        from oridecon.ai import AIProvider
            ...
            if self.llm and self.llm.api_key:
                ...
                if any(
                    ...
                    raise ValueError(
                        ...
                        "You MUST set a valid API key via ORI_AI_LLM__API_KEY.",
                    )
        return self
...
try:
    # RAG pipeline detail configs — available when oridecon-ai-rag is installed
