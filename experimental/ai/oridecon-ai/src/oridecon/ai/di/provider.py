"""Intelligence Provider for Oridecon Framework dependency injection.

This module defines the main provider class that integrates Oridecon AI
with the Oridecon Framework's dependency injection system.
"""
...
if TYPE_CHECKING:
    ...
    from oridecon.ai.observability.metrics import AIMetrics
...
class AIProvider(Provider, AIProviderProtocol):
    """Provider for registering Intelligence services with Oridecon DI container.
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        "oridecon.ai.subsystems" entry point. Delegates LLM, Vector, and
        RAG service registration to the respective sub-providers.

        Args:
            container: The Oridecon DI container
        """
        logger.info("Registering Oridecon AI services with container")
        ...
        from oridecon.ai.observability.metrics import AIMetrics
        from oridecon.ai.observability.tracing import AITracer
        from oridecon.contracts.ai.callbacks import CallbackManagerProtocol
        ...
        # Packages that declare the "oridecon.ai.subsystems" entry-point
        ...
        try:
            ...
            for _ep in _entry_points(group="oridecon.ai.subsystems"):
        ...
        logger.info("Oridecon AI services registered successfully")
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        """
        logger.info("Starting Oridecon AI provider")
        ...
        logger.info("Oridecon AI provider started successfully")

    async def shutdown(self) -> None:
        """Clean up resources on application shutdown."""
        logger.info("Shutting down Oridecon AI provider")
        ...
        logger.info("Oridecon AI provider shutdown complete")
