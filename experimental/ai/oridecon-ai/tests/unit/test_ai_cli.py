"""Tests for oridecon-ai CLI modules.

Covers:
    - oridecon.ai.cli.checks     (check_llm_provider, check_subsystem_discovery)
    - oridecon.ai.cli.commands   (create_ai_app)
    - oridecon.ai.cli.contributor (AICliContributor)
    - oridecon.ai.cli.doctor     (check_ai_api_keys)
    - oridecon.ai.cli.shell      (provide_ai_client)
    - oridecon.ai.decorators     (import coverage)
    - oridecon.ai.events         (import coverage)
    - oridecon.ai.hooks          (import coverage)
    - oridecon.ai.protocols      (import coverage)
    - oridecon.ai.module         (AIModule.stub)
"""
...
class TestCLIChecks:
    """Tests for oridecon.ai.cli.checks."""
    ...
    async def test_check_llm_provider_returns_healthy_dict(self) -> None:
        ...
        from oridecon.ai.cli.checks import check_llm_provider
    ...
    async def test_check_subsystem_discovery_returns_healthy_dict(self) -> None:
        ...
        from oridecon.ai.cli.checks import check_subsystem_discovery
    ...
    async def test_checks_accept_any_container_object(self) -> None:
        ...
        from oridecon.ai.cli.checks import check_llm_provider, check_subsystem_discovery
...
class TestCLICommands:
    """Tests for oridecon.ai.cli.commands.create_ai_app."""
    ...
    def test_create_ai_app_returns_typer_app(self) -> None:
        ...
        from oridecon.ai.cli.commands import create_ai_app
...
class TestAICliContributor:
    ...
    def test_contributor_id_returns_ai(self) -> None:
        ...
        from oridecon.ai.cli.contributor import AICliContributor
...
class TestCLIShell:
    """Tests for oridecon.ai.cli.shell.provide_ai_client."""
    ...
    async def test_provide_ai_client_calls_container_resolve(self) -> None:
        ...
        from oridecon.ai.cli.shell import provide_ai_client
...
class TestStubModules:
    ...
    def test_decorators_module_importable(self) -> None:
        """oridecon.ai.decorators can be imported without error."""
        import oridecon.ai.decorators  # noqa: F401

    def test_events_module_importable(self) -> None:
        """oridecon.ai.events can be imported without error."""
        import oridecon.ai.events  # noqa: F401

    def test_hooks_module_importable(self) -> None:
        """oridecon.ai.hooks can be imported without error."""
        import oridecon.ai.hooks  # noqa: F401

    def test_protocols_module_importable(self) -> None:
        """oridecon.ai.protocols can be imported without error."""
        import oridecon.ai.protocols  # noqa: F401
...
class TestAIModuleStub:
    ...
    def test_stub_exports_ai_provider_protocol(self) -> None:
        ...
        from oridecon.ai.module import AIModule
        from oridecon.contracts.ai import AIProviderProtocol
