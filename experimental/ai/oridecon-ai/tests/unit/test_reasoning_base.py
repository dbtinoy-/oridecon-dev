...
from oridecon.ai.rag.reasoning import IterativeRefinementReasoner
...
def test_canonical_import_paths():
    ...
    from oridecon.ai.rag.reasoning.base import ReasoningResult as BR
    ...
    from oridecon.ai.rag.reasoning import IterativeRefinementReasoner as IRR
