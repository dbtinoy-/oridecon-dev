"""Tests for oridecon.intelligence.exceptions module."""
...
from oridecon.contracts.ai.exceptions import RAGError as ContractsRAGError

# Base alias for backward compat
IntelligenceError = OrideconError
...
class TestExceptionHierarchy:
    ...
    def test_base_exception_inheritance(self):
        """Test that IntelligenceError inherits from OrideconError."""
    ...
    def test_vector_store_exceptions_inheritance(self):
        ...
        assert issubclass(VectorStoreError, OrideconError)
    ...
    def test_rag_exceptions_inheritance(self):
        ...
        assert issubclass(RAGError, OrideconError)
    ...
    def test_multimodal_exceptions_inheritance(self):
        ...
        assert issubclass(MultimodalError, OrideconError)
