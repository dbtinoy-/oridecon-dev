...
async def test_rag_pipeline_advanced_flow() -> None:
    ...
    try:
        from oridecon.ai.rag.pipeline.base import RAGPipeline
    except ImportError:
        pytest.skip("oridecon-ai-rag not installed")
...
async def test_retrieval_stage_branches() -> None:
    ...
    try:
        ...
        from oridecon.ai.rag.config import RetrievalConfig
    except ImportError:
        pytest.skip("oridecon-ai-rag not installed")
...
async def test_context_processing_branches() -> None:
    ...
    try:
        ...
        from oridecon.ai.rag.query.pipeline import QueryPipeline
    except ImportError:
        pytest.skip("oridecon-ai-rag query pipeline not found")
