...
from oridecon.ai.rag.knowledge_graph import (
    Entity,
    EntityType,
    Relationship,
    RelationshipType,
...
try:
    from oridecon.ai.llm.clients.mock import MockLLMClient
...
async def populated_graph(sample_entities, sample_relationships):
    ...
    from oridecon.ai.rag.knowledge_graph import KnowledgeGraph
