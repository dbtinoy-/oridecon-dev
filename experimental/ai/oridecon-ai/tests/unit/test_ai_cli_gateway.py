...
class TestLoadGatewayConfig:
    ...
    def test_json_config_round_trip(self, tmp_path: Path) -> None:
        from oridecon.ai.cli.gateway import load_gateway_config
...
class TestBuildGatewayApp:
    ...
    def test_composes_expected_modules(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from oridecon.ai.cli import gateway as gateway_cli
        ...
        assert captured == [
            ("oridecon.ai.modules", "relay"),
            ("oridecon.ai.modules", "relay-gateway"),
            ("oridecon.modules", "http"),
            ("oridecon.modules", "web"),
        ]
