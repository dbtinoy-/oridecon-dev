...
from oridecon.ai.rag.multimodal.types import Modality
import pytest
from oridecon.ai.rag.multimodal.types import Modality
...
try:  # noqa: F401
    from oridecon.ai.rag.routing import (
    ...
    pytest.skip(f"oridecon-ai-rag not installed: {e}", allow_module_level=True)
