"""
╔══════════════════════════════════════════════════════════╗
║  Oridecon Tool Calling — every provider, one demo       ║
╚══════════════════════════════════════════════════════════╝
...
from oridecon.ai.llm.docs.gifs.tools.registry import p
from oridecon.ai.llm.docs.gifs.tools.live_examples import (
    example1_live_openai_compat,
    example2_live_native_ollama,
)
from oridecon.ai.llm.docs.gifs.tools.openai_anthropic_wire import (
    example3_openai_family_wire,
    example4_anthropic_wire,
)
from oridecon.ai.llm.docs.gifs.tools.gemini_bedrock_wire import (
