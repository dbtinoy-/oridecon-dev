...
:mod:`oridecon.ai.relay.gateway.job_passthrough` wraps this pipeline
...
from oridecon.ai.relay.gateway.errors import auth_denied, with_request_id
from oridecon.ai.relay.gateway.job_registry import RelayJobRegistry
from oridecon.ai.relay.gateway.job_support import (
    JOB_ENDPOINT_PATHS,
    call_upstream,
    job_not_found_error,
    job_url,
