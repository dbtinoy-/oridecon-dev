...
from oridecon.ai.relay.gateway.web.audio_endpoints import AUDIO_ROUTE_TABLE
from oridecon.ai.relay.gateway.web.image_endpoints import build_image_routes
from oridecon.ai.relay.gateway.web.routes.common import (
    ResolveGateway,
    ResolveJobPassthrough,
    ResolveModelCatalog,
    _with_auth_guard,
)
from oridecon.ai.relay.gateway.web.routes.health import (
    HEALTH_ROUTE_PATH,
    ResolveRelayHealth,
    health_endpoint,
)
from oridecon.ai.relay.gateway.web.routes.jobs import (
    job_status_endpoint,
    job_submit_endpoint,
)
from oridecon.ai.relay.gateway.web.routes.models import (
    model_detail_endpoint,
    models_endpoint,
)
from oridecon.ai.relay.gateway.web.routes.passthrough import passthrough_endpoint
from oridecon.ai.relay.gateway.web.routes.relay import relay_endpoint
from oridecon.ai.relay.gateway.web.routes.tables import (
    _AUDIO_HANDLERS,
    _JOB_ROUTE_TABLE,
    _JOB_STATUS_PATH,
...
from oridecon.ai.relay.gateway.web.shared import ResolvePassthrough
