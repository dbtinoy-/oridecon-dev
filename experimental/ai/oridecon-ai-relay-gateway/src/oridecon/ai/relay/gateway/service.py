...
- :mod:`oridecon.ai.relay.gateway.validation` — request boundary checks.
- :mod:`oridecon.ai.relay.gateway.buffered` — buffered dispatch pipeline.
- :mod:`oridecon.ai.relay.gateway.streaming` — streaming preflight and
  lazy stream consumption with exactly-once settlement.
- :mod:`oridecon.ai.relay.gateway.operations.billing` — admission and
  settlement lifecycle.
- :mod:`oridecon.ai.relay.gateway.operations.upstream` — endpoint URLs,
  model resolution, upstream calls, and failover accounting.
- :mod:`oridecon.ai.relay.gateway.operations.telemetry` — structured
  request events.
...
from oridecon.ai.relay.gateway.buffered import BufferedDispatchMixin
...
from oridecon.ai.relay.gateway.errors import unexpected_error
from oridecon.ai.relay.gateway.operations import telemetry
...
from oridecon.ai.relay.gateway.streaming import StreamingMixin
from oridecon.ai.relay.gateway.upstream import HTTPUpstreamAdapter
from oridecon.ai.relay.gateway.validation import validate_gateway_request
from oridecon.contracts.ai.governance import RelayBillingProtocol
