...
from oridecon.ai.relay.gateway.admin.contributor_actions import (
    ACTIONS as _ACTIONS,
)
from oridecon.ai.relay.gateway.admin.contributor_actions import (
...
from oridecon.ai.relay.gateway.admin.contributor_health import (
    HEALTH_DEFS,
)
from oridecon.ai.relay.gateway.admin.contributor_health import (
    render_health_check as _render_health_check,
)
from oridecon.ai.relay.gateway.admin.contributor_widgets import (
    WIDGETS,
...
from oridecon.contracts.admin.errors import WidgetNotFoundError
...
from oridecon.contracts.exceptions.container import ContainerError
...
class RelayGatewayAdminContributor(BaseAdminContributor):
    ...
    ``oridecon.admin.contributors`` entry point.
    """
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        return [
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.relay.gateway.admin.pages:RelayGatewayOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.relay.gateway.admin.pages:RelayGatewayRoutesPage",
                category=PageCategory.AI,
                icon="activity",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.relay.gateway.admin.pages:RelayGatewayStreamsPage",
                category=PageCategory.AI,
                icon="radio",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.relay.gateway.admin.pages:RelayGatewaySettingsPage",
                category=PageCategory.AI,
                icon="settings",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.relay.gateway.admin.pages:RelayGatewayChannelsPage",
                category=PageCategory.AI,
                icon="server",
