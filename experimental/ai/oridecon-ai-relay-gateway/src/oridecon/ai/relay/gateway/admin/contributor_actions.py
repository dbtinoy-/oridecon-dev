...
ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        handler="oridecon.ai.relay.gateway.admin.actions:set_channel_state",
        icon="toggle-right",
    ...
    AdminActionDefinition(
        ...
        contributor="relay-gateway",
        handler="oridecon.ai.relay.gateway.admin.actions:force_cancel_stream",
        icon="x-circle",
    ...
    AdminActionDefinition(
        ...
        contributor="relay-gateway",
        handler="oridecon.ai.relay.gateway.admin.actions:create_channel",
        icon="plus-circle",
    ...
    AdminActionDefinition(
        ...
        contributor="relay-gateway",
        handler="oridecon.ai.relay.gateway.admin.actions:update_channel",
        icon="pencil",
    ...
    AdminActionDefinition(
        ...
        contributor="relay-gateway",
        handler="oridecon.ai.relay.gateway.admin.actions:delete_channel",
        icon="trash-2",
    ...
    AdminActionDefinition(
        ...
        title="Test Channel",
        contributor="relay-gateway",
        handler="oridecon.ai.relay.gateway.admin.actions:test_channel",
        icon="activity",
