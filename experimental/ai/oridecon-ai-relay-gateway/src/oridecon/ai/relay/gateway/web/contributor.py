...
The gateway package cannot import oridecon-web controller classes, so
...
from oridecon.ai.relay.gateway.web.routes import build_routes
...
class RelayGatewayWebContributor:
    ...
    are contributed (controller classes are oridecon-web types), and the
    ...
    def get_controllers(self) -> list[type[Any]]:
        ...
        Controller classes are oridecon-web types, which the gateway
