...
from oridecon.ai.relay.gateway.admin import actions as relay_actions
from oridecon.ai.relay.gateway.admin.contributor import (
    RelayGatewayAdminContributor,
)
from oridecon.ai.relay.gateway.admin.pages import RelayGatewayChannelsPage
...
class TestContributorRegistration:
    def test_channels_page_registered(self) -> None:
        ...
        assert (
            ...
            == "oridecon.ai.relay.gateway.admin.pages:RelayGatewayChannelsPage"
        )
