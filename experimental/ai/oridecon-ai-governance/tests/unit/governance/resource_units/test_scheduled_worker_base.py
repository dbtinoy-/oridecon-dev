...
:class:`~oridecon.contracts.infra.tasks.TaskManagerProtocol` so governance
never imports ``oridecon.tasks`` (mirrors ``oridecon.monitor``'s
...
from oridecon.contracts.infra.tasks import OnErrorPolicy, TaskManagerProtocol
