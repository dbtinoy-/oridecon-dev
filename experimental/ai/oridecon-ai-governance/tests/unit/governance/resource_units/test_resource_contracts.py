...
pytest.importorskip("oridecon.contracts.ai.governance.resource_unit")
...
class TestResourceExhaustedError:
    def test_is_governance_error(self):
        ...
        from oridecon.contracts.ai.governance import GovernanceError
    ...
    def test_default_code(self):
        ...
        assert exc._code == "ORI_ERR_GOV_010"
