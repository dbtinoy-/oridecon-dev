...
from oridecon.ai.governance.audit import AIAuditEvent, AuditEventType
...
class TestAIGovernanceAdvanced:
    ...
    async def test_redis_persistence_auto_creation(self) -> None:
        ...
        with patch("oridecon.ai.governance.persistence.RedisGovernancePersistence") as mock_redis_p:
