...
:class:`~oridecon.ai.governance.admin.contributor.GovernanceAdminContributor`.
"""
...
_PAGE_DEFS: tuple[ManagementPageDefinition, ...] = (
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.pages:GovernanceRelayUsagePage",
    ...
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.pages:GovernanceQuotasPage",
        category=PageCategory.AI,
        icon="gauge",
    ...
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.pages:GovernanceSettlementsPage",
        category=PageCategory.AI,
        icon="receipt",
    ...
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.logs_pages:RelayRequestLogsPage",
        category=PageCategory.AI,
        icon="list",
        permission=PERMISSION_LOG_READ,
    ...
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.logs_pages:RelayUsageRankingsPage",
        category=PageCategory.AI,
        icon="trending-up",
        permission=PERMISSION_LOG_READ,
    ...
    ManagementPageDefinition(
        ...
        handler="oridecon.ai.governance.admin.ledger_pages:RelayLedgerPage",
        category=PageCategory.AI,
        icon="wallet",
        permission=PERMISSION_LEDGER,
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        title="Settle Top-Up",
        contributor="ai-governance",
        handler="oridecon.ai.governance.admin.ledger_actions:settle_topup",
        icon="check-circle",
    ...
    AdminActionDefinition(
        ...
        contributor="ai-governance",
        handler="oridecon.ai.governance.admin.ledger_actions:run_checkin",
        icon="calendar-check",
