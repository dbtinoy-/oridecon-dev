...
:class:`~oridecon.contracts.data.DatabaseProviderProtocol` using only
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.ai.governance import RelayUsageReservation
    from oridecon.contracts.ai.relay import JsonValue
...
class DatabaseRelayUsageStore(RelayUsageStoreProtocol):
    ...
    Args:
        db: A connected :class:`~oridecon.contracts.data.DatabaseProviderProtocol`
