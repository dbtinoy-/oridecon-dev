...
from oridecon.ai.governance.exceptions import GovernancePersistenceError
from oridecon.ai.governance.services.governance_audit import (
    emit_audit_event,
    notify_soft_limit,
)
from oridecon.ai.governance.services.model_policy import model_access_allowed
from oridecon.ai.governance.services.resource_coordinator import (
...
if TYPE_CHECKING:
    ...
    from oridecon.ai.governance.exceptions import GovernanceError
    from oridecon.ai.governance.persistence import GovernancePersistence
...
class AIGovernanceManager:
    ...
    :class:`~oridecon.ai.governance.persistence.GovernancePersistence`
