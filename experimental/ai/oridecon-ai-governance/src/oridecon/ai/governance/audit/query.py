...
:class:`~oridecon.ai.governance.audit.models.AIAuditEvent` records stored
via any :class:`~oridecon.ai.governance.audit.store.AIAuditStore` implementation.
"""
...
from oridecon.ai.governance.audit.models import AIAuditEvent, AuditQuery, AuditSummary
...
class AuditQueryService:
    ...
    async def export_json(self, query: AuditQuery) -> AsyncIterator[bytes]:
        ...
        :class:`~oridecon.ai.governance.audit.models.AIAuditEvent`.
    ...
    async def summary(self, window_hours: int = 24) -> AuditSummary:
        ...
        Returns:
            :class:`~oridecon.ai.governance.audit.models.AuditSummary` with
