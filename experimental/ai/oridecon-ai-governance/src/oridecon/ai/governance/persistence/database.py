...
:class:`~oridecon.contracts.data.DatabaseProviderProtocol` — suitable where
...
class DatabaseGovernancePersistence:
    """SQL-backed governance persistence using :class:`~oridecon.contracts.data.DatabaseProviderProtocol`.
