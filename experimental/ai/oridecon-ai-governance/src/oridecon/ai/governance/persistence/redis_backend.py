...
:class:`~oridecon.contracts.infra.cache.CacheBackendProtocol`, enabling
...
class RedisGovernancePersistence:
    """Distributed governance persistence backed by a Oridecon CacheBackendProtocol.
    ...
    Args:
        cache: A :class:`~oridecon.contracts.cache.CacheBackendProtocol` that has been
