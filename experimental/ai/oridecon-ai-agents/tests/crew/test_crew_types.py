...
class TestProcess:
    ...
    def test_process_enum_values(self) -> None:
        ...
        from oridecon.ai.agents.crew import Process
...
class TestCrewTask:
    ...
    def test_crewtask_required_fields(self) -> None:
        ...
        from oridecon.ai.agents.crew import CrewTask
...
class TestCrew:
    ...
    def test_crew_required_fields(self, mock_agent: MagicMock) -> None:
        ...
        from oridecon.ai.agents.crew import Crew, CrewTask
    ...
    def test_crew_all_fields(self, mock_agent: MagicMock) -> None:
        ...
        from oridecon.ai.agents.crew import Crew, CrewTask, Process
...
class TestCrewBuilder:
    ...
    def test_builder_create(self) -> None:
        ...
        from oridecon.ai.agents.crew import CrewBuilder
    ...
    def test_builder_add_task(self) -> None:
        ...
        from oridecon.ai.agents.crew import CrewBuilder, CrewTask
    ...
    def test_builder_process(self) -> None:
        ...
        from oridecon.ai.agents.crew import CrewBuilder, Process
...
class TestCrewExecutionResult:
    ...
    def test_execution_result_basic(self) -> None:
        ...
        from oridecon.ai.agents.crew.runner import CrewExecutionResult
    ...
    def test_execution_result_with_task_results(self) -> None:
        ...
        from oridecon.ai.agents.crew.runner import CrewExecutionResult, TaskResult
...
class TestTaskResult:
    ...
    def test_task_result_basic(self) -> None:
        ...
        from oridecon.ai.agents.crew.runner import TaskResult
