"""P2 hook surface import verification for oridecon-ai-agents."""
...
def test_agents_hooks_root_module_exists() -> None:
    ...
    assert oridecon.ai.agents.AgentStartedHook is AgentStartedHook
    assert oridecon.ai.agents.AgentCompletedHook is AgentCompletedHook
    assert oridecon.ai.agents.AgentToolCalledHook is AgentToolCalledHook
