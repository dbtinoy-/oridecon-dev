"""Unit tests for oridecon-ai-agents strategies."""
...
from oridecon.ai.agents.types import AgentResponse, ReasoningStep
...
class TestStrategyProtocol:
    ...
    def test_react_implements_protocol(self) -> None:
        ...
        from oridecon.contracts.ai.agents import StrategyProtocol
