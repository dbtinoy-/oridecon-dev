...
from oridecon.ai.agents.executor.executor import AgentObservability, AgentSafetyInfra
...
class TestAgentExecutorInit:
    ...
    def test_executor_initializes_metrics(self):
        ...
        from oridecon.ai.agents.observability import AgentMetrics
    ...
    def test_executor_initializes_tracer(self):
        ...
        from oridecon.ai.agents.observability import AgentTracer
