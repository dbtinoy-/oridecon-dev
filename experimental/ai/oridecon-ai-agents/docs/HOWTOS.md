---
title: oridecon-ai-agents How-Tos
...
```python
from oridecon.ai.agents import AgentBase
from oridecon.ai.agents.strategies import PlanAndExecuteStrategy
...
```python
from oridecon.ai.agents import AgentStrategyRegistry
from oridecon.ai.agents.strategies import AbstractStrategy
...
```python
from oridecon.ai.agents import AgentAsToolAdapter
...
```python
from oridecon.ai.agents import AgentExecutorImpl
from oridecon.contracts.ai.agents import AgentEventType
...
```python
from oridecon.ai.agents import AgentStartedHook, AgentCompletedHook, AgentToolCalledHook
...
```python
from oridecon.ai.agents import CrewBuilder, CrewTask, Process
