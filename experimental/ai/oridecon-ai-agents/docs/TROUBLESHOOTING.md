---
title: oridecon-ai-agents Troubleshooting
...
**Exception:** `oridecon.ai.agents.exceptions.AgentConfigurationError`
...
**Fix:** Ensure an LLM provider (e.g., `oridecon-ai-llm`) is wired before agent execution:
...
**Exception:** `oridecon.ai.agents.exceptions.AgentExecutionError`
...
```python
from oridecon.ai.agents.exceptions import BudgetExceededError
...
**Exception:** `oridecon.ai.agents.exceptions.BudgetExceededError`
...
**Exception:** `oridecon.ai.agents.exceptions.MaxIterationsExceededError`
...
**Exception:** `oridecon.ai.agents.exceptions.ToolNotFoundError`
...
**Exception:** `oridecon.ai.agents.exceptions.ToolExecutionError`
...
**Exception:** `oridecon.contracts.ai.agents.AgentError`
