---
title: oridecon-ai-agents Guide
...
| `oridecon-ai-llm` | Optional | LLM client integration |
| `oridecon-ai-memory` | Optional | Memory system integration |
| `oridecon-ai-skills` | Optional | Skills system integration |
| `oridecon-ai-observability` | Optional | Observability |

## Problem & Mental Model

LLMs are powerful at generating text, but they can't query databases, call APIs, or remember past conversations without tooling. **oridecon-ai-agents** solves this by giving LLMs:
...
```python
from oridecon.ai.agents.strategies import ReActStrategy
...
from oridecon.ai.agents import AgentsProvider, AgentConfig
...
```python
from oridecon.ai.agents.strategies import SupervisorStrategy
...
from oridecon.contracts.ai.agents import AgentResponse, AgentError
...
```python
from oridecon.ai.agents import CrewBuilder, Process, CrewTask
