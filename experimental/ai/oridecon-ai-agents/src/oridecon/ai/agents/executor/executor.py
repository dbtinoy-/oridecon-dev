...
of the Oridecon infrastructure.
"""
...
from oridecon.ai.agents.executor.run_support import (
    assemble_history,
    check_input_guard,
    check_output_guard,
...
from oridecon.ai.agents.executor.streaming import astream as _astream
...
class AgentExecutorImpl(AgentExecutorProtocol):
    ...
    async def _publish_event(
        ...
        try:
            from oridecon.ai.agents import events as agent_events
