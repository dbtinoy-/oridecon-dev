...
**Skills** (``oridecon-ai-skills``) are composed multi-step workflows that may
...
from oridecon.contracts.ai.agents import ToolError, ToolProtocol, ToolRegistryProtocol
...
if TYPE_CHECKING:
    from oridecon.contracts.core.module import CompiledModuleGraphProtocol
