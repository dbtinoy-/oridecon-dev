...
from oridecon.ai.agents.strategies.plan_execute_executor import (
    call_llm,
...
from oridecon.ai.agents.strategies.plan_execute_planner import (
...
from oridecon.ai.agents.strategies.plan_execute_synthesis import build_direct_response
from oridecon.ai.agents.strategies.plan_execute_types import (
    PLANNING_PROMPT,
    PlanStep,
    PlanStepStatus,
)
from oridecon.ai.agents.strategies.token_utils import TokenAccumulator
from oridecon.ai.agents.types import ReasoningStep, ToolExecutionRecord
from oridecon.contracts.ai.agents import AgentError, AgentResponse
...
if TYPE_CHECKING:
    from oridecon.contracts.ai.agents import ToolProtocol
...
class PlanAndExecuteStrategy(AbstractStrategy):
    ...
    async def _call_llm(
        ...
        from oridecon.ai.agents.strategies.parsing import build_chat_messages_from_dict
