...
from oridecon.ai.agents.strategies.parsing import (
...
if TYPE_CHECKING:
    from oridecon.contracts.ai.agents import MemoryProtocol, ToolProtocol
    from oridecon.contracts.ai.llm import CompletionProtocol, LLMClientProtocol
...
class ReActStrategy(AbstractStrategy):
    ...
    This is the default strategy for Oridecon agents.

    Example::

        from oridecon.ai.agents import Agent
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        for iteration in range(1, self.max_iterations + 1):
            ...
            from oridecon.ai.agents.strategies.guard_hook import guard_observation
