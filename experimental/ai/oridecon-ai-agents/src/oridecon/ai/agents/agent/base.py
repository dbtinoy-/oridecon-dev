...
from oridecon.ai.agents.exceptions import AgentConfigurationError
from oridecon.contracts.ai.agents import AgentProtocol, ToolProtocol

if TYPE_CHECKING:
    from oridecon.ai.agents.agent.builder import AgentBuilder
