...
```python
from oridecon.ai.evaluation.evaluators import EmbeddingDistanceEvaluator
...
- `oridecon-ai-llm` — evaluate model outputs
- `oridecon-contracts` — uses `EvaluatorProtocol`, `EvaluationHarnessProtocol`
