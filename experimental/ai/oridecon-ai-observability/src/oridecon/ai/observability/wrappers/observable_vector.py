...
Wraps any :class:`~oridecon.contracts.ai.VectorStoreProtocol` with tracing and metrics
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.data.vector.exceptions import VectorError
...
class ObservableVectorStore:
    ...
    :class:`~oridecon.contracts.ai.VectorStoreProtocol` protocol while every
