...
from oridecon.logging.redaction import DefaultRedactor
...
class ObservabilityProvider(Provider):
    ...
    Registers :class:`~oridecon.ai.observability.metrics.AIMetrics`,
    :class:`~oridecon.ai.observability.tracing.AITracer`, and
    :class:`~oridecon.ai.observability.health.AIHealthMonitor`.
    ...
    async def boot(self, container: BootContainerProtocol) -> None:
        ...
        if tracer or metrics:
            try:
                ...
                from oridecon.ai.observability.wrappers import ObservableLLMClient
            ...
            try:
                ...
                from oridecon.ai.observability.wrappers import ObservableVectorStore
