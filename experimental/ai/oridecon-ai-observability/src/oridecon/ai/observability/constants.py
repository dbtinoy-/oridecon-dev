...
try:
    __version__: str = importlib.metadata.version("oridecon-ai-observability")
except ImportError:
    __version__ = "0.0.0"


# Environment variable prefix
ENV_PREFIX: str = "ORI_AI_OBSERVABILITY__"
...
METRIC_PREFIX_LLM: str = "oridecon.ai.llm"
"""Metric name prefix for LLM operations."""

METRIC_PREFIX_VECTOR: str = "oridecon.ai.vector"
"""Metric name prefix for vector operations."""

METRIC_PREFIX_EMBEDDING: str = "oridecon.ai.embedding"
