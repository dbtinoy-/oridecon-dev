"""
Metrics collection for Oridecon Intelligence operations.
...
All metrics use oridecon-monitor's MetricsCollectorProtocol for consistent observability.
"""
...
class AIMetrics:
    ...
    def __init__(
        ...
        if collector is None:
            raise ValueError(
                "No metrics collector provided and oridecon-monitor not available",
            )
