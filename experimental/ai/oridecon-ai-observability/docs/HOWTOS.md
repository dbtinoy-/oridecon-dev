---
title: oridecon-ai-observability How-Tos
...
```python
from oridecon.ai.observability import trace_llm, trace_vector
...
```bash
uv add "oridecon-ai-observability[opentelemetry]"
```
...
```python
from oridecon.ai.observability import track_embedding_operation, AITracer
...
```python
from oridecon.ai.observability import ObservableLLMClient, ObservableVectorStore
...
```python
from oridecon.ai.observability import trace_rag
