---
title: oridecon-ai-observability Guide
...
| `oridecon-ai-llm` | Optional | LLM tracing |
| `oridecon-ai-rag` | Optional | RAG tracing |
| `oridecon-ai-agents` | Optional | Agent tracing |
| `oridecon-vector` | Optional | Vector store tracing |
...
`oridecon-ai-observability` solves this by wrapping your AI clients with distributed tracing, metrics collection, and health monitoring — automatically.
...
```python
from oridecon.ai.observability import AITracer
...
```python
from oridecon.ai.observability import AIMetrics
...
```python
from oridecon.ai.observability import AIHealthMonitor
...
```python
from oridecon.ai.observability import trace_llm, track_llm_call
...
```python
from oridecon.ai.observability.hooks import LLMCallTracedHook
