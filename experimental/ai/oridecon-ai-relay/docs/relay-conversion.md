...
`oridecon-ai-relay` converts between four LLM wire formats through one
...
from oridecon.contracts.ai.relay.dto import ClaudeResponse
...
```python
from oridecon.contracts.ai.relay import RelayConversionContext
