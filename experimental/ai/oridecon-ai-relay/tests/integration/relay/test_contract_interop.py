"""Interop with existing Oridecon LLM conventions (Task 14).
...
prove the IR is consumable by the existing oridecon-ai-llm serializers
...
never imports oridecon-ai-llm, web, http, or channel modules.
"""
...
from oridecon.contracts.ai.llm import ChatMessage, FunctionCall, ToolCall
from oridecon.contracts.ai.multimodal import TextPart
from oridecon.contracts.ai.relay.ir import RelayRequest
from oridecon.contracts.ai.relay.types import RelayUsage

from oridecon.ai.llm.clients._message_utils import (
...
def test_relay_package_never_imports_llm_or_channel_modules(forbidden: str) -> None:
    """Importing oridecon.ai.relay loads no llm/web/http/channel modules."""
    script = (
        "import sys; "
        "import oridecon.ai.relay; "
