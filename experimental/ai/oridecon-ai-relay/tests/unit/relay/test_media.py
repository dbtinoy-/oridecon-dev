...
from oridecon.ai.relay.media import decode_data_uri, resolve_media
...
from oridecon.contracts.core.result import Err, Ok
...
def test_media_module_never_imports_network_libraries() -> None:
    ...
    import oridecon.ai.relay.media as media
