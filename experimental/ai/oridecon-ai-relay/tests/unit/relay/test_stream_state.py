...
from oridecon.ai.relay.stream import StreamNormalizer, StreamSession
from oridecon.contracts.ai.exceptions import RelayError, RelayErrorCode
from oridecon.contracts.ai.relay.ir import StreamDelta
...
def test_session_implements_relay_stream_session_protocol() -> None:
    ...
    from oridecon.contracts.ai.relay.protocols import RelayStreamSessionProtocol
