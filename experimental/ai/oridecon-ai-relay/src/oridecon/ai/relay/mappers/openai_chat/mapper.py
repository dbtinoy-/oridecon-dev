...
from oridecon.ai.relay.errors import translate, unsupported_feature, unsupported_format
from oridecon.ai.relay.mappers.base import new_uuid, record_loss
from oridecon.ai.relay.mappers.openai_chat._helpers import (
    _TARGET,
    _extract_text,
    _tool_call_to_wire,
    _tool_calls_to_ir,
)
from oridecon.ai.relay.mappers.openai_chat.ir_to_wire import IRToWireMixin
from oridecon.ai.relay.mappers.openai_chat.wire_to_ir import WireToIRMixin
from oridecon.contracts.ai.exceptions import RelayError
from oridecon.contracts.ai.llm import ChatMessage, ToolCall
...
from oridecon.contracts.ai.thinking import ThinkingConfig, ThinkingResult
