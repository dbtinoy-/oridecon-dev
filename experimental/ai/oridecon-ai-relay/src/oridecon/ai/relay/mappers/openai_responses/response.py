...
from oridecon.ai.relay.errors import translate, unsupported_format
from oridecon.ai.relay.finish_reasons import (
    responses_status_from_finish,
)
from oridecon.ai.relay.mappers.base import new_uuid, record_loss
from oridecon.ai.relay.mappers.openai_responses.utils import (
    _TARGET,
    _arguments_to_wire,
...
from oridecon.contracts.ai.relay.ir import RelayResponse
from oridecon.contracts.ai.relay.types import RelayUsage
from oridecon.contracts.ai.thinking import ThinkingResult
