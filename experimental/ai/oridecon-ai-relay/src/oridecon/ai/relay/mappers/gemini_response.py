...
from oridecon.ai.relay.mappers.base import record_loss
from oridecon.ai.relay.mappers.gemini_request import (
    _TARGET,
    _tool_call_from_part,
    _tool_call_to_part,
)
from oridecon.contracts.ai.exceptions import RelayError
from oridecon.contracts.ai.llm import ToolCall
...
from oridecon.contracts.ai.relay.ir import RelayResponse, normalize_finish_reason
