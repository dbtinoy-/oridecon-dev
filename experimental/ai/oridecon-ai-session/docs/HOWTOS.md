---
title: oridecon-ai-session How-tos
...
```python
from oridecon.ai.session import AppendMerge
...
```python
from oridecon.ai.session import SessionStateMachine, SessionError
...
```python
from oridecon.ai.session import (
    SessionCreatedEvent,
    SessionClosedEvent,
    SessionStartedHook,
    SessionClosedHook,
