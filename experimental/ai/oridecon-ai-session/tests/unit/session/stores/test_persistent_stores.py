...
from oridecon.contracts.ai.session import SessionCheckpoint, SessionStatus
...
class TestCacheSessionStore:
    ...
    async def test_load_returns_hydrated_state(self, store, mock_cache, make_state) -> None:
        ...
        from oridecon.ai.session.stores.cache import _state_to_dict
        from oridecon.serialization.backends.json import dumps_str
