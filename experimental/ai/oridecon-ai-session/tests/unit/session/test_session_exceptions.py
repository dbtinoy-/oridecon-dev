...
class TestSessionExceptions:
    ...
    def test_session_error_base(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionError
    ...
    def test_session_not_found_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionNotFoundError
    ...
    def test_session_closed_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionClosedError
    ...
    def test_session_expired_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionExpiredError
    ...
    def test_checkpoint_not_found_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import CheckpointNotFoundError
    ...
    def test_session_transition_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionTransitionError
    ...
    def test_session_capacity_error(self) -> None:
        ...
        from oridecon.ai.session.exceptions import SessionCapacityError
...
class TestSessionExceptionsExports:
    ...
    def test_exceptions_exported(self) -> None:
        ...
        from oridecon.ai.session import exceptions
