...
class TestSessionCreatedEvent:
    ...
    def test_event_creation(self) -> None:
        ...
        from oridecon.ai.session.events import SessionCreatedEvent
...
class TestSessionClosedEvent:
    ...
    def test_event_creation(self) -> None:
        ...
        from oridecon.ai.session.events import SessionClosedEvent
...
class TestSessionEventsExports:
    ...
    def test_events_exported(self) -> None:
        ...
        from oridecon.ai.session import events
