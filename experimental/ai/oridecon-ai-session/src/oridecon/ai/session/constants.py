"""Constants for oridecon-ai-session."""
...
try:
    __version__: str = importlib.metadata.version("oridecon-ai-session")
except ImportError:
    __version__ = "0.0.0"
...
ENV_PREFIX: str = "ORI_AI_SESSION__"
...
DEFAULT_COOKIE_NAME: str = "oridecon_session"
