"""Errors for the oridecon-ai-session package."""

from __future__ import annotations

from oridecon.contracts.ai.session import SessionError as _ContractsSessionError
