...
from oridecon.contracts.ai.session import SessionManagerProtocol, SessionStoreProtocol
...
class SessionModule(Module):
    ...
    :class:`~oridecon.contracts.ai.session.SessionStoreProtocol` and
    :class:`~oridecon.contracts.ai.session.SessionManagerProtocol`
    ...
    Exports:
        :class:`~oridecon.contracts.ai.session.SessionStoreProtocol`,
        :class:`~oridecon.contracts.ai.session.SessionManagerProtocol`,
        :class:`~oridecon.ai.session.exceptions.SessionError`,
        :class:`~oridecon.ai.session.exceptions.SessionNotFoundError`,
        :class:`~oridecon.ai.session.exceptions.SessionClosedError`,
        :class:`~oridecon.ai.session.exceptions.SessionExpiredError`,
        :class:`~oridecon.ai.session.exceptions.CheckpointNotFoundError`
    """
    ...
    def configure(
        ...
        *,
        ...
        Args:
            config: :class:`~oridecon.ai.session.config.SessionConfig`, a
