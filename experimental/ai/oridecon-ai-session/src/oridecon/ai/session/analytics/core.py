...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.ai.session import SessionState
...
class SessionAnalytics:
    ...
    All fields are derived from :class:`~oridecon.contracts.ai.session.SessionState`
    and its :class:`~oridecon.contracts.ai.session.SessionTurn` records.
