...
from oridecon.ai.prompt.service.loader import DictPromptLoader, DirectoryPromptLoader
from oridecon.ai.prompt.service.models import PromptTemplate
from oridecon.ai.prompt.service.observer import PromptObserverProtocol
from oridecon.ai.prompt.service.service import PromptService, PromptServiceProtocol
from oridecon.contracts.ai.llm import PromptAssemblerProtocol
...
class PromptProvider(Provider):
    ...
    Reads :class:`~oridecon.ai.prompt.config.PromptConfig`, builds a
    :class:`~oridecon.ai.prompt.registry.registry.PromptRegistry` and a
    :class:`~oridecon.ai.prompt.service.service.PromptService`, and registers
    both as singletons.
    ...
    * ``inline_templates`` — list of raw template dicts (see
      :class:`~oridecon.ai.prompt.service.loader.DictPromptLoader`).
    * ``observer`` — an object implementing
      :class:`~oridecon.ai.prompt.service.observer.PromptObserverProtocol`.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            config: Optional :class:`~oridecon.ai.prompt.config.PromptConfig`.
