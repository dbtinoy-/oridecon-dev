...
from oridecon.ai.prompt.exceptions import OptimizationError
...
if TYPE_CHECKING:
    from oridecon.contracts.ai import EmbeddingClientProtocol, LLMClientProtocol
...
class PromptOptimizer:
    ...
    * ``ENSEMBLE`` — evaluates a list of candidate templates, returns the best.
    ...
    Example::
        ...
        from oridecon.ai.prompt.optimization import PromptOptimizer, Example
