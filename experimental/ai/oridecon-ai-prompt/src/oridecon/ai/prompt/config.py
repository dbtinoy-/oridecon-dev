"""Prompt configuration for the Oridecon framework."""
...
from oridecon.ai.prompt.constants import (
...
class PromptConfig(BaseConfig):
    ...
    Attributes:
        ...
        sanitize_inputs: When ``True``, apply :class:`~oridecon.ai.prompt.rendering.sanitizer.InputSanitizer`
