...
def validate_variable(
    ...
    Args:
        var: The declared :class:`~oridecon.ai.prompt.variables.types.PromptVariable`.
    ...
    Raises:
        :class:`~oridecon.ai.prompt.exceptions.PromptValidationError` when
...
def resolve_variables(
    ...
    :class:`~oridecon.ai.prompt.exceptions.PromptRenderError`.  Missing
    optional variables fall back to their ``default``.

    Args:
        declared: List of :class:`~oridecon.ai.prompt.variables.types.PromptVariable`
