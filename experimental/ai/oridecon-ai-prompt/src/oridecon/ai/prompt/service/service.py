...
* Variable substitution delegates to :class:`~oridecon.ai.prompt.rendering.engine.PromptRenderer`
  so every :class:`~oridecon.ai.prompt.rendering.engine.RenderFormat` is
...
from oridecon.ai.prompt.constants import DEFAULT_RENDER_FORMAT
...
from oridecon.contracts.core.hooks import HookRegistryProtocol
...
class PromptServiceProtocol(Protocol):
    ...
    def get_template(self, name: str, version: str = _LATEST) -> PromptTemplate:
        """Return the :class:`~oridecon.ai.prompt.service.models.PromptTemplate`
...
class PromptService:
    ...
    :class:`~oridecon.ai.prompt.service.loader.PromptLoaderProtocol` sources.

    Args:
        templates: Pre-built list of :class:`~oridecon.ai.prompt.service.models.PromptTemplate`
        ...
        observer:  Optional observability hook.  Defaults to
                   :class:`~oridecon.ai.prompt.service.observer.NoOpPromptObserver`.
        sanitizer: Optional :class:`~oridecon.ai.prompt.rendering.sanitizer.InputSanitizer`
    ...
    Example::
        ...
        from oridecon.ai.prompt.service import (
    ...
    def attach_hook_registry(self, hook_registry: HookRegistryProtocol | None) -> None:
        ...
        :meth:`~oridecon.ai.prompt.service.service.PromptService._emit_action`).
        """
    ...
    def render(self, request: PromptRenderRequest) -> PromptRenderResult:
        ...
        Returns:
            :class:`~oridecon.ai.prompt.service.models.PromptRenderResult`
    ...
    def get_template(self, name: str, version: str = _LATEST) -> PromptTemplate:
        ...
        Returns:
            The matching :class:`~oridecon.ai.prompt.service.models.PromptTemplate`.
    ...
    def _substitute(
        ...
        Delegates to :class:`~oridecon.ai.prompt.rendering.engine.PromptRenderer`
        ...
        Raises:
            ...
            :class:`~oridecon.ai.prompt.exceptions.PromptConfigError`:
                ``render_format`` is not a valid
                :class:`~oridecon.ai.prompt.rendering.engine.RenderFormat`.
        """
    ...
    def _emit_action(self, hook_name: str, payload: object) -> None:
        ...
        (:class:`~oridecon.hooks.registry.HookRegistry`).  When no registry is
