...
Dict format
-----------
Pass a list of dicts, each matching the :class:`~oridecon.ai.prompt.service.models.PromptTemplate`
fields::
...
from oridecon.ai.prompt.rendering.engine import RenderFormat
from oridecon.ai.prompt.service.models import LLMProvider, PromptTemplate
from oridecon.logging import get_logger
from oridecon.serialization import JSONDecodeError, loads
...
class PromptLoaderProtocol(Protocol):
    """Interface for objects that supply :class:`~oridecon.ai.prompt.service.models.PromptTemplate` instances."""
...
class DirectoryPromptLoader:
    ...
    :class:`~oridecon.config.lib.sources.DirectoryConfigSource`.
