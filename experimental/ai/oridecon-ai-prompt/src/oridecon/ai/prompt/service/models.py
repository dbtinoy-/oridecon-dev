...
class LLMProvider(str, enum.Enum):
    ...
    so that :class:`~oridecon.ai.prompt.service.service.PromptService` can
...
class PromptTemplate:
    ...
    :class:`~oridecon.ai.prompt.service.service.PromptService`.
...
class PromptRenderRequest:
    """Input to :meth:`~oridecon.ai.prompt.service.service.PromptService.render`.
...
class PromptRenderResult:
    """Output from :meth:`~oridecon.ai.prompt.service.service.PromptService.render`.
