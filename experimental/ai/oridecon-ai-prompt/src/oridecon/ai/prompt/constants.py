...
try:
    __version__: str = importlib.metadata.version("oridecon-ai-prompt")
except ImportError:
    __version__ = "0.0.0"


# -- Environment Variable Prefixes -------------------------------------------
ENV_PREFIX: str = "ORI_AI_PROMPT__"
...
ERROR_TEMPLATE_NOT_FOUND: str = "ORI_PROMPT_001"
ERROR_VARIABLE_MISSING: str = "ORI_PROMPT_002"
ERROR_RENDER_FAILED: str = "ORI_PROMPT_003"
