...
from oridecon.ai.prompt.exceptions import PromptConfigError, PromptRenderError
...
from oridecon.ai.prompt.service.loader import DictPromptLoader
from oridecon.ai.prompt.service.models import PromptTemplate
from oridecon.ai.prompt.service.service import PromptService
...
def test_format_engine_simple_substitution() -> None:
    ...
    from oridecon.ai.prompt.service.models import PromptRenderRequest
...
def test_jinja2_engine_filter() -> None:
    ...
    result = svc.render(PromptRenderRequest(name="t", variables={"name": "oridecon"}))
    assert result.rendered == "ORIDECON"
