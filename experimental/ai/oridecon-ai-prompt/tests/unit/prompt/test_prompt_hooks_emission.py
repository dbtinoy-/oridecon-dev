...
from oridecon.ai.prompt.service.models import PromptRenderRequest, PromptTemplate
from oridecon.ai.prompt.service.observer import NoOpPromptObserver, PromptObserverProtocol
