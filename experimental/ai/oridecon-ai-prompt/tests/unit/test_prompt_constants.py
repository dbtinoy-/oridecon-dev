...
import pytest
from oridecon.ai.prompt import constants
...
class TestConstants:
    ...
    def test_env_prefix(self) -> None:
        assert constants.ENV_PREFIX == "ORI_AI_PROMPT__"
    ...
    def test_error_template_not_found(self) -> None:
        assert constants.ERROR_TEMPLATE_NOT_FOUND == "ORI_PROMPT_001"

    def test_error_variable_missing(self) -> None:
        assert constants.ERROR_VARIABLE_MISSING == "ORI_PROMPT_002"

    def test_error_render_failed(self) -> None:
        assert constants.ERROR_RENDER_FAILED == "ORI_PROMPT_003"
