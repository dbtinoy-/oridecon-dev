---
title: oridecon-ai-feedback How-Tos
...
feedback_id = await collector.collect_correction(
    original="Oridecon is a framework.",
    corrected="Oridecon is an async Python framework.",
...
```python
from oridecon.ai.feedback import (
    FeedbackCollector,
    FeedbackError,
...
```python
from oridecon.ai.feedback import FeedbackService
from oridecon.web import get, Controller
