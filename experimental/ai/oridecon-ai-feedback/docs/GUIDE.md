---
title: oridecon-ai-feedback Guide
...
| `oridecon-cache` | Optional | Feedback caching |
| `oridecon-sql` | Optional | Feedback storage |
...
`oridecon-ai-feedback` provides four feedback types, a pluggable storage layer, processor pipelines, and lifecycle hooks — all wired via DI.
...
```python
from oridecon.ai.feedback import FeedbackItem, FeedbackType
...
```python
from oridecon.ai.feedback import FeedbackType
...
```python
from oridecon.ai.feedback import DatabaseFeedbackStore, CachedFeedbackStore
...
```python
from oridecon.ai.feedback import FeedbackCollector
...
```python
from oridecon.ai.feedback import FeedbackService
...
```python
from oridecon.ai.feedback import FeedbackMiddleware, FeedbackCollector
...
```python
from oridecon.ai.feedback.processors.processor_registry import (
...
```python
from oridecon.ai.feedback import FeedbackContext, FeedbackCollector
