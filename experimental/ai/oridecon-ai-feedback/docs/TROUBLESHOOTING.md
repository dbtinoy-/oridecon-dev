...
**Exception:** `oridecon.ai.feedback.exceptions.FeedbackProcessingError`
...
**Exception:** `oridecon.ai.feedback.exceptions.FeedbackError`
...
```python
from oridecon.ai.feedback.processors import FeedbackProcessorRegistry
...
```python
from oridecon.ai.feedback.constants import DEFAULT_RATING_MIN, DEFAULT_RATING_MAX
...
export ORI_LOGGING__LEVEL=DEBUG
```
