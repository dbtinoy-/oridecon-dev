...
Integrates with Oridecon's middleware system to automatically capture
...
from oridecon.ai.feedback.exceptions import FeedbackAuthorizationError
...
from oridecon.ai.feedback.types import FeedbackType
    ...
    def __init__(
        ...
        Args:
            ...
            authorize: Optional callback gating feedback submissions.
                ...
                :class:`~oridecon.ai.feedback.exceptions.FeedbackAuthorizationError`.
