...
from oridecon.ai.feedback.constants import MAX_CONTEXT_SIZE, MAX_FEEDBACK_TEXT_LENGTH
from oridecon.ai.feedback.exceptions import FeedbackTooLargeError
...
class FeedbackService:
    ...
    Implements :class:`~oridecon.contracts.ai.feedback.FeedbackProtocol`.
    Wraps a :class:`~oridecon.contracts.ai.feedback.FeedbackStoreProtocol`
