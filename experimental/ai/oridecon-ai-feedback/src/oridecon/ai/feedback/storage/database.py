"""SQL-backed feedback store using :class:`~oridecon.contracts.data.DatabaseProviderProtocol`.
...
from oridecon.ai.feedback.exceptions import FeedbackError
from oridecon.ai.feedback.storage.protocols import FeedbackSummary
...
class DatabaseFeedbackStore:
    """Persist and query feedback items via :class:`~oridecon.contracts.data.DatabaseProviderProtocol`.
