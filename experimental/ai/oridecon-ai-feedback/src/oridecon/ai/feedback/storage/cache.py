...
Wraps a durable :class:`~oridecon.ai.feedback.storage.protocols.FeedbackStoreProtocol`
with a :class:`~oridecon.contracts.cache.CacheBackendProtocol` for fast reads.
...
class CachedFeedbackStore:
    ...
    Args:
        store: Durable backing store (e.g. :class:`~oridecon.ai.feedback.storage.database.DatabaseFeedbackStore`).
    ...
    async def aggregate(
        ...
        Returns:
            :class:`~oridecon.ai.feedback.storage.protocols.FeedbackSummary`.
        """
