---
title: oridecon-ai-llm How-Tos
description: Common usage patterns for `oridecon-ai-llm`.
---
...
```python
from oridecon.ai.llm import ProviderRegistry
...
```python
from oridecon.ai.llm import TiktokenCounter

counter = TiktokenCounter(model="gpt-4")
count = counter.count("Hello, world!")
print(f"Tokens: {count.total}")

from oridecon.ai.llm import (
...
```python
from oridecon.ai.llm import RateLimiter
