...
from oridecon.ai.llm.exceptions import ModelRevisionMismatchError
...
class TestModelPinPolicy:
    ...
    def test_enum_values(self) -> None:
        from oridecon.ai.llm.pinning import ModelPinPolicy
...
class TestEnforcePinPolicy:
    ...
    def test_exact_match_passes(self) -> None:
        from oridecon.ai.llm.pinning import enforce_pin_policy, ModelPinPolicy
...
class TestCompletionProvenance:
    ...
    def test_completion_has_provenance_fields(self) -> None:
        from oridecon.ai.llm.types import Completion
...
class TestBuildLLMCacheKey:
    ...
    def test_cache_key_includes_provider_model_prompt(self) -> None:
        from oridecon.ai.llm.caching.types import build_llm_cache_key
...
class TestModelRevisionMismatchError:
    ...
    def test_is_llm_error(self) -> None:
        from oridecon.ai.llm.exceptions import LLMError, ModelRevisionMismatchError
