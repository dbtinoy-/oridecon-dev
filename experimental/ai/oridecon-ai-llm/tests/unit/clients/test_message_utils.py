...
from oridecon.contracts.ai.multimodal import ImageBase64Part, ImageUrlPart, TextPart


class TestSerializeContentForOpenAI:
    def test_string_content_returned_unchanged(self) -> None:
        from oridecon.ai.llm.clients._message_utils import serialize_content_for_openai
