...
class TestOpenAICompatibleClient:
    ...
    async def test_deepseek_complete_success(self, monkeypatch: Any) -> None:
        ...
        from oridecon.ai.llm.clients.openai_compatible import DeepSeekClient
    ...
    async def test_together_complete_success(self, monkeypatch: Any) -> None:
        ...
        from oridecon.ai.llm.clients.openai_compatible import TogetherClient
    ...
    async def test_fireworks_complete_success(self, monkeypatch: Any) -> None:
        ...
        from oridecon.ai.llm.clients.openai_compatible import FireworksClient
