...
dedicated resilience layer (``oridecon-resilience``).
"""
...
class ResilientHTTPClient:
    ...
    from ``oridecon-resilience`` can be injected to add retry and circuit-breaker
    ...
    async def request(
        ...
        **kwargs: Any,
        ...
        """Execute an HTTP request and return an :class:`~oridecon.contracts.web.models.HttpResponse`.
