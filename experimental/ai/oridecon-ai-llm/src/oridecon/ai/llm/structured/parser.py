...
:class:`~oridecon.ai.llm.structured.extractor.StructuredExtractor`.
...
from oridecon.serialization import JSONDecodeError as _JSONDecodeError
from oridecon.serialization import loads as _json_loads
