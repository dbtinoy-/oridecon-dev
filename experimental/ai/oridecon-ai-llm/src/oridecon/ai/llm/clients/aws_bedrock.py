"""AWS Bedrock LLM client for the Oridecon LLM routing system.

Implements the :class:`~oridecon.contracts.ai.protocols.LLMClientProtocol`
...
from oridecon.ai.llm.clients._bedrock_errors import error_to_result
from oridecon.ai.llm.clients._bedrock_mappers import (
    bedrock_stream_chunks,
    parse_bedrock_response,
)
from oridecon.ai.llm.clients._bedrock_requests import (
    apply_thinking,
    build_converse_request,
    content_to_text,
)
from oridecon.ai.llm.clients._bedrock_transport import get_thread_pool
from oridecon.ai.llm.clients._tools_utils import parse_json_arguments
from oridecon.ai.llm.clients.base import AbstractLLMClient
from oridecon.ai.llm.exceptions import LLMError
from oridecon.ai.llm.multimodal.fetcher import fetch_image_as_base64
from oridecon.ai.llm.types import Completion, StreamChunk
...
class BedrockClient(AbstractLLMClient):
    ...
    async def health_check(self, timeout: float = 5.0) -> HealthCheckResult:
        ...
        Returns:
            Structured :class:`~oridecon.contracts.core.health.HealthCheckResult`.
        """
        try:
            import boto3
    ...
    def _apply_thinking(self, request: dict[str, Any]) -> None:
        ...
        Delegates to :func:`~oridecon.ai.llm.clients._bedrock_requests.apply_thinking`.
