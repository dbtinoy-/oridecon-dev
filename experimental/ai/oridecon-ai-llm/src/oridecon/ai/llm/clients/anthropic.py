...
from oridecon.ai.llm.clients._anthropic_requests import (
    _tool_result_text,
    _tool_to_anthropic,
)
from oridecon.ai.llm.clients._message_utils import serialize_content_for_anthropic
    ...
    def __init__(self, config: ClientConfig):
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install oridecon-ai-llm[anthropic]",
            ) from e
