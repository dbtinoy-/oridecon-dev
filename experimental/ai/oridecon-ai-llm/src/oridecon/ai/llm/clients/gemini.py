"""Google Gemini REST API client for the Oridecon LLM routing system.
...
* Return a normalised :class:`~oridecon.ai.llm.types.Completion` object.

Notes:
    Gemini does *not* expose an OpenAI-compatible endpoint — this client
    uses the native REST API directly via :class:`~oridecon.http.BaseURLHTTPClient`.
"""
