"""Azure OpenAI LLM client for the Oridecon LLM routing system.

Extends :class:`~oridecon.ai.llm.clients.openai.OpenAIClient` to target the
    ...
    def __init__(self, config: ClientConfig) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install oridecon-ai-llm[openai]"
            ) from exc
