...
Example:
    >>> from oridecon.ai.llm import CohereClient
    >>>
...
from oridecon.ai.llm.clients._cohere_mappers import (
    COHERE_MODELS,
...
class CohereClient(AbstractLLMClient):
    ...
    async def _do_chat(
        ...
        **kwargs: Any,
        ...
        Tool conversion happens in :func:`~oridecon.ai.llm.clients._cohere_mappers.build_cohere_payload`
