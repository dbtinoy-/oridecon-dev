...
from oridecon.ai.llm.clients._message_utils import serialize_text_for_ollama
...
from oridecon.contracts.ai.llm import FunctionCall, ToolCall
from oridecon.contracts.ai.multimodal import ImageUrlPart
...
class OllamaClient(AbstractLLMClient):
    ...
    Conforms to: :class:`~oridecon.contracts.ai.LLMClientProtocol` protocol via structural typing.
    ...
    Example:
        >>> from oridecon.ai import ClientConfig
        >>> config = ClientConfig(
        ...     provider="ollama",
        ...     model="llama3:8b",
    ...
    def __init__(self, config: ClientConfig):
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install oridecon-ai-llm[ollama]",
            ) from e
    ...
    async def health_check(self, timeout: float = 5.0) -> HealthCheckResult:
        ...
        Returns:
            :class:`~oridecon.contracts.core.health.HealthCheckResult`.
        """
        try:
