"""Base class for Oridecon LLM clients.
...
from oridecon.ai.llm.health import ProviderCircuitBreaker
...
class AbstractLLMClient(ABC):
    ...
    async def _exceeds_token_limit(
        ...
        Uses :class:`~oridecon.ai.llm.pricing.tokens.TiktokenCounter` for accurate
        ...
        from oridecon.ai.llm.pricing.tokens import TiktokenCounter
