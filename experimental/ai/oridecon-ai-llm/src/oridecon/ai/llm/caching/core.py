...
Example:
    >>> from oridecon.contracts import CacheBackendProtocol, LLMClientProtocol, VectorStoreProtocol
    >>>
...
from oridecon.ai.llm.caching.types import CacheEntry, CacheStats
