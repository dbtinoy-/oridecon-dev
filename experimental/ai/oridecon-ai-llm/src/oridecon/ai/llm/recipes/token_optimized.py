...
from oridecon.contracts.ai.rag import RAGContext
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts.ai.session import ContextPrunerProtocol
...
class TokenOptimizedPipeline:
    ...
    - TokenCounterProtocol (from oridecon-ai-llm)
    - SemanticCacheProtocol (from oridecon-cache, optional)
    - ContextPrunerProtocol (from oridecon-ai-memory, optional)
    - PromptCompressorProtocol (from oridecon-ai-rag, optional)
    - PromptAssemblerProtocol (from the AI prompt layer)
    - LLMClientProtocol (from oridecon-ai-llm)
    """
