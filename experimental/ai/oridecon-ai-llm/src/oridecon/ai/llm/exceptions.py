...
from oridecon.contracts.ai.exceptions import LLMError as _ContractsLLMError
...
class LLMError(_ContractsLLMError):
    """Base exception for all LLM-domain errors in oridecon-ai-llm."""

    _code: str = "ORI_ERR_LLM_002"
