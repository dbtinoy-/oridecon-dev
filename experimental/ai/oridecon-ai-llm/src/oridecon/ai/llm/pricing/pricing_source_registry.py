...
if TYPE_CHECKING:
    from oridecon.ai.llm.config import PricingSourceConfig
...
class PricingSourceRegistry:
    ...
    pricing source from a :class:`~oridecon.ai.llm.config.PricingSourceConfig`.
    ...
    def with_defaults(cls) -> PricingSourceRegistry:
        ...
        """
        from oridecon.ai.llm.pricing.pricing_source_static import (
            StaticPricingSource,
        )
