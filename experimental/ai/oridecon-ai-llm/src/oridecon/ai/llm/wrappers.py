...
Both wrappers preserve the :class:`~oridecon.contracts.ai.llm.LLMClientProtocol`
...
from oridecon.security.hashing import ambient as hashing
        ...
        *,
        ...
        Args:
            ...
            cache: Backing cache (must implement
                :class:`~oridecon.ai.llm.protocols.LLMCacheProtocol`).
