...
from oridecon.ai.llm.types import ChatMessage, Completion, Role
from oridecon.contracts.ai.llm import TokenCounterProtocol
from oridecon.contracts.core import Metadata

if TYPE_CHECKING:
    from oridecon.contracts import AbstractLLMClient
...
from oridecon.ai.llm.conversation.types import ConversationConfig, ConversationStats
...
class ConversationManager:
    ...
    Example:
        >>> from oridecon.ai.llm import OpenAIClient, ConversationManager
        >>>
    ...
    def __init__(
        ...
        if token_counter is None:
            from oridecon.ai.llm.pricing.tokens import CharEstimateCounter
