"""Admin contributor for oridecon-ai-llm — surfaces token usage, provider
status, and error-rate widgets into the Oridecon admin dashboard.
"""
...
from oridecon.contracts.ai.routing import InferenceLoggerProtocol, LLMRouterProtocol
...
_ACTIONS: tuple[AdminActionDefinition, ...] = (
    AdminActionDefinition(
        ...
        contributor="ai-llm",
        handler="oridecon.ai.llm.admin.actions:rotate_api_key",
        icon="refresh-cw",
...
class LlmAdminContributor(BaseAdminContributor):
    """Admin contributor for the oridecon-ai-llm package."""
    ...
    def get_management_pages(self) -> Sequence[ManagementPageDefinition]:
        return [
            ManagementPageDefinition(
                ...
                contributor="ai-llm",
                route_path="/ai/llm",
                handler="oridecon.ai.llm.admin.pages.overview:LlmOverviewPage",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.llm.admin.pages.usage:LlmUsagePage",
                category=PageCategory.AI,
                icon="bar-chart-2",
            ...
            ManagementPageDefinition(
                ...
                handler="oridecon.ai.llm.admin.pages.providers:LlmProvidersPage",
                category=PageCategory.AI,
                icon="server",
