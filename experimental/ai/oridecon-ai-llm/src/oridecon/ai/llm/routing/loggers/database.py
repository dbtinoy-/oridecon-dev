...
from oridecon.ai.llm.routing.types import InferenceLog
...
class DatabaseInferenceLogger:
    ...
    async def log(self, entry: InferenceLog) -> None:
        ...
        Args:
            entry: :class:`~oridecon.ai.llm.routing.types.InferenceLog` instance.
        """
        try:
    ...
    async def get_recent(self, limit: int = 100) -> list[InferenceLog]:
        ...
        Returns:
            List of :class:`~oridecon.ai.llm.routing.types.InferenceLog` instances,
