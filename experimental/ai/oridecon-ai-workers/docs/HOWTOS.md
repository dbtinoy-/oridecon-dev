---
title: oridecon-ai-workers How-Tos
...
from oridecon.contracts.ai.rag import ChunkProtocol
...
from oridecon.ai.workers.types import DLQItem
...
```python
from oridecon.ai.workers.adapters import (
    IngestionReport,
    LoaderWorkerBridge,
    RAGIngestionAdapter,
)
from oridecon.ai.workers.document_ingestion.types import Document
...
# ORI_AI_WORKERS__ENABLE_MAINTENANCE=true
