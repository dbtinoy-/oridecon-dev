...
class WorkersModule(Module):
    ...
    Registers the :class:`~oridecon.ai.workers.di.provider.WorkersProvider`
    ...
    def configure(
        ...
        Args:
            config: Optional :class:`~oridecon.ai.workers.config.WorkersConfig`.
