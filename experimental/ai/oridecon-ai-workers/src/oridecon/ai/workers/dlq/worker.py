...
if TYPE_CHECKING:
    ...
    from oridecon.contracts import JobProtocol, TaskQueueProtocol

from oridecon.ai.workers.dlq.classifier import ErrorClassifier
...
class DeadLetterQueueWorker:
    ...
    Example:
        ```python
        from oridecon.ai.workers import DeadLetterQueueWorker
