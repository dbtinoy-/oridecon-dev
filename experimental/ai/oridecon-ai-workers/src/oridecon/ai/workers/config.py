"""Worker configuration for the Oridecon framework."""
...
from oridecon.ai.workers.constants import ENV_NESTED_DELIMITER, ENV_PREFIX
...
class WorkersConfig(BaseConfig):
    ...
    variable overrides via ``ORI_AI_WORKERS__*`` prefix.
    """
