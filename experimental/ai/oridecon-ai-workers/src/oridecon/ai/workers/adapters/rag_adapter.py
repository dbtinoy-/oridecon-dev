...
from oridecon.ai.workers.exceptions import WorkerError
...
class RAGIngestionAdapter:
    ...
    Pulls parsed :class:`~oridecon.ai.workers.document_ingestion.types.Document`
    objects, converts them to :class:`~oridecon.ai.rag.chunking.types.Chunk`
