...
from oridecon.contracts.core import ExecutionStrategy
...
if TYPE_CHECKING:
    ...
    from oridecon.contracts import VectorStoreProtocol
    from oridecon.contracts.ai.rag import ChunkProtocol
    from oridecon.contracts.infra.tasks import TaskQueueProtocol
    from oridecon.contracts.infra.tasks import TaskWorkerProtocol as TaskWorker
