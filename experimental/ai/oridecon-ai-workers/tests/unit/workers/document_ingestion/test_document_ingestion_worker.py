"""Unit tests for oridecon.ai.workers.document_ingestion.worker."""
...
from oridecon.ai.workers.document_ingestion import UniversalDocumentParser
...
class TestDocumentIngestionWorker:
    ...
    @pytest.mark.asyncio
    @patch("oridecon.di.resolution.context.get_resolver")
