...
from oridecon.contracts.infra.tasks import JobProtocol, JobStatus
...
class TestOrideconTasksAdapter:
    """Test OrideconTasksAdapter class."""
    ...
    @pytest.fixture
    def adapter(self, mock_queue: MagicMock) -> OrideconTasksAdapter:
        """Create a OrideconTasksAdapter instance."""
        return OrideconTasksAdapter(mock_queue)

    @pytest.mark.asyncio
    async def test_enqueue_success(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_enqueue_failure_raises(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
        """Test enqueue failure raises RuntimeError."""
        from oridecon.contracts.infra.tasks import TaskQueueError
    ...
    @pytest.mark.asyncio
    async def test_dequeue_returns_none(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_dequeue_returns_adapter(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_job_returns_none(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_job_returns_adapter(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_job(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_count(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_count_with_status(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_stats_reports_pending_from_task_count(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_stats_returns_none_without_task_count(self, adapter: OrideconTasksAdapter, mock_queue: MagicMock) -> None:
