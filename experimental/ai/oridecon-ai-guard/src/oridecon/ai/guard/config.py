"""GuardProtocol configuration for the Oridecon framework."""
...
from oridecon.ai.guard.constants import ENV_NESTED_DELIMITER, ENV_PREFIX
...
class GuardConfig(BaseConfig):
    ...
    :class:`~oridecon.ai.guard.pipeline.guard_pipeline.GuardPipeline`.
    ...
    :class:`~oridecon.ai.guard.input.llm_injection.LLMInjectionDetector` and
    :class:`~oridecon.ai.guard.input.llm_jailbreak.LLMJailbreakDetector` are
