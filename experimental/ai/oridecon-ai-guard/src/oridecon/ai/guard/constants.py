...
try:
    __version__: str = importlib.metadata.version("oridecon-ai-guard")
except ImportError:
    __version__ = "0.0.0"


# -- Environment Variable Prefixes -------------------------------------------
ENV_PREFIX: str = "ORI_AI_GUARD__"
...
ERROR_INPUT_GUARD_VIOLATION: str = "ORI_GUARD_001"
ERROR_OUTPUT_GUARD_VIOLATION: str = "ORI_GUARD_002"
ERROR_GUARD_CONFIG_INVALID: str = "ORI_GUARD_003"
