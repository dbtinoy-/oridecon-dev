"""User-facing decorators for oridecon-ai-safety guard.

Applied by application developers when attaching safety guards to
LLM-calling functions. The decorator executes a real
:class:`~oridecon.ai.guard.pipeline.guard_pipeline.GuardPipeline` around
...
def guarded(
    ...
    *,
    ...
    Builds a :class:`~oridecon.ai.guard.pipeline.guard_pipeline.GuardPipeline`
    ...
    A BLOCK raises :class:`~oridecon.ai.guard.exceptions.GuardPipelineError`;
