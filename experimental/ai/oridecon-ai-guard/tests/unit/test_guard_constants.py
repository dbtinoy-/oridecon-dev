...
import pytest
from oridecon.ai.guard import constants
...
class TestEnvironmentConstants:
    ...
    def test_env_prefix(self) -> None:
        assert constants.ENV_PREFIX == "ORI_AI_GUARD__"
...
class TestErrorCodes:
    ...
    def test_error_input_guard_violation(self) -> None:
        assert constants.ERROR_INPUT_GUARD_VIOLATION == "ORI_GUARD_001"

    def test_error_output_guard_violation(self) -> None:
        assert constants.ERROR_OUTPUT_GUARD_VIOLATION == "ORI_GUARD_002"

    def test_error_guard_config_invalid(self) -> None:
        assert constants.ERROR_GUARD_CONFIG_INVALID == "ORI_GUARD_003"
...
class TestAllExports:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("ENV_PREFIX", "ORI_AI_GUARD__"),
            ("ERROR_GUARD_CONFIG_INVALID", "ORI_GUARD_003"),
            ("ERROR_INPUT_GUARD_VIOLATION", "ORI_GUARD_001"),
            ("ERROR_OUTPUT_GUARD_VIOLATION", "ORI_GUARD_002"),
