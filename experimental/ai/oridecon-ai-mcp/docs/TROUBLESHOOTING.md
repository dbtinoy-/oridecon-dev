---
title: oridecon-ai-mcp Troubleshooting
...
**Solution:** Upgrade both client and server to the same oridecon version. The current protocol version is `2024-11-05`.

```python
from oridecon.ai.mcp.server.core import MCP_PROTOCOL_VERSION
