...
class TestToolDecorator:
    ...
    def test_decorator_basic(self) -> None:
        from oridecon.ai.mcp.controllers.decorators import tool
...
class TestResourceDecorator:
    ...
    def test_decorator_basic(self) -> None:
        from oridecon.ai.mcp.controllers.decorators import resource
...
class TestPromptDecorator:
    ...
    def test_decorator_basic(self) -> None:
        from oridecon.ai.mcp.controllers.decorators import prompt
