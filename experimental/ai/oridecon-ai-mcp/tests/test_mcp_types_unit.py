...
class TestMCPToolDefinition:
    ...
    def test_creation(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPToolDefinition
...
class TestMCPToolResult:
    ...
    def test_creation(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPToolResult
...
class TestMCPResource:
    ...
    def test_creation(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPResource
...
class TestMCPResourceContent:
    ...
    def test_creation_with_text(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPResourceContent
...
class TestMCPServerCapabilities:
    ...
    def test_creation_with_defaults(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPServerCapabilities
...
class TestMCPJSONRPCRequest:
    ...
    def test_creation(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPJSONRPCRequest
...
class TestMCPJSONRPCResponse:
    ...
    def test_create_success(self) -> None:
        ...
        from oridecon.ai.mcp.types import MCPJSONRPCResponse
