...
from oridecon.ai.mcp.config import (
    ConnectorsConfig,
...
class TestFilesystemConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import FilesystemConnectorConfig
...
class TestGitHubConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import GitHubConnectorConfig
...
class TestWebFetchConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import WebFetchConnectorConfig

        config = WebFetchConnectorConfig()
        assert config.enabled is False
        assert config.max_content_bytes == 512 * 1024
        assert config.user_agent == "oridecon-mcp/1.0"
...
class TestWebSearchConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import WebSearchConnectorConfig
...
class TestSlackConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import SlackConnectorConfig
...
class TestGoogleDriveConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import GoogleDriveConnectorConfig
...
class TestSQLConnectorConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import SQLConnectorConfig
...
class TestConnectorsConfig:
    ...
    def test_default_values(self) -> None:
        from oridecon.ai.mcp.config import ConnectorsConfig
    ...
    def test_custom_values(self) -> None:
        from oridecon.ai.mcp.config import ConnectorsConfig, FilesystemConnectorConfig
...
class TestMCPConfig:
    ...
    def test_default_values(self) -> None:
        ...
        assert config.server_name == "oridecon-mcp"
    ...
    def test_connectors_nested_config(self) -> None:
        from oridecon.ai.mcp.config import MCPConfig, ConnectorsConfig, FilesystemConnectorConfig
