...
class TestMCPConstants:
    ...
    def test_env_prefix(self) -> None:
        from oridecon.ai.mcp.constants import ENV_PREFIX

        assert ENV_PREFIX == "ORI_AI_MCP__"

    def test_env_nested_delimiter(self) -> None:
        from oridecon.ai.mcp.constants import ENV_NESTED_DELIMITER

        assert ENV_NESTED_DELIMITER == "__"

    def test_jsonrpc_methods(self) -> None:
        from oridecon.ai.mcp.constants import (
    ...
    def test_error_codes(self) -> None:
        ...
        assert ERROR_MCP_TOOL_NOT_FOUND == "ORI_MCP_001"
        assert ERROR_MCP_CONNECTION_FAILED == "ORI_MCP_002"
        assert ERROR_MCP_INVALID_RESPONSE == "ORI_MCP_003"

    def test_version_is_string(self) -> None:
        from oridecon.ai.mcp.constants import __version__

        assert isinstance(__version__, str)

    def test_all_exports(self) -> None:
        from oridecon.ai.mcp import constants
