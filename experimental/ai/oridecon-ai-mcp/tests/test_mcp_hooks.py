...
class TestMCPServerStartedHook:
    ...
    def test_creation(self) -> None:
        from oridecon.ai.mcp.hooks import MCPServerStartedHook
...
class TestMCPServerStoppedHook:
    ...
    def test_creation(self) -> None:
        from oridecon.ai.mcp.hooks import MCPServerStoppedHook
...
class TestMCPToolInvokedHook:
    ...
    def test_creation(self) -> None:
        from oridecon.ai.mcp.hooks import MCPToolInvokedHook
...
class TestHooksExports:
    ...
    def test_all_exports(self) -> None:
        from oridecon.ai.mcp import hooks
