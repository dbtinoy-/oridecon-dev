"""Unit tests for oridecon-ai-mcp configuration and server."""

from __future__ import annotations

import pytest

from oridecon.ai.mcp import MCPConfig, MCPServer
...
class TestMCPTransport:
    ...
    def test_stdio_transport_exists(self) -> None:
        ...
        from oridecon.ai.mcp import StdioTransport
    ...
    def test_sse_transport_exists(self) -> None:
        ...
        from oridecon.ai.mcp import SSETransport
...
class TestMCPModule:
    ...
    def test_mcp_module_configure_returns_dynamic_module(self) -> None:
        ...
        from oridecon.ai.mcp import MCPModule, MCPProvider
...
class TestMCPProvider:
    ...
    def test_mcp_provider_exists(self) -> None:
        ...
        from oridecon.ai.mcp import MCPProvider
