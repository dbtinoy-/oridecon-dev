"""P2 hook surface import verification for oridecon-ai-mcp."""
...
def test_mcp_hooks_root_module_exists() -> None:
    ...
    assert oridecon.ai.mcp.MCPServerStartedHook is MCPServerStartedHook
    assert oridecon.ai.mcp.MCPServerStoppedHook is MCPServerStoppedHook
    assert oridecon.ai.mcp.MCPToolInvokedHook is MCPToolInvokedHook
