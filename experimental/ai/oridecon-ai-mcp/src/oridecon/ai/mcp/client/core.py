...
Example (SSE)::
    ...
    from oridecon.ai.mcp.client.core import MCPClient, SSEClientTransport
...
from oridecon.ai.mcp.client._transports import (
    MCPClientTransport,
    SSEClientTransport,
...
_CLIENT_NAME = "oridecon-mcp-client"
...
class MCPClient:
    ...
    Args:
        ...
        request_timeout: Per-request wait timeout in seconds.  If a response
            ...
            :exc:`~oridecon.ai.mcp.exceptions.MCPTransportError` is raised.
    """
