...
Wraps :class:`~oridecon.ai.mcp.server.handlers.tools.ToolHandler` and
:class:`~oridecon.ai.mcp.server.handlers.resources.ResourceHandler` to record
metrics for every tool call and resource read using
:class:`~oridecon.ai.observability.metrics.core.AIMetrics`.
...
conventions as the rest of oridecon-ai-observability.
"""
...
from oridecon.contracts.mcp.exceptions import MCPError
