...
try:
    __version__: str = importlib.metadata.version("oridecon-ai-mcp")
except ImportError:
    __version__ = "0.0.0"


# -- Environment Variable Prefixes -------------------------------------------
ENV_PREFIX: str = "ORI_AI_MCP__"
...
ERROR_MCP_TOOL_NOT_FOUND: str = "ORI_MCP_001"
ERROR_MCP_CONNECTION_FAILED: str = "ORI_MCP_002"
ERROR_MCP_INVALID_RESPONSE: str = "ORI_MCP_003"
