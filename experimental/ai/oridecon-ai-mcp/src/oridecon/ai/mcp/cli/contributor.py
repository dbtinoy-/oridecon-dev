...
from oridecon.contracts.cli.contributions import CommandContribution
from oridecon.contracts.cli.types import GeneratorDefinition


class McpCliContributor:
    """CLI contributor for the oridecon-ai-mcp package."""
    ...
    def get_generators(self) -> list[GeneratorDefinition]:
        ...
        return [
            GeneratorDefinition(
                ...
                contributor="mcp",
                generator_path="oridecon.ai.mcp.cli.generators.mcp_controller:MCPControllerGenerator",
            ...
            GeneratorDefinition(
                ...
                contributor="mcp",
                generator_path="oridecon.ai.mcp.cli.generators.mcp_server:MCPServerGenerator",
    ...
    def get_commands(self) -> list[CommandContribution]:
        ...
        return [
            CommandContribution(
                ...
                app_factory_path="oridecon.ai.mcp.cli.commands:create_mcp_app",
                contributor="mcp",
                category="ai",
            ),
        ]
