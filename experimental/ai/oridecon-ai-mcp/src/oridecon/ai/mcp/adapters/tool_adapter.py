"""Tool adapter for bridging oridecon-agents with MCP.
...
class ToolRegistryAdapter:
    """Adapter that bridges oridecon-agents ToolRegistry to MCPToolProviderProtocol.

    This adapter allows the MCP server to use the @tool-decorated
    functions from oridecon-agents.  The translation is minimal:
