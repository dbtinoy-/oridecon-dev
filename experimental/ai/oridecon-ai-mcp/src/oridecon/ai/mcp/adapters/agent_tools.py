"""Adapter for consuming MCP tools as Oridecon agent tools."""
...
class MCPToolAdapter:
    """Adapter that wraps an MCP tool into a Oridecon ToolProtocol.

    Allows Oridecon agents to natively invoke tools hosted on an
    external MCP server.
    """
