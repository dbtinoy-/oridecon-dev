...
class MCPModule(Module):
    ...
    def from_services(
        ...
        *,
        ...
        Args:
            ...
            config: Optional :class:`~oridecon.ai.mcp.config.MCPConfig` override.
    ...
    def configure(
        ...
        **provider_kwargs: Any,
        ...
        Args:
            config: Optional :class:`~oridecon.ai.mcp.config.MCPConfig`.
            controllers: :class:`~oridecon.ai.mcp.controllers.MCPController`
            ...
            **provider_kwargs: Additional keyword arguments forwarded to
                :class:`~oridecon.ai.mcp.di.provider.MCPProvider`.
