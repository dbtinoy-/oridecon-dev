...
def tool(
    ...
    *,
    ...
    :meth:`~oridecon.ai.mcp.controllers.base.MCPController.collect_tools`.
...
def resource(
    ...
    *,
    ...
    :meth:`~oridecon.ai.mcp.controllers.base.MCPController.collect_resources`.
...
def prompt(
    ...
    *,
    ...
    :meth:`~oridecon.ai.mcp.controllers.base.MCPController.collect_prompts`.
