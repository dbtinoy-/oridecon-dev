...
from oridecon.ai.mcp.controllers._internal import _build_input_schema
...
class _CombinedToolProvider:
    ...
    Used by :class:`~oridecon.ai.mcp.di.MCPProvider` when both
...
class _CombinedResourceProvider:
    ...
    Used by :class:`~oridecon.ai.mcp.di.MCPProvider` when both controllers
