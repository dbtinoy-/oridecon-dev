...
class SystemBox(Component):
    ...
    def render(self) -> Any:
            ...
            if m.get("render") == "block":
                ...
                if not has_icon:
                    first_letter_node = el(
                        "span",
                        first_letter,
                        class_="font-bold text-xs w-6 h-6 flex items-center justify-center shrink-0 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400",
                        x_show="sidebarMini",
                    )
                ...
                block_items.append(
                    el(
                        ...
                        href=href,
                        class_=(
                            "group flex items-center px-3 py-2 rounded-xl text-sm font-medium transition-colors duration-200 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary-600 dark:hover:text-primary-400"
                        ),
                        **{
                ...
                compact_nodes.append(
                    el(
                        ...
                        title=label,
                        class_=(
                            "inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
                        ),
                        **attrs,
                    ),
                )
        ...
        return el(
            ...
            block_area,
            compact_bar,
            class_="flex flex-col px-3 py-2 border-b border-gray-100 dark:border-gray-800",
        )
