        ...
        return el(
            ...
            el(
                "button",
                {
                    "type": "button",
                    "x-on:click": "toggle()",
                    "class": "relative p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500",
                ...
                el(
                    "span",
                    {
                        ...
                        "class": "absolute -top-0.5 -right-0.5 inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold leading-none text-white bg-red-500 rounded-full min-w-[16px]",
                    },
                ),
            ),
            # Dropdown
            el(
                "div",
                {
                    ...
                    "class": "absolute right-0 mt-2 w-80 rounded-xl shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-gray-700 z-50",
                },
                # Header
                el(
                    "div",
                        ...
                        el(
                            ...
                            el(
                                "span",
                                {
                                    ...
                                    ":class": "{'bg-blue-500': notif.level === 'info', 'bg-yellow-500': notif.level === 'warning', 'bg-red-500': notif.level === 'error', 'bg-green-500': notif.level === 'success'}",
                                },
                            ),
                            # Content
                            el(
                ...
                el(
                    ...
                    el(
                        ...
                        {
                            "href": self.inbox_url,
                            "class": "block w-full text-center px-4 py-2 text-xs text-primary-600 dark:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-b-xl transition-colors",
                        },
