...
class ColumnRenderingMixin:
    ...
    def render_cell(
        ...
        if self._copyable:
            classes.append("cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800")
    ...
    def render_header(
        ...
        if self._sortable:
            ...
            classes.append("hover:bg-gray-100")
            classes.append("dark:hover:bg-gray-700")
            ...
            if is_current:
                ...
                icon_classes = "h-4 w-4 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity"
        ...
        classes.append("relative group sticky top-0 z-20 bg-gray-50 dark:bg-gray-900")
