...
class TextColumn(Column):
    ...
    def render(self, value: Any, record: dict) -> Any:
        ...
        if value is None:
            return el("span", "—", class_="text-gray-400 dark:text-gray-600 italic")
        ...
        if self._color:
            ...
            classes.append("text-gray-900 dark:text-gray-100")
    ...
    def render(self, value: Any, record: dict) -> Any:
        ...
        if isinstance(value, str):
            try:
                ...
                return el("span", str(value), class_="text-gray-900 dark:text-gray-100")
        ...
        if self._relative:
            ...
            return el(
                "span",
                relative,
                class_="text-gray-900 dark:text-gray-100",
                title=formatted,
            )

        return el("span", formatted, class_="text-gray-900 dark:text-gray-100")
...
class CurrencyColumn(Column):
    ...
    def render(self, value: Any, record: dict) -> Any:
        ...
        try:
            ...
            color_class = "text-gray-900 dark:text-gray-100"
            if amount < 0:
    ...
    def render(self, value: Any, record: dict) -> Any:
        ...
        for item in items:
            if self._badge:
                ...
                elements.append(
                    el("span", item, class_="text-gray-700 dark:text-gray-300"),
                )
