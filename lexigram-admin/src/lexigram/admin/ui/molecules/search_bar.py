    ...
    def render(self) -> Any:
        ...
        if self.show_icon:
            inner_content.append(
                el(
                    ...
                    class_="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
                ),
            )
        ...
        if self.show_clear:
            clear_btn = el(
                ...
                class_="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 cursor-pointer",
