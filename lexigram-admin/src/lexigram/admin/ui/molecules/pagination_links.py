    ...
    def page_link(
        ...
        if disabled:
            return el(
                "span",
                label,
                class_=f"{base_cls} text-gray-300 dark:text-gray-600 cursor-not-allowed bg-gray-50 dark:bg-gray-800 {extra_cls}",
                **{"aria-disabled": "true"},
            )
        ...
        if active:
            ...
            cls = f"{base_cls} text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 {extra_cls}"
            ...
            if item == "...":
                page_links.append(
                    el(
                        "span",
                        "...",
                        class_="relative inline-flex items-center justify-center min-w-[40px] h-10 text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 border-y border-gray-300 dark:border-gray-600",
                    ),
                )
            else:
                page_links.append(
