    ...
    def render(self) -> Any:
        ...
        def get_props(type_name: str, icon_name: str, label_text: str) -> Any:
            ...
            if is_active:
                ...
                props["class_"] = (
                    "bg-gray-100 dark:bg-gray-700 text-primary-600 dark:text-primary-400 cursor-default pointer-events-none"
                )
                ...
                props.update(
                    {
                        ...
                        "class_": "text-gray-500 hover:text-gray-700 hover:bg-gray-50 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-800",
                    },
                )
        ...
        return el(
            ...
            el(
                ...
                stack_btn.render(),
                sidebar_btn.render(),
                class_="inline-flex items-center gap-1 bg-white dark:bg-gray-800 rounded-md p-1 border border-gray-200 dark:border-gray-700",
            ),
