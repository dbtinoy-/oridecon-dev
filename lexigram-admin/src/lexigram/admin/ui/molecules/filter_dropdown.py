    ...
    def render(self) -> Any:
        ...
        return el(
            ...
            el(
                ...
                self.label,
                for_=self.name,
                class_="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5",
            ),
            el(
                "select",
                ...
                *option_els,
                ...
                id=self.name,
                multiple=self.multi,
                class_="block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm focus:border-primary-500 focus:ring-primary-500 py-2 pl-3 pr-10 transition-colors",
