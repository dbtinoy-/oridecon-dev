...
CONTROL_SELECT_CLASSES = "px-2 py-1.5 h-8 border rounded text-sm bg-white dark:bg-gray-800 dark:border-gray-600"
...
class Pagination(Component):
    ...
    def render(self) -> Any:
        ...
        if self.page > 1:
            ...
            links.append(
                el(
                    "span",
                    "Prev",
                    class_="px-2 py-1 text-sm text-gray-400 cursor-not-allowed",
                ),
            )
        ...
        for p in visible_pages:
            if p is None:
                links.append(
                    el("span", "...", class_="px-2 py-1 text-sm text-gray-400"),
                )
            elif p == self.page:
                ...
                links.append(
                    el(
                        "span",
                        str(p),
                        class_="px-2 py-1 text-sm font-bold text-gray-900 dark:text-gray-100",
                    ),
                )
            else:
        ...
        if self.show_size_selector:
            ...
            size_selector = el(
                ...
                el(
                    "label",
                    "Show",
                    class_="mr-2 text-sm text-gray-500 dark:text-gray-400",
                ),
                el(
                    "select",
                    *size_items,
