...
def _auth_form(
    ...
    *,
    ...
    children.append(
        SubmitButton(label=submit_label, variant=submit_variant, class_="w-full")
    )
...
def render_roles_list_page(
    ...
    *,
    ...
    """Render the roles management list page content.
    ...
    Returns:
        HTML string fragment for the roles list page body.
    """
    rows = "\n".join(
        f"""
        <tr>
...
def render_role_form_page(
    *,
    ...
    """Render the role create/edit form page content.
    ...
    Returns:
        HTML string fragment for the role form page body.
    """
...
def render_users_list_page(
    ...
    *,
    ...
    """Render the admin users list page content with role badges.
    ...
    Returns:
        HTML string fragment for the users list page body.
    """
    rows = "\n".join(
        f"""
        <tr>
...
def render_user_roles_page(
    ...
    *,
    ...
    """Render the user role assignment form content.
    ...
    Returns:
        HTML string fragment for the user roles page body.
    """
...
def render_user_permissions_page(
    ...
    *,
    ...
    """Render the user direct-permission editing form content.
    ...
    Returns:
        HTML string fragment for the user permissions page body.
    """
    selected = selected or set()
    options = permission_options or {}
    groups = "\n".join(
