---
title: "oridecon-contracts How-Tos"
description: "Practical how-to guides for defining protocols, adding types, and creating exceptions in oridecon-contracts."
---
# How-To Guides
...
Place it in the correct domain directory under `oridecon/contracts/` (e.g. `data/index/protocols.py`).
...
```python
# core/oridecon-contracts/src/oridecon/contracts/ai/exceptions.py
class AIMemoryError(AIError):
    """Base for AI memory system errors. Extended in oridecon-ai-memory."""


# oridecon-ai-memory/exceptions.py
from oridecon.contracts.ai.exceptions import AIMemoryError
...
# overrides apply to built-in sections, e.g. ORI_LOGGING__LEVEL.
```
...
```python
# oridecon/contracts/ai/vector.py
