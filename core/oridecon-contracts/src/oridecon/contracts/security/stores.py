...
Unlike the synchronous :class:`~oridecon.contracts.security.secrets.SecretStoreProtocol`
...
Implementations ship in ``oridecon-sql`` (``oridecon.sql.stores``) so they can share
