...
Moved from ``oridecon.contracts.execution`` — step results are a workflow
...
class SagaStep:
    ...
    Shared across ``oridecon-workflow`` and ``oridecon-events`` via contracts.
