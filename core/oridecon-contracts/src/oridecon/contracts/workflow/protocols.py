"""Workflow orchestration protocols for Oridecon Framework.

Defines protocols for pipeline execution, bulk processing, and saga
coordination. These are the contracts that oridecon-workflow implements.
"""
...
from oridecon.contracts.workflow.types import (
...
class StateMachineProtocol(Protocol):
    ...
    raising :exc:`~oridecon.contracts.workflow.StateError`.
    """
