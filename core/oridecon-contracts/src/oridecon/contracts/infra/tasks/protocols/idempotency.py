...
if TYPE_CHECKING:
    from oridecon.contracts.infra.tasks.idempotency import IdempotencyResult
...
class IdempotencyManagerProtocol(Protocol):
    ...
    Implementations (e.g. ``oridecon-tasks``
    :class:`~oridecon.tasks.execution.manager.IdempotencyManager`) generate
...
class IdempotentTaskManagerProtocol(Protocol):
    ...
    Implementations (e.g. ``oridecon-tasks``
    :class:`~oridecon.tasks.execution.manager.IdempotentTaskManager`)
