...
These live in contracts so ANY package (oridecon-events, oridecon-web, etc.)
can reference retry/circuit breaker configs without depending on
the oridecon-resilience implementation package.
"""
...
class CircuitBreakerConfig:
    ...
    Attributes:
        ...
        backend: State store backend for distributed circuit breaker coordination.
            ...
            ``"redis"`` — uses a :class:`~oridecon.contracts.cache.CacheBackendProtocol`
