...
from oridecon.contracts.web.http_types import ServiceInfo as ServiceInfo

if TYPE_CHECKING:
    from oridecon.contracts.web.http_models import HttpResponse
...
class InterceptorProtocol(Protocol):
    ...
    :class:`~oridecon.http.HTTPClient`.  Implementations receive typed
    ...
    async def intercept_request(self, context: Any) -> Any:
        ...
        Args:
            context: :class:`~oridecon.http.RequestContext` for the outbound
