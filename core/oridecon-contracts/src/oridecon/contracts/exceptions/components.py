...
These exceptions inherit from the canonical Oridecon hierarchy but provide
...
class ComponentError(OrideconError):
    """Base exception for all component-related errors."""

    _code = "ORI_ERR_INFRA_004"
