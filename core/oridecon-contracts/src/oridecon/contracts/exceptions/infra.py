...
class InfrastructureError(OrideconError):
    """System-level failures (DB down, network timeouts)."""

    _code = "ORI_ERR_INFRA_001"
...
class RegistryError(OrideconError):
    """Base exception for registry errors."""

    _code = "ORI_ERR_REG_001"
