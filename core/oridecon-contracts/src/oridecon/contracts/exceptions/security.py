"""Security exception classes for the Oridecon Framework.
...
class SecurityError(OrideconError):
    """Base security error for the Oridecon security subsystem."""

    _code = "ORI_ERR_SEC_001"
