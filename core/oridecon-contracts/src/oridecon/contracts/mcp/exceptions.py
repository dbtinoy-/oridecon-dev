"""MCP exception hierarchy for the Oridecon framework.

MCP-specific errors that can occur during MCP server operation.
These extend the base OrideconError for consistent error handling.
"""
...
class MCPError(OrideconError):
    """Base exception for all MCP errors."""

    _code = "ORI_ERR_MCP_001"
