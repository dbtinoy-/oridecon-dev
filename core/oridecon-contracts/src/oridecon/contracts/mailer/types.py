# oridecon-contracts/src/oridecon/contracts/mailer/types.py
"""Mailer value types."""
...
from oridecon.contracts.lib.time import utcnow as _utcnow
...
class EmailMessage:
    ...
    Passed to :class:`~oridecon.contracts.mailer.protocols.MailerProtocol`.
