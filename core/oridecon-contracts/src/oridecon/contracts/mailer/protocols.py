# oridecon-contracts/src/oridecon/contracts/mailer/protocols.py
...
class MailerProtocol(Protocol):
    ...
    :class:`~oridecon.contracts.mailer.types.EmailMessage` and
    ...
    async def health_check(self, timeout: float = 5.0) -> HealthCheckResult:
        ...
        Returns:
            :class:`~oridecon.contracts.core.HealthCheckResult` with status details.
        """
        ...
