...
class LLMError(AIError):
    ...
    Extended in oridecon-ai-llm with specific failures like
    rate limiting, content filtering, invalid tokens, etc.
    """

    _code = "ORI_ERR_LLM_001"
...
class RAGError(AIError):
    ...
    Extended in oridecon-ai-rag with specific failures like
    retrieval, preprocessing, synthesis, etc.
    """

    _code = "ORI_ERR_RAG_001"
...
class AIMemoryError(AIError):
    ...
    Extended in oridecon-ai-memory with specific failures like
    consolidation, retrieval, storage issues, etc.
    """

    _code = "ORI_ERR_MEM_001"
...
class SkillError(AIError):
    ...
    Extended in oridecon-ai-skills with specific failures like
    skill not found, execution failure, parameter validation, etc.
    """

    _code = "ORI_ERR_SKILL_001"
...
class ExtractionError(AIError):
    ...
    Extended in oridecon-ai-llm with specific failures like parse errors,
    validation failures, and max retry exhaustion.
    """

    _code = "ORI_ERR_AI_002"
...
class RelayError(AIError):
    ...
    Extended in oridecon-ai-llm with specific conversion failures (e.g.
