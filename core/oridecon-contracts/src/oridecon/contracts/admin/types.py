...
oridecon extension that contributes admin dashboard surfaces.
"""
...
from oridecon.contracts.admin.widget_content import WidgetContent, WidgetKind

if TYPE_CHECKING:
    from oridecon.contracts.admin.page_handler import AdminPageHandlerProtocol
...
class WidgetParams:
    ...
    Parsing belongs in ``oridecon.admin.params.parse_widget_params``.
    """
