...
for domain models in the Oridecon framework. The actual implementation
lives in ``oridecon.domain.base``.
"""
...
class DomainModelProtocol(Protocol):
    ...
    concrete base in ``oridecon.domain``) builds on Pydantic v2.  This
