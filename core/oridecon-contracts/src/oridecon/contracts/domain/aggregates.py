...
The concrete ``AggregateRoot`` base class lives in ``oridecon.domain.models.aggregate``
(the core ``oridecon`` package).  Contracts expose only the structural protocol
