"""Configuration protocol for the Oridecon framework.
...
class Environment(StrEnum):
    ...
    ``ORI_ENV`` (or ``APP_ENV``) environment variable.
    """
    ...
    def from_env(cls, default: Environment = "development") -> Environment:  # type: ignore[assignment]
        ...
        """
        raw = os.environ.get("ORI_ENV") or os.environ.get("APP_ENV") or default
        try:
...
class ConfigProtocol(Protocol):
    ...
    Any configuration object (BaseConfig, OrideconConfig, or custom
