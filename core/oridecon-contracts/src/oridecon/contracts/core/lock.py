"""Distributed Lock protocol for Oridecon Framework.
...
Example::
    ...
    from oridecon.contracts.lock import DistributedLockProtocol
...
class AsyncLockProtocol(Protocol):
    ...
    **single-process** (i.e. not distributed); use :class:`DistributedLockProtocol`
    ...
    Example::
        ...
        from oridecon.contracts.lock import AsyncLockProtocol
...
class LockManagerProtocol(Protocol):
    ...
    Example::
        ...
        from oridecon.contracts.lock import LockManagerProtocol
