...
from oridecon.contracts.admin.widget_content import MessageContent, WidgetKind
...
class TestManagementPageDefinition:
    def test_creation(self) -> None:
        page = ManagementPageDefinition(
            ...
            handler="oridecon.cache.admin.pages:cache_overview",
        )
...
class TestSettingsPanelDefinition:
    def test_creation(self) -> None:
        panel = SettingsPanelDefinition(
            ...
            handler="oridecon.cache.admin.pages:cache_settings",
        )
...
class TestAdminActionDefinition:
    def test_creation(self) -> None:
        action = AdminActionDefinition(
            ...
            contributor="cache",
            handler="oridecon.cache.admin.actions:flush_all",
        )
