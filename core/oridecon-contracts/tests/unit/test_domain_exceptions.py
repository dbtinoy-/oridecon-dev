...
class TestDomainError:
    def test_domain_error_code(self) -> None:
        exc = DomainError()
        assert exc.code == "ORI_ERR_DOM_001"
...
class TestNotFoundError:
    def test_not_found_error_code(self) -> None:
        exc = NotFoundError()
        assert exc.code == "ORI_ERR_DOM_002"
...
class TestPermissionDeniedError:
    def test_permission_denied_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_DOM_003"
...
class TestAuthenticationError:
    def test_authentication_error_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_DOM_004"
...
class TestAuthorizationError:
    def test_authorization_error_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_DOM_005"
...
class TestRateLimitError:
    def test_rate_limit_error_code(self) -> None:
        exc = RateLimitError()
        assert exc.code == "ORI_ERR_DOM_006"
...
class TestConflictError:
    def test_conflict_error_code(self) -> None:
        exc = ConflictError()
        assert exc.code == "ORI_ERR_DOM_007"
...
class TestSerializationError:
    def test_serialization_error_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_SERIAL_001"
...
class TestMappingError:
    def test_mapping_error_code(self) -> None:
        exc = MappingError()
        assert exc.code == "ORI_ERR_MAP_001"
...
class TestWebError:
    def test_web_error_code(self) -> None:
        exc = WebError()
        assert exc.code == "ORI_ERR_WEB_001"
...
class TestValidationError:
    def test_validation_error_code(self) -> None:
        exc = ValidationError()
        assert exc.code == "ORI_ERR_VAL_002"
