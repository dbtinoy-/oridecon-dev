...
This test suite ensures that the entire Oridecon Framework follows
...
from oridecon.contracts.ai.governance import AuditEventType
from oridecon.contracts.ai.session import SessionStatus
from oridecon.contracts.ai.types import ModelCapability, ModelProvider
from oridecon.contracts.core.concurrency_enums import ConcurrencyStrategy
from oridecon.contracts.core.health import HealthStatus
from oridecon.contracts.core.provider import Lifecycle, ProviderPriority
from oridecon.contracts.data.sql.sql_dialect import SQLDialect
from oridecon.contracts.data.vector.enums import DistanceMetric, IndexState, IndexType
from oridecon.contracts.infra.resilience.enums import CircuitState, RetryStrategy
...
class TestEnumComplianceCoreLibrary:
    """Test that oridecon.contracts defines NO bare string constant classes."""

    @pytest.fixture
    def contracts_path(self) -> Path:
        """Get path to oridecon.contracts source."""
        import oridecon.contracts

        module_file = oridecon.contracts.__file__
    ...
    def test_no_bare_string_classes(self, contracts_path: Path) -> None:
        """Verify that oridecon.contracts contains NO bare string constant classes.
