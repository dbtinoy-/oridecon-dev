...
def test_json_parser():
    ...
    from oridecon.contracts.ai.parsers import JSONOutputParser
...
def test_xml_parser():
    ...
    from oridecon.contracts.ai.parsers import XMLOutputParser
...
def test_pydantic_parser():
    ...
    from oridecon.contracts.ai.parsers import PydanticOutputParser
