...
def test_document():
    ...
    from oridecon.contracts.ai.document import Document
...
def test_text_splitter():
    ...
    from oridecon.contracts.ai.document import TextSplitter
...
def test_recursive_character_text_splitter():
    ...
    from oridecon.contracts.ai.document import RecursiveCharacterTextSplitter
