...
def test_retrieval_query_is_frozen_dataclass():
    ...
    from oridecon.contracts.ai.retrievers import RetrievalQuery
...
def test_retrieved_node_is_frozen_dataclass():
    ...
    from oridecon.contracts.ai.retrievers import RetrievedNode
...
def test_retriever_protocol_returns_result():
    ...
    from oridecon.contracts.ai.retrievers import RetrievedNode, RetrieverProtocol
...
def test_node_postprocessor_protocol_is_runtime_checkable():
    ...
    from oridecon.contracts.ai.retrievers import NodePostprocessorProtocol
...
def test_retriever_protocol_exports():
    ...
    from oridecon.contracts.ai import RetrieverProtocol
...
def test_node_postprocessor_protocol_exports():
    ...
    from oridecon.contracts.ai import NodePostprocessorProtocol
...
def test_retrieval_query_exports():
    ...
    from oridecon.contracts.ai import RetrievalQuery
...
def test_retrieved_node_exports():
    ...
    from oridecon.contracts.ai import RetrievedNode
...
def test_retriever_error_exports():
    ...
    from oridecon.contracts.ai import RetrieverError
...
def test_retriever_error_is_ai_error():
    ...
    from oridecon.contracts.ai.exceptions import AIError
    from oridecon.contracts.ai.retrievers import RetrieverError
