...
def test_conversation_memory_add_message():
    ...
    from oridecon.contracts.ai.memory import ConversationMemory
...
def test_window_memory_limits():
    ...
    from oridecon.contracts.ai.memory import WindowMemory
...
def test_memory_protocol_exists():
    ...
    from oridecon.contracts.ai.memory import MemoryProtocol
