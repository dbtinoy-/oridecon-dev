...
def test_chat_message():
    ...
    from oridecon.contracts.ai.chat import ChatMessage
...
def test_chat_history():
    ...
    from oridecon.contracts.ai.chat import ChatHistory, ChatMessage
...
def test_chat_history_to_lc_format():
    ...
    from oridecon.contracts.ai.chat import ChatHistory
