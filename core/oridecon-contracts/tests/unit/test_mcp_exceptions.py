...
class TestMCPError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_001"
    ...
    def test_is_oridecon_error(self) -> None:
        """Test MCPError is a OrideconError."""
        from oridecon.contracts.exceptions.base import OrideconError

        exc = MCPError("Test")
        assert isinstance(exc, OrideconError)
...
class TestMCPTransportError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_002"
...
class TestMCPToolCallError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_003"
...
class TestMCPResourceError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_004"
...
class TestMCPProtocolError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_005"
...
class TestMCPMethodNotFoundError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_006"
...
class TestMCPPromptError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_007"
...
class TestMCPInitializationError:
    ...
    def test_creation(self) -> None:
        ...
        assert exc._code == "ORI_ERR_MCP_008"
...
class TestMCPExceptionsIntegration:
    ...
    def test_can_raise_transport_error(self) -> None:
        ...
        assert exc_info.value._code == "ORI_ERR_MCP_002"
