...
from oridecon.contracts.data import OutboxStoreProtocol
...
class TestDataProtocolsExports:
    ...
    def test_unit_of_work_protocol_exported(self) -> None:
        ...
        from oridecon.contracts.data.sql import UnitOfWorkProtocol
...
class TestDataIdentifiers:
    ...
    def test_identifier_types_exported(self) -> None:
        ...
        from oridecon.contracts.data.identifiers import Table, Column, Schema
