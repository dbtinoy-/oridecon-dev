...
class TestFlagManagerProtocol:
    ...
    async def test_has_get_value_method(self) -> None:
        ...
        from oridecon.contracts.feature_flags.models import FlagValue
    ...
    async def test_has_evaluate_method(self) -> None:
        ...
        from oridecon.contracts.feature_flags.models import FlagEvaluation, FlagType
    ...
    async def test_has_get_all_flags_method(self) -> None:
        ...
        from oridecon.contracts.feature_flags.models import FlagEvaluation
