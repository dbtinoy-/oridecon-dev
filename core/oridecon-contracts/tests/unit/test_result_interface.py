"""Tests for Result protocol in oridecon-contracts.

Note: This tests the protocol/interface definitions, not implementations.
The concrete implementations (Ok, Err, Result) are in oridecon.contracts.core.result.
"""


import pytest
from oridecon.contracts.core.result import Ok, Err, Result
