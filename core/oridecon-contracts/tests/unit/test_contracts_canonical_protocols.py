"""Tests locking canonical protocol definitions to oridecon-contracts.

Enforces R5 of docs/oridecon-docs/guides/contracts.md: a protocol or type
shared across packages has exactly ONE canonical definition in
oridecon-contracts, and extension packages import it rather than redefining
it locally.
"""
...
class TestCanonicalChunkerProtocol:
    """The canonical ChunkerProtocol lives in oridecon-contracts only."""
