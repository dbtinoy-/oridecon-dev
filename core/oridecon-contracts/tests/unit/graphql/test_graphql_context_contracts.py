...
class TestGraphQLContractsExports:
    ...
    def test_graphql_principal_exported_from_graphql_module(self) -> None:
        """GraphQLPrincipal must be exported from oridecon.contracts.graphql."""
        from oridecon.contracts.graphql import GraphQLPrincipal
    ...
    def test_graphql_principal_resolver_protocol_exported_from_graphql_module(
        ...
        """GraphQLPrincipalResolverProtocol must be exported from oridecon.contracts.graphql."""
        from oridecon.contracts.graphql import GraphQLPrincipalResolverProtocol

        # Should be importable from the package root
        assert GraphQLPrincipalResolverProtocol is not None

    def test_graphql_principal_in_all_export(self) -> None:
        """GraphQLPrincipal must be in __all__ of oridecon.contracts.graphql."""
        from oridecon.contracts import graphql
