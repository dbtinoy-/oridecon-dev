"""Core no-op observability primitives for Oridecon Framework.

These implementations satisfy the observability contracts without requiring
``oridecon-monitor``. They are intentionally lightweight and safe to keep as
...
from oridecon.contracts.observability.metrics import MetricProtocol
from oridecon.contracts.observability.tracing import SpanProtocol
