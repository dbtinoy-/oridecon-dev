...
from oridecon.contracts.exceptions.config import (
...
class UnknownConfigKeysError(ConfigurationError):
    ...
    ``ORI_CONFIG_ALLOW_UNKNOWN=true`` when a key is genuinely forward-declared.
    """

    _code: str = "ORI_ERR_CFG_006"
