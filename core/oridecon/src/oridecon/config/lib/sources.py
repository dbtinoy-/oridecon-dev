"""Configuration sources for Oridecon Framework."""

from __future__ import annotations

from abc import ABC, abstractmethod
import argparse
import json  # noqa: TID251 — config loading intentionally uses stdlib json, not oridecon.serialization
import os
from pathlib import Path
from typing import Any, TypeVar

from oridecon.config.lib.merge import deep_merge, interpolate_env_vars
    ...
    def _collect_sync(self, sources: list[ConfigSource] | None) -> dict[str, Any]:
        ...
        for source in self._get_sources(sources):
            try:
                ...
                # fast (consistent with ${VAR} interpolation, ORI_ERR_CFG_001).
                raise
            except OSError:
            ...
            if not source.pre_interpolated:
                ...
                # unresolved references fail fast (ORI_ERR_CFG_001).
