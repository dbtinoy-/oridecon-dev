...
:class:`~oridecon.app.pipeline.MiddlewarePipeline`.  Use it when
...
Example::
    ...
    from oridecon.middleware.builtins import LoggingMiddleware, TimingMiddleware
...
class MiddlewareChain:
    """Mutable builder for :class:`~oridecon.app.pipeline.MiddlewarePipeline`.
