...
try:
    __version__: str = importlib.metadata.version("oridecon")
except ImportError:
    __version__ = "0.0.0"

# -- Environment Variable Prefix -------------------------------------------

ENV_PREFIX: str = "ORI_MIDDLEWARE__"
"""Environment variable prefix for middleware configuration."""

ENV_NESTED_DELIMITER: str = "__"
"""Nested delimiter for environment variables (e.g., ORI_MIDDLEWARE__NESTED__KEY)."""
