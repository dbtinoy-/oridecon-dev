...
from oridecon.middleware.di.provider import MiddlewareProvider
...
class MiddlewareModule(Module):
    ...
    Usage::
        ...
        from oridecon.middleware.config import MiddlewareConfig
    ...
    def configure(cls, config: Any | None = None) -> DynamicModule:
        ...
        Args:
            config: :class:`~oridecon.middleware.config.MiddlewareConfig` or ``None``
    ...
    def stub(cls, config: Any | None = None) -> DynamicModule:
        ...
        Args:
            config: Accepted for interface compatibility with
                :meth:`~oridecon.di.module.base.Module.stub`; ignored.
                Pass :class:`~oridecon.middleware.config.MiddlewareConfig`
