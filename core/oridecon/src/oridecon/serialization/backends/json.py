...
Provides a standard JSON serialization interface across all Oridecon packages
...
try:
    ...
    def _default_encoder(obj: Any) -> Any:
        ...
        from oridecon.serialization.domain import json_serialize
...
class OrjsonSerializer:
    ...
    def __init__(self, config: SerializationConfig | None = None) -> None:
        ...
        from oridecon.serialization.config import SerializationConfig
        from oridecon.serialization.types import JSONBackend
