"""Boot-time configuration validation for :class:`~oridecon.app.base.Application`.
...
def validate_app_config(
    ...
    <oridecon.contracts.core.config.ConfigProtocol.validate_for_environment>`
    on the root config and collects all returned
    :class:`~oridecon.contracts.core.config.ConfigIssue` entries.
    ...
    """
    from oridecon.config.lib.validation import validate_all_configs
