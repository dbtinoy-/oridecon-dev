"""Health probe surface for :class:`~oridecon.app.base.Application`."""
...
class HealthProbeMixin:
    ...
    :class:`~oridecon.app.base.Application`.
    """
    ...
    async def health_check(self, timeout: float | None = None) -> AggregateHealthResult:
        ...
        Returns an :class:`~oridecon.contracts.core.health.AggregateHealthResult`
        whose ``status`` follows worst-case aggregation across all registered
        provider health checks.
        """
        from oridecon.app.base import AppState  # local: avoid circular import
