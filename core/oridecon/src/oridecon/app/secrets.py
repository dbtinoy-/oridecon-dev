"""Secret registration surface for :class:`~oridecon.app.base.Application`."""
...
class SecretsMixin:
    ...
    def register_secrets_from_store(
        ...
        *,
        ...
        :class:`~oridecon.config.secrets.SecretsValidator` logic as literal secrets.

        Args:
            store: An implementation of
                :class:`~oridecon.contracts.security.secrets.SecretStoreProtocol`.
        ...
        Example::
            ...
            from oridecon.security.secrets import EnvSecretStore
    ...
    def _validate_secrets(self) -> None:
        ...
        """
        from oridecon.config.secrets import SecretsPolicy, SecretsValidator
