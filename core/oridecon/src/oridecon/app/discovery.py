...
_PROVIDER_ATTR = "__oridecon_provider__"
...
def discover_modules_from_entry_points(
    ...
    Args:
        group: Entry-point group name. Default "oridecon.modules".
        ...
        for candidate in ("plugin.py", "__init__.py"):
            ...
            try:
                spec = importlib.util.spec_from_file_location(
                    f"_oridecon_discovery_{path.name}", file_path
                )
