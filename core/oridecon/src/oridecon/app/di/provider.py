"""Core providers for Oridecon Applications.
...
class CoreProvider(Provider):
    """Main **aggregating** provider for Oridecon core services.
    ...
    **Do NOT confuse with** :class:`~oridecon.primitives.di.provider.CoreInfrastructureProvider`:
