"""Logging system configuration for the Oridecon Framework.
...
import oridecon.logging.processors as _proc
from oridecon.logging.processors import (
    LEVEL_NAME_TO_INT,
    _add_logger_name,
    _context_processor,
...
def configure_logging(
    ...
    Args:
        ...
        levels: Per-logger level overrides. Keys are logger name prefixes,
            ...
            ``{"oridecon.di": "DEBUG", "oridecon.resilience": "WARNING"}``.
...
def apply_config(logging_config: Any, *, service_name: str | None = None) -> None:
    ...
    configure_logging(
        ...
        service_name=service_name or "oridecon-app",
        levels=levels,
