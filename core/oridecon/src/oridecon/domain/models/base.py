...
from oridecon.domain.models.coercion import coerce_and_build, resolve_type_hints
from oridecon.identity import ambient as identity_ambient
from oridecon.primitives.typing import type_allows_none

# Infrastructure imports (new locations)
from oridecon.serialization.domain import (
    get_model_extra,
    json_serialize,
    model_dump_to_dict,
)
...
from oridecon.validation.engine import coerce_field_value
