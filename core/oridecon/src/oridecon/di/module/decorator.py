...
def module(
    ...
    *,
    ...
    """Declare a class as a Oridecon module.
...
def _attach_metadata(
    ...
    *,
    ...
    if resolved_scan:
        from oridecon.app.discovery import discover_injectables
    ...
    metadata.__oridecon_owner__ = cls
...
def _create_scan_provider(
    ...
    """
    from oridecon.app import InjectableAutoProvider
