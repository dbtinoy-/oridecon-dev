...
in ``oridecon.contracts.exceptions.provider``.  The compiler calls
...
def format_cycle_error(cycle: list[str]) -> str:
    ...
    return (
        ...
        f"\n"
        f"Reference: https://docs.oridecon.dev/modules#cycles"
    )
...
def format_missing_import_error(
    ...
    return (
        ...
        f"\n"
        f"Reference: https://docs.oridecon.dev/modules#imports"
    )
...
def format_visibility_error(
    ...
    return (
        ...
        f"\n"
        f"  Reference: https://docs.oridecon.dev/modules#visibility"
    )
...
def format_duplicate_module_error(
    ...
    return (
        ...
        f"\n"
        f"Reference: https://docs.oridecon.dev/modules#configuration"
    )
