...
from oridecon.di.module.compiler.context import CompilerContext
from oridecon.di.module.compiler.phases.collect import CollectPhase
from oridecon.di.module.compiler.phases.detect_cycles import CycleDetectionPhase
from oridecon.di.module.compiler.phases.expand import ReexportExpansionPhase
from oridecon.di.module.compiler.phases.order import ProviderOrderingPhase
from oridecon.di.module.compiler.phases.validate import ValidationPhase
from oridecon.di.module.compiler.phases.visibility import VisibilityPhase
from oridecon.di.module.graph import CompiledModuleGraph
from oridecon.logging import get_logger

if TYPE_CHECKING:
    from oridecon.di.module.compiler.phases import CompilerPhase
...
class ModuleCompiler:
    ...
    def _check_stub_requirements(self, ctx: CompilerContext) -> None:
        ...
        from the base :class:`~oridecon.di.module.base.Module` class.  Appends
        ...
        Args:
            ctx: Shared compilation state.  Reads ``nodes``; appends to
                ``warnings``.
        """
        from oridecon.di.module.base import Module
