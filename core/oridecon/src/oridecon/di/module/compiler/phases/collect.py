...
from oridecon.contracts.exceptions.provider import ModuleDuplicateError, ModuleError
...
from oridecon.di.module.graph import ModuleNode
from oridecon.di.module.introspection import get_module_metadata, is_dynamic_module
    ...
    def _collect_static(self, cls: type, ctx: CompilerContext) -> type:
        ...
        if meta is None:
            raise ModuleError(
                ...
                f"\n"
                f"Reference: https://docs.oridecon.dev/modules#declaration",
                hint=(
