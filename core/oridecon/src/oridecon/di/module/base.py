...
class ModuleMeta(type):
    ...
    def __repr__(cls) -> str:
        metadata = getattr(cls, "__oridecon_module__", None)
        module_name = (
...
class Module(metaclass=ModuleMeta):
    ...
    **Inheriting from Module is NOT required** — any class decorated with
    ``@module()`` is a valid Oridecon module.  This base class is a
    ...
    def __call__(self, cls: type[_T]) -> type[_T]:
        ...
        Attaches :class:`~oridecon.di.module.ModuleMetadata` to *cls* using
        ...
        Example::
            ...
            class AppModule(ModuleBase):
                pass
        """
        from oridecon.di.module.decorator import _attach_metadata
