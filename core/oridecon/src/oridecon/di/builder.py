...
:class:`~oridecon.app.base.Application` with :meth:`add_module`
...
from oridecon.contracts import ServiceScope
from oridecon.contracts.exceptions import ContainerBuildError, OrideconError
...
class ContainerBuilder(AbstractBuilder[Container]):
    ...
    For application-level composition, use
    :class:`~oridecon.app.base.Application` instead — it provides the
    ...
    def add_module(self, module_or_dynamic: type | DynamicModule) -> Self:
        ...
        use :class:`~oridecon.app.base.Application`.
