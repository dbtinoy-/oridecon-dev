...
from oridecon.di.container.container_introspection import ContainerIntrospectionMixin
from oridecon.di.container.container_runtime import ContainerRuntimeMixin
...
from oridecon.di.context import _module_graph, check_visibility, get_current_module
from oridecon.di.extensions.interceptors import InterceptorRegistry
from oridecon.di.extensions.validator import ProtocolValidator
from oridecon.di.module.errors import format_visibility_error
from oridecon.di.resolution.diagnostics import ContainerDiagnostics
from oridecon.di.resolution.injector import DependencyInjector
from oridecon.di.resolution.invoker import FunctionInvoker
...
if TYPE_CHECKING:
    ...
    from oridecon.di.resolution.type_hints import BoundedCache
    from oridecon.di.types import ServiceFactory
...
class Container(
    ...
    def create_invoker(self) -> FunctionInvoker:
        """Create a :class:`~oridecon.di.resolution.invoker.FunctionInvoker` bound to this container.
        ...
        Returns:
            A :class:`~oridecon.di.resolution.invoker.FunctionInvoker` configured
    ...
    def freeze(self, validate: bool = True) -> None:
        ...
        or ``clear()`` will raise :class:`~oridecon.exceptions.ContainerError`.
        ...
        Args:
            validate: When ``True`` (default), runs pre-flight dependency
                ...
                :class:`~oridecon.contracts.exceptions.container.ContainerValidationError`
        ...
        """
        if validate:
            from oridecon.contracts.exceptions.container import ContainerValidationError
