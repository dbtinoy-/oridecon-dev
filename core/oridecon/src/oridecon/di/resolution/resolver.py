...
from oridecon.di.resolution.descriptor import ServiceDescriptor, ServiceScope
from oridecon.logging import get_logger

if TYPE_CHECKING:
    from oridecon.di.protocols import InjectorProtocol
...
class ServiceResolver:
    ...
    def can_resolve(self, service_type: object) -> bool:
        ...
        return bool(
            ...
            and getattr(service_type, "__oridecon_inject__", False)
        )
    ...
    async def _do_resolve(self, service_type: object) -> Any:
        ...
        if descriptor.scope is ServiceScope.SCOPED:
            ...
            from oridecon.contracts.exceptions.container import ScopedResolutionError
    ...
    async def _resolve_unregistered(self, service_type: object) -> Any:
        ...
        if getattr(service_type, "__oridecon_inject__", False):
    ...
    def _unwrap_annotated(
        ...
        from oridecon.di.markers import Inject, Named
