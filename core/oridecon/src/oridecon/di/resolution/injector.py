...
from oridecon.di.markers import Inject, Named, OptionalDep, Qualifier
from oridecon.logging import get_logger

if TYPE_CHECKING:
    from oridecon.di.protocols import DIResolverProtocol, TypeHintResolverProtocol
...
class DependencyInjector:
    ...
    async def instantiate(self, cls: type, force_inject: bool = False) -> Any:
        ...
        Args:
            ...
            force_inject: If True, inject even without ``__oridecon_inject__`` marker.
        ...
        """
        if not force_inject and not getattr(cls, "__oridecon_inject__", False):
            return cls()
