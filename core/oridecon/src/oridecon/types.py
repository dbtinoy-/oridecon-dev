"""Public type aliases and generics for the oridecon framework.
...
Callable signatures::
    ...
    from oridecon.types import ServiceFactory, MiddlewareFactory

    def boot_service(factory: ServiceFactory) -> Any: ...

Hook handler signatures::

    from oridecon.types import ActionHandler, FilterHandler
"""
