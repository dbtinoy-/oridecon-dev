...
if TYPE_CHECKING:
    from oridecon.contracts.web import GuardProtocol
...
def use_guards(*guards: GuardProtocol) -> Callable[[F], F]:
    ...
    guard denies access, a :class:`~oridecon.contracts.exceptions.middleware.MiddlewareGuardError`
    is raised.
    ...
    Example::
        ...
        from oridecon.security.guards import use_guards
