...
if TYPE_CHECKING:
    from oridecon.security.sanitization import InputSanitizer
...
def sanitize_input(
    *fields: str,
    ...
    Uses :class:`~oridecon.security.sanitization.InputSanitizer` to strip
    ...
    def decorator(fn: F) -> F:
        from oridecon.security.sanitization import (
