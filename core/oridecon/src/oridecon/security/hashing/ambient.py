...
Use `from oridecon import hashing` for ambient hashing.

Example:
    from oridecon import hashing
...
For tests:
    from oridecon import hashing
    from oridecon.security.hashing.digest import Sha256Hasher
...
from oridecon.contracts.security.protocols import HasherProtocol
from oridecon.security.hashing.digest import Sha256Hasher
