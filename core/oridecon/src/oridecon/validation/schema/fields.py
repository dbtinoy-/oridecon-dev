...
All consumers import from ``oridecon.validation`` as before; this module
...
``oridecon.contracts.exceptions.domain`` which is the single canonical
definition that inherits from ``OrideconError``.
"""
