...
Applies a :class:`~oridecon.validation.validator.ValidatorImpl` to function
...
if TYPE_CHECKING:
    from oridecon.validation.engine.validator import ValidatorImpl
...
def validate_input(validator: ValidatorImpl[Any]) -> Callable[[F], F]:
    ...
    failure a :class:`~oridecon.contracts.validation.ValidationError` is
