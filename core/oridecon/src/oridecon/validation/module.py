...
class ValidationModule(Module):
    """Composable validation pipeline for the Oridecon Framework.
    ...
    Usage::
        ...
        from oridecon.validation import ValidationModule, ValidatorImpl
    ...
    def configure(cls) -> DynamicModule:
        ...
        Returns:
            A :class:`~oridecon.di.module.DynamicModule` with no providers.
        """
