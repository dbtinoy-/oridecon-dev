"""Abstract repository and mapper base classes for the Oridecon core layer.
...
Typical usage::
    ...
    from oridecon.primitives.data import AbstractRepository, DataMapper
