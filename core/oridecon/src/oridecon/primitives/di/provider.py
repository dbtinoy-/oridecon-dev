...
class CoreInfrastructureProvider(Provider):
    """Provider for **shared low-level Oridecon infrastructure**.
    ...
    **Do NOT confuse with** :class:`~oridecon.app.di.provider.CoreProvider`:
    ...
    +-----------------------------------+----------------------------------------------------+
    | Used inside the framework         | Used by application bootstrap (``OrideconApp``)    |
    +-----------------------------------+----------------------------------------------------+
    ...
    async def register(self, container: ContainerRegistrarProtocol) -> None:
        ...
        from oridecon.contracts.core.context import RequestContextProtocol
    ...
    async def boot(self, container: ContainerResolverProtocol) -> None:
        ...
        logger.info("Oridecon Common infrastructure starting up")

    async def shutdown(self) -> None:
        """Clean up common resources."""
        logger.info("Oridecon Common infrastructure shutting down")
