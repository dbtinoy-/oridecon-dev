"""Context variable registry for the Oridecon Framework.

Injectable storage backend managing ``contextvars.ContextVar`` instances
keyed by name; consumed by :class:`oridecon.primitives.context.Context`.
"""
...
if TYPE_CHECKING:
    from oridecon.primitives.context_keys import ContextKey
