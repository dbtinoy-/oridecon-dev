...
from oridecon.mapping.exceptions import MappingExecutionError
from oridecon.result import Err, Ok, Result

if TYPE_CHECKING:
    from collections.abc import Callable

    from oridecon.contracts.core.validation import ValidatorProtocol
    from oridecon.mapping.config import MappingConfig
...
class ObjectMapperImpl:
    ...
    def __init__(
        ...
        from oridecon.mapping.config import MappingConfig as _MappingConfig
    ...
    def map(
        ...
        *,
        ...
        if mapper_func is None:
            from oridecon.mapping.exceptions import MappingNotFoundError
