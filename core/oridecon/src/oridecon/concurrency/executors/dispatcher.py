...
from oridecon.concurrency.config import DispatcherConfig
from oridecon.concurrency.exceptions import DispatcherError
...
async def dispatch(
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        from oridecon.concurrency.executors.dispatcher import DispatcherImpl, dispatch
...
def run_sync(
    ...
    **kwargs: Any,
    ...
    :class:`~oridecon.concurrency.sync_bridge.SyncBridge`.  If *func*
