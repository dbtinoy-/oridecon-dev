...
from oridecon.contracts.core.di import ContainerRegistrarImpl
...
from oridecon.di.module import (
...
class TestCycleDetection:
    ...
    def test_direct_cycle(self):
        ...
        ModA.__oridecon_module__ = ModA.__oridecon_module__.__class__(
            name="ModA",
            providers=(StubProviderA,),
            imports=(ModB,),
        )
        ModB.__oridecon_module__ = ModB.__oridecon_module__.__class__(
            name="ModB",
            providers=(StubProviderB,),
            imports=(ModA,),
        )
    ...
    def test_indirect_cycle(self):
        ...
        ModA.__oridecon_module__ = ModuleMetadata(
            name="ModA", providers=(StubProviderA,), imports=(ModB,),
        )
        ModB.__oridecon_module__ = ModuleMetadata(
            name="ModB", providers=(StubProviderB,), imports=(ModC,),
        )
        ModC.__oridecon_module__ = ModuleMetadata(
...
from oridecon.di.module import DynamicModule, ModuleCompiler, global_module, module
from tests.di.module.conftest import (
    ProtoA,
    ProtoB,
    ProtoC,
...
from oridecon.di.module import ModuleCompiler, module
from tests.di.module.conftest import (
    ProtoA,
    ProtoB,
    ProtoC,
...
from oridecon.di.module import ModuleCompiler, module, global_module
from tests.di.module.conftest import (
    ProtoA,
    ProtoB,
    ProtoC,
...
from oridecon.di.module import ModuleCompiler, ModuleRegistry, module
...
from oridecon.di.module.errors import (
    format_cycle_error,
...
from oridecon.contracts.core.di import ContainerRegistrarImpl, ContainerResolverImpl
from oridecon.contracts.core.lifecycle import OnModuleInit, OnApplicationBootstrap
...
from oridecon.app.base import AppState, Application
from oridecon.config.main import OrideconConfig
from oridecon.contracts.core.di import ContainerRegistrarImpl, ContainerResolverImpl
from oridecon.di.module import DynamicModule, Module, global_module, module
from oridecon.di.provider import Provider, ProviderPriority
