...
class TestLoggingLazyImports:
    ...
    def test_import_logger_factory(self) -> None:
        ...
        from oridecon.logging import LoggerFactoryProtocol
    ...
    def test_import_logger_factory_impl(self) -> None:
        ...
        from oridecon.logging import LoggerFactoryImpl
...
class TestLoggingModuleVisibility:
    ...
    def test_core_module_exports_logging_contracts(self) -> None:
        ...
        from oridecon.app.module import _get_core_exports
    ...
    def test_root_package_exports_logging_contracts(self) -> None:
        """The root ``oridecon`` facade exposes the logging contracts."""
        import oridecon

        assert oridecon.LoggerProtocol is not None
        assert oridecon.LoggerFactoryProtocol is not None
        assert oridecon.RedactorProtocol is not None
