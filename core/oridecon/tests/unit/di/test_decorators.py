...
class TestInjectableClass:
    ...
    def test_call_marks_class(self) -> None:
        ...
        assert MyService.__oridecon_injectable__["scope"] == ServiceScope.TRANSIENT
    ...
    def test_call_with_scope_and_name(self) -> None:
        ...
        assert MyService.__oridecon_injectable__["scope"] == ServiceScope.SCOPED
        assert MyService.__oridecon_injectable__["name"] == "custom-name"
...
class TestInjectableDecorator:
    ...
    def test_injectable_with_scope_kwarg(self) -> None:
        ...
        assert MyService.__oridecon_injectable__["scope"] == ServiceScope.SINGLETON
    ...
    def test_injectable_with_name_kwarg(self) -> None:
        ...
        assert MyService.__oridecon_injectable__["name"] == "my-named-service"
    ...
    def test_injectable_with_both_kwargs(self) -> None:
        ...
        assert MyService.__oridecon_injectable__["scope"] == ServiceScope.SCOPED
        assert MyService.__oridecon_injectable__["name"] == "scoped-service"
...
class TestInjectDecorator:
    ...
    def test_inject_on_class(self) -> None:
        ...
        assert MyService.__oridecon_inject__ is True
