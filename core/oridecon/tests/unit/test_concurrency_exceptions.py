...
class TestConcurrencyError:
    ...
    def test_code(self) -> None:
        assert ConcurrencyError._code == "ORI_ERR_CONC_001"
...
class TestAsyncError:
    ...
    def test_code(self) -> None:
        assert AsyncError._code == "ORI_ERR_CONC_002"
...
class TestChannelClosedError:
    ...
    def test_code(self) -> None:
        assert ChannelClosedError._code == "ORI_ERR_CONC_003"
...
class TestChannelFullError:
    ...
    def test_code(self) -> None:
        assert ChannelFullError._code == "ORI_ERR_CONC_004"
...
class TestDispatcherError:
    ...
    def test_code(self) -> None:
        assert DispatcherError._code == "ORI_ERR_CONC_005"
...
class TestStructuredParallelismError:
    ...
    def test_code(self) -> None:
        assert StructuredParallelismError._code == "ORI_ERR_CONC_006"
...
class TestTaskGroupError:
    ...
    def test_code(self) -> None:
        assert TaskGroupError._code == "ORI_ERR_CONC_007"
...
class TestCancellationScopeError:
    ...
    def test_code(self) -> None:
        assert CancellationScopeError._code == "ORI_ERR_CONC_008"