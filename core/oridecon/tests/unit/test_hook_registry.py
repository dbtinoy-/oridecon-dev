...
class TestHookEntry:
    def test_hook_entry_is_frozen(self) -> None:
        from oridecon.hooks.types import HookEntry
...
class TestDecoratorAPI:
    ...
    async def test_decorator_with_priority_and_once(self) -> None:
        from oridecon.contracts.core.hooks import HookPriority
...
class TestProtocolCompliance:
    ...
    def test_hook_priority_importable_from_oridecon(self) -> None:
        import oridecon

        assert hasattr(oridecon, "HookPriority")
        from oridecon import HookPriority
        from oridecon.contracts.core.hooks import HookPriority as HookPriorityContract

        assert HookPriority is HookPriorityContract

    def test_hook_registry_protocol_importable_from_oridecon(self) -> None:
        from oridecon import HookRegistryProtocol
        from oridecon.contracts.core.hooks import (
...
class TestAmbientHooks:
    ...
    def test_install_sets_process_registry(self) -> None:
        from oridecon.hooks.ambient import current, install
    ...
    async def test_fire_invokes_registered_action(self) -> None:
        from oridecon.hooks.ambient import fire, use
