...
from oridecon.middleware.di.provider import _EP_GROUP, MiddlewareProvider
...
class TestMiddlewareProviderEpDiscovery:
    ...
    async def test_no_entry_points(self) -> None:
        ...
        with patch(
            "oridecon.middleware.di.provider.importlib.metadata.entry_points",
            return_value=[],
        ):
    ...
    async def test_ep_group_constant(self) -> None:
        ...
        assert _EP_GROUP == "oridecon.middleware"
