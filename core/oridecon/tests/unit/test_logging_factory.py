...
class TestGetLogger:
    ...
    def test_default_name(self) -> None:
        """Test get_logger with None returns oridecon."""
        logger = get_logger(None)
        assert logger.name == "oridecon"

    def test_no_prefix_already_prefixed(self) -> None:
        """Test get_logger doesn't double prefix oridecon."""
        logger = get_logger("oridecon.module")
        assert logger.name == "oridecon.module"
...
class TestLoggerFactoryImpl:
    ...
    def test_get_logger_binds_service(self) -> None:
        ...
        factory = LoggerFactoryImpl()
        logger = factory.get_logger("test")
        assert logger.name == "oridecon.test"
...
class TestGetLoggerEdgeCases:
    ...
    def test_logger_with_dot_prefix(self) -> None:
        """Test get_logger with . prefix adds oridecon."""
        logger = get_logger(".something")
        assert logger.name == "oridecon..something"

    def test_get_logger_no_name_returns_oridecon(self) -> None:
        """Test get_logger with no args returns oridecon."""
        logger = get_logger()
        assert logger.name == "oridecon"
...
class TestLoggerFactoryImplEdgeCases:
    ...
    def test_get_logger_bind_type_error_returns_unchanged_logger(
        ...
        monkeypatch.setattr(
            "oridecon.logging.factory.get_logger",
