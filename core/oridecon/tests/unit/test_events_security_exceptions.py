...
class TestEventsExceptionHierarchy:
    ...
    def test_event_error_inherits_from_oridecon(self) -> None:
        """EventError inherits from OrideconError."""
        assert issubclass(EventError, OrideconError)
...
class TestSecurityExceptionHierarchy:
    ...
    def test_security_error_inherits_from_oridecon(self) -> None:
        """SecurityError inherits from OrideconError."""
