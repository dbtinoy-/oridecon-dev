...
class TestInfraExceptionHierarchy:
    ...
    def test_infrastructure_error_inherits_from_oridecon(self) -> None:
        """InfrastructureError inherits from OrideconError."""
        assert issubclass(InfrastructureError, OrideconError)
...
class TestRegistryKeyError:
    ...
    def test_has_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_REG_002"
...
class TestRegistryAlreadyExistsError:
    ...
    def test_has_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_REG_003"
...
class TestDuplicateKeyError:
    ...
    def test_has_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_DB_005"
