...
class TestConcurrencyError:
    def test_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_CONC_001"


class TestAsyncError:
    def test_code(self) -> None:
        exc = AsyncError()
        assert exc.code == "ORI_ERR_CONC_002"


class TestChannelClosedError:
    def test_code(self) -> None:
        exc = ChannelClosedError()
        assert exc.code == "ORI_ERR_CONC_003"
...
class TestChannelFullError:
    def test_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_CONC_004"
...
class TestStructuredParallelismError:
    def test_code(self) -> None:
        ...
        assert exc.code == "ORI_ERR_CONC_006"


class TestTaskGroupError:
    def test_code(self) -> None:
        exc = TaskGroupError()
        assert exc.code == "ORI_ERR_CONC_007"


class TestCancellationScopeError:
    def test_code(self) -> None:
        exc = CancellationScopeError()
        assert exc.code == "ORI_ERR_CONC_008"
