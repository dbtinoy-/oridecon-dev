...
from oridecon.logging.debug import is_debug_mode, log_lifecycle
...
class TestIsDebugMode:
    ...
    def test_debug_mode_disabled_by_default(self) -> None:
        ...
        with patch.dict(os.environ, {}, clear=True):
            # Remove ORI_DEBUG from environment
            env_without = {k: v for k, v in os.environ.items() if k != "ORI_DEBUG"}
...
class TestLogLifecycle:
    ...
    @patch("oridecon.logging.debug.is_debug_mode")
    def test_log_lifecycle_disabled_when_not_debug(
        ...
        with patch("oridecon.logging.debug.logger") as mock_logger:
...
class TestDebugModuleExports:
    ...
    def test_log_lifecycle_exported(self) -> None:
        ...
        from oridecon.logging.debug import log_lifecycle
