...
Verifies that all __all__ exports in oridecon-contracts actually resolve,
...
CONTRACT_PACKAGES = [
    "oridecon.contracts",
    "oridecon.contracts.admin",
    "oridecon.contracts.ai",
    "oridecon.contracts.auth",
    "oridecon.contracts.core",
    "oridecon.contracts.data",
    "oridecon.contracts.domain",
    "oridecon.contracts.events",
    "oridecon.contracts.exceptions",
    "oridecon.contracts.feature_flags",
    "oridecon.contracts.graphql",
    "oridecon.contracts.infra",
    "oridecon.contracts.mapping",
    "oridecon.contracts.mcp",
    "oridecon.contracts.observability",
    "oridecon.contracts.search",
    "oridecon.contracts.security",
    "oridecon.contracts.web",
    "oridecon.contracts.workflow",
]
...
class TestNoPhantomAuthExports:
    ...
    def test_authenticator_protocol_in_all(self) -> None:
        ...
        from oridecon.contracts import auth
    ...
    def test_authenticator_exists(self) -> None:
        ...
        from oridecon.contracts.auth import AuthenticatorProtocol
...
class TestAuthExportsComplete:
    ...
    def test_user_identity_exported(self) -> None:
        ...
        from oridecon.contracts.auth import UserIdentityProtocol
    ...
    def test_user_reader_exported(self) -> None:
        ...
        from oridecon.contracts.auth import UserReaderProtocol
    ...
    def test_user_writer_exported(self) -> None:
        ...
        from oridecon.contracts.auth import UserWriterProtocol
    ...
    def test_user_store_exported(self) -> None:
        ...
        from oridecon.contracts.auth import UserStoreProtocol
...
class TestSearchExports:
    ...
    def test_database_search_backend_exported(self) -> None:
        ...
        from oridecon.contracts.search import DatabaseSearchBackendProtocol
    ...
    def test_all_search_exports_resolve(self) -> None:
        ...
        from oridecon.contracts import search
...
class TestTopLevelContractsExports:
    ...
    def test_config_protocol_exported(self) -> None:
        ...
        from oridecon.contracts import ConfigProtocol
    ...
    def test_event_middleware_exported(self) -> None:
        ...
        from oridecon.contracts.events import EventMiddlewareProtocol
