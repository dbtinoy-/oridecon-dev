...
class TestApplyConfig:
    ...
    def test_apply_with_levels(self) -> None:
        ...
        from oridecon.logging.processors import _state
        assert "oridecon.di" in _state.logger_levels
    ...
    def test_apply_redaction_enabled_default(self) -> None:
        ...
        from oridecon.logging.redaction import DefaultRedactor, get_redactor
    ...
    def test_apply_redaction_disabled(self) -> None:
        ...
        from oridecon.logging.redaction import NoOpRedactor, get_redactor
