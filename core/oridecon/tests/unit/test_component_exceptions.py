...
from oridecon.contracts.exceptions.security import SecretAccessError


class TestComponentExceptionHierarchy:
    """Tests for component exception inheritance."""

    def test_component_error_inherits_from_oridecon(self) -> None:
        """ComponentError inherits from OrideconError."""
...
class TestComponentErrorCodes:
    ...
    def test_component_error_has_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_INFRA_004"
    ...
    def test_driver_not_available_error_has_code(self) -> None:
        ...
        assert exc._code == "ORI_ERR_INFRA_010"
