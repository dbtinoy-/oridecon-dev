...
class TestResilienceExceptionHierarchy:
    ...
    def test_resilience_error_inherits_from_oridecon(self) -> None:
        """ResilienceError inherits from OrideconError."""
