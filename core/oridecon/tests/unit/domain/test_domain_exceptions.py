...
class TestDomainExceptionHierarchy:
    ...
    def test_domain_error_inherits_from_oridecon(self) -> None:
        """DomainError inherits from OrideconError."""
        assert issubclass(DomainError, OrideconError)
...
class TestSerializationError:
    ...
    def test_inherits_from_oridecon_error(self) -> None:
        """SerializationError inherits from OrideconError."""
        assert issubclass(SerializationError, OrideconError)

    def test_has_code(self) -> None:
        """SerializationError has _code."""
        exc = SerializationError()
        assert exc._code == "ORI_ERR_SERIAL_001"
...
class TestMappingError:
    ...
    def test_inherits_from_oridecon_error(self) -> None:
        """MappingError inherits from OrideconError."""
        assert issubclass(MappingError, OrideconError)

    def test_has_code(self) -> None:
        """MappingError has _code."""
        exc = MappingError()
        assert exc._code == "ORI_ERR_MAP_001"
...
class TestValidationError:
    ...
    def test_has_code(self) -> None:
        ...
        exc = ValidationError()
        assert exc._code == "ORI_ERR_VAL_002"
