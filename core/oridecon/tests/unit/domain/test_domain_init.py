...
class TestDomainLazyImports:
    ...
    def test_lazy_import_domain_error(self) -> None:
        ...
        from oridecon.domain import DomainError
    ...
    def test_lazy_import_field_error(self) -> None:
        ...
        from oridecon.domain import FieldError
    ...
    def test_lazy_import_unit_of_work_error(self) -> None:
        ...
        from oridecon.domain import UnitOfWorkError
    ...
    def test_lazy_import_validation_error(self) -> None:
        ...
        from oridecon.domain import ValidationError
    ...
    def test_lazy_import_specification(self) -> None:
        ...
        from oridecon.domain import SpecificationProtocol
    ...
    def test_lazy_import_unit_of_work_protocol(self) -> None:
        ...
        from oridecon.domain import UnitOfWorkProtocol
    ...
    def test_coerce_str_to_bool_from_canonical_source(self) -> None:
        """coerce_str_to_bool lives in oridecon.validation.engine.coercion."""
        from oridecon.validation.engine.coercion import coerce_str_to_bool

        assert callable(coerce_str_to_bool)

    def test_coerce_to_bool_from_canonical_source(self) -> None:
        """coerce_to_bool lives in oridecon.validation.engine.coercion."""
        from oridecon.validation.engine.coercion import coerce_to_bool

        assert callable(coerce_to_bool)

    def test_coerce_field_value_from_canonical_source(self) -> None:
        """coerce_field_value lives in oridecon.validation.engine.coercion."""
        from oridecon.validation.engine.coercion import coerce_field_value

        assert callable(coerce_field_value)

    def test_bool_true_from_canonical_source(self) -> None:
        """BOOL_TRUE lives in oridecon.validation.engine.coercion."""
        from oridecon.validation.engine.coercion import BOOL_TRUE

        assert isinstance(BOOL_TRUE, frozenset)

    def test_bool_false_from_canonical_source(self) -> None:
        """BOOL_FALSE lives in oridecon.validation.engine.coercion."""
        from oridecon.validation.engine.coercion import BOOL_FALSE

        assert isinstance(BOOL_FALSE, frozenset)

    def test_build_json_schema_from_canonical_source(self) -> None:
        """build_json_schema lives in oridecon.serialization.schema."""
        from oridecon.serialization.schema import build_json_schema

        assert callable(build_json_schema)

    def test_field_validator_from_canonical_source(self) -> None:
        """field_validator lives in oridecon.validation."""
