...
Adapted from oridecon-security/tests/unit/test_secret_rotation_policy.py.
"""
...
from oridecon.security.types import SecretRotationPolicy as DirectImport
...
class TestSecretRotationPolicyImport:
    ...
    def test_in_all_exports(self) -> None:
        from oridecon.contracts.security import __all__ as exported  # noqa: PLC0415
