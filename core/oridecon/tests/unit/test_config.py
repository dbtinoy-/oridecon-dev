...
from oridecon.config import BaseConfig, ConfigSourceType, OrideconConfig
...
class TestBaseConfig:
    ...
    def test_get_returns_default_for_missing_nested_dict_leaf(self) -> None:
        ...
        config = OrideconConfig.from_dict({})
...
class TestOrideconConfig:
    """Tests for OrideconConfig main class."""
    ...
    def test_environment_property_overrides_field(self) -> None:
        ...
        config = OrideconConfig.from_dict({"env": Environment.DEVELOPMENT})
    ...
    def test_to_dict_redacts_secrets_by_default(self) -> None:
        ...
        config = OrideconConfig.from_dict({"api_key": "secret123"})
        result = config.to_dict()
    ...
    def test_extra_fields_allowed(self) -> None:
        ...
        config = OrideconConfig.from_dict({"extra_field": "value"})
...
class TestConfigConstants:
    ...
    def test_default_env_var_prefix(self) -> None:
        ...
        assert DEFAULT_ENV_VAR_PREFIX == "ORI_"
