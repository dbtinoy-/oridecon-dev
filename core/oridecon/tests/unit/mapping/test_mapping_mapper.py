...
from oridecon.mapping.exceptions import MappingError
from oridecon.mapping.types import MapperProtocol
...
class TestMappingModule:
    ...
    def test_module_class_is_accessible(self):
        """MappingModule is importable and accessible from oridecon.mapping."""
        assert MappingModule is not None
