"""Tests for oridecon.plugins.state — boot-readable disabled-plugin file mirror."""
...
from oridecon.plugins.state import load_disabled, save_disabled
...
def test_load_disabled_uses_env_var_when_no_path_given(
    ...
    monkeypatch.setenv("ORIDECON_PLUGINS_STATE_PATH", str(path))
