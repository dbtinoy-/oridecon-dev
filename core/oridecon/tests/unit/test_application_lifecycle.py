...
class TestApplicationShutdownTimeout:
    ...
    async def test_stop_raises_when_shutdown_exceeds_timeout(self) -> None:
        ...
        app = Application()
        app._state = AppState.RUNNING
        app._config = OrideconConfig(app={"shutdown_timeout": 0.05})
    ...
    async def test_stop_within_timeout_succeeds(self) -> None:
        ...
        app = Application()
        app._state = AppState.RUNNING
        app._config = OrideconConfig(app={"shutdown_timeout": 30.0})
    ...
    async def test_stop_uses_default_when_timeout_is_missing(self) -> None:
        ...
        app = Application()
        app._state = AppState.RUNNING
        app._config = OrideconConfig(app={})
        ...
        with patch.object(
            ...
            with patch("oridecon.app.base.asyncio.wait_for", new=wait_for):
                await app.stop()
