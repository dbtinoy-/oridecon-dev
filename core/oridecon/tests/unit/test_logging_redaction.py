...
from oridecon.logging.redaction import (
    DefaultRedactor,
    DelegatingRedactor,
    NoOpRedactor,
    _redactor_var,
...
class TestGetRedactor:
    ...
    def test_get_redactor_with_context_override(self) -> None:
        ...
        try:
            ...
            from oridecon.logging.redaction import _redactor_var
            _redactor_var.reset(token)
