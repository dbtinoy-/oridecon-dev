...
from oridecon.di.module import ModuleMetadata, module
from oridecon.di.module.decorator import _create_scan_provider
...
class TestModuleScanParameter:
    ...
    def test_scan_stored_in_metadata(self) -> None:
        ...
        meta: ModuleMetadata = MyModule.__oridecon_module__
...
class TestProvideDecorator:
    ...
    def test_provide_instantiable(self) -> None:
        ...
        from oridecon.di.function_provider import provide
