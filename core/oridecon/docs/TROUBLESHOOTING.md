---
title: "oridecon Troubleshooting"
description: "Solutions to common issues with the Oridecon framework."
---
# Troubleshooting
...
**Solution:** Set `debug: false` or remove the `ORI_DEBUG` env var in production environments. Run `config.validate_for_environment()` at startup:
